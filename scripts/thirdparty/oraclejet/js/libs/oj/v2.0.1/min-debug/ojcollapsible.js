...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$29$$, $$$$28$$) {
  (function() {
    ...
    $oj$$29$$.$__registerWidget$("oj.ojCollapsible", $$$$28$$.oj.baseComponent, {widgetEventPrefix:"oj", options:{expanded:!1, disabled:null, expandOn:"click", expandArea:"header", beforeExpand:null, expand:null, beforeCollapse:null, collapse:null, optionChange:null}, _ComponentCreate:function() {
      ...
      var $elem$$68$$ = this.element[0];
      this.$_expandCollapseHandler$({type:this.options.expanded ? "ojexpand" : "ojcollapse", target:$elem$$68$$, currentTarget:$elem$$68$$, preventDefault:$$$$28$$.noop});
    ...
    }, _setOption:function($key$$142$$, $value$$262$$, $flags$$37$$) {
      "expanded" === $key$$142$$ ? $value$$262$$ !== this.options.expanded && this.$_setExpanded$($value$$262$$) : "disabled" === $key$$142$$ ? (this.header.add(this.header.next()), this.element.toggleClass("oj-disabled", !!$value$$262$$)) : "expandOn" === $key$$142$$ || "expandArea" === $key$$142$$ ? (this.$_tearDownEvents$(), this._super($key$$142$$, $value$$262$$, $flags$$37$$), this.$_setupEvents$()) : this._super($key$$142$$, $value$$262$$, $flags$$37$$);
      ...
      if (!this.$_isDisabled$() && $event$$389$$.target === this.element[0] && (this.$_initialRender$ || !$event$$389$$.isDefaultPrevented())) {
        var $element$$121$$ = this.element, $options$$298$$ = this.options, $content$$22$$ = this.content, $wrapper$$ = this.$wrapper$, $isExpanded$$ = "ojexpand" === $event$$389$$.type;
        $event$$389$$.preventDefault();
        this.$_initialRender$ ? ($options$$298$$.expanded = $isExpanded$$) ? ($element$$121$$.removeClass("oj-collapsed"), $element$$121$$.addClass("oj-expanded"), $oj$$29$$.Components.$subtreeShown$($wrapper$$[0])) : ($element$$121$$.removeClass("oj-expanded"), $element$$121$$.addClass("oj-collapsed"), $wrapper$$.css("max-height", 0), $wrapper$$.hide(), $oj$$29$$.Components.$subtreeHidden$($wrapper$$[0])) : (this.$_changeExpandedOption$($isExpanded$$, $event$$389$$), $wrapper$$.$contentHeight$ = 
        $wrapper$$.outerHeight(), $isExpanded$$ ? ($wrapper$$.show(), setTimeout(function() {
          ...
          $element$$121$$.removeClass("oj-collapsed");
          $element$$121$$.addClass("oj-expanded");
          ...
          $element$$121$$.removeClass("oj-expanded");
          $element$$121$$.addClass("oj-collapsed");
    ...
    }, $_changeExpandedOption$:function($value$$263$$, $originalEvent$$1$$) {
      this.option("expanded", $value$$263$$, {_context:{originalEvent:$originalEvent$$1$$, $writeback$:!0, $internalSet$:!0}});
