...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojconveyorbelt", "ojs/ojmenu", "jqueryui-amd/sortable", "ojs/ojtouchproxy"], function($oj$$72$$, $$$$65$$) {
  (function() {
    ...
    $oj$$72$$.$__registerWidget$("oj.ojTabs", $$$$65$$.oj.baseComponent, {widgetEventPrefix:"oj", delay:300, options:{selected:0, disabledTabs:null, truncation:"auto", selectOn:"click", orientation:"horizontal", edge:"top", removable:!1, reorderable:!1, beforeSelect:null, select:null, beforeDeselect:null, deselect:null, beforeRemove:null, remove:null, beforeReorder:null, reorder:null, optionChange:null}, _ComponentCreate:function() {
    ...
    }, _setOption:function($edge$$13_key$$183_selectedIndex$$4$$, $value$$314$$, $flags$$49$$) {
      "selected" === $edge$$13_key$$183_selectedIndex$$4$$ ? ($value$$314$$ = this.$_getTab$($value$$314$$), void 0 !== $value$$314$$ && this.$_activate$($value$$314$$)) : "disabledTabs" === $edge$$13_key$$183_selectedIndex$$4$$ ? Array.isArray($value$$314$$) && (this.$_setOjDisabledOnTab$($value$$314$$), $edge$$13_key$$183_selectedIndex$$4$$ = this.$_getSelectedIndex$(), this.$_isTabDisabled$($edge$$13_key$$183_selectedIndex$$4$$) && this.$_fireSelectEvents$($edge$$13_key$$183_selectedIndex$$4$$), 
      this.refresh()) : "removable" === $edge$$13_key$$183_selectedIndex$$4$$ || "truncation" === $edge$$13_key$$183_selectedIndex$$4$$ ? $value$$314$$ != this.options[$edge$$13_key$$183_selectedIndex$$4$$] && (this._super($edge$$13_key$$183_selectedIndex$$4$$, $value$$314$$, $flags$$49$$), this.refresh()) : "reorderable" === $edge$$13_key$$183_selectedIndex$$4$$ ? $value$$314$$ !== this.options.reorderable && (this._super($edge$$13_key$$183_selectedIndex$$4$$, $value$$314$$, $flags$$49$$), this.refresh()) : 
      "orientation" === $edge$$13_key$$183_selectedIndex$$4$$ ? this.$_edgeSpecified$ || ($edge$$13_key$$183_selectedIndex$$4$$ = this.$_orientationToEdge$($value$$314$$)) && this.$_setupEdge$($edge$$13_key$$183_selectedIndex$$4$$) && this.refresh() : "edge" === $edge$$13_key$$183_selectedIndex$$4$$ ? this.$_setupEdge$($value$$314$$) && (this.$_edgeSpecified$ = !0, this._super($edge$$13_key$$183_selectedIndex$$4$$, $value$$314$$, $flags$$49$$), this.refresh()) : "selectOn" === $edge$$13_key$$183_selectedIndex$$4$$ ? 
      (this.$_tearDownEvents$(!0), this._super($edge$$13_key$$183_selectedIndex$$4$$, $value$$314$$, $flags$$49$$), this.$_setupEvents$()) : ("contextMenu" === $edge$$13_key$$183_selectedIndex$$4$$ && (this.$_clearMenu$(), $value$$314$$ && this.$_initMenu$($value$$314$$)), this._super($edge$$13_key$$183_selectedIndex$$4$$, $value$$314$$, $flags$$49$$), "translations" === $edge$$13_key$$183_selectedIndex$$4$$ && $flags$$49$$ && "removeCueText" === $flags$$49$$.subkey && this.$tablist$ && this.$_getCloseIcons$(this.$tablist$).attr("aria-label", 
      $value$$314$$ ? $value$$314$$.removeCueText : ""));
    }, refresh:function() {
      this._super();
      this.$_processTabs$();
      this.$_refresh$();
    ...
    }, $_getCloseIcons$:function($elem$$162$$) {
      return $elem$$162$$.find(".oj-tabs-close-icon");
    ...
    }, $_orientationToEdge$:function($value$$315$$) {
      return "horizontal" == $value$$315$$ ? "top" : "vertical" == $value$$315$$ ? "start" : null;
      ...
      return $ulParent$$;
    }, $_addPrefixId$:function($elem$$163$$) {
      0 > $elem$$163$$.id.indexOf("ojtabs-id_") && $$$$65$$($elem$$163$$).attr("id", "ojtabs-id_" + $elem$$163$$.id);
      ...
      for (var $panels_title$$11$$ = [], $i$$447_tabIndex$$5$$ = 0;$i$$447_tabIndex$$5$$ < this.$tabs$.length;$i$$447_tabIndex$$5$$++) {
        $panels_title$$11$$.push(this.$_getPanelForTab$(this.$tabs$[$i$$447_tabIndex$$5$$])[0]);
      }
      for (var $closeIcon_panelIndex$$ = $i$$447_tabIndex$$5$$ = -1, $currentNode$$4$$ = $node$$127$$;$currentNode$$4$$;) {
        if (this.$conveyor$ && $currentNode$$4$$ === this.$conveyor$[0]) {
          return{subId:"oj-conveyorbelt"};
        }
        $i$$447_tabIndex$$5$$ = Array.prototype.indexOf.call(this.$tabs$, $currentNode$$4$$);
        if (-1 != $i$$447_tabIndex$$5$$) {
          break;
        }
      ...
      if (-1 != $i$$447_tabIndex$$5$$) {
        for ($panels_title$$11$$ = this.getNodeBySubId({subId:"oj-tabs-title", index:$i$$447_tabIndex$$5$$}), $closeIcon_panelIndex$$ = this.getNodeBySubId({subId:"oj-tabs-close", index:$i$$447_tabIndex$$5$$}), $currentNode$$4$$ = $node$$127$$;$currentNode$$4$$;) {
          if ($currentNode$$4$$ === $panels_title$$11$$) {
            return{subId:"oj-tabs-title", index:$i$$447_tabIndex$$5$$};
          }
          if ($currentNode$$4$$ === $closeIcon_panelIndex$$) {
            return{subId:"oj-tabs-close", index:$i$$447_tabIndex$$5$$};
          }
          if ($currentNode$$4$$ === this.$tabs$[$i$$447_tabIndex$$5$$]) {
            return{subId:"oj-tabs-tab", index:$i$$447_tabIndex$$5$$};
          }
          $currentNode$$4$$ = $currentNode$$4$$.parentElement;
        }
      }
      ...
      if ($$menuContainer$$1$$ || this.options.reorderable || this.options.removable) {
        ...
        if (0 == $$menuContainer$$1$$.length) {
          var $key$$184$$ = this.options.reorderable ? "labelReorder" : $_arMenuKeyMap$$.remove, $menuId$$ = this.element.uniqueId().attr("id") + "contextmenu", $$menuContainer$$1$$ = $$$$65$$("\x3cul\x3e");
          $$menuContainer$$1$$.css("display", "none").attr("id", $menuId$$).attr("aria-label", this.$getTranslatedString$($key$$184$$));
      ...
      if ($disTabs$$ && 0 < $disTabs$$.length) {
        for (var $id$$60$$, $tab$$9$$, $i$$448$$ = 0;$i$$448$$ < $disTabs$$.length;$i$$448$$++) {
          if ($tab$$9$$ = this.$_getTab$($disTabs$$[$i$$448$$])) {
    ...
    }, $_isInATab$:function($element$$164$$) {
      var $found$$8$$ = !1;
      this.$tabs$.each(function() {
        if (this === $element$$164$$ || $$$$65$$.contains(this, $element$$164$$)) {
          return $found$$8$$ = !0, !1;
        }
      });
      return $found$$8$$;
