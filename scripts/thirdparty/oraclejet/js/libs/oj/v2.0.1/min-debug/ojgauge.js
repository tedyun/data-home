...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtGauge"], function($oj$$16$$, $$$$16$$, $comp$$6$$, $base$$4$$, $dvt$$2$$) {
  ...
  }, _setOption:function($key$$75$$, $value$$226$$, $flags$$25$$) {
    "rawValue" === $key$$75$$ ? $oj$$16$$.$Logger$.error("'rawValue' is a read-only option and cannot be set") : ("value" === $key$$75$$ && this.option("rawValue", $value$$226$$, {_context:{$writeback$:!0, $internalSet$:!0}}), this._super($key$$75$$, $value$$226$$, $flags$$25$$));
  ...
  $oj$$16$$.$__registerWidget$("oj.ojDialGauge", $$$$16$$.oj.dvtBaseGauge, {widgetEventPrefix:"oj", options:{input:null, optionChange:null, rawValue:void 0}, $_CreateDvtComponent$:function($context$$74$$, $callback$$93$$, $callbackObj$$1$$) {
    return $dvt$$2$$.DialGauge.newInstance($context$$74$$, $callback$$93$$, $callbackObj$$1$$);
  ...
  $oj$$16$$.$__registerWidget$("oj.ojLedGauge", $$$$16$$.oj.dvtBaseGauge, {widgetEventPrefix:"oj", options:{}, $_CreateDvtComponent$:function($context$$75$$, $callback$$94$$, $callbackObj$$2$$) {
    return $dvt$$2$$.LedGauge.newInstance($context$$75$$, $callback$$94$$, $callbackObj$$2$$);
  ...
  $oj$$16$$.$__registerWidget$("oj.ojRatingGauge", $$$$16$$.oj.dvtBaseGauge, {widgetEventPrefix:"oj", options:{input:null, optionChange:null, rawValue:void 0}, $_CreateDvtComponent$:function($context$$76$$, $callback$$95$$, $callbackObj$$3$$) {
    return $dvt$$2$$.RatingGauge.newInstance($context$$76$$, $callback$$95$$, $callbackObj$$3$$);
    ...
    this.element.attr("title") ? (this.options.shortDesc = this.element.attr("title"), this.element.data(this.element, "title", this.element.attr("title")), this.element.removeAttr("title")) : this.element.data("title") && (this.options.shortDesc = this.element.data("title"));
    this._super();
  }, $_UserOptionChange$:function($key$$76$$, $value$$227$$) {
    this._superApply(arguments);
    "value" == $key$$76$$ && this.$_UserOptionChange$("changed", !0);
  }});
  $oj$$16$$.$__registerWidget$("oj.ojStatusMeterGauge", $$$$16$$.oj.dvtBaseGauge, {widgetEventPrefix:"oj", options:{input:null, optionChange:null, rawValue:void 0}, $_CreateDvtComponent$:function($context$$77$$, $callback$$96$$, $callbackObj$$4$$) {
    return $dvt$$2$$.StatusMeterGauge.newInstance($context$$77$$, $callback$$96$$, $callbackObj$$4$$);
