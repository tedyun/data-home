...
define(["ojs/ojcore", "jquery", "hammerjs", "promise", "ojs/ojjquery-hammer", "ojs/ojcomponentcore"], function($oj$$56$$, $$$$50$$, $Hammer$$5$$) {
  ...
  $oj$$56$$.$OffcanvasUtils$.$SURROGATE_ATTR$ = "data-oj-surrogate-id";
  ...
  $oj$$56$$.$OffcanvasUtils$.$_toggleClass$ = function $$oj$$56$$$$OffcanvasUtils$$$_toggleClass$$($offcanvas$$5$$, $wrapper$$6$$, $isOpen$$2_oTabIndex$$) {
    var $displayMode$$1_wrapperClass$$ = $offcanvas$$5$$[$oj$$56$$.$OffcanvasUtils$.$DISPLAY_MODE_KEY$], $drawer$$4$$ = $oj$$56$$.$OffcanvasUtils$.$_getDrawer$($offcanvas$$5$$), $drawerClass$$ = $oj$$56$$.$OffcanvasUtils$.$OPEN_SELECTOR$, $displayMode$$1_wrapperClass$$ = $displayMode$$1_wrapperClass$$ === $oj$$56$$.$OffcanvasUtils$.$DISPLAY_MODE_OVERLAY$ ? $oj$$56$$.$OffcanvasUtils$.$TRANSITION_SELECTOR$ + " oj-offcanvas-overlay" : $oj$$56$$.$OffcanvasUtils$.$TRANSITION_SELECTOR$;
  ...
  $oj$$56$$.$OffcanvasUtils$.$_isAutoDismiss$ = function $$oj$$56$$$$OffcanvasUtils$$$_isAutoDismiss$$($offcanvas$$6$$) {
  ...
  $oj$$56$$.$OffcanvasUtils$.$_registerCloseHandler$ = function $$oj$$56$$$$OffcanvasUtils$$$_registerCloseHandler$$($offcanvas$$7$$) {
    $oj$$56$$.$OffcanvasUtils$.$_unregisterCloseHandler$($offcanvas$$7$$);
    if ($oj$$56$$.$OffcanvasUtils$.$_isAutoDismiss$($offcanvas$$7$$)) {
      var $drawer$$5$$ = $oj$$56$$.$OffcanvasUtils$.$_getDrawer$($offcanvas$$7$$), $dismisHandler$$ = $offcanvas$$7$$[$oj$$56$$.$OffcanvasUtils$.$DISMISS_HANDLER_KEY$] = function $$offcanvas$$7$$$$oj$$56$$$$OffcanvasUtils$$$DISMISS_HANDLER_KEY$$($event$$567$$) {
        var $target$$98$$ = $event$$567$$.target;
        $oj$$56$$.$DomUtils$.$isChromeEvent$($event$$567$$) || "focus" === $event$$567$$.type && !$$$$50$$($target$$98$$).is(":focusable") || (null == $$$$50$$.data($drawer$$5$$[0], $oj$$56$$.$OffcanvasUtils$.$_DATA_OFFCANVAS_KEY$) ? $oj$$56$$.$OffcanvasUtils$.$_unregisterCloseHandler$($offcanvas$$7$$) : $oj$$56$$.$DomUtils$.$isLogicalAncestorOrSelf$($drawer$$5$$[0], $target$$98$$) || $oj$$56$$.$OffcanvasUtils$.close($offcanvas$$7$$));
    ...
    $oj$$56$$.$OffcanvasUtils$.$_registerSwipeHandler$($offcanvas$$7$$);
  };
  $oj$$56$$.$OffcanvasUtils$.$_unregisterCloseHandler$ = function $$oj$$56$$$$OffcanvasUtils$$$_unregisterCloseHandler$$($offcanvas$$8$$) {
    var $dismisHandler$$1$$ = $offcanvas$$8$$[$oj$$56$$.$OffcanvasUtils$.$DISMISS_HANDLER_KEY$];
    if ($dismisHandler$$1$$) {
      ...
      delete $offcanvas$$8$$[$oj$$56$$.$OffcanvasUtils$.$DISMISS_HANDLER_KEY$];
      $offcanvas$$8$$[$oj$$56$$.$OffcanvasUtils$.$DISMISS_HANDLER_KEY$] = null;
    }
    $oj$$56$$.$OffcanvasUtils$.$_unregisterSwipeHandler$($offcanvas$$8$$);
  };
  $oj$$56$$.$OffcanvasUtils$.$_registerSwipeHandler$ = function $$oj$$56$$$$OffcanvasUtils$$$_registerSwipeHandler$$($offcanvas$$9$$) {
    if ($oj$$56$$.$DomUtils$.$isTouchSupported$()) {
      var $selector$$40$$ = $offcanvas$$9$$[$oj$$56$$.$OffcanvasUtils$.$SELECTOR_KEY$], $drawer$$6_drawerHammer$$ = $$$$50$$($selector$$40$$), $edge$$6$$ = $oj$$56$$.$OffcanvasUtils$.$_getEdge$($drawer$$6_drawerHammer$$), $swipeEvent$$, $options$$367$$;
      ...
      $drawer$$6_drawerHammer$$ = $drawer$$6_drawerHammer$$.$ojHammer$($options$$367$$).on($swipeEvent$$, function($event$$568$$) {
        ...
        $oj$$56$$.$OffcanvasUtils$.close($offcanvas$$9$$);
      });
      $$$$50$$.data($$$$50$$($selector$$40$$)[0], $oj$$56$$.$OffcanvasUtils$.$_DATA_HAMMER_KEY$, {event:$swipeEvent$$, hammer:$drawer$$6_drawerHammer$$});
    }
  };
  $oj$$56$$.$OffcanvasUtils$.$_unregisterSwipeHandler$ = function $$oj$$56$$$$OffcanvasUtils$$$_unregisterSwipeHandler$$($dHammer_drawer$$7_offcanvas$$10$$) {
    $dHammer_drawer$$7_offcanvas$$10$$ = $oj$$56$$.$OffcanvasUtils$.$_getDrawer$($dHammer_drawer$$7_offcanvas$$10$$);
    0 < $dHammer_drawer$$7_offcanvas$$10$$.length && ($dHammer_drawer$$7_offcanvas$$10$$ = $$$$50$$.data($dHammer_drawer$$7_offcanvas$$10$$[0], $oj$$56$$.$OffcanvasUtils$.$_DATA_HAMMER_KEY$)) && $dHammer_drawer$$7_offcanvas$$10$$.hammer.off($dHammer_drawer$$7_offcanvas$$10$$.event);
  };
  $oj$$56$$.$OffcanvasUtils$.$_afterCloseHandler$ = function $$oj$$56$$$$OffcanvasUtils$$$_afterCloseHandler$$($offcanvas$$11$$) {
    var $drawer$$8$$ = $oj$$56$$.$OffcanvasUtils$.$_getDrawer$($offcanvas$$11$$);
    if ($$$$50$$.data($drawer$$8$$[0], $oj$$56$$.$OffcanvasUtils$.$_DATA_OFFCANVAS_KEY$) === $offcanvas$$11$$) {
      $oj$$56$$.$OffcanvasUtils$.$_getEdge$($drawer$$8$$);
      var $wrapper$$8$$ = $oj$$56$$.$OffcanvasUtils$.$_getAnimateWrapper$($offcanvas$$11$$);
      $oj$$56$$.$OffcanvasUtils$.$_toggleClass$($offcanvas$$11$$, $wrapper$$8$$, !1);
      $oj$$56$$.$OffcanvasUtils$.$_removeModality$($offcanvas$$11$$);
      $oj$$56$$.$OffcanvasUtils$.$_unregisterCloseHandler$($offcanvas$$11$$);
      $drawer$$8$$.trigger("ojclose", $offcanvas$$11$$);
      $$$$50$$.removeData($drawer$$8$$[0], $oj$$56$$.$OffcanvasUtils$.$_DATA_OFFCANVAS_KEY$);
    }
  };
  $oj$$56$$.$OffcanvasUtils$.$_setVisible$ = function $$oj$$56$$$$OffcanvasUtils$$$_setVisible$$($selector$$41$$, $visible$$1$$, $edge$$8$$) {
    ...
    ($visible$$1$$ = !!$visible$$1$$) && $oj$$56$$.$OffcanvasUtils$.$_isOpen$($drawer$$9$$) && $oj$$56$$.$OffcanvasUtils$.$_close$($selector$$41$$, !1);
    $drawer$$9$$.toggleClass($oj$$56$$.$OffcanvasUtils$.$_drawerSelector$[$edge$$8$$], !$visible$$1$$);
  };
  $oj$$56$$.$OffcanvasUtils$.$setupResponsive$ = function $$oj$$56$$$$OffcanvasUtils$$$setupResponsive$$($mqListener_offcanvas$$12$$) {
    var $mqs_query$$11$$ = $mqListener_offcanvas$$12$$.query;
    if (null !== $mqs_query$$11$$) {
      var $selector$$42$$ = $mqListener_offcanvas$$12$$[$oj$$56$$.$OffcanvasUtils$.$SELECTOR_KEY$], $mqs_query$$11$$ = window.matchMedia($mqs_query$$11$$), $edge$$9$$ = $oj$$56$$.$OffcanvasUtils$.$_saveEdge$($mqListener_offcanvas$$12$$);
      ...
      $$$$50$$.data($$$$50$$($selector$$42$$)[0], $oj$$56$$.$OffcanvasUtils$.$_DATA_MEDIA_QUERY_KEY$, {mqList:$mqs_query$$11$$, mqListener:$mqListener_offcanvas$$12$$});
    }
  };
  $goog$exportPath_$$("OffcanvasUtils.setupResponsive", $oj$$56$$.$OffcanvasUtils$.$setupResponsive$, $oj$$56$$);
  $oj$$56$$.$OffcanvasUtils$.$tearDownResponsive$ = function $$oj$$56$$$$OffcanvasUtils$$$tearDownResponsive$$($drawer$$10_offcanvas$$13$$) {
    $drawer$$10_offcanvas$$13$$ = $oj$$56$$.$OffcanvasUtils$.$_getDrawer$($drawer$$10_offcanvas$$13$$);
    var $mql$$ = $$$$50$$.data($drawer$$10_offcanvas$$13$$[0], $oj$$56$$.$OffcanvasUtils$.$_DATA_MEDIA_QUERY_KEY$);
    $mql$$ && ($mql$$.mqList.removeListener($mql$$.mqListener), $$$$50$$.removeData($drawer$$10_offcanvas$$13$$[0], $oj$$56$$.$OffcanvasUtils$.$_DATA_MEDIA_QUERY_KEY$));
  };
  $goog$exportPath_$$("OffcanvasUtils.tearDownResponsive", $oj$$56$$.$OffcanvasUtils$.$tearDownResponsive$, $oj$$56$$);
  $oj$$56$$.$OffcanvasUtils$.open = function $$oj$$56$$$$OffcanvasUtils$$open$($offcanvas$$14$$) {
    var $drawer$$11$$ = $oj$$56$$.$OffcanvasUtils$.$_getDrawer$($offcanvas$$14$$), $oldOffcanvas_promise$$9$$ = $$$$50$$.data($drawer$$11$$[0], $oj$$56$$.$OffcanvasUtils$.$_DATA_OFFCANVAS_KEY$);
    if ($oldOffcanvas_promise$$9$$) {
      if ($oldOffcanvas_promise$$9$$[$oj$$56$$.$OffcanvasUtils$.$CLOSE_PROMISE_KEY$]) {
        return $oldOffcanvas_promise$$9$$[$oj$$56$$.$OffcanvasUtils$.$CLOSE_PROMISE_KEY$];
      }
      if ($oldOffcanvas_promise$$9$$[$oj$$56$$.$OffcanvasUtils$.$OPEN_PROMISE_KEY$]) {
        return $oldOffcanvas_promise$$9$$[$oj$$56$$.$OffcanvasUtils$.$OPEN_PROMISE_KEY$];
      }
    }
    var $oldOffcanvas_promise$$9$$ = new Promise(function($resolve$$64$$, $reject$$60$$) {
      $oj$$56$$.$Assert$.$assertPrototype$($drawer$$11$$, jQuery);
      var $edge$$10$$ = $oj$$56$$.$OffcanvasUtils$.$_saveEdge$($offcanvas$$14$$), $displayMode$$2_event$$570$$ = $$$$50$$.Event("ojbeforeopen");
      $drawer$$11$$.trigger($displayMode$$2_event$$570$$, $offcanvas$$14$$);
      if (!1 === $displayMode$$2_event$$570$$.result) {
        $reject$$60$$("ojbeforeopen veto");
      } else {
        var $size$$26$$, $displayMode$$2_event$$570$$ = $oj$$56$$.$OffcanvasUtils$.$_getDisplayMode$($offcanvas$$14$$), $myOffcanvas$$ = $$$$50$$.extend({}, $offcanvas$$14$$);
        $myOffcanvas$$[$oj$$56$$.$OffcanvasUtils$.$DISPLAY_MODE_KEY$] = $displayMode$$2_event$$570$$;
        $$$$50$$.data($drawer$$11$$[0], $oj$$56$$.$OffcanvasUtils$.$_DATA_OFFCANVAS_KEY$, $myOffcanvas$$);
        var $wrapper$$9$$;
        ...
        $edge$$10$$ === $oj$$56$$.$OffcanvasUtils$.$EDGE_START$ || $edge$$10$$ === $oj$$56$$.$OffcanvasUtils$.$EDGE_END$ ? ($size$$26$$ = void 0 === $size$$26$$ ? $drawer$$11$$.outerWidth(!0) + "px" : $size$$26$$, $displayMode$$2_event$$570$$ === $oj$$56$$.$OffcanvasUtils$.$DISPLAY_MODE_PUSH$ && $oj$$56$$.$OffcanvasUtils$.$_setTranslationX$($wrapper$$9$$, $edge$$10$$, $size$$26$$)) : ($size$$26$$ = void 0 === $size$$26$$ ? $drawer$$11$$.outerHeight(!0) + "px" : $size$$26$$, $displayMode$$2_event$$570$$ === 
        $oj$$56$$.$OffcanvasUtils$.$DISPLAY_MODE_PUSH$ && $oj$$56$$.$OffcanvasUtils$.$_setTranslationY$($wrapper$$9$$, $edge$$10$$, $size$$26$$));
        var $outerWrapper$$;
        window.setTimeout(function() {
          $outerWrapper$$ = $oj$$56$$.$OffcanvasUtils$.$_getOuterWrapper$($drawer$$11$$);
          $oj$$56$$.$Assert$.$assertPrototype$($outerWrapper$$, jQuery);
          $outerWrapper$$.addClass($oj$$56$$.$OffcanvasUtils$.$_getShiftSelector$($edge$$10$$));
        }, 10);
        $oj$$56$$.$OffcanvasUtils$.$_applyModality$($myOffcanvas$$, $drawer$$11$$);
        $oj$$56$$.$OffcanvasUtils$.$_onTransitionEnd$($wrapper$$9$$, function() {
          $wrapper$$9$$.removeClass($oj$$56$$.$OffcanvasUtils$.$TRANSITION_SELECTOR$);
          $oj$$56$$.$FocusUtils$.$focusElement$($drawer$$11$$[0]);
          $drawer$$11$$.trigger("ojopen", $myOffcanvas$$);
          $oj$$56$$.$OffcanvasUtils$.$_registerCloseHandler$($myOffcanvas$$);
          $resolve$$64$$(!0);
        });
      }
    }), $nOffcanvas$$ = $$$$50$$.data($drawer$$11$$[0], $oj$$56$$.$OffcanvasUtils$.$_DATA_OFFCANVAS_KEY$);
    $nOffcanvas$$ && ($nOffcanvas$$[$oj$$56$$.$OffcanvasUtils$.$OPEN_PROMISE_KEY$] = $oldOffcanvas_promise$$9$$);
    return $oldOffcanvas_promise$$9$$;
  };
  $goog$exportPath_$$("OffcanvasUtils.open", $oj$$56$$.$OffcanvasUtils$.open, $oj$$56$$);
  $oj$$56$$.$OffcanvasUtils$.close = function $$oj$$56$$$$OffcanvasUtils$$close$($offcanvas$$15$$) {
    return $oj$$56$$.$OffcanvasUtils$.$_close$($offcanvas$$15$$[$oj$$56$$.$OffcanvasUtils$.$SELECTOR_KEY$], !0);
  };
  ...
  $oj$$56$$.$OffcanvasUtils$.$_close$ = function $$oj$$56$$$$OffcanvasUtils$$$_close$$($selector$$43$$, $animation$$2$$) {
    ...
    var $offcanvas$$16$$ = $$$$50$$.data($drawer$$12$$[0], $oj$$56$$.$OffcanvasUtils$.$_DATA_OFFCANVAS_KEY$);
    if ($offcanvas$$16$$ && $offcanvas$$16$$[$oj$$56$$.$OffcanvasUtils$.$CLOSE_PROMISE_KEY$]) {
      return $offcanvas$$16$$[$oj$$56$$.$OffcanvasUtils$.$CLOSE_PROMISE_KEY$];
    }
    var $promise$$10$$ = new Promise(function($resolve$$65$$, $reject$$61$$) {
      if ($oj$$56$$.$OffcanvasUtils$.$_isOpen$($drawer$$12$$)) {
        $selector$$43$$ != $offcanvas$$16$$[$oj$$56$$.$OffcanvasUtils$.$SELECTOR_KEY$] && $resolve$$65$$(!0);
        var $edge$$11_shiftSelector$$ = $oj$$56$$.$OffcanvasUtils$.$_getEdge$($drawer$$12$$), $displayMode$$3$$ = $offcanvas$$16$$[$oj$$56$$.$OffcanvasUtils$.$DISPLAY_MODE_KEY$], $edge$$11_shiftSelector$$ = $oj$$56$$.$OffcanvasUtils$.$_getShiftSelector$($edge$$11_shiftSelector$$), $outerWrapper$$1$$ = $oj$$56$$.$OffcanvasUtils$.$_getOuterWrapper$($drawer$$12$$);
        ...
        if (!1 === $event$$571_wrapper$$10$$.result) {
          $reject$$61$$("beforeClose veto");
        } else {
          $event$$571_wrapper$$10$$ = $oj$$56$$.$OffcanvasUtils$.$_getAnimateWrapper$($offcanvas$$16$$);
          if ($animation$$2$$) {
            var $rafId$$ = 0, $endHandler$$1$$ = function $$endHandler$$1$$$() {
              $oj$$56$$.$OffcanvasUtils$.$_afterCloseHandler$($offcanvas$$16$$);
          ...
          $oj$$56$$.$OffcanvasUtils$.$_isModal$($offcanvas$$16$$) && $offcanvas$$16$$[$oj$$56$$.$OffcanvasUtils$.$GLASS_PANE_KEY$].removeClass($oj$$56$$.$OffcanvasUtils$.$GLASSPANE_DIM_SELECTOR$);
          $animation$$2$$ ? $event$$571_wrapper$$10$$.addClass($oj$$56$$.$OffcanvasUtils$.$TRANSITION_SELECTOR$) : ($oj$$56$$.$OffcanvasUtils$.$_afterCloseHandler$($offcanvas$$16$$), $resolve$$65$$(!0));
        }
      } else {
        $resolve$$65$$(!0);
      }
    });
    ($offcanvas$$16$$ = $$$$50$$.data($drawer$$12$$[0], $oj$$56$$.$OffcanvasUtils$.$_DATA_OFFCANVAS_KEY$)) && ($offcanvas$$16$$[$oj$$56$$.$OffcanvasUtils$.$CLOSE_PROMISE_KEY$] = $promise$$10$$);
    return $promise$$10$$;
  };
  $oj$$56$$.$OffcanvasUtils$.toggle = function $$oj$$56$$$$OffcanvasUtils$$toggle$($offcanvas$$17$$) {
    var $drawer$$13$$ = $oj$$56$$.$OffcanvasUtils$.$_getDrawer$($offcanvas$$17$$);
    $oj$$56$$.$Assert$.$assertPrototype$($drawer$$13$$, jQuery);
    return $oj$$56$$.$OffcanvasUtils$.$_isOpen$($drawer$$13$$) ? $oj$$56$$.$OffcanvasUtils$.close($offcanvas$$17$$) : $oj$$56$$.$OffcanvasUtils$.open($offcanvas$$17$$);
  };
  $goog$exportPath_$$("OffcanvasUtils.toggle", $oj$$56$$.$OffcanvasUtils$.toggle, $oj$$56$$);
  $oj$$56$$.$OffcanvasUtils$.$_addGlassPane$ = function $$oj$$56$$$$OffcanvasUtils$$$_addGlassPane$$($drawer$$14$$) {
  ...
  $oj$$56$$.$OffcanvasUtils$.$_swapOrder$ = function $$oj$$56$$$$OffcanvasUtils$$$_swapOrder$$($offcanvas$$18$$, $drawer$$15$$) {
    $offcanvas$$18$$[$oj$$56$$.$OffcanvasUtils$.$SURROGATE_KEY$] = $oj$$56$$.$OffcanvasUtils$.$_createSurrogate$($drawer$$15$$);
    $drawer$$15$$.appendTo($drawer$$15$$.parent());
  };
  $oj$$56$$.$OffcanvasUtils$.$_restoreOrder$ = function $$oj$$56$$$$OffcanvasUtils$$$_restoreOrder$$($offcanvas$$19_surrogate$$1$$) {
    var $drawer$$16$$ = $oj$$56$$.$OffcanvasUtils$.$_getDrawer$($offcanvas$$19_surrogate$$1$$);
    $offcanvas$$19_surrogate$$1$$ = $offcanvas$$19_surrogate$$1$$[$oj$$56$$.$OffcanvasUtils$.$SURROGATE_KEY$];
    $drawer$$16$$ && $offcanvas$$19_surrogate$$1$$ && $drawer$$16$$.attr($oj$$56$$.$OffcanvasUtils$.$SURROGATE_ATTR$) === $offcanvas$$19_surrogate$$1$$.attr("id") && ($drawer$$16$$.insertAfter($offcanvas$$19_surrogate$$1$$), $drawer$$16$$.removeAttr($oj$$56$$.$OffcanvasUtils$.$SURROGATE_ATTR$), $offcanvas$$19_surrogate$$1$$.remove());
  };
  $oj$$56$$.$OffcanvasUtils$.$_applyModality$ = function $$oj$$56$$$$OffcanvasUtils$$$_applyModality$$($offcanvas$$20$$, $drawer$$17$$) {
    $oj$$56$$.$OffcanvasUtils$.$_isModal$($offcanvas$$20$$) && ($offcanvas$$20$$[$oj$$56$$.$OffcanvasUtils$.$GLASS_PANE_KEY$] = $oj$$56$$.$OffcanvasUtils$.$_addGlassPane$($drawer$$17$$), $oj$$56$$.$OffcanvasUtils$.$_swapOrder$($offcanvas$$20$$, $drawer$$17$$), window.setTimeout(function() {
      $offcanvas$$20$$[$oj$$56$$.$OffcanvasUtils$.$GLASS_PANE_KEY$].addClass($oj$$56$$.$OffcanvasUtils$.$GLASSPANE_DIM_SELECTOR$);
    }, 0));
  };
  $oj$$56$$.$OffcanvasUtils$.$_removeModality$ = function $$oj$$56$$$$OffcanvasUtils$$$_removeModality$$($offcanvas$$21$$) {
    $oj$$56$$.$OffcanvasUtils$.$_isModal$($offcanvas$$21$$) && ($offcanvas$$21$$[$oj$$56$$.$OffcanvasUtils$.$GLASS_PANE_KEY$].remove(), $oj$$56$$.$OffcanvasUtils$.$_restoreOrder$($offcanvas$$21$$));
  };
  $oj$$56$$.$OffcanvasUtils$.$setupPanToReveal$ = function $$oj$$56$$$$OffcanvasUtils$$$setupPanToReveal$$($offcanvas$$22$$) {
    var $drawer$$19$$, $size$$27$$, $outerWrapper$$2$$, $wrapper$$11$$, $mOptions$$, $proceed$$, $direction$$13$$, $ui$$33$$, $evt$$29$$, $delta$$7$$, $edge$$12$$, $listener$$44$$;
    null == $$$$50$$($offcanvas$$22$$).attr("oj-data-pansetup") && ($$$$50$$($offcanvas$$22$$).attr("oj-data-pansetup", "true"), $offcanvas$$22$$.displayMode = "push", $drawer$$19$$ = $oj$$56$$.$OffcanvasUtils$.$_getDrawer$($offcanvas$$22$$), $size$$27$$ = $offcanvas$$22$$.size, null == $size$$27$$ && ($size$$27$$ = $drawer$$19$$.outerWidth()), $outerWrapper$$2$$ = $oj$$56$$.$OffcanvasUtils$.$_getOuterWrapper$($drawer$$19$$), $wrapper$$11$$ = $oj$$56$$.$OffcanvasUtils$.$_getAnimateWrapper$($offcanvas$$22$$), 
    $mOptions$$ = {recognizers:[[$Hammer$$5$$.Pan, {direction:$Hammer$$5$$.DIRECTION_HORIZONTAL}]]}, $proceed$$ = !1, $$$$50$$($outerWrapper$$2$$).$ojHammer$($mOptions$$).on("panstart", function($event$$573$$) {
      ...
      null != $direction$$13$$ && ($ui$$33$$ = {direction:$direction$$13$$, distance:Math.abs($event$$573$$.gesture.deltaX)}, $evt$$29$$ = $$$$50$$.Event("ojpanstart"), $drawer$$19$$.trigger($evt$$29$$, $ui$$33$$), $evt$$29$$.isDefaultPrevented() || ($offcanvas$$22$$._closePromise = null, $oj$$56$$.$OffcanvasUtils$.$_toggleClass$($offcanvas$$22$$, $wrapper$$11$$, !0), $proceed$$ = !0, $event$$573$$.stopPropagation()));
    }).on("panmove", function($event$$574$$) {
      $proceed$$ && ($delta$$7$$ = Math.abs($event$$574$$.gesture.deltaX), $drawer$$19$$.css("width", $delta$$7$$), $wrapper$$11$$.removeClass($oj$$56$$.$OffcanvasUtils$.$TRANSITION_SELECTOR$), $oj$$56$$.$OffcanvasUtils$.$_setTranslationX$($wrapper$$11$$, "start", $event$$574$$.gesture.deltaX + "px"), $ui$$33$$ = {direction:$direction$$13$$, distance:$delta$$7$$}, $evt$$29$$ = $$$$50$$.Event("ojpanmove"), $drawer$$19$$.trigger($evt$$29$$, $ui$$33$$), $event$$574$$.stopPropagation());
    }).on("panend", function($event$$575$$) {
      $proceed$$ && ($proceed$$ = !1, $delta$$7$$ = Math.abs($event$$575$$.gesture.deltaX), $ui$$33$$ = {distance:$delta$$7$$}, $evt$$29$$ = $$$$50$$.Event("ojpanend"), $drawer$$19$$.trigger($evt$$29$$, $ui$$33$$), $event$$575$$.stopPropagation(), $evt$$29$$.isDefaultPrevented() ? ($listener$$44$$ = function $$listener$$44$$$() {
        $oj$$56$$.$OffcanvasUtils$.$_toggleClass$($offcanvas$$22$$, $wrapper$$11$$, !1);
      ...
      }, $wrapper$$11$$.on("transitionend webkitTransitionEnd otransitionend oTransitionEnd", $listener$$44$$), $wrapper$$11$$.addClass($oj$$56$$.$OffcanvasUtils$.$TRANSITION_SELECTOR$), $oj$$56$$.$OffcanvasUtils$.$_setTranslationX$($wrapper$$11$$, "start", "0px")) : ($wrapper$$11$$.addClass($oj$$56$$.$OffcanvasUtils$.$TRANSITION_SELECTOR$), $drawer$$19$$.css("width", $size$$27$$ + "px"), $edge$$12$$ = $offcanvas$$22$$.edge, null == $edge$$12$$ && ($edge$$12$$ = $drawer$$19$$.hasClass("oj-offcanvas-start") ? 
      "start" : "end"), $oj$$56$$.$OffcanvasUtils$.$_setTranslationX$($wrapper$$11$$, $edge$$12$$, $size$$27$$ + "px"), $$$$50$$.data($drawer$$19$$[0], $oj$$56$$.$OffcanvasUtils$.$_DATA_OFFCANVAS_KEY$, $offcanvas$$22$$), $$$$50$$.data($drawer$$19$$[0], $oj$$56$$.$OffcanvasUtils$.$_DATA_EDGE_KEY$, $edge$$12$$), $oj$$56$$.$OffcanvasUtils$.$_registerCloseHandler$($offcanvas$$22$$)));
    }));
  };
  $goog$exportPath_$$("OffcanvasUtils.setupPanToReveal", $oj$$56$$.$OffcanvasUtils$.$setupPanToReveal$, $oj$$56$$);
  $oj$$56$$.$OffcanvasUtils$.$tearDownPanToReveal$ = function $$oj$$56$$$$OffcanvasUtils$$$tearDownPanToReveal$$($drawer$$20_offcanvas$$23$$) {
    $drawer$$20_offcanvas$$23$$ = $oj$$56$$.$OffcanvasUtils$.$_getDrawer$($drawer$$20_offcanvas$$23$$);
    $$$$50$$($oj$$56$$.$OffcanvasUtils$.$_getOuterWrapper$($drawer$$20_offcanvas$$23$$)).off("panstart panmove panend");
  };
