...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojdnd"], function($oj$$51$$, $$$$47$$) {
  function $MasonryLayoutCommon$$($elem$$115$$, $rtl$$2_sizeDivWrapper$$, $automationEnabled_style$$21$$, $selectors$$8_sizeDiv$$, $styles$$1$$, $callbackInfo$$2$$) {
    ...
    $elem$$115$$.insertBefore($rtl$$2_sizeDivWrapper$$, $elem$$115$$.firstChild);
  ...
  $MasonryLayoutCommon$$.prototype.destroy = function $$MasonryLayoutCommon$$$$destroy$() {
    for (var $elem$$116$$ = this.$_elem$, $children$$13$$ = this.$_getTileChildren$(), $i$$393$$ = 0;$i$$393$$ < $children$$13$$.length;$i$$393$$++) {
      var $style$$22$$ = $children$$13$$[$i$$393$$].style;
  ...
  $MasonryLayoutCommon$$.prototype.$finishLayoutCycle$ = function $$MasonryLayoutCommon$$$$$finishLayoutCycle$$() {
    ...
    for (var $tileChildren$$ = this.$_getTileChildren$(), $i$$394$$ = 0;$i$$394$$ < $tileChildren$$.length;$i$$394$$++) {
      var $child$$15$$ = $tileChildren$$[$i$$394$$];
  ...
  $MasonryLayoutCommon$$.$_getElemSize$ = function $$MasonryLayoutCommon$$$$_getElemSize$$($elem$$121$$) {
    var $computedStyle$$3$$ = $MasonryLayoutCommon$$.$_getComputedStyle$($elem$$121$$);
    return{$w$:$elem$$121$$.offsetWidth + ($MasonryLayoutCommon$$.$_getCSSLengthAsInt$($computedStyle$$3$$.marginLeft) + $MasonryLayoutCommon$$.$_getCSSLengthAsInt$($computedStyle$$3$$.marginRight)), $h$:$elem$$121$$.offsetHeight + ($MasonryLayoutCommon$$.$_getCSSLengthAsInt$($computedStyle$$3$$.marginTop) + $MasonryLayoutCommon$$.$_getCSSLengthAsInt$($computedStyle$$3$$.marginBottom))};
  };
  $MasonryLayoutCommon$$.$_getElemInsets$ = function $$MasonryLayoutCommon$$$$_getElemInsets$$($computedStyle$$4_elem$$122$$) {
    $computedStyle$$4_elem$$122$$ = $MasonryLayoutCommon$$.$_getComputedStyle$($computedStyle$$4_elem$$122$$);
    return{paddingLeft:$MasonryLayoutCommon$$.$_getCSSLengthAsInt$($computedStyle$$4_elem$$122$$.paddingLeft), paddingRight:$MasonryLayoutCommon$$.$_getCSSLengthAsInt$($computedStyle$$4_elem$$122$$.paddingRight), paddingTop:$MasonryLayoutCommon$$.$_getCSSLengthAsInt$($computedStyle$$4_elem$$122$$.paddingTop), paddingBottom:$MasonryLayoutCommon$$.$_getCSSLengthAsInt$($computedStyle$$4_elem$$122$$.paddingBottom), borderLeftWidth:$MasonryLayoutCommon$$.$_getCSSLengthAsInt$($computedStyle$$4_elem$$122$$.borderLeftWidth), 
    borderRightWidth:$MasonryLayoutCommon$$.$_getCSSLengthAsInt$($computedStyle$$4_elem$$122$$.borderRightWidth), borderTopWidth:$MasonryLayoutCommon$$.$_getCSSLengthAsInt$($computedStyle$$4_elem$$122$$.borderTopWidth), borderBottomWidth:$MasonryLayoutCommon$$.$_getCSSLengthAsInt$($computedStyle$$4_elem$$122$$.borderBottomWidth)};
  };
  $MasonryLayoutCommon$$.$_getComputedStyle$ = function $$MasonryLayoutCommon$$$$_getComputedStyle$$($elem$$123$$) {
    var $defView$$1$$ = $elem$$123$$.ownerDocument.defaultView, $computedStyle$$5$$ = null;
    return $computedStyle$$5$$ = $defView$$1$$ ? $defView$$1$$.getComputedStyle($elem$$123$$, null) : $elem$$123$$.currentStyle;
  };
  ...
  $MasonryLayoutCommon$$.$_addBubbleEventListener$ = function $$MasonryLayoutCommon$$$$_addBubbleEventListener$$($node$$107$$, $type$$96$$, $listener$$40$$) {
    $node$$107$$.addEventListener ? $node$$107$$.addEventListener($type$$96$$, $listener$$40$$, !1) : $node$$107$$.attachEvent && $node$$107$$.attachEvent("on" + $type$$96$$, $listener$$40$$);
  };
  $MasonryLayoutCommon$$.$_removeBubbleEventListener$ = function $$MasonryLayoutCommon$$$$_removeBubbleEventListener$$($node$$108$$, $type$$97$$, $listener$$41$$) {
    $node$$108$$.removeEventListener ? $node$$108$$.removeEventListener($type$$97$$, $listener$$41$$, !1) : $node$$108$$.detachEvent && $node$$108$$.detachEvent("on" + $type$$97$$, $listener$$41$$);
  };
  $MasonryLayoutCommon$$.$_arrayIndexOf$ = function $$MasonryLayoutCommon$$$$_arrayIndexOf$$($array$$18$$, $item$$124$$) {
    if ($array$$18$$) {
      for (var $i$$395$$ = 0;$i$$395$$ < $array$$18$$.length;$i$$395$$++) {
        if ($array$$18$$[$i$$395$$] == $item$$124$$) {
          return $i$$395$$;
        }
      }
    }
  ...
  $MasonryLayoutCommon$$.$_isMinimumAgentMet$ = function $$MasonryLayoutCommon$$$$_isMinimumAgentMet$$($actualAgentType$$, $actualAgentVersion$$) {
    ...
    if (0 == $argCount$$ % 2) {
      for (var $i$$396$$ = 0;$i$$396$$ <= $argCount$$ - 2;$i$$396$$ += 2) {
        if ($actualAgentType$$ == $agentRequirements$$[$i$$396$$]) {
          if ($actualAgentVersion$$ >= $agentRequirements$$[1 + $i$$396$$]) {
            return!0;
          }
          break;
        }
  ...
  $MasonryLayoutCommon$$.prototype.$_getTileChildren$ = function $$MasonryLayoutCommon$$$$$_getTileChildren$$() {
    for (var $children$$14$$ = this.$_elem$.querySelectorAll(this.$_tilesSelector$), $arChildren$$1$$ = [], $i$$397$$ = 0;$i$$397$$ < $children$$14$$.length;$i$$397$$++) {
      var $child$$16$$ = $children$$14$$[$i$$397$$], $childStyle$$ = $child$$16$$.style;
  ...
  $MasonryLayoutCommon$$.prototype.$_transitionLayout$ = function $$MasonryLayoutCommon$$$$$_transitionLayout$$() {
    ...
    if (this.$_arInfoletsToResize$) {
      ...
      for (var $i$$398$$ = 0;$i$$398$$ < $arInfoletsToResize$$1_calledHandleTransitionEnd$$.length;$i$$398$$ += 2) {
        var $resizedInfolet$$ = $arInfoletsToResize$$1_calledHandleTransitionEnd$$[$i$$398$$];
  ...
  $MasonryLayoutCommon$$.prototype.$_layout$ = function $$MasonryLayoutCommon$$$$$_layout$$() {
    var $elem$$125_style$$23$$ = this.$_elem$, $children$$15$$ = this.$_getTileChildren$();
    ...
    var $arMovedInfolets$$ = [], $arOldPositions$$ = [], $arCols$$ = [], $rtl$$3$$ = this.$_rtl$, $insets$$ = $MasonryLayoutCommon$$.$_getElemInsets$($elem$$125_style$$23$$), $maxColSpan$$ = 0, $arTilePositions$$ = [];
    this.$_arTilePositions$ = $arTilePositions$$;
    for (var $i$$399$$ = 0;$i$$399$$ < $children$$15$$.length;$i$$399$$++) {
      var $child$$17$$ = $children$$15$$[$i$$399$$], $childSpan$$ = this.$_getTileSpanFunc$($child$$17$$);
      ...
      this.$_occupancyMap$ || (this.$_cols$ = Math.max(Math.floor(($elem$$125_style$$23$$.offsetWidth - $insets$$.paddingLeft - $insets$$.paddingRight - $insets$$.borderLeftWidth - $insets$$.borderRightWidth) / $cellSize_oldSizeStyleClass$$.$w$), 1), this.$_initOccupancyMap$(this.$_cols$, this.$_rows$), $maxColSpan$$ = this.$_cols$);
    ...
    $cellSize_oldSizeStyleClass$$ && ($elem$$125_style$$23$$ = this.$_sizeDiv$.style, $elem$$125_style$$23$$.width = $maxColSpan$$ * $cellSize_oldSizeStyleClass$$.$w$ + "px", $elem$$125_style$$23$$.height = this.$_rows$ * $cellSize_oldSizeStyleClass$$.$h$ + "px");
    for ($i$$399$$ = 0;$i$$399$$ < $children$$15$$.length;$i$$399$$++) {
      $child$$17$$ = $children$$15$$[$i$$399$$], $childStyle$$1_next$$7$$ = $child$$17$$.style, $oldPosition$$ = $arOldPositions$$[$i$$399$$], "" != $oldPosition$$.top && ($rtl$$3$$ && parseInt($childStyle$$1_next$$7$$.right, 10) !== parseInt($oldPosition$$.right, 10) || !$rtl$$3$$ && parseInt($childStyle$$1_next$$7$$.left, 10) !== parseInt($oldPosition$$.left, 10) || parseInt($childStyle$$1_next$$7$$.top, 10) !== parseInt($oldPosition$$.top, 10)) && $arMovedInfolets$$.push($child$$17$$);
    }
  ...
  $MasonryLayoutCommon$$.prototype.$_reorderTilesForLayout$ = function $$MasonryLayoutCommon$$$$$_reorderTilesForLayout$$() {
    ...
    for (var $arTilePositions$$1$$ = $arTilePositions$$1$$.sort($MasonryLayoutCommon$$.$_compareTilePositions$), $children$$16$$ = this.$_getTileChildren$(), $i$$400$$ = 0;$i$$400$$ < $children$$16$$.length;$i$$400$$++) {
      var $child$$18_posTileIndex$$ = $children$$16$$[$i$$400$$], $posTile$$ = $arTilePositions$$1$$[$i$$400$$].tile;
      $child$$18_posTileIndex$$ != $posTile$$ && (this.$_subtreeDetachedFunc$($posTile$$), $child$$18_posTileIndex$$.parentNode.insertBefore($posTile$$, $child$$18_posTileIndex$$), this.$_subtreeAttachedFunc$($posTile$$), $child$$18_posTileIndex$$ = $MasonryLayoutCommon$$.$_arrayIndexOf$($children$$16$$, $posTile$$), $child$$18_posTileIndex$$ > $i$$400$$ && ($children$$16$$.splice($child$$18_posTileIndex$$, 1), $children$$16$$.splice($i$$400$$, 0, $posTile$$)));
    }
  };
  ...
  $MasonryLayoutCommon$$.prototype.$_position$ = function $$MasonryLayoutCommon$$$$$_position$$($child$$19_style$$24$$, $col$$6$$, $row$$54$$, $childSpan$$2_rowSpan$$1$$, $cellSize$$1$$, $insets$$1$$) {
    ...
    $child$$19_style$$24$$.top = $insets$$1$$.paddingTop + $row$$54$$ * $cellSize$$1$$.$h$ + "px";
  ...
  $MasonryLayoutCommon$$.prototype.$_addStyleClassToTiles$ = function $$MasonryLayoutCommon$$$$$_addStyleClassToTiles$$($styleClassName$$) {
    for (var $children$$17$$ = this.$_getTileChildren$(), $i$$401$$ = 0;$i$$401$$ < $children$$17$$.length;$i$$401$$++) {
      this.$_addStyleClassNameFunc$($children$$17$$[$i$$401$$], $styleClassName$$);
    }
  };
  $MasonryLayoutCommon$$.prototype.$_removeStyleClassFromTiles$ = function $$MasonryLayoutCommon$$$$$_removeStyleClassFromTiles$$($styleClassName$$1$$) {
    for (var $children$$18$$ = this.$_getTileChildren$(), $i$$402$$ = 0;$i$$402$$ < $children$$18$$.length;$i$$402$$++) {
      this.$_removeStyleClassNameFunc$($children$$18$$[$i$$402$$], $styleClassName$$1$$);
    }
  };
  ...
  $MasonryLayoutCommon$$.prototype.$_handleTransitionEnd$ = function $$MasonryLayoutCommon$$$$$_handleTransitionEnd$$($event$$519_i$$403$$) {
    var $arInfoletsToResize$$2_doneTransitioning$$ = !0;
    if (this.$_arMovedInfolets$) {
      var $arMovedInfolets$$1$$ = this.$_arMovedInfolets$;
      if ($event$$519_i$$403$$) {
        var $target$$93$$ = $event$$519_i$$403$$.target;
        for ($event$$519_i$$403$$ = 0;$event$$519_i$$403$$ < $arMovedInfolets$$1$$.length;$event$$519_i$$403$$++) {
          if ($target$$93$$ === $arMovedInfolets$$1$$[$event$$519_i$$403$$]) {
            $arMovedInfolets$$1$$.splice($event$$519_i$$403$$, 1);
            break;
          }
        }
      } else {
    ...
    if ($arInfoletsToResize$$2_doneTransitioning$$) {
      if (this.$_arInfoletsToResize$ && ($arInfoletsToResize$$2_doneTransitioning$$ = this.$_arInfoletsToResize$, this.$_arInfoletsToResize$ = null, this.$isAnimationEnabled$())) {
        for ($event$$519_i$$403$$ = 0;$event$$519_i$$403$$ < $arInfoletsToResize$$2_doneTransitioning$$.length;$event$$519_i$$403$$ += 2) {
          this.$_removeStyleClassNameFunc$($arInfoletsToResize$$2_doneTransitioning$$[$event$$519_i$$403$$], this.$_transitionResizeToStyleClass$);
        }
      }
  ...
  $MasonryLayoutCommon$$.prototype.$_hideTiles$ = function $$MasonryLayoutCommon$$$$$_hideTiles$$() {
    ...
    if (this.$_arInfoletsToHide$ && this.$isAnimationEnabled$()) {
      for (var $arInfoletsToHide$$1$$ = this.$_arInfoletsToHide$, $i$$404$$ = 0;$i$$404$$ < $arInfoletsToHide$$1$$.length;$i$$404$$++) {
        var $infolet$$4$$ = $arInfoletsToHide$$1$$[$i$$404$$];
      ...
      this.$_hideTilesInternalTimeout$ = setTimeout(function() {
        for (var $i$$405$$ = 0;$i$$405$$ < $arInfoletsToHide$$1$$.length;$i$$405$$++) {
          var $infolet$$5$$ = $arInfoletsToHide$$1$$[$i$$405$$];
  ...
  $MasonryLayoutCommon$$.prototype.$_handleHideTransitionEnd$ = function $$MasonryLayoutCommon$$$$$_handleHideTransitionEnd$$($event$$520_infolet$$6$$) {
    ...
    if ($event$$520_infolet$$6$$) {
      ...
      if ($arInfoletsToHide$$2_newSizeStyleClass_style$$25$$) {
        for (var $i$$406$$ = 0;$i$$406$$ < $arInfoletsToHide$$2_newSizeStyleClass_style$$25$$.length;$i$$406$$++) {
          var $oldSizeStyleClass$$1_tmpInfolet$$ = $arInfoletsToHide$$2_newSizeStyleClass_style$$25$$[$i$$406$$];
          if ($oldSizeStyleClass$$1_tmpInfolet$$ === $event$$520_infolet$$6$$) {
            $arInfoletsToHide$$2_newSizeStyleClass_style$$25$$.splice($i$$406$$, 1);
      ...
      if (!this.$isAnimationEnabled$() && ($arInfoletsToHide$$2_newSizeStyleClass_style$$25$$ = this.$_arInfoletsToHide$)) {
        for ($i$$406$$ = 0;$i$$406$$ < $arInfoletsToHide$$2_newSizeStyleClass_style$$25$$.length;$i$$406$$++) {
          $oldSizeStyleClass$$1_tmpInfolet$$ = $arInfoletsToHide$$2_newSizeStyleClass_style$$25$$[$i$$406$$], this.$_arFireHideOnEnd$ || (this.$_arFireHideOnEnd$ = []), $arFireHideOnEnd_arInfoletsToResize$$3$$ = this.$_arFireHideOnEnd$, $arFireHideOnEnd_arInfoletsToResize$$3$$.push($oldSizeStyleClass$$1_tmpInfolet$$);
        }
    ...
    if (!this.$_arInfoletsToHide$) {
      ...
      if (this.$_arInfoletsToResize$) {
        for ($arFireHideOnEnd_arInfoletsToResize$$3$$ = this.$_arInfoletsToResize$, $i$$406$$ = 0;$i$$406$$ < $arFireHideOnEnd_arInfoletsToResize$$3$$.length;$i$$406$$ += 2) {
          $event$$520_infolet$$6$$ = $arFireHideOnEnd_arInfoletsToResize$$3$$[$i$$406$$], $arInfoletsToHide$$2_newSizeStyleClass_style$$25$$ = $arFireHideOnEnd_arInfoletsToResize$$3$$[$i$$406$$ + 1], $oldSizeStyleClass$$1_tmpInfolet$$ = this.$_getSizeStyleClassNameFunc$($event$$520_infolet$$6$$), this.$_removeStyleClassNameFunc$($event$$520_infolet$$6$$, $oldSizeStyleClass$$1_tmpInfolet$$), this.$_addStyleClassNameFunc$($event$$520_infolet$$6$$, $arInfoletsToHide$$2_newSizeStyleClass_style$$25$$), 
  ...
  $MasonryLayoutCommon$$.prototype.$_showTiles$ = function $$MasonryLayoutCommon$$$$$_showTiles$$() {
    ...
    if (this.$_arInfoletsToShow$ && this.$isAnimationEnabled$()) {
      for (var $arInfoletsToShow$$1$$ = this.$_arInfoletsToShow$, $i$$407$$ = 0;$i$$407$$ < $arInfoletsToShow$$1$$.length;$i$$407$$++) {
        var $infolet$$7$$ = $arInfoletsToShow$$1$$[$i$$407$$];
      ...
      if (this.$_arInfoletsToShow$) {
        for ($arInfoletsToShow$$1$$ = this.$_arInfoletsToShow$, $i$$407$$ = 0;$i$$407$$ < $arInfoletsToShow$$1$$.length;$i$$407$$++) {
          $infolet$$7$$ = $arInfoletsToShow$$1$$[$i$$407$$], this.$_removeStyleClassNameFunc$($infolet$$7$$, this.$_transitionShowFromStyleClass$);
        }
      }
      this.$_handleShowTransitionEnd$(null);
    }
  ...
  $MasonryLayoutCommon$$.prototype.$_handleShowTransitionEnd$ = function $$MasonryLayoutCommon$$$$$_handleShowTransitionEnd$$($event$$521_infolet$$8$$) {
    if ($event$$521_infolet$$8$$) {
      ...
      if ($arInfoletsToShow$$2$$) {
        for (var $i$$408$$ = 0;$i$$408$$ < $arInfoletsToShow$$2$$.length;$i$$408$$++) {
          var $tmpInfolet$$1$$ = $arInfoletsToShow$$2$$[$i$$408$$];
          if ($tmpInfolet$$1$$ === $event$$521_infolet$$8$$) {
            $arInfoletsToShow$$2$$.splice($i$$408$$, 1);
      ...
      if (!this.$isAnimationEnabled$() && ($arInfoletsToShow$$2$$ = this.$_arInfoletsToShow$)) {
        for ($i$$408$$ = 0;$i$$408$$ < $arInfoletsToShow$$2$$.length;$i$$408$$++) {
          $tmpInfolet$$1$$ = $arInfoletsToShow$$2$$[$i$$408$$], this.$_showTileOnEndFunc$ && this.$_showTileOnEndFunc$($tmpInfolet$$1$$);
        }
  ...
  (function() {
    function $_getNextElement$$($currElem$$1_elem$$157_nextElem$$2$$) {
      for (;$currElem$$1_elem$$157_nextElem$$2$$;) {
        $currElem$$1_elem$$157_nextElem$$2$$ = $currElem$$1_elem$$157_nextElem$$2$$.nextSibling;
        var $bVisible$$ = !0;
        if ($currElem$$1_elem$$157_nextElem$$2$$) {
          var $style$$32$$ = $currElem$$1_elem$$157_nextElem$$2$$.style;
          !$style$$32$$ || $style$$32$$.visibility !== $_HIDDEN$$1$$ && $style$$32$$.display !== $_NONE$$1$$ || ($bVisible$$ = !1);
        }
        if ($currElem$$1_elem$$157_nextElem$$2$$ && 1 === $currElem$$1_elem$$157_nextElem$$2$$.nodeType && $bVisible$$) {
          return $currElem$$1_elem$$157_nextElem$$2$$;
        }
      }
      return null;
    }
    function $_findContainingTile$$($elem$$156$$, $rootElem$$) {
      for (var $currElem$$ = $elem$$156$$;$currElem$$;) {
    ...
    function $_getTileSpan$$($elem$$155_tile$$12$$) {
      var $span$$1$$ = null;
      $elem$$155_tile$$12$$ = $$$$47$$($elem$$155_tile$$12$$);
      $elem$$155_tile$$12$$.hasClass("oj-masonrylayout-tile-1x1") ? $span$$1$$ = {colSpan:1, rowSpan:1} : $elem$$155_tile$$12$$.hasClass("oj-masonrylayout-tile-2x1") ? $span$$1$$ = {colSpan:2, rowSpan:1} : $elem$$155_tile$$12$$.hasClass("oj-masonrylayout-tile-3x1") ? $span$$1$$ = {colSpan:3, rowSpan:1} : $elem$$155_tile$$12$$.hasClass("oj-masonrylayout-tile-1x2") ? $span$$1$$ = {colSpan:1, rowSpan:2} : $elem$$155_tile$$12$$.hasClass("oj-masonrylayout-tile-1x3") ? $span$$1$$ = {colSpan:1, rowSpan:3} : 
      $elem$$155_tile$$12$$.hasClass("oj-masonrylayout-tile-2x2") ? $span$$1$$ = {colSpan:2, rowSpan:2} : $elem$$155_tile$$12$$.hasClass("oj-masonrylayout-tile-2x3") ? $span$$1$$ = {colSpan:2, rowSpan:3} : $elem$$155_tile$$12$$.hasClass("oj-masonrylayout-tile-3x2") && ($span$$1$$ = {colSpan:3, rowSpan:2});
      return $span$$1$$;
    }
    function $_getSizeStyleClassName$$($elem$$154_tile$$11$$) {
      var $str$$21$$ = null;
      $elem$$154_tile$$11$$ = $$$$47$$($elem$$154_tile$$11$$);
      $elem$$154_tile$$11$$.hasClass("oj-masonrylayout-tile-1x1") ? $str$$21$$ = "oj-masonrylayout-tile-1x1" : $elem$$154_tile$$11$$.hasClass("oj-masonrylayout-tile-2x1") ? $str$$21$$ = "oj-masonrylayout-tile-2x1" : $elem$$154_tile$$11$$.hasClass("oj-masonrylayout-tile-3x1") ? $str$$21$$ = "oj-masonrylayout-tile-3x1" : $elem$$154_tile$$11$$.hasClass("oj-masonrylayout-tile-1x2") ? $str$$21$$ = "oj-masonrylayout-tile-1x2" : $elem$$154_tile$$11$$.hasClass("oj-masonrylayout-tile-1x3") ? $str$$21$$ = 
      "oj-masonrylayout-tile-1x3" : $elem$$154_tile$$11$$.hasClass("oj-masonrylayout-tile-2x2") ? $str$$21$$ = "oj-masonrylayout-tile-2x2" : $elem$$154_tile$$11$$.hasClass("oj-masonrylayout-tile-2x3") ? $str$$21$$ = "oj-masonrylayout-tile-2x3" : $elem$$154_tile$$11$$.hasClass("oj-masonrylayout-tile-3x2") && ($str$$21$$ = "oj-masonrylayout-tile-3x2");
      return $str$$21$$;
    }
    function $_removeStyleClassName$$($elem$$153$$, $styleClass$$9$$) {
      $$$$47$$($elem$$153$$).removeClass($styleClass$$9$$);
    }
    function $_addStyleClassName$$($elem$$152$$, $styleClass$$8$$) {
      $$$$47$$($elem$$152$$).addClass($styleClass$$8$$);
    }
    $oj$$51$$.$__registerWidget$("oj.ojMasonryLayout", $$$$47$$.oj.baseComponent, {defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{reorderHandle:null, beforeInsert:null, insert:null, beforeRemove:null, remove:null, beforeResize:null, resize:null, beforeReorder:null, reorder:null}, _ComponentCreate:function() {
      ...
      if (this.$_canCalculateSizes$()) {
        ...
        var $elem$$127_oldIsInit$$2$$ = this.element, $children$$19_options$$359$$ = this.options;
        if ($isInit$$2$$) {
          var $self$$200$$ = this;
          this.$_showTileOnEndFunc$ = function $this$$_showTileOnEndFunc$$($elem$$128$$) {
            $self$$200$$.$_showTileOnEnd$($elem$$128$$);
          };
          this.$_hideTileOnEndFunc$ = function $this$$_hideTileOnEndFunc$$($elem$$129$$) {
            $self$$200$$.$_hideTileOnEnd$($elem$$129$$);
          };
          ...
          if (!this.$_mlCommon$) {
            ...
            this.$_mlCommon$ = new $MasonryLayoutCommon$$($elem$$127_oldIsInit$$2$$[0], this.$_bRTL$, "enabled" === $oj$$51$$.$Config$.$getAutomationMode$(), $selectors$$9$$, $styles$$2$$, $callbackInfo$$3$$);
          }
          ...
          $children$$19_options$$359$$ = $elem$$127_oldIsInit$$2$$.children(), this.$_tearDownReorderHandlesForElem$($children$$19_options$$359$$), this.$_setupReorderHandlesForElem$($children$$19_options$$359$$), this.$_checkTilesOriginalOrder$();
        }
        this.$_mlCommon$.$setup$($isInit$$2$$);
        $isInit$$2$$ && (this.$_handleResizeFunc$ = function $this$$_handleResizeFunc$$() {
          $self$$200$$.$_handleResize$();
        }, $oj$$51$$.$DomUtils$.$addResizeListener$($elem$$127_oldIsInit$$2$$[0], this.$_handleResizeFunc$));
      } else {
        $elem$$127_oldIsInit$$2$$ = !1, this.$_needsSetup$ && ($elem$$127_oldIsInit$$2$$ = this.$_needsSetup$[0]), this.$_needsSetup$ = [$isInit$$2$$ || $elem$$127_oldIsInit$$2$$];
      }
    }, _destroy:function() {
      this.$_clearMenu$();
      var $elem$$130$$ = this.element;
      $oj$$51$$.$DomUtils$.$removeResizeListener$($elem$$130$$[0], this.$_handleResizeFunc$);
      this.$_handleResizeFunc$ = null;
      this.$_restoreTilesOriginalOrder$();
      for (var $children$$20$$ = this.$_getTileElements$(), $numChildren$$ = $children$$20$$.length, $i$$409$$ = 0;$i$$409$$ < $numChildren$$;$i$$409$$++) {
        delete $children$$20$$[$i$$409$$].$_jetDataMasonryOriginalOrder$;
      }
      this.$_destroyMLCommon$();
      $elem$$130$$.removeClass("oj-masonrylayout oj-component");
      ...
      this._super();
    }, _setOption:function($key$$170$$, $value$$294$$, $flags$$43$$) {
      ...
      switch($key$$170$$) {
        ...
        case "disabled":
          ...
          break;
        case "contextMenu":
          $oj$$51$$.$DomUtils$.$isTouchSupported$() || (this.$_clearMenu$(), $value$$294$$ && this.$_initMenu$($value$$294$$));
      }
      this._super($key$$170$$, $value$$294$$, $flags$$43$$);
      $bReorderHandle$$ && $value$$294$$ && this.$_setupReorderHandles$();
      ...
      var $jqElem$$1$$ = $$$$47$$($selector$$35$$), $elem$$132$$ = $jqElem$$1$$[0], $prevSizeStyleClass$$ = $_getSizeStyleClassName$$($elem$$132$$);
      ...
      !1 !== this._trigger("beforeResize", null, {tile:$jqElem$$1$$, previousSizeStyleClass:$prevSizeStyleClass$$, sizeStyleClass:$sizeStyleClass$$1$$}) && (this.$_arResizingTiles$ || (this.$_arResizingTiles$ = []), this.$_arResizingTiles$.push($elem$$132$$, $prevSizeStyleClass$$, $sizeStyleClass$$1$$), $mlCommon$$1$$.resizeTile($selector$$35$$, $sizeStyleClass$$1$$));
      ...
      var $jqElem$$2_style$$26$$ = $$$$47$$($selector$$36$$), $elem$$133$$ = $jqElem$$2_style$$26$$[0];
      !1 !== this._trigger("beforeInsert", null, {tile:$jqElem$$2_style$$26$$, index:$index$$239$$}) && ($elem$$133$$.$_jetDataTileInsertIndex$ = $index$$239$$, $mlCommon$$2$$.$isAnimationEnabled$() && $jqElem$$2_style$$26$$.addClass($_OJ_MASONRYLAYOUT_TILE_TRANSITION_SHOW_FROM_CLASS$$), $jqElem$$2_style$$26$$ = $elem$$133$$.style, $jqElem$$2_style$$26$$.top = "-1px", this.$_bRTL$ ? $jqElem$$2_style$$26$$.right = "-1px" : $jqElem$$2_style$$26$$.left = "-1px", this.$_insertTileOriginalOrder$($elem$$133$$, 
      $index$$239$$), $mlCommon$$2$$.$insertTileDomElem$($elem$$133$$, $index$$239$$), $oj$$51$$.Components.$subtreeAttached$($elem$$133$$), this.$_arTilesToInsert$ || (this.$_arTilesToInsert$ = []), this.$_arTilesToInsert$.push($selector$$36$$));
    ...
    }, $_showTileOnEnd$:function($elem$$134$$) {
      var $jqElem$$3$$ = $$$$47$$($elem$$134$$), $index$$241$$ = $elem$$134$$.$_jetDataTileInsertIndex$;
      delete $elem$$134$$.$_jetDataTileInsertIndex$;
    ...
    }, $_hideTileOnEnd$:function($elem$$135$$) {
      var $jqElem$$4$$ = $$$$47$$($elem$$135$$);
      this.options.reorderHandle && this.$_tearDownReorderHandlesForElem$($jqElem$$4$$);
      $oj$$51$$.Components.$subtreeDetached$($elem$$135$$);
      $elem$$135$$.parentNode.removeChild($elem$$135$$);
      this.$_removeTileOriginalOrder$($elem$$135$$);
      this._trigger("remove", null, {tile:$jqElem$$4$$});
    }, $_layoutOnEnd$:function() {
      if (this.$_arTilesToInsert$) {
        for (var $arResizingTiles$$1_mlCommon$$5$$ = this.$_mlCommon$, $arTilesToInsert$$1_eventData$$21_prevSizeStyleClass$$1$$ = this.$_arTilesToInsert$, $i$$410$$ = 0;$i$$410$$ < $arTilesToInsert$$1_eventData$$21_prevSizeStyleClass$$1$$.length;$i$$410$$++) {
          $arResizingTiles$$1_mlCommon$$5$$.$showTile$($arTilesToInsert$$1_eventData$$21_prevSizeStyleClass$$1$$[$i$$410$$]);
        }
        this.$_arTilesToInsert$ = null;
      }
      if (this.$_arResizingTiles$) {
        $arResizingTiles$$1_mlCommon$$5$$ = this.$_arResizingTiles$;
        for ($i$$410$$ = 0;$i$$410$$ < $arResizingTiles$$1_mlCommon$$5$$.length;$i$$410$$ += 3) {
          var $arTilesToInsert$$1_eventData$$21_prevSizeStyleClass$$1$$ = $arResizingTiles$$1_mlCommon$$5$$[$i$$410$$ + 1], $sizeStyleClass$$2$$ = $arResizingTiles$$1_mlCommon$$5$$[$i$$410$$ + 2], $arTilesToInsert$$1_eventData$$21_prevSizeStyleClass$$1$$ = {tile:$$$$47$$($arResizingTiles$$1_mlCommon$$5$$[$i$$410$$]), previousSizeStyleClass:$arTilesToInsert$$1_eventData$$21_prevSizeStyleClass$$1$$, sizeStyleClass:$sizeStyleClass$$2$$};
      ...
      var $children$$22_elem$$137$$ = this.element[0];
      if (this.$_layoutStartActiveDomElem$) {
        ...
        if (this.$_deletingTileWithFocusPrev$) {
          if ($layoutStartActiveDomElem_tile$$ = this.$_deletingTileWithFocusPrev$, this.$_deletingTileWithFocusPrev$ = null, $layoutStartActiveDomElem_tile$$ && $oj$$51$$.$DomUtils$.$isAncestor$($children$$22_elem$$137$$, $layoutStartActiveDomElem_tile$$)) {
            var $children$$22_elem$$137$$ = this.$_getTileElements$($children$$22_elem$$137$$, !0), $index$$242$$ = $children$$22_elem$$137$$.indexOf($layoutStartActiveDomElem_tile$$);
            0 <= $index$$242$$ && $index$$242$$ < $children$$22_elem$$137$$.length - 1 ? $oj$$51$$.$FocusUtils$.$focusFirstTabStop$($children$$22_elem$$137$$[$index$$242$$ + 1]) : $oj$$51$$.$FocusUtils$.$focusFirstTabStop$($layoutStartActiveDomElem_tile$$);
          }
        } else {
          $oj$$51$$.$DomUtils$.$isAncestor$($children$$22_elem$$137$$, $layoutStartActiveDomElem_tile$$) ? $oj$$51$$.$FocusUtils$.$focusElement$($layoutStartActiveDomElem_tile$$) : $oj$$51$$.$FocusUtils$.$focusFirstTabStop$($children$$22_elem$$137$$);
        }
      }
      ...
      var $div$$5$$ = document.createElement("div"), $elem$$138_style$$27$$ = $div$$5$$.style;
      $elem$$138_style$$27$$.width = "10px";
      $elem$$138_style$$27$$.height = "10px";
      $elem$$138_style$$27$$ = this.element[0];
      $elem$$138_style$$27$$.appendChild($div$$5$$);
      var $bCanCalcSizes$$2$$ = !1;
      try {
        $bCanCalcSizes$$2$$ = 0 < $div$$5$$.offsetWidth && 0 < $div$$5$$.offsetHeight;
      } catch ($e$$107$$) {
      }
      $elem$$138_style$$27$$.removeChild($div$$5$$);
      return $bCanCalcSizes$$2$$;
    }, $_getTileElements$:function($excludeDropSite$$) {
      for (var $children$$23$$ = this.element.children($_TILE_SELECTOR$$), $numChildren$$1$$ = $children$$23$$.length, $arChildren$$2$$ = [], $i$$411$$ = 0;$i$$411$$ < $numChildren$$1$$;$i$$411$$++) {
        var $child$$22$$ = $children$$23$$[$i$$411$$];
      ...
      if ($arTiles$$) {
        for (var $i$$412$$ = 0;$i$$412$$ < $arTiles$$.length;$i$$412$$++) {
          var $tile$$1$$ = $arTiles$$[$i$$412$$];
          $tile$$1$$.$_jetDataMasonryOriginalOrder$ || ($tile$$1$$.$_jetDataMasonryOriginalOrder$ = $i$$412$$ + 1);
        }
      }
    }, $_checkTilesOriginalOrder$:function() {
      var $arTiles$$1$$ = this.$_getTileElements$();
      if ($arTiles$$1$$) {
        for (var $i$$413$$ = 0;$i$$413$$ < $arTiles$$1$$.length;$i$$413$$++) {
          var $tile$$2$$ = $arTiles$$1$$[$i$$413$$];
          $tile$$2$$.$_jetDataMasonryOriginalOrder$ || this.$_insertTileOriginalOrder$($tile$$2$$, $i$$413$$);
        }
      }
      ...
      for (var $i$$414$$ = 0;$i$$414$$ < $children$$24$$.length;$i$$414$$++) {
        var $child$$23_sortedChildIndex$$ = $children$$24$$[$i$$414$$], $sortedChild$$ = $sortedChildren$$[$i$$414$$];
        $child$$23_sortedChildIndex$$ != $sortedChild$$ && ($oj$$51$$.Components.$subtreeDetached$($sortedChild$$), $child$$23_sortedChildIndex$$.parentNode.insertBefore($sortedChild$$, $child$$23_sortedChildIndex$$), $oj$$51$$.Components.$subtreeAttached$($sortedChild$$), $child$$23_sortedChildIndex$$ = $children$$24$$.indexOf($sortedChild$$), $child$$23_sortedChildIndex$$ > $i$$414$$ && ($children$$24$$.splice($child$$23_sortedChildIndex$$, 1), $children$$24$$.splice($i$$414$$, 0, $sortedChild$$)));
      }
      ...
      if ($arTiles$$2$$) {
        for (var $i$$415$$ = 0;$i$$415$$ < $arTiles$$2$$.length;$i$$415$$++) {
          var $tile$$3$$ = $arTiles$$2$$[$i$$415$$];
      ...
      if ($removedTile$$.$_jetDataMasonryOriginalOrder$) {
        ...
        if ($arTiles$$3$$) {
          for (var $i$$416$$ = 0;$i$$416$$ < $arTiles$$3$$.length;$i$$416$$++) {
            var $tile$$4$$ = $arTiles$$3$$[$i$$416$$];
      ...
      for (var $numChildren$$2$$ = $children$$25$$.length, $i$$417$$ = 0;$i$$417$$ < $numChildren$$2$$;$i$$417$$++) {
        if ($children$$25$$[$i$$417$$] === $tile$$6$$) {
          return $i$$417$$;
        }
      }
      return-1;
    }, $_setupReorderHandles$:function() {
      var $elem$$142$$ = this.element, $children$$26$$ = $elem$$142$$.children();
      this.$_setupReorderHandlesForElem$($children$$26$$);
      $elem$$142$$.on("dragstart" + this.$reorderHandleEventNamespace$, this.$_handleDragStartFunc$).on("dragenter" + this.$reorderHandleEventNamespace$, this.$_handleDragEnterFunc$).on("dragover" + this.$reorderHandleEventNamespace$, this.$_handleDragOverFunc$).on("dragleave" + this.$reorderHandleEventNamespace$, this.$_handleDragLeaveFunc$).on("dragend" + this.$reorderHandleEventNamespace$, this.$_handleDragEndFunc$).on("drop" + this.$reorderHandleEventNamespace$, this.$_handleDropFunc$);
      ...
      var $elem$$143$$ = this.element, $children$$27$$ = $elem$$143$$.children();
      this.$_tearDownReorderHandlesForElem$($children$$27$$);
      $elem$$143$$.off(this.$reorderHandleEventNamespace$);
      ...
      var $elemUnderPoint_relatedTarget$$ = $event$$530_originalEvent$$7$$.relatedTarget, $elem$$145$$ = this.element[0], $enteringMasonryLayout$$ = !1;
      $elemUnderPoint_relatedTarget$$ ? $enteringMasonryLayout$$ = $elem$$145$$ != $elemUnderPoint_relatedTarget$$ && !$oj$$51$$.$DomUtils$.$isAncestor$($elem$$145$$, $elemUnderPoint_relatedTarget$$) : this.$_dragLeftMasonryLayout$ && ($enteringMasonryLayout$$ = ($elemUnderPoint_relatedTarget$$ = document.elementFromPoint($event$$530_originalEvent$$7$$.clientX, $event$$530_originalEvent$$7$$.clientY)) && ($elemUnderPoint_relatedTarget$$ == $elem$$145$$ || $oj$$51$$.$DomUtils$.$isAncestor$($elem$$145$$, 
      $elemUnderPoint_relatedTarget$$)));
      ...
      return!1;
    }, $_handleDragLeave$:function($elem$$146_event$$532$$) {
      var $elemUnderPoint$$1_originalEvent$$9$$ = $elem$$146_event$$532$$.originalEvent, $relatedTarget$$1$$ = $elemUnderPoint$$1_originalEvent$$9$$.relatedTarget;
      $elem$$146_event$$532$$ = this.element[0];
      var $leavingMasonryLayout$$ = !1;
      $leavingMasonryLayout$$ = $relatedTarget$$1$$ ? $elem$$146_event$$532$$ != $relatedTarget$$1$$ && !$oj$$51$$.$DomUtils$.$isAncestor$($elem$$146_event$$532$$, $relatedTarget$$1$$) : ($elemUnderPoint$$1_originalEvent$$9$$ = document.elementFromPoint($elemUnderPoint$$1_originalEvent$$9$$.clientX, $elemUnderPoint$$1_originalEvent$$9$$.clientY)) && $elemUnderPoint$$1_originalEvent$$9$$ != $elem$$146_event$$532$$ && !$oj$$51$$.$DomUtils$.$isAncestor$($elem$$146_event$$532$$, $elemUnderPoint$$1_originalEvent$$9$$);
      ...
      var $elem$$148$$ = this.element[0], $offset$$28_sizeClass_style$$29$$ = $_getSizeStyleClassName$$($tile$$8$$), $dropSite$$1$$ = this.$_dropSite$ = document.createElement("div");
      ...
      $elem$$148$$.insertBefore($dropSite$$1$$, $tile$$8$$);
      ...
      if (this.$_bDragStartTileHidden$ && !this.$_bDragMoveTransition$) {
        ...
        if (($clientX$$2_elemUnderPoint$$2_tileUnderPoint$$ = $_findContainingTile$$($clientX$$2_elemUnderPoint$$2_tileUnderPoint$$, $elem$$149$$)) && $clientX$$2_elemUnderPoint$$2_tileUnderPoint$$ !== this.$_dropSite$ && $clientX$$2_elemUnderPoint$$2_tileUnderPoint$$ !== this.$_draggedTile$) {
          var $offset$$29$$ = $$$$47$$($elem$$149$$).offset();
          ...
          $bRightSide_nextElem$$1_pageX$$2$$ && !this.$_bRTL$ || !$bRightSide_nextElem$$1_pageX$$2$$ && this.$_bRTL$ ? ($bRightSide_nextElem$$1_pageX$$2$$ = $_getNextElement$$($clientX$$2_elemUnderPoint$$2_tileUnderPoint$$)) ? (this.$_insertTileOriginalOrder$(this.$_dropSite$, $bRightSide_nextElem$$1_pageX$$2$$.$_jetDataMasonryOriginalOrder$ - 1), $elem$$149$$.insertBefore(this.$_dropSite$, $bRightSide_nextElem$$1_pageX$$2$$)) : (this.$_insertTileOriginalOrder$(this.$_dropSite$, $clientX$$2_elemUnderPoint$$2_tileUnderPoint$$.$_jetDataMasonryOriginalOrder$), 
          $elem$$149$$.appendChild(this.$_dropSite$)) : (this.$_insertTileOriginalOrder$(this.$_dropSite$, $clientX$$2_elemUnderPoint$$2_tileUnderPoint$$.$_jetDataMasonryOriginalOrder$ - 1), $elem$$149$$.insertBefore(this.$_dropSite$, $clientX$$2_elemUnderPoint$$2_tileUnderPoint$$));
      ...
      this.$_bDropping$ = !0;
      var $elem$$150$$ = this.element[0], $dropSite$$2_style$$30$$ = this.$_dropSite$;
      this.$_dropSite$ = null;
      $oj$$51$$.Components.$subtreeDetached$($tile$$9$$);
      $elem$$150$$.replaceChild($tile$$9$$, $dropSite$$2_style$$30$$);
      ...
      var $offset$$30$$ = $$$$47$$($elem$$150$$).offset(), $dragOffset$$1$$ = this.$_dragOffset$;
      ...
      this.$_bRTL$ ? ($dropSite$$2_style$$30$$.right = $elem$$150$$.offsetWidth - ($newLeft$$1_pageX$$3$$ + $$$$47$$($tile$$9$$).outerWidth(!0)) + $_PX$$1$$, $dropSite$$2_style$$30$$.left = "") : $dropSite$$2_style$$30$$.left = $newLeft$$1_pageX$$3$$ + $_PX$$1$$;
      this.$_dragOffset$ = null;
