...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common"], function($oj$$59$$) {
  ...
  $oj$$59$$.$PagingTableDataSource$.prototype.setPage = function $$oj$$59$$$$PagingTableDataSource$$$setPage$($value$$301$$, $options$$375$$) {
    $options$$375$$ = $options$$375$$ || {};
    $value$$301$$ = parseInt($value$$301$$, 10);
    try {
      $oj$$59$$.$PagingTableDataSource$.$superclass$.handleEvent.call(this, $oj$$59$$.$PagingModel$.$EventType$.BEFOREPAGE, {page:$value$$301$$, previousPage:this.$_getPageFromStartIndex$()});
    } catch ($err$$26$$) {
    ...
    $options$$375$$.startIndex = $value$$301$$ * this.$_pageSize$;
    ...
    return new Promise(function($resolve$$68$$, $reject$$64$$) {
      0 < $self$$208$$.$_pageSize$ ? $self$$208$$.$dataSource$.fetch($options$$375$$).then(function($result$$78$$) {
        ...
        $self$$208$$.$_updateEndIndex$($result$$78$$.data.length);
  ...
  $oj$$59$$.$PagingTableDataSource$.prototype.fetch = function $$oj$$59$$$$PagingTableDataSource$$$fetch$($options$$377$$) {
    ...
    return new Promise(function($resolve$$69$$, $reject$$65$$) {
      0 < $pageSize$$13$$ ? $self$$209$$.$dataSource$.fetch($options$$377$$).then(function($result$$79$$) {
        $self$$209$$.$_updateEndIndex$($result$$79$$.data.length);
        $resolve$$69$$($result$$79$$);
      }, function($e$$111$$) {
        $reject$$65$$($e$$111$$);
      }) : $resolve$$69$$(null);
    });
  ...
  $oj$$59$$.$PagingTableDataSource$.prototype.$_handleRowEvent$ = function $$oj$$59$$$$PagingTableDataSource$$$$_handleRowEvent$$($event$$579$$, $eventHandler$$7$$) {
    var $ignoreRows$$ = [], $i$$424$$;
    for ($i$$424$$ = 0;$i$$424$$ < $event$$579$$.indexes.length;$i$$424$$++) {
      var $rowIdx$$43$$ = $event$$579$$.indexes[$i$$424$$];
      void 0 !== $rowIdx$$43$$ && ($rowIdx$$43$$ -= this.$_startIndex$, (0 > $rowIdx$$43$$ || $rowIdx$$43$$ >= this.$_startIndex$ + this.$_pageSize$) && $ignoreRows$$.push($i$$424$$));
    }
    if (0 < $ignoreRows$$.length) {
      for ($ignoreRows$$.sort(function($a$$125$$, $b$$79$$) {
        return $a$$125$$ - $b$$79$$;
      }), $i$$424$$ = $ignoreRows$$.length - 1;0 <= $i$$424$$;$i$$424$$--) {
        $event$$579$$.data.splice($ignoreRows$$[$i$$424$$], 1), $event$$579$$.indexes.splice($ignoreRows$$[$i$$424$$], 1), $event$$579$$.keys.splice($ignoreRows$$[$i$$424$$], 1);
      }
    }
