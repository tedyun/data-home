...
define(["ojs/ojcore", "jquery", "hammerjs", "promise", "ojs/ojjquery-hammer", "ojs/ojcomponentcore"], function($oj$$64$$, $$$$58$$) {
  ...
  $oj$$64$$.$PullToRefreshUtils$.$setupPullToRefresh$ = function $$oj$$64$$$$PullToRefreshUtils$$$setupPullToRefresh$$($element$$159$$, $refreshFunc$$, $options$$396$$) {
  ...
  $oj$$64$$.$PullToRefreshUtils$.$tearDownPullToRefresh$ = function $$oj$$64$$$$PullToRefreshUtils$$$tearDownPullToRefresh$$($element$$160$$) {
    $$$$58$$($element$$160$$).children().first().remove();
    $$$$58$$($element$$160$$).off(".pulltorefresh");
  };
  $goog$exportPath_$$("PullToRefreshUtils.tearDownPullToRefresh", $oj$$64$$.$PullToRefreshUtils$.$tearDownPullToRefresh$, $oj$$64$$);
  $oj$$64$$.$PullToRefreshUtils$.$_fireEvent$ = function $$oj$$64$$$$PullToRefreshUtils$$$_fireEvent$$($originalEvent$$12$$, $event$$601_key$$178$$, $content$$34$$, $distance$$) {
    $event$$601_key$$178$$ = $$$$58$$.Event("oj" + $event$$601_key$$178$$);
    $event$$601_key$$178$$.originalEvent = $originalEvent$$12$$;
    $content$$34$$.trigger($event$$601_key$$178$$, {content:$content$$34$$, distance:$distance$$});
  };
