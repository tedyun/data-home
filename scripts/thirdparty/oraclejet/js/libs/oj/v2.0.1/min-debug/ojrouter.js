...
define(["ojs/ojcore", "knockout", "signals", "promise"], function($oj$$17$$, $ko$$3$$, $signals$$1$$) {
  (function() {
    ...
    function $parseQueryParam$$($key$$77_queryString$$2$$) {
      var $params$$18$$ = {}, $keyValPairs$$ = [], $pairNum$$, $parts$$4_value$$228$$;
      if ($key$$77_queryString$$2$$) {
        for ($pairNum$$ in $keyValPairs$$ = $key$$77_queryString$$2$$.split("\x26"), $keyValPairs$$) {
          $parts$$4_value$$228$$ = $keyValPairs$$[$pairNum$$].split(/\=(.+)?/), $key$$77_queryString$$2$$ = $parts$$4_value$$228$$[0], $key$$77_queryString$$2$$.length && ($params$$18$$[$key$$77_queryString$$2$$] || ($params$$18$$[$key$$77_queryString$$2$$] = []), $parts$$4_value$$228$$ = $parts$$4_value$$228$$[1] && decodeURIComponent($parts$$4_value$$228$$[1].replace(/\+/g, " ")), $params$$18$$[$key$$77_queryString$$2$$].push($parts$$4_value$$228$$));
        }
      }
      return $params$$18$$;
    }
    ...
    function $_getChildRouter$$($router$$3$$, $value$$229$$) {
      var $subRouter$$;
      $router$$3$$.$_childRouters$.every(function($sr$$) {
        return $sr$$.$_parentState$ && $sr$$.$_parentState$ !== $value$$229$$ ? !0 : ($subRouter$$ = $sr$$, !1);
      });
      return $subRouter$$;
    }
    ...
    function $_parseUrlAndCompare$$($reducedChanges_url$$23$$) {
      var $extra$$1$$ = {}, $name$$112$$, $search$$4_stateStr$$ = $reducedChanges_url$$23$$.split("?")[1] || "";
      ...
      if ($oj$$17$$.$Logger$.option("level") === $oj$$17$$.$Logger$.$LEVEL_INFO$) {
        for ($name$$112$$ in $oj$$17$$.$Logger$.info("Bookmarkable data: "), $extra$$1$$) {
          $oj$$17$$.$Logger$.info("   { router: %s, value: %s }", $name$$112$$, $extra$$1$$[$name$$112$$]);
        }
      }
    ...
    function $_resolveTransition$$() {
      ...
      return $promise$$3_transition$$1$$.then(function($params$$19$$) {
    ...
    $oj$$17$$.$Router$ = function $$oj$$17$$$$Router$$($key$$78$$, $parentRouter$$, $parentState$$) {
      var $router$$9$$ = this;
      this.$_name$ = $key$$78$$;
      ...
      }, write:function($value$$230$$) {
        this.go($value$$230$$).then(null, function($error$$36$$) {
          throw $error$$36$$;
        });
      }, owner:$router$$9$$});
      this.$_states$ = null;
    ...
    $oj$$17$$.$Router$.prototype.$getChildRouter$ = function $$oj$$17$$$$Router$$$$getChildRouter$$($name$$113$$) {
      var $childRouter$$;
      $name$$113$$ && "string" === typeof $name$$113$$ && ($name$$113$$ = $name$$113$$.trim(), 0 < $name$$113$$.length && this.$_childRouters$.every(function($sr$$2$$) {
        return $sr$$2$$.$_name$ === $name$$113$$ ? ($childRouter$$ = $sr$$2$$, !1) : !0;
      }));
      return $childRouter$$;
    };
    $oj$$17$$.$Object$.$exportPrototypeSymbol$("Router.prototype.getChildRouter", {$getChildRouter$:$oj$$17$$.$Router$.prototype.$getChildRouter$});
    $oj$$17$$.$Router$.prototype.$createChildRouter$ = function $$oj$$17$$$$Router$$$$createChildRouter$$($name$$114$$, $parentStateId$$2$$) {
      var $childRouter$$1_i$$254$$, $sr$$3$$;
      $oj$$17$$.$Assert$.$assertString$($name$$114$$);
      $parentStateId$$2$$ = $parentStateId$$2$$ || this.$_stateId$();
      $name$$114$$ = encodeURIComponent($name$$114$$.trim());
      for ($childRouter$$1_i$$254$$ = 0;$childRouter$$1_i$$254$$ < this.$_childRouters$.length;$childRouter$$1_i$$254$$++) {
        $sr$$3$$ = this.$_childRouters$[$childRouter$$1_i$$254$$];
        if ($sr$$3$$.$_name$ === $name$$114$$) {
          throw Error('Invalid router name "' + $name$$114$$ + '", it already exists.');
        }
      ...
      $childRouter$$1_i$$254$$ = new $oj$$17$$.$Router$($name$$114$$, this, $parentStateId$$2$$);
      this.$_childRouters$.push($childRouter$$1_i$$254$$);
      return $childRouter$$1_i$$254$$;
    };
    ...
    $oj$$17$$.$Router$.prototype.$configure$ = function $$oj$$17$$$$Router$$$$configure$$($option$$29$$) {
      ...
      this.$_navigationType$ = void 0;
      this.$_navHistory$ = [];
      "function" === typeof $option$$29$$ ? (this.$_states$ = null, this.$stateFromIdCallback$ = $option$$29$$) : (this.$_states$ = [], delete this.$stateFromIdCallback$, Object.keys($option$$29$$).forEach(function($key$$79$$) {
        var $rsOptions$$ = $option$$29$$[$key$$79$$];
        this.$_states$.push(new $oj$$17$$.$RouterState$($key$$79$$, $rsOptions$$, this));
        "boolean" === typeof $rsOptions$$.isDefault && $rsOptions$$.isDefault && (this.$_defaultStateId$ = $key$$79$$);
      }, this));
      return this;
    };
    ...
    $oj$$17$$.$Router$.prototype.$_go$ = function $$oj$$17$$$$Router$$$$_go$$($stateIdPath$$1$$, $replace$$) {
      function $_changeState$$($canExit$$3$$) {
        return $canExit$$3$$ ? $parseAndUpdate$$($newUrl$$.replace(/^\//, "")).then(function($params$$21$$) {
    ...
    $oj$$17$$.$Router$.$urlPathAdapter$ = function $$oj$$17$$$$Router$$$urlPathAdapter$$() {
      this.parse = function $this$parse$($segments_url$$27$$) {
        ...
        var $changes$$3$$ = [], $value$$231$$;
        do {
          ($value$$231$$ = $segments_url$$27$$.shift()) && (0 === $value$$231$$.length || /\.html$/i.test($value$$231$$)) && ($value$$231$$ = void 0), $value$$231$$ = $value$$231$$ || $router$$11$$.$_defaultStateId$, $changes$$3$$.push({value:$value$$231$$, $router$:$router$$11$$}), $router$$11$$ = $_getChildRouter$$($router$$11$$, $value$$231$$);
        } while ($router$$11$$);
        return $changes$$3$$;
      };
    ...
    $oj$$17$$.$Router$.$urlParamAdapter$ = function $$oj$$17$$$$Router$$$urlParamAdapter$$() {
      this.parse = function $this$parse$($params$$22_url$$30$$) {
        ...
        var $router$$12$$ = $rootRouter$$, $changes$$4$$ = [], $value$$232$$;
        do {
          if ($value$$232$$ = $params$$22_url$$30$$[$router$$12$$.$_name$]) {
            $value$$232$$ = $value$$232$$[0], delete $params$$22_url$$30$$[$router$$12$$.$_name$];
          }
          $value$$232$$ = $value$$232$$ || $router$$12$$.$_defaultStateId$;
          $changes$$4$$.push({value:$value$$232$$, $router$:$router$$12$$});
          $router$$12$$ = $_getChildRouter$$($router$$12$$, $value$$232$$);
        } while ($router$$12$$);
        return $changes$$4$$;
      };
  ...
  (function() {
    function $_compress$$($uncompressed$$, $getCharFromInt$$) {
      ...
      var $i$$258$$, $value$$233$$, $context_dictionary$$ = {}, $context_dictionaryToCreate$$ = {}, $context_w$$ = "", $context_enlargeIn$$ = 2, $context_dictSize$$ = 3, $context_numBits$$ = 2, $context_data_string$$ = "", $context_data_val$$ = 0, $context_data_position$$ = 0, $context_c$$, $context_wc$$, $ii$$, $len$$17$$ = $uncompressed$$.length;
        ...
        if ($context_c$$ = $uncompressed$$[$ii$$], Object.prototype.hasOwnProperty.call($context_dictionary$$, $context_c$$) || ($context_dictionary$$[$context_c$$] = $context_dictSize$$++, $context_dictionaryToCreate$$[$context_c$$] = !0), $context_wc$$ = $context_w$$ + $context_c$$, Object.prototype.hasOwnProperty.call($context_dictionary$$, $context_wc$$)) {
          ...
          if (Object.prototype.hasOwnProperty.call($context_dictionaryToCreate$$, $context_w$$)) {
            if (256 > $context_w$$.charCodeAt(0)) {
              ...
              $value$$233$$ = $context_w$$.charCodeAt(0);
              $i$$258$$ = 8;
            } else {
              $value$$233$$ = 1;
              for ($i$$258$$ = $context_numBits$$;$i$$258$$--;) {
                $context_data_val$$ = $context_data_val$$ << 1 | $value$$233$$, 5 == $context_data_position$$ ? ($context_data_position$$ = 0, $context_data_string$$ += $getCharFromInt$$($context_data_val$$), $context_data_val$$ = 0) : $context_data_position$$++, $value$$233$$ = 0;
              }
              $value$$233$$ = $context_w$$.charCodeAt(0);
              $i$$258$$ = 16;
            }
            for (;$i$$258$$--;) {
              $context_data_val$$ = $context_data_val$$ << 1 | $value$$233$$ & 1, 5 == $context_data_position$$ ? ($context_data_position$$ = 0, $context_data_string$$ += $getCharFromInt$$($context_data_val$$), $context_data_val$$ = 0) : $context_data_position$$++, $value$$233$$ >>= 1;
            }
            $context_enlargeIn$$--;
            0 == $context_enlargeIn$$ && ($context_enlargeIn$$ = Math.pow(2, $context_numBits$$), $context_numBits$$++);
            delete $context_dictionaryToCreate$$[$context_w$$];
          } else {
            for ($value$$233$$ = $context_dictionary$$[$context_w$$], $i$$258$$ = $context_numBits$$;$i$$258$$--;) {
              $context_data_val$$ = $context_data_val$$ << 1 | $value$$233$$ & 1, 5 == $context_data_position$$ ? ($context_data_position$$ = 0, $context_data_string$$ += $getCharFromInt$$($context_data_val$$), $context_data_val$$ = 0) : $context_data_position$$++, $value$$233$$ >>= 1;
            }
          }
          $context_enlargeIn$$--;
    ...
    $oj$$17$$.$LZString$ = {$compressToEncodedURIComponent$:function $$oj$$17$$$$LZString$$$compressToEncodedURIComponent$$($input$$6$$) {
      ...
      return null === $input$$7$$ ? "" : "" === $input$$7$$ ? null : $_decompress$$($input$$7$$.length, function($character$$inline_738_index$$112$$) {
        var $alphabet$$inline_737$$ = $_keyStrUriSafe$$;
        $character$$inline_738_index$$112$$ = $input$$7$$.charAt($character$$inline_738_index$$112$$);
        var $i$$inline_739$$;
        $_baseReverseDic$$ || ($_baseReverseDic$$ = {});
        if (!$_baseReverseDic$$[$alphabet$$inline_737$$]) {
          for ($_baseReverseDic$$[$alphabet$$inline_737$$] = {}, $i$$inline_739$$ = 0;$i$$inline_739$$ < $alphabet$$inline_737$$.length;$i$$inline_739$$++) {
            $_baseReverseDic$$[$alphabet$$inline_737$$][$alphabet$$inline_737$$[$i$$inline_739$$]] = $i$$inline_739$$;
          }
        }
        return $_baseReverseDic$$[$alphabet$$inline_737$$][$character$$inline_738_index$$112$$];
      });
    }};
