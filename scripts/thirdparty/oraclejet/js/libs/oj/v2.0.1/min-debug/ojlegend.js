 ...
 */
"use strict";
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtLegend"], function($oj$$50$$, $$$$46$$, $comp$$12$$, $base$$8$$, $dvt$$5$$) {
  $oj$$50$$.$__registerWidget$("oj.ojLegend", $$$$46$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{categoryFilter:null, categoryHighlight:null, drill:null}, $_CreateDvtComponent$:function($context$$120$$, $callback$$110$$, $callbackObj$$8$$) {
    return $dvt$$5$$.Legend.newInstance($context$$120$$, $callback$$110$$, $callbackObj$$8$$);
    ...
    var $type$$95$$ = $event$$515$$.type;
    "categoryHide" === $type$$95$$ || "categoryShow" === $type$$95$$ ? (this._trigger("categoryFilter", null, {category:$event$$515$$.category, type:"categoryHide" === $type$$95$$ ? "out" : "in"}), this.$_UserOptionChange$("hiddenCategories", $event$$515$$.hiddenCategories)) : "categoryHighlight" === $type$$95$$ ? (this._trigger("categoryHighlight", null, {categories:$event$$515$$.categories, type:$event$$515$$.categories && 0 < $event$$515$$.categories.length ? "on" : "off"}), this.$_UserOptionChange$("highlightedCategories", 
    $event$$515$$.categories)) : "drill" === $type$$95$$ ? this._trigger("drill", null, {id:$event$$515$$.id}) : this._super($event$$515$$);
  ...
  }, getContextByNode:function($context$$121_node$$106$$) {
    return($context$$121_node$$106$$ = this.getSubIdByNode($context$$121_node$$106$$)) && "oj-legend-tooltip" !== $context$$121_node$$106$$.subId ? $context$$121_node$$106$$ : null;
