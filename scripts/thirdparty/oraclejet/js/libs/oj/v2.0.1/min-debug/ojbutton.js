...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$26$$, $$$$25$$) {
  (function() {
    function $_getChromingDefault$$($componentName$$8$$, $element$$120_element$$inline_837$$, $actualContainers$$1_containerConstructor$$) {
      a: {
        for (var $interestingContainers$$inline_839$$ = $_interestingContainers$$[$componentName$$8$$], $i$$inline_840$$ = 0;$i$$inline_840$$ < $interestingContainers$$inline_839$$.length;++$i$$inline_840$$) {
          ...
          if (0 <= $actualContainers$$1_containerConstructor$$.indexOf($containerName$$inline_841$$)) {
            for (;;$element$$120_element$$inline_837$$ = $element$$120_element$$inline_837$$.parentNode) {
              var $func$$inline_842$$ = $oj$$26$$.Components.$getWidgetConstructor$($element$$120_element$$inline_837$$, $containerName$$inline_841$$);
              if ($func$$inline_842$$) {
    ...
    function $_radioGroup$$($radio$$, $$elems$$) {
      var $name$$119_selector$$30$$ = $radio$$.name, $$radios_form$$1$$ = $radio$$.form;
      $name$$119_selector$$30$$ ? ($name$$119_selector$$30$$ = $name$$119_selector$$30$$.replace(/'/g, "\\'"), $name$$119_selector$$30$$ = ":radio[name\x3d'" + $name$$119_selector$$30$$ + "']:oj-button", $$radios_form$$1$$ = $$elems$$ ? $$elems$$.filter($name$$119_selector$$30$$) : $$radios_form$$1$$ ? $$$$25$$($$radios_form$$1$$).find($name$$119_selector$$30$$) : $$$$25$$($name$$119_selector$$30$$, $radio$$.ownerDocument).filter(function() {
        return!this.form;
    ...
    }, _setOption:function($key$$139$$, $value$$257$$, $flags$$34$$) {
      this._super($key$$139$$, $value$$257$$, $flags$$34$$);
      switch($key$$139$$) {
        case "chroming":
          $_setChromingClass$$(this.$rootElement$, $value$$257$$);
          break;
        case "disabled":
          this.$_updateEffectivelyDisabled$();
          break;
    ...
    }, $_checkMenuParent$:function($element$$118$$) {
      return!$element$$118$$.hasClass("oj-selected");
    ...
    $oj$$26$$.$__registerWidget$("oj.ojButtonset", $$$$25$$.oj.baseComponent, {$_items$:"button, input[type\x3dbutton], input[type\x3dsubmit], input[type\x3dreset], input[type\x3dcheckbox], input[type\x3dradio], a", widgetEventPrefix:"oj", options:{checked:null, chroming:"full", focusManagement:"oneTabstop"}, $_setCheckedOnDom$:function($checked$$1$$, $$buttons$$1$$) {
      var $name$$117_type$$86_valid$$10_validRadios$$ = $$$$25$$.type($checked$$1$$), $allCheckboxes$$;
      if ("null" === $name$$117_type$$86_valid$$10_validRadios$$ || "array" === $name$$117_type$$86_valid$$10_validRadios$$) {
        $allCheckboxes$$ = $$buttons$$1$$.filter("input[type\x3dcheckbox]").length === $$buttons$$1$$.length;
      }
      if ($allCheckboxes$$ && "null" === $name$$117_type$$86_valid$$10_validRadios$$) {
        throw Error("Invalid 'checked' value set on JET Buttonset: " + $checked$$1$$);
      }
      if ("string" === $name$$117_type$$86_valid$$10_validRadios$$ || "null" === $name$$117_type$$86_valid$$10_validRadios$$) {
        ($name$$117_type$$86_valid$$10_validRadios$$ = (($name$$117_type$$86_valid$$10_validRadios$$ = $$buttons$$1$$[0].name) || 1 >= $$buttons$$1$$.length) && $$buttons$$1$$.filter("input[type\x3dradio][name\x3d" + $name$$117_type$$86_valid$$10_validRadios$$ + "]").length === $$buttons$$1$$.length && (null === $checked$$1$$ || $$buttons$$1$$.filter("[value\x3d" + $checked$$1$$ + "]").length)) && $$buttons$$1$$.each(function() {
          this.checked = this.value === $checked$$1$$;
        }), $name$$117_type$$86_valid$$10_validRadios$$ = $name$$117_type$$86_valid$$10_validRadios$$ || null === $checked$$1$$;
      } else {
        if ("array" === $name$$117_type$$86_valid$$10_validRadios$$) {
          var $last$$2$$;
          ($name$$117_type$$86_valid$$10_validRadios$$ = $allCheckboxes$$ && $checked$$1$$.concat().sort().every(function($elem$$66$$) {
            var $retVal$$16$$ = $elem$$66$$ !== $last$$2$$ && $$buttons$$1$$.filter("[value\x3d" + $elem$$66$$ + "]").length;
            $last$$2$$ = $elem$$66$$;
            return $retVal$$16$$;
          ...
          $name$$117_type$$86_valid$$10_validRadios$$ = !1;
        }
      }
      if (!$name$$117_type$$86_valid$$10_validRadios$$) {
        throw Error("Invalid 'checked' value set on JET Buttonset: " + $checked$$1$$);
      }
    }, $_getCheckedFromDom$:function($$buttons$$2$$) {
      var $checked$$2$$ = void 0, $isRadio$$ = null, $name$$118$$ = null;
      $$buttons$$2$$.each(function() {
        ...
        if (void 0 !== $checked$$2$$ && ($currentIsRadio_currentType$$ !== $isRadio$$ || $currentName$$ !== $name$$118$$ || $isRadio$$ && !$name$$118$$)) {
          return $checked$$2$$ = void 0, !1;
        }
        void 0 === $checked$$2$$ ? ($checked$$2$$ = $currentIsRadio_currentType$$ ? this.checked ? this.value : null : this.checked ? [this.value] : [], $isRadio$$ = $currentIsRadio_currentType$$, $name$$118$$ = $currentName$$) : this.checked && ($isRadio$$ ? $checked$$2$$ = this.value : $checked$$2$$.push(this.value));
      });
      return $checked$$2$$;
    ...
    }, _setOption:function($key$$140$$, $value$$258$$, $flags$$35$$) {
      this._superApply(arguments);
      "disabled" === $key$$140$$ ? this.$_propagateDisabled$($value$$258$$) : "checked" === $key$$140$$ ? (this.$_setCheckedOnDom$($value$$258$$, this.$$buttons$), this.$$buttons$.each(function() {
        $$$$25$$(this).data("oj-ojButton").$_applyCheckedStateFromDom$(!1);
      })) : "focusManagement" === $key$$140$$ ? this.$_setRole$($value$$258$$) : "chroming" === $key$$140$$ && ($_setChromingClass$$(this.element, $value$$258$$), this.$$buttons$.ojButton("refresh"));
    }, refresh:function() {
      this._super();
      this.$_setup$(!1);
      ...
      return $$button$$.map(function($index$$194$$, $elem$$67$$) {
        if ("radio" != $elem$$67$$.type || $elem$$67$$.checked || "" == $elem$$67$$.name) {
          return $elem$$67$$;
        }
        var $$checkedRadio$$ = $_radioGroup$$($elem$$67$$, $$enabledButtons$$).filter(":checked");
        return $$checkedRadio$$.length ? $$checkedRadio$$[0] : $elem$$67$$;
      });
    ...
    $oj$$26$$.Components.$setDefaultOptions$({ojButton:{chroming:$oj$$26$$.Components.$createDynamicPropertyGetter$(function($context$$108$$) {
      return $_getChromingDefault$$("button", $context$$108$$.element, $context$$108$$.containers);
    })}, ojButtonset:{chroming:$oj$$26$$.Components.$createDynamicPropertyGetter$(function($context$$109$$) {
      return $_getChromingDefault$$("buttonset", $context$$109$$.element, $context$$109$$.containers);
    })}});
  })();
});
