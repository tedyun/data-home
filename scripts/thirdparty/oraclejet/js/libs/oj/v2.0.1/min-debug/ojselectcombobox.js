...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue"], function($oj$$12$$, $$$$12$$) {
  var $_ComboUtils$$ = {$GENERATED_OPTIONS_SELECTOR$:"oj-select-options-generated", $KEY$:{TAB:9, ENTER:13, $ESC$:27, SPACE:32, LEFT:37, UP:38, RIGHT:39, DOWN:40, $SHIFT$:16, $CTRL$:17, $ALT$:18, PAGE_UP:33, PAGE_DOWN:34, HOME:36, END:35, $BACKSPACE$:8, $DELETE$:46, $isControl$:function($e$$51$$) {
    ...
    return $val$$27$$;
  }, $getSideBorderPadding$:function($element$$73$$) {
    return $element$$73$$.outerWidth(!1) - $element$$73$$.width();
  }, $installKeyUpChangeEvent$:function($element$$74$$) {
    $element$$74$$.on("keydown", function() {
      void 0 === $$$$12$$.data($element$$74$$, "keyup-change-value") && $$$$12$$.data($element$$74$$, "keyup-change-value", $element$$74$$.val());
    });
    $element$$74$$.on("keyup", function($e$$52_val$$28$$) {
      $e$$52_val$$28$$.which === $_ComboUtils$$.$KEY$.ENTER ? $e$$52_val$$28$$.stopPropagation() : ($e$$52_val$$28$$ = $$$$12$$.data($element$$74$$, "keyup-change-value"), void 0 !== $e$$52_val$$28$$ && $element$$74$$.val() !== $e$$52_val$$28$$ && ($$$$12$$.removeData($element$$74$$, "keyup-change-value"), $element$$74$$.trigger("keyup-change")));
    });
  }, $installFilteredMouseMove$:function($element$$75$$) {
    $element$$75$$.on("mousemove", function($e$$53$$) {
    ...
    var $evaluated$$ = !1, $value$$186$$;
    return function() {
      !1 === $evaluated$$ && ($value$$186$$ = $formula$$(), $evaluated$$ = !0);
      return $value$$186$$;
    };
  }, $_focus$:function($$el$$) {
  ...
  }, $createOptionTag$:function($depth$$4$$, $value$$187$$, $label$$4$$, $formatFunc$$) {
    ...
    function $populate$$1$$($container$$6$$, $arrlist$$1$$, $depth$$6$$, $optionsKeys$$2$$) {
      for (var $item$$8$$, $label$$7_node$$35$$, $children$$1_value$$188$$, $i$$143$$ = 0, $l$$5$$ = $arrlist$$1$$.length;$i$$143$$ < $l$$5$$;$i$$143$$++) {
        $item$$8$$ = $arrlist$$1$$[$i$$143$$], $children$$1_value$$188$$ = $_ComboUtils$$.$lookupOptionKeys$($item$$8$$, $optionsKeys$$2$$, "children"), $label$$7_node$$35$$ = $_ComboUtils$$.$lookupOptionKeys$($item$$8$$, $optionsKeys$$2$$, "label"), $children$$1_value$$188$$ && 0 < $children$$1_value$$188$$.length ? ($label$$7_node$$35$$ = $_ComboUtils$$.$createOptgroupTag$($container$$6$$, $label$$7_node$$35$$, $formatFunc$$3$$), $populate$$1$$($label$$7_node$$35$$, $children$$1_value$$188$$, $depth$$6$$ + 
        1, $optionsKeys$$2$$.childKeys || {})) : ($children$$1_value$$188$$ = $_ComboUtils$$.$lookupOptionKeys$($item$$8$$, $optionsKeys$$2$$, "value"), $label$$7_node$$35$$ = $_ComboUtils$$.$createOptionTag$($depth$$6$$, $children$$1_value$$188$$, $label$$7_node$$35$$, $formatFunc$$3$$)), $label$$7_node$$35$$.appendTo($container$$6$$);
      }
    }
    ...
    return function($query$$7$$) {
      var $context$$55$$ = {component:this.$ojContext$};
      $query$$7$$.value ? $context$$55$$.value = $query$$7$$.value : $context$$55$$.term = $query$$7$$.$term$ || "";
      $options$$224$$($context$$55$$).then(function($data$$78$$) {
  ...
  }, $LAST_QUERY_RESULT$:"last-query-result", $getLastQueryResult$:function($context$$56$$) {
    return $$$$12$$.data($context$$56$$.$container$, $context$$56$$.$_classNm$ + "-" + $_ComboUtils$$.$LAST_QUERY_RESULT$);
  }, $saveLastQueryResult$:function($context$$57$$, $queryResult$$2$$) {
    $$$$12$$.data($context$$57$$.$container$, $context$$57$$.$_classNm$ + "-" + $_ComboUtils$$.$LAST_QUERY_RESULT$, $queryResult$$2$$);
    ...
    var $closeDelayTimer_element$$76$$ = this.$_closeDelayTimer$;
    isNaN($closeDelayTimer_element$$76$$) || (delete this.$_closeDelayTimer$, window.clearTimeout($closeDelayTimer_element$$76$$));
    var $closeDelayTimer_element$$76$$ = this.$opts$.element, $ojcomp$$ = $closeDelayTimer_element$$76$$.data(this.$_elemNm$);
    this.close();
    ...
    void 0 !== $ojcomp$$ && ($ojcomp$$.$container$.remove(), $ojcomp$$.$dropdown$.remove(), $closeDelayTimer_element$$76$$.removeAttr("aria-hidden").removeData(this.$_elemNm$).off("." + this.$_classNm$).prop("autofocus", this.autofocus || !1), this.$elementTabIndex$ ? $closeDelayTimer_element$$76$$.attr({$tabindex$:this.$elementTabIndex$}) : $closeDelayTimer_element$$76$$.removeAttr("tabindex"), $closeDelayTimer_element$$76$$.show());
  ...
  }, $_optionToData$:function($element$$77$$) {
    if ($element$$77$$.is("option")) {
      return{value:$element$$77$$.prop("value"), label:$element$$77$$.text(), element:$element$$77$$.get(), css:$element$$77$$.attr("class"), disabled:$element$$77$$.prop("disabled"), locked:"locked" === $element$$77$$.attr("locked") || !0 === $element$$77$$.data("locked")};
    }
    if ($element$$77$$.is("optgroup")) {
      return{label:$element$$77$$.attr("label"), children:[], element:$element$$77$$.get(), css:$element$$77$$.attr("class")};
    }
    if ($element$$77$$.is("li")) {
      var $elemChildren_itemLabel$$, $groupData$$ = null;
      ($elemChildren_itemLabel$$ = $element$$77$$.children()) && 0 < $elemChildren_itemLabel$$.length && $elemChildren_itemLabel$$.is("ul") ? ($elemChildren_itemLabel$$ = $element$$77$$.attr("oj-data-label") ? $element$$77$$.attr("oj-data-label") : $element$$77$$.clone().children().remove().end().text().trim(), $groupData$$ = []) : $elemChildren_itemLabel$$ = $element$$77$$.attr("oj-data-label") ? $element$$77$$.attr("oj-data-label") : $element$$77$$.text().trim();
      return{value:$element$$77$$.attr("oj-data-value"), label:$elemChildren_itemLabel$$, element:$element$$77$$.get(), css:$element$$77$$.attr("class"), children:$groupData$$};
    }
  }, $_prepareOpts$:function($opts$$12$$) {
    var $element$$78$$, $datalist$$, $self$$75$$ = this;
    $opts$$12$$.options && Array.isArray($opts$$12$$.options) && $opts$$12$$.optionsKeys && ($opts$$12$$.options = $$$$12$$.extend(!0, [], $opts$$12$$.options));
    $element$$78$$ = $opts$$12$$.element;
    var $tagName$$2$$ = $element$$78$$.get(0).tagName.toLowerCase();
    "input" === $tagName$$2$$ && $element$$78$$.attr("list") ? this.$datalist$ = $datalist$$ = $$$$12$$("#" + $element$$78$$.attr("list")) : "select" === $tagName$$2$$ && 0 < $element$$78$$.children().length ? this.$datalist$ = $datalist$$ = $element$$78$$ : $opts$$12$$.list && (this.$datalist$ = $datalist$$ = $$$$12$$("#" + $opts$$12$$.list));
    $opts$$12$$ = $$$$12$$.extend({}, {$populateResults$:function($container$$8$$, $results$$1$$, $query$$9$$, $showPlaceholder$$) {
      ...
      $populate$$2$$ = function $$populate$$2$$$($resultsParent$$, $results$$2$$, $container$$9$$, $depth$$7$$, $l$$6_showPlaceholder$$1$$) {
        function $createLabelContent$$($labelNode$$, $result$$32$$) {
          if ($optionRenderer$$1$$) {
            var $content$$15_context$$58_highlighterSection$$1$$ = {index:$i$$147$$, depth:$depth$$7$$, leaf:!$result$$32$$.children, parent:$resultsParent$$, data:$result$$32$$, component:$opts$$12$$.$ojContext$, parentElement:$labelNode$$.get(0)}, $content$$15_context$$58_highlighterSection$$1$$ = $optionRenderer$$1$$.call($opts$$12$$.$ojContext$, $content$$15_context$$58_highlighterSection$$1$$);
            null !== $content$$15_context$$58_highlighterSection$$1$$ && (null === $content$$15_context$$58_highlighterSection$$1$$.parentNode || $content$$15_context$$58_highlighterSection$$1$$.parentNode instanceof DocumentFragment) && $labelNode$$.appendChild($content$$15_context$$58_highlighterSection$$1$$);
          } else {
            $formatted$$ = $opts$$12$$.$formatResult$($result$$32$$), void 0 !== $formatted$$ && $labelNode$$.text($formatted$$);
          }
          !0 !== $query$$9$$.$initial$ && ($content$$15_context$$58_highlighterSection$$1$$ = $labelNode$$.find(".oj-listbox-highlighter-section"), $content$$15_context$$58_highlighterSection$$1$$.length || ($content$$15_context$$58_highlighterSection$$1$$ = $labelNode$$), $termHighlight$$($content$$15_context$$58_highlighterSection$$1$$, $query$$9$$.$term$));
        }
    ...
    $datalist$$ ? $opts$$12$$.$query$ = this.$_bind$(function($query$$10$$) {
      ...
      $process$$ = function $$process$$$($element$$79$$, $collection$$30$$) {
        var $group$$1$$, $nestedLi$$ = $element$$79$$.children() && 0 < $element$$79$$.children().length && $element$$79$$.children().is("ul");
        if ($element$$79$$.is("option") || $element$$79$$.is("li") && !$nestedLi$$) {
          $query$$10$$.$matcher$($term$$1$$, $element$$79$$.text(), $element$$79$$) && $collection$$30$$.push($self$$75$$.$_optionToData$($element$$79$$));
        } else {
          if ($element$$79$$.is("optgroup") || $element$$79$$.is("li") && $nestedLi$$) {
            $group$$1$$ = $self$$75$$.$_optionToData$($element$$79$$), $_ComboUtils$$.$each2$($element$$79$$.is("optgroup") ? $element$$79$$.children() : $element$$79$$.children("ul").children(), function($i$$149$$, $elm$$1$$) {
  ...
  }, $setVal$:function($val$$29$$, $event$$116$$, $context$$59$$) {
    var $options$$226$$ = {$doValueChangeCheck$:!1};
    $context$$59$$ && ($options$$226$$._context = $context$$59$$);
  ...
  }, $_findItem$:function($list$$5$$, $value$$189$$) {
    for (var $i$$153$$ = 0;$i$$153$$ < $list$$5$$.length;$i$$153$$++) {
      if ($$$$12$$($list$$5$$[$i$$153$$]).data(this.$_elemNm$).value === $value$$189$$) {
        return $list$$5$$[$i$$153$$];
      }
    }
    return null;
    ...
    if ("input" === $tagName$$3$$ && $opts$$14$$.element.attr("list") || "select" === $tagName$$3$$ && 0 < $opts$$14$$.element.children().length || $opts$$14$$.list) {
      ...
      $opts$$14$$.$initSelection$ = function $$opts$$14$$$$initSelection$$($element$$81$$, $callback$$85$$) {
        var $selected$$1$$, $value$$190$$ = $self$$79$$.$getVal$();
        Array.isArray($value$$190$$) && ($value$$190$$ = $value$$190$$[0]);
        $selected$$1$$ = void 0 !== $value$$190$$ && null !== $value$$190$$ ? $self$$79$$.$_optionToData$($element$$81$$.find($eleName$$).filter(function() {
          if ("li" == $eleName$$) {
            return this.getAttribute("oj-data-value") === $value$$190$$;
          }
          if ("option" == $eleName$$) {
            return this.value === $value$$190$$;
          }
        })) : $self$$79$$.$_optionToData$($element$$81$$.find($eleName$$).filter(function() {
          if ("li" == $eleName$$) {
      ...
      $opts$$14$$.validate = function $$opts$$14$$$validate$($element$$82$$, $value$$191$$) {
        var $selected$$2$$;
        void 0 !== $value$$191$$ && null !== $value$$191$$ && ($selected$$2$$ = $self$$79$$.$_optionToData$($element$$82$$.find($eleName$$).filter(function() {
          if ("li" == $eleName$$) {
            return this.getAttribute("oj-data-value") === $value$$191$$;
          }
          if ("option" == $eleName$$) {
            return this.value === $value$$191$$;
          }
        })));
        return!!$selected$$2$$;
      };
      ...
      if ("options" in $opts$$14$$ || this.$getVal$() && 0 < this.$getVal$().length) {
        $$$$12$$.isFunction($opts$$14$$.options) ? $opts$$14$$.$initSelection$ = function $$opts$$14$$$$initSelection$$($element$$83$$, $callback$$86$$) {
        ...
        } : ($opts$$14$$.$initSelection$ = function $$opts$$14$$$$initSelection$$($element$$84$$, $callback$$87$$) {
          var $id$$18$$ = "";
        ...
        }, $opts$$14$$.validate = function $$opts$$14$$$validate$($element$$85$$, $value$$192$$) {
          var $match$$19$$ = null;
          $opts$$14$$.$query$({$matcher$:function($is_match$$1_term$$6$$, $text$$13$$, $el$$7$$) {
            ($is_match$$1_term$$6$$ = $value$$192$$ === $opts$$14$$.id($el$$7$$)) && ($match$$19$$ = $el$$7$$);
    ...
    if (this.$_triggerSelect$($data$$88$$)) {
      var $context$$60$$;
      $options$$228$$ && $options$$228$$.trigger && ($context$$60$$ = {$optionMetadata$:{trigger:$options$$228$$.trigger}});
      this.close($event$$118$$);
      this.$setVal$(0 === this.id($data$$88$$).length ? [] : this.id($data$$88$$), $event$$118$$, $context$$60$$);
  ...
  }, $_updateSelectedOption$:function($data$$90_selected$$4_value$$193$$) {
    if (void 0 === $data$$90_selected$$4_value$$193$$ || null === $data$$90_selected$$4_value$$193$$) {
      $data$$90_selected$$4_value$$193$$ = ($data$$90_selected$$4_value$$193$$ = this.$getVal$()) ? Array.isArray($data$$90_selected$$4_value$$193$$) ? Array.isArray($data$$90_selected$$4_value$$193$$) && $data$$90_selected$$4_value$$193$$.length ? {label:$data$$90_selected$$4_value$$193$$[0]} : null : {label:$data$$90_selected$$4_value$$193$$} : null;
    }
    this.$_updateSelection$($data$$90_selected$$4_value$$193$$);
    ...
    if (void 0 !== $selected$$5$$ && null !== $selected$$5$$) {
      var $selectedVal$$, $value$$194$$ = this.$getVal$(), $value$$194$$ = Array.isArray($value$$194$$) ? $value$$194$$[0] : $value$$194$$;
      $selectedVal$$ = this.$opts$.id($selected$$5$$);
      $value$$194$$ !== $selectedVal$$ && (void 0 === $value$$194$$ || null === $value$$194$$ ? this.$ojContext$.options.value = Array.isArray($selectedVal$$) ? $selectedVal$$ : [$selectedVal$$] : this.$setVal$(Array.isArray($selectedVal$$) ? $selectedVal$$ : [$selectedVal$$]));
  ...
  }, $setVal$:function($val$$31$$, $event$$123$$, $context$$61$$) {
    $_OjSingleSelect$$.$superclass$.$setVal$.call(this, $val$$31$$, $event$$123$$, $context$$61$$);
    ...
    if ("input" === $tagName$$4$$ && $opts$$15$$.element.attr("list") || "select" === $tagName$$4$$ && 0 < $opts$$15$$.element.children().length || $opts$$15$$.list) {
      ...
      $opts$$15$$.$initSelection$ = function $$opts$$15$$$$initSelection$$($element$$86$$, $callback$$88$$) {
        var $data$$92$$ = [];
        if ($self$$83$$.$getVal$()) {
          for (var $selected$$6$$, $ids$$ = $self$$83$$.$getVal$(), $i$$156$$ = 0;$i$$156$$ < $ids$$.length;$i$$156$$++) {
            var $id$$20$$ = $ids$$[$i$$156$$];
            ($selected$$6$$ = $element$$86$$.find($eleName$$1$$).filter(function() {
              if ("option" === $eleName$$1$$) {
          ...
          "select" !== $tagName$$4$$ && ($selected$$6$$ = $element$$86$$.find($eleName$$1$$).filter(function() {
            if ("option" === $eleName$$1$$) {
              return this.selected;
            }
            if ("li" === $eleName$$1$$) {
      ...
      "options" in $opts$$15$$ && ($opts$$15$$.$initSelection$ = $$$$12$$.isFunction($opts$$15$$.options) ? function($element$$87$$, $callback$$89$$) {
      ...
      } : $opts$$15$$.$initSelection$ || function($element$$88$$, $callback$$90$$) {
    ...
    if (this.$_triggerSelect$($data$$97$$)) {
      var $context$$62$$;
      $options$$230$$ && $options$$230$$.trigger && ($context$$62$$ = {$optionMetadata$:{trigger:$options$$230$$.trigger}});
      ...
      this.$setVal$($val$$32$$, $event$$127$$, $context$$62$$);
  ...
  }, $setVal$:function($options$$231_val$$35$$, $event$$130$$, $context$$63$$) {
    var $unique$$;
    $unique$$ = [];
    ...
    $context$$63$$ && ($options$$231_val$$35$$._context = $context$$63$$);
  ...
  $oj$$12$$.$__registerWidget$("oj.ojCombobox", $$$$12$$.oj.editableValue, {defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{converter:void 0, placeholder:"", list:void 0, multiple:!1, options:null, optionsKeys:null, optionRenderer:null, minLength:0, beforeExpand:null}, widget:function() {
    ...
    if (void 0 === this.options.value) {
      ...
      var $value$$195$$ = this.options.value;
      Array.isArray($value$$195$$) ? $value$$195$$ = $value$$195$$.slice(0) : "string" === typeof $value$$195$$ && ($value$$195$$ = !0 === this.options.multiple ? $_ComboUtils$$.$splitVal$($value$$195$$, ",") : [$value$$195$$]);
      this.options.value = $value$$195$$;
    }
  }, $_setup$:function() {
  ...
  }, _setOption:function($key$$61$$, $value$$196$$, $flags$$17$$) {
    "value" === $key$$61$$ && (Array.isArray($value$$196$$) ? $value$$196$$ = $value$$196$$.slice(0) : "string" === typeof $value$$196$$ && ($value$$196$$ = !0 === this.options.multiple ? $_ComboUtils$$.$splitVal$($value$$196$$, ",") : [$value$$196$$]), this.$combobox$.$valueChangeTrigger$ = $flags$$17$$ && $flags$$17$$._context && $flags$$17$$._context.$optionMetadata$ ? $flags$$17$$._context.$optionMetadata$.trigger : null);
    this._super($key$$61$$, $value$$196$$, $flags$$17$$);
    "options" === $key$$61$$ && (this.$combobox$.$opts$.options = $value$$196$$, this.$combobox$.$opts$ = this.$combobox$.$_prepareOpts$(this.$combobox$.$opts$));
    "disabled" === $key$$61$$ && ($value$$196$$ ? this.$combobox$.$_disable$() : this.$combobox$.$_enable$());
  ...
  }, $_SetPlaceholder$:function($value$$197$$) {
    this.$combobox$ && (this.$combobox$.$opts$.placeholder = $value$$197$$, this.$combobox$.$_setPlaceholder$ && this.$combobox$.$_setPlaceholder$());
  }, validate:function() {
    ...
    return null;
  }, $_findItem$:function($list$$6$$, $value$$198$$) {
    for (var $i$$166$$ = 0;$i$$166$$ < $list$$6$$.length;$i$$166$$++) {
      if ($$$$12$$($list$$6$$[$i$$166$$]).data("ojcombobox").value === $value$$198$$) {
        return $list$$6$$[$i$$166$$];
      }
    }
    return null;
  ...
  $oj$$12$$.$__registerWidget$("oj.ojInputSearch", $$$$12$$.oj.editableValue, {defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{placeholder:void 0, options:null, optionsKeys:null, optionRenderer:null, minLength:0, beforeExpand:null, optionChange:null}, widget:function() {
    ...
    if (void 0 === this.options.value) {
      ...
      var $value$$199$$ = this.options.value;
      Array.isArray($value$$199$$) ? $value$$199$$ = $value$$199$$.slice(0) : "string" === typeof $value$$199$$ && ($value$$199$$ = [$value$$199$$]);
      this.options.value = $value$$199$$;
    }
  }, $_setup$:function() {
    var $opts$$17$$ = {};
    ...
    this.$_SetRootAttributes$();
    this.$_Refresh$("required", this.options.required);
  }, _setOption:function($key$$62$$, $value$$200$$, $flags$$18$$) {
    "value" === $key$$62$$ && (Array.isArray($value$$200$$) ? $value$$200$$ = $value$$200$$.slice(0) : "string" === typeof $value$$200$$ && ($value$$200$$ = [$value$$200$$]), this.$inputSearch$.$valueChangeTrigger$ = $flags$$18$$ && $flags$$18$$._context && $flags$$18$$._context.$optionMetadata$ ? $flags$$18$$._context.$optionMetadata$.trigger : null);
    this._super($key$$62$$, $value$$200$$, $flags$$18$$);
    "options" === $key$$62$$ && (this.$inputSearch$.$opts$.options = $value$$200$$, this.$inputSearch$.$opts$ = this.$inputSearch$.$_prepareOpts$(this.$inputSearch$.$opts$));
    "disabled" === $key$$62$$ && ($value$$200$$ ? this.$inputSearch$.$_disable$() : this.$inputSearch$.$_enable$());
  }, $_NotifyDetached$:function() {
    ...
    this.$inputSearch$ && (this.$inputSearch$.$opts$.placeholder = $value$$201$$, this.$inputSearch$.$_setPlaceholder$ && this.$inputSearch$.$_setPlaceholder$());
  }, validate:function() {
    ...
    var $list$$8_node$$41$$ = null, $dropdown$$7_subId$$10$$;
    if (null === $locator$$13$$) {
      return this.$inputSearch$.$container$ ? this.$inputSearch$.$container$[0] : null;
    }
    $list$$8_node$$41$$ = this._super($locator$$13$$);
    if (!$list$$8_node$$41$$) {
      switch($dropdown$$7_subId$$10$$ = $locator$$13$$.subId, "oj-inputsearch-search" === $dropdown$$7_subId$$10$$ && ($dropdown$$7_subId$$10$$ = "oj-inputsearch-search-button"), $dropdown$$7_subId$$10$$) {
        ...
        case "oj-inputsearch-search-button":
          $list$$8_node$$41$$ = this.widget().find("." + $dropdown$$7_subId$$10$$)[0];
          break;
        case "oj-listitem":
          if ($dropdown$$7_subId$$10$$ = this.$_getDropdown$()) {
            $list$$8_node$$41$$ = $dropdown$$7_subId$$10$$.find(".oj-listbox-result"), $list$$8_node$$41$$ = this.$inputSearch$.$_findItem$($list$$8_node$$41$$, $locator$$13$$.value);
          }
        ;
      }
    }
    return $list$$8_node$$41$$ || null;
  }, getSubIdByNode:function($node$$42_nodeCached$$1$$) {
    var $subId$$11$$ = null;
    null != $node$$42_nodeCached$$1$$ && ($node$$42_nodeCached$$1$$ = $$$$12$$($node$$42_nodeCached$$1$$), $node$$42_nodeCached$$1$$.hasClass("oj-inputsearch-input") ? $subId$$11$$ = {subId:"oj-inputsearch-input"} : $node$$42_nodeCached$$1$$.hasClass("oj-inputsearch-search-button") ? $subId$$11$$ = {subId:"oj-inputsearch-search"} : $node$$42_nodeCached$$1$$.hasClass("oj-listbox-result") && ($subId$$11$$ = {subId:"oj-listitem", value:$node$$42_nodeCached$$1$$.data("ojinputsearch").value}));
    return $subId$$11$$;
  }});
  $oj$$12$$.$__registerWidget$("oj.ojSelect", $$$$12$$.oj.editableValue, {defaultElement:"\x3cselect\x3e", widgetEventPrefix:"oj", options:{minimumResultsForSearch:10, placeholder:null, list:void 0, multiple:!1, options:null, optionsKeys:null, beforeExpand:null, renderMode:"jet"}, widget:function() {
  ...
  }, $_nativeChangeHandler$:function($event$$133$$) {
    var $arr$$21$$ = [], $emptyValueAllowed$$ = !this.$_IsRequired$() && this.$_HasPlaceholderSet$();
    $$$$12$$($event$$133$$.target).find("option").each(function() {
      this.selected && (this.value || $emptyValueAllowed$$ && "" === this.value) && $arr$$21$$.push(this.value);
    });
    this.$_SetValue$($arr$$21$$, $event$$133$$, {$doValueChangeCheck$:!1});
  }, $_nativeSetup$:function() {
    var $element$$90$$ = this.element;
    $element$$90$$.wrap("\x3cdiv\x3e").parent().addClass("oj-select-native oj-component oj-select oj-form-control");
    $element$$90$$.addClass("oj-select-select oj-component-initnode");
    this.options.multiple ? ($element$$90$$.attr("multiple", ""), $element$$90$$.parent().prepend("\x3ca class\x3d'oj-select-arrow oj-component-icon oj-clickable-icon-nocontext oj-select-multiple-open-icon' role\x3d'presentation'\x3e\x3c/a\x3e")) : $element$$90$$.parent().prepend("\x3ca class\x3d'oj-select-arrow oj-component-icon oj-clickable-icon-nocontext oj-select-open-icon' role\x3d'presentation'\x3e\x3c/a\x3e");
    this.$_nativeSetDisabled$(this.options.disabled);
    this.options.list ? ($_ComboUtils$$.$listPopulateResults$($element$$90$$, $$$$12$$("#" + this.options.list).children(), this.$_formatValue$.bind(this)), $element$$90$$.addClass($_ComboUtils$$.$GENERATED_OPTIONS_SELECTOR$)) : this.options.options && ($_ComboUtils$$.$arrayPopulateResults$($element$$90$$, this.options.options, this.$_formatValue$.bind(this), this.options.optionsKeys), $element$$90$$.addClass($_ComboUtils$$.$GENERATED_OPTIONS_SELECTOR$));
    $element$$90$$.change(this.$_nativeChangeHandler$.bind(this));
  }, $_jetSetup$:function() {
    ...
    var $oSelected$$ = this.options.value, $element$$91$$ = this.element;
    if ($element$$91$$.hasClass($_ComboUtils$$.$GENERATED_OPTIONS_SELECTOR$)) {
      $_ComboUtils$$.$cleanupResults$($element$$91$$);
    } else {
      var $children$$5$$ = $element$$91$$.children();
      0 < $children$$5$$.length && $children$$5$$.remove();
    }
    $_ComboUtils$$.$arrayPopulateResults$($element$$91$$, $defVal_value$$204$$, this.$_formatValue$.bind(this), this.options.optionsKeys);
    $element$$91$$.addClass($_ComboUtils$$.$GENERATED_OPTIONS_SELECTOR$);
    ...
    return $narr$$;
  }, _setOption:function($key$$63$$, $value$$205$$, $flags$$19$$) {
    if ("value" === $key$$63$$) {
      if (this.$_HasPlaceholderSet$() && $value$$205$$ && 0 == $value$$205$$.length) {
        this._super($key$$63$$, $value$$205$$, $flags$$19$$);
      } else {
        var $element$$92_selected$$10$$;
        this.select && ($element$$92_selected$$10$$ = this.select.$datalist$, $element$$92_selected$$10$$ || ($element$$92_selected$$10$$ = this.select.$opts$.element));
        ...
        for (var $newArr$$ = [], $i$$170$$ = 0;$i$$170$$ < $value$$205$$.length;$i$$170$$++) {
          this.select ? (this.options.multiple || this.select.$opts$.validate($element$$92_selected$$10$$, $value$$205$$[$i$$170$$])) && $newArr$$.push($value$$205$$[$i$$170$$]) : 0 < this.element.find("option[value\x3d'" + $value$$205$$[$i$$170$$] + "']").length && $newArr$$.push($value$$205$$[$i$$170$$]);
        }
        (0 < $newArr$$.length || this.options.multiple) && this._super($key$$63$$, $newArr$$, $flags$$19$$);
      }
    } else {
      "placeholder" === $key$$63$$ ? this.select ? (this.select.$opts$.placeholder = $value$$205$$, this.select.$_setPlaceholder$()) : ($element$$92_selected$$10$$ = this.options.value, $element$$92_selected$$10$$ && 0 !== $element$$92_selected$$10$$.length && $element$$92_selected$$10$$[0] || (this.element[0].selectedIndex = 0)) : "minimumResultsForSearch" === $key$$63$$ ? this.select && (this.select.$opts$.minimumResultsForSearch = $value$$205$$) : "renderMode" === $key$$63$$ && (this.$_cleanup$(), 
      this.options.renderMode = $value$$205$$, this.refresh()), this._super($key$$63$$, $value$$205$$, $flags$$19$$), "disabled" === $key$$63$$ ? this.select ? $value$$205$$ ? this.select.$_disable$() : this.select.$_enable$() : this.$_nativeSetDisabled$($value$$205$$) : "options" === $key$$63$$ && (this.select ? (this.select.$opts$.options = $value$$205$$, this.select.$opts$ = this.select.$_prepareOpts$(this.select.$opts$), this._super("value", this.select.$getVal$())) : this.$_nativeSetOptions$($value$$205$$))
      ;
    }
  }, $_getDropdown$:function() {
    ...
    var $list$$9_node$$43_selectedItems$$1$$ = null, $subId$$12$$;
    ...
    $list$$9_node$$43_selectedItems$$1$$ = this._super($container$$18_index$$109_item$$13_locator$$14$$);
    if (!$list$$9_node$$43_selectedItems$$1$$) {
      var $ddlist_dropdown$$9$$ = this.$_getDropdown$();
      $subId$$12$$ = $container$$18_index$$109_item$$13_locator$$14$$.subId;
      switch($subId$$12$$) {
        case "oj-select-drop":
          $ddlist_dropdown$$9$$ && ($list$$9_node$$43_selectedItems$$1$$ = $ddlist_dropdown$$9$$[0]);
          break;
        case "oj-select-results":
          $ddlist_dropdown$$9$$ && ($list$$9_node$$43_selectedItems$$1$$ = $ddlist_dropdown$$9$$.find(".oj-listbox-results")[0]);
          break;
        case "oj-select-search":
          $ddlist_dropdown$$9$$ && ($list$$9_node$$43_selectedItems$$1$$ = $ddlist_dropdown$$9$$.find(".oj-listbox-search")[0]);
          break;
        case "oj-select-input":
        ;
        case "oj-listbox-input":
          !0 === this.options.multiple ? $list$$9_node$$43_selectedItems$$1$$ = this.widget().find(".oj-listbox-input")[0] : $ddlist_dropdown$$9$$ && ($list$$9_node$$43_selectedItems$$1$$ = $ddlist_dropdown$$9$$.find(".oj-listbox-input")[0]);
          break;
        ...
        case "oj-select-arrow":
          $list$$9_node$$43_selectedItems$$1$$ = this.widget().find("." + $subId$$12$$)[0];
          break;
        case "oj-listitem":
          $ddlist_dropdown$$9$$ && ($list$$9_node$$43_selectedItems$$1$$ = $ddlist_dropdown$$9$$.find(".oj-listbox-result"), $list$$9_node$$43_selectedItems$$1$$ = this.select.$_findItem$($list$$9_node$$43_selectedItems$$1$$, $container$$18_index$$109_item$$13_locator$$14$$.value));
          break;
        case "oj-select-remove":
          $list$$9_node$$43_selectedItems$$1$$ = this.widget().find(".oj-select-selected-choice");
          $list$$9_node$$43_selectedItems$$1$$ = ($container$$18_index$$109_item$$13_locator$$14$$ = this.select.$_findItem$($list$$9_node$$43_selectedItems$$1$$, $container$$18_index$$109_item$$13_locator$$14$$.value)) ? $$$$12$$($container$$18_index$$109_item$$13_locator$$14$$).find(".oj-select-clear-entry-icon")[0] : null;
          break;
        case "oj-listbox-result-label":
          $ddlist_dropdown$$9$$ && ($ddlist_dropdown$$9$$ = $$$$12$$("#" + this.select.$results$.attr("id")).children(), $container$$18_index$$109_item$$13_locator$$14$$ = $container$$18_index$$109_item$$13_locator$$14$$.index, $ddlist_dropdown$$9$$.length && $container$$18_index$$109_item$$13_locator$$14$$ < $ddlist_dropdown$$9$$.length && ($list$$9_node$$43_selectedItems$$1$$ = $ddlist_dropdown$$9$$.eq($container$$18_index$$109_item$$13_locator$$14$$).find("." + $subId$$12$$)[0]));
      }
    }
    return $list$$9_node$$43_selectedItems$$1$$ || null;
  }, getSubIdByNode:function($node$$44_nodeCached$$2$$) {
    if (this.$_isNative$()) {
      return this._super($node$$44_nodeCached$$2$$);
    }
    var $subId$$13$$ = null;
    null != $node$$44_nodeCached$$2$$ && ($node$$44_nodeCached$$2$$ = $$$$12$$($node$$44_nodeCached$$2$$), $node$$44_nodeCached$$2$$.hasClass("oj-listbox-input") ? $subId$$13$$ = {subId:"oj-select-input"} : $node$$44_nodeCached$$2$$.hasClass("oj-select-arrow") ? $subId$$13$$ = {subId:"oj-select-arrow"} : $node$$44_nodeCached$$2$$.hasClass("oj-listbox-result") ? $subId$$13$$ = {subId:"oj-listitem", value:$node$$44_nodeCached$$2$$.data("ojselect").value} : $node$$44_nodeCached$$2$$.hasClass("oj-select-clear-entry-icon") && 
    ($subId$$13$$ = {subId:"oj-select-remove", value:$node$$44_nodeCached$$2$$.closest(".oj-select-selected-choice").data("ojselect").value}));
    return $subId$$13$$;
  }, _GetDefaultStyleClass:function() {
    return "oj-select";
  }, _GetMessagingLauncherElement:function() {
