 ...
 */
"use strict";
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtPictoChart"], function($oj$$60$$, $$$$54$$, $comp$$14$$, $base$$10$$, $dvt$$7$$) {
  $oj$$60$$.$__registerWidget$("oj.ojPictoChart", $$$$54$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{optionChange:null, drill:null}, $_CreateDvtComponent$:function($context$$143$$, $callback$$118$$, $callbackObj$$10$$) {
    return $dvt$$7$$.PictoChart.newInstance($context$$143$$, $callback$$118$$, $callbackObj$$10$$);
  ...
  }, getContextByNode:function($context$$144_node$$118$$) {
    return($context$$144_node$$118$$ = this.getSubIdByNode($context$$144_node$$118$$)) && "oj-pictochart-tooltip" !== $context$$144_node$$118$$.subId ? $context$$144_node$$118$$ : null;
