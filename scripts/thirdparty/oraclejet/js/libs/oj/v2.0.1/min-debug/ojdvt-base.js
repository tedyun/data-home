...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojvalidation", "ojs/internal-deps/dvt/DvtToolkit", "promise"], function($oj$$15$$, $$$$15$$, $comp$$5$$, $val$$39$$, $dvt$$1$$) {
  ...
  $oj$$15$$.$AttributeGroupHandler$.prototype.Init = function $$oj$$15$$$$AttributeGroupHandler$$$Init$($idx$$12_matchRules$$1$$) {
    ...
    for (var $key$$70$$ in this.$_matchRules$) {
      $idx$$12_matchRules$$1$$ = this.$Values$.indexOf(this.$_matchRules$[$key$$70$$]), -1 !== $idx$$12_matchRules$$1$$ && this.$Values$.splice($idx$$12_matchRules$$1$$, 1);
    }
  };
  ...
  $DvtJsonPath$$.prototype.$setValue$ = function $$DvtJsonPath$$$$$setValue$$($value$$218$$, $bOverride$$) {
    this.$_resolvePath$(!0);
    if ($bOverride$$ || !this.$_leaf$[this.$_param$]) {
      this.$_leaf$[this.$_param$] = $value$$218$$;
    }
  };
  var $DvtStyleProcessor$$ = {CSS_TEXT_PROPERTIES:function($cssDiv$$) {
    ...
    var $cssObj$$1$$ = {}, $value$$219$$ = $cssDiv$$6$$.css("font-family");
    $value$$219$$ && $value$$219$$ !== $DvtStyleProcessor$$.$_INHERITED_FONT_FAMILY$ && ($cssObj$$1$$["font-family"] = $value$$219$$.replace(/"/g, "'"));
    $value$$219$$ = $cssDiv$$6$$.css("font-size");
    !$value$$219$$ || -1 < $value$$219$$.indexOf("px") && parseFloat($value$$219$$) < $DvtStyleProcessor$$.$_FONT_SIZE_BUFFER$ || $ignoreProperties$$1$$["font-size"] || ($cssObj$$1$$["font-size"] = $value$$219$$);
    ($value$$219$$ = $cssDiv$$6$$.css("font-weight")) && $value$$219$$ !== $DvtStyleProcessor$$.$_INHERITED_FONT_WEIGHT$ && !$ignoreProperties$$1$$["font-weight"] && ($cssObj$$1$$["font-weight"] = $value$$219$$);
    ($value$$219$$ = $cssDiv$$6$$.css("color")) && $value$$219$$ !== $DvtStyleProcessor$$.$_INHERITED_FONT_COLOR$ && !$ignoreProperties$$1$$.color && ($cssObj$$1$$.color = $value$$219$$);
    ($value$$219$$ = $cssDiv$$6$$.css("font-style")) && $value$$219$$ !== $DvtStyleProcessor$$.$_INHERITED_FONT_STYLE$ && ($cssObj$$1$$["font-style"] = $value$$219$$);
    return $cssObj$$1$$;
  }, $processStyles$:function($definitions_element$$108_styleClasses$$, $options$$249$$, $componentClasses_innerDummyDiv$$, $childClasses$$) {
    var $outerDummyDiv$$ = $$$$15$$(document.createElement("div"));
    $outerDummyDiv$$.attr("style", "display:none;");
    $definitions_element$$108_styleClasses$$.append($outerDummyDiv$$);
    $definitions_element$$108_styleClasses$$ = "";
    for (var $i$$242$$ = 0;$i$$242$$ < $componentClasses_innerDummyDiv$$.length;$i$$242$$++) {
      $definitions_element$$108_styleClasses$$ = $definitions_element$$108_styleClasses$$ + $componentClasses_innerDummyDiv$$[$i$$242$$] + " ";
    }
    $outerDummyDiv$$.attr("class", $definitions_element$$108_styleClasses$$);
    ...
    for (var $styleClass$$4$$ in $childClasses$$) {
      $definitions_element$$108_styleClasses$$ = $childClasses$$[$styleClass$$4$$], $definitions_element$$108_styleClasses$$ instanceof Array || ($definitions_element$$108_styleClasses$$ = [$definitions_element$$108_styleClasses$$]), $DvtStyleProcessor$$.$_processStyle$($componentClasses_innerDummyDiv$$, $options$$249$$, $styleClass$$4$$, $definitions_element$$108_styleClasses$$);
    }
    $outerDummyDiv$$.remove();
  }, $_processStyle$:function($element$$109$$, $options$$250$$, $styleClass$$5$$, $definitions$$1$$) {
    ...
    for (var $cssDiv$$7$$ = null, $i$$243$$ = 0;$i$$243$$ < $definitions$$1$$.length;$i$$243$$++) {
      ...
      if ($property$$24_strValue$$) {
        var $value$$220$$ = $DvtStyleProcessor$$.$_styleCache$[$styleClass$$5$$][$property$$24_strValue$$];
        "undefined" == typeof $value$$220$$ && ($cssDiv$$7$$ || ($cssDiv$$7$$ = $$$$15$$(document.createElement("div")), $cssDiv$$7$$.addClass($styleClass$$5$$), $element$$109$$.append($cssDiv$$7$$)), $value$$220$$ = $DvtStyleProcessor$$.$_resolveStyle$($cssDiv$$7$$, $property$$24_strValue$$), $DvtStyleProcessor$$.$_styleCache$[$styleClass$$5$$][$property$$24_strValue$$] = $value$$220$$);
        if (null != $value$$220$$) {
          ...
          if (null != $handler$$48$$) {
            ...
            if ("CSS_URL" !== $property$$24_strValue$$) {
              ...
              if (null != $optionsValue$$) {
                for (var $attr$$16$$ in $value$$220$$) {
                  -1 === $optionsValue$$.indexOf($attr$$16$$) && ($property$$24_strValue$$ += $attr$$16$$ + ":" + $value$$220$$[$attr$$16$$] + ";");
                }
                $property$$24_strValue$$ += $optionsValue$$;
              } else {
                for ($attr$$16$$ in $value$$220$$) {
                  $property$$24_strValue$$ += $attr$$16$$ + ":" + $value$$220$$[$attr$$16$$] + ";";
                }
              }
              $value$$220$$ = $property$$24_strValue$$;
            }
          }
          $definition_path$$10$$.$setValue$($value$$220$$, null != $handler$$48$$);
        }
      }
    }
  }, $_resolveStyle$:function($cssDiv$$8$$, $property$$25$$) {
    var $handler$$49_value$$221$$ = $DvtStyleProcessor$$[$property$$25$$], $handler$$49_value$$221$$ = $handler$$49_value$$221$$ ? $handler$$49_value$$221$$($cssDiv$$8$$) : $DvtStyleProcessor$$.$defaultStyleProcessor$($cssDiv$$8$$, $property$$25$$);
    return null == $handler$$49_value$$221$$ || "string" == typeof $handler$$49_value$$221$$ && "" == $handler$$49_value$$221$$.replace(/^\s+/g, "") ? null : $handler$$49_value$$221$$;
  }};
  $oj$$15$$.$__registerWidget$("oj.dvtBaseComponent", $$$$15$$.oj.baseComponent, {_ComponentCreate:function() {
    ...
    if (!this.$_bUserDrivenChange$) {
      ...
      $$$$15$$.each($options$$251$$, function($key$$71$$) {
        if (0 > $eventTypes$$.indexOf($key$$71$$) && 0 > $optimizedOptions$$.indexOf($key$$71$$)) {
    ...
    this._super();
    this.$_context$.hideTooltips();
  }, $_UserOptionChange$:function($key$$72$$, $value$$223$$, $optionMetadata$$1$$) {
    this.$_bUserDrivenChange$ = !0;
    this.option($key$$72$$, $value$$223$$, {_context:{$writeback$:!0, $optionMetadata$:$optionMetadata$$1$$, $internalSet$:!0}});
  ...
  }, $_GetDvtComponent$:function($element$$110_widget$$4$$) {
    return($element$$110_widget$$4$$ = $oj$$15$$.Components.$getWidgetConstructor$($element$$110_widget$$4$$)("instance")) ? $element$$110_widget$$4$$.$_component$ : null;
  }, $_AddAutomationGetters$:function($map$$1$$) {
    if ($map$$1$$) {
      var $props$$12$$ = {}, $key$$73$$;
      for ($key$$73$$ in $map$$1$$) {
        this.$_addGetter$($map$$1$$, $key$$73$$, $props$$12$$);
      }
      Object.defineProperties($map$$1$$, $props$$12$$);
    }
  }, $_addGetter$:function($map$$2$$, $key$$74$$, $props$$13$$) {
    var $getterName$$ = ("selected" == $key$$74$$ ? "is" : "get") + $key$$74$$.charAt(0).toUpperCase() + $key$$74$$.slice(1);
    $props$$13$$[$getterName$$] = {value:function $$props$$13$$$$getterName$$$value$() {
      return $map$$2$$[$key$$74$$];
    }};
  }, $_GetStringFromIndexPath$:function($indexPath$$) {
    for (var $ret$$30$$ = "", $i$$246$$ = 0;$i$$246$$ < $indexPath$$.length;$i$$246$$++) {
      $ret$$30$$ += "[" + $indexPath$$[$i$$246$$] + "]";
    }
    return $ret$$30$$;
    ...
    if ($optionValue$$3$$ && $optionValue$$3$$ instanceof Promise) {
      ...
      $optionValue$$3$$.then(function($value$$224$$) {
        $self$$113$$.$_renderDeferredData$($renderCount$$, $optionPath$$, $value$$224$$);
      }, function() {
    ...
    return null;
  }, $_renderDeferredData$:function($renderCount$$1$$, $optionPath$$1$$, $value$$225$$) {
    $renderCount$$1$$ === this.$_renderCount$ && (this.$_numDeferredObjs$--, $optionPath$$1$$.$setValue$($value$$225$$, !0), 0 === this.$_numDeferredObjs$ && (this.$_renderComponent$(this.$_optionsCopy$), this.$_optionsCopy$ = null));
