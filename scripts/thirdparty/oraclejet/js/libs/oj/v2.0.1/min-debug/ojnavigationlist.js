...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojbutton", "ojs/ojmenu", "ojs/ojlistview"], function($oj$$20$$, $$$$19$$) {
  ...
  $oj$$20$$.$DefaultNavListHandler$.prototype.$UpdateAriaPropertiesOnSelectedItem$ = function $$oj$$20$$$$DefaultNavListHandler$$$$UpdateAriaPropertiesOnSelectedItem$$($elem$$54$$, $highlight$$1$$) {
    $elem$$54$$.attr("aria-selected", $highlight$$1$$ ? "true" : "false");
  };
  ...
  $oj$$20$$.$HorizontalNavListHandler$.prototype.$UpdateAriaPropertiesOnSelectedItem$ = function $$oj$$20$$$$HorizontalNavListHandler$$$$UpdateAriaPropertiesOnSelectedItem$$($elem$$57$$, $highlight$$2$$) {
    $elem$$57$$.attr("aria-pressed", $highlight$$2$$ ? "true" : "false");
  };
  ...
  $oj$$20$$.$HorizontalNavListHandler$.prototype.$_addSeparator$ = function $$oj$$20$$$$HorizontalNavListHandler$$$$_addSeparator$$($elem$$58$$, $index$$145$$) {
    var $$elem$$ = $$$$19$$($elem$$58$$), $previousElement$$ = $$elem$$.prev();
  ...
  $oj$$20$$.$HorizontalNavListHandler$.prototype.$ItemInsertComplete$ = function $$oj$$20$$$$HorizontalNavListHandler$$$$ItemInsertComplete$$($elem$$59$$, $context$$99$$) {
    this.$_addSeparator$($elem$$59$$, $context$$99$$.index);
  };
  $oj$$20$$.$HorizontalNavListHandler$.prototype.$ItemRemoveComplete$ = function $$oj$$20$$$$HorizontalNavListHandler$$$$ItemRemoveComplete$$($$elem$$1_elem$$60_nextElement$$) {
    $$elem$$1_elem$$60_nextElement$$ = $$$$19$$($$elem$$1_elem$$60_nextElement$$);
    var $previousElement$$1$$ = $$elem$$1_elem$$60_nextElement$$.prev();
    $previousElement$$1$$.length && $previousElement$$1$$.is("li." + this.$m_widget$.$DIVIDER_STYLE_CLASS$) ? $previousElement$$1$$.remove() : ($$elem$$1_elem$$60_nextElement$$ = $$elem$$1_elem$$60_nextElement$$.next(), $$elem$$1_elem$$60_nextElement$$.is("li." + this.$m_widget$.$DIVIDER_STYLE_CLASS$) && $$elem$$1_elem$$60_nextElement$$.remove());
  };
  ...
  $oj$$20$$.$SlidingNavListHandler$.prototype.$_slideAnimationComplete$ = function $$oj$$20$$$$SlidingNavListHandler$$$$_slideAnimationComplete$$($item$$88$$, $isMovingNext$$1$$, $focusableElement$$2_key$$106$$) {
    null !== this.$m_widget$.$m_contentHandler$ && ($focusableElement$$2_key$$106$$ && ($focusableElement$$2_key$$106$$ = this.$m_widget$.$GetKey$($focusableElement$$2_key$$106$$[0]), this.$m_widget$.$SetOption$("currentItem", $focusableElement$$2_key$$106$$)), $isMovingNext$$1$$ ? this.$m_widget$.$AnimateExpandComplete$($item$$88$$.children("." + this.$m_widget$.$getGroupStyleClass$())) : this.$m_widget$.$AnimateCollapseComplete$($item$$88$$.children("." + this.$m_widget$.$getGroupStyleClass$())));
  };
  ...
  $oj$$20$$.$SlidingNavListHandler$.prototype.$UpdateAriaPropertiesOnSelectedItem$ = function $$oj$$20$$$$SlidingNavListHandler$$$$UpdateAriaPropertiesOnSelectedItem$$($elem$$61$$, $highlight$$3$$) {
    $highlight$$3$$ ? $elem$$61$$.attr("aria-describedby", "selectedLabel") : $elem$$61$$.removeAttr("aria-describedby");
  };
  ...
  $_PAGE_LEVEL_NAV_STYLE_CLASS$:"oj-navigationlist-page-level", $_NAVLIST_ITEM_ICON_HAS_TITLE$:"navigationListItemIconHastitle", $_NAVLIST_NO_FOLLOW_LINK_CLASS$:"oj-navigationlist-nofollow-link", $getItemLabel$:function($itemContent$$7_target$$86$$) {
  ...
  }, $itemInsertComplete$:function($elem$$62$$, $context$$100$$) {
    this.$m_listHandler$.$ItemInsertComplete$($elem$$62$$, $context$$100$$);
  }, $itemRemoveComplete$:function($elem$$63$$) {
    this.$m_listHandler$.$ItemRemoveComplete$($elem$$63$$);
    ...
    $opts$$26$$.item.focusable = function $$opts$$26$$$item$focusable$($context$$101$$) {
      return $$$$19$$($context$$101$$.data).is("li") ? !$$$$19$$($context$$101$$.data).hasClass("oj-disabled") : !$$$$19$$($context$$101$$.parentElement).hasClass("oj-disabled");
    };
    ...
    var $self$$137$$ = this, $element$$117_listViewContainer$$ = $navlistopts_opts$$28$$.$ojContext$.element;
    $element$$117_listViewContainer$$.addClass(this.$_NAVLIST_STYLE_CLASS$);
    $oj$$20$$.$DomUtils$.$isTouchSupported$() && $element$$117_listViewContainer$$.addClass(this.$_NAVLIST_TOUCH_STYLE_CLASS$);
    this.$_list$ = $element$$117_listViewContainer$$.children("ul:first");
    0 === this.$_list$.length && (this.$_list$ = $$$$19$$(document.createElement("ul")), $element$$117_listViewContainer$$.append(this.$_list$));
    $element$$117_listViewContainer$$ = $$$$19$$(document.createElement("div"));
    $element$$117_listViewContainer$$.addClass(this.$_NAVLIST_LISTVIEW_CONTAINER_STYLE_CLASS$);
    this.$_list$.wrap($element$$117_listViewContainer$$);
    ...
    if ($keyCode$$16_processExpansion$$ === $$$$19$$.ui.keyCode.HOME || $keyCode$$16_processExpansion$$ === $$$$19$$.ui.keyCode.END) {
      var $item$$103_key$$107_processed$$4$$;
      $item$$103_key$$107_processed$$4$$ = $keyCode$$16_processExpansion$$ === $$$$19$$.ui.keyCode.HOME ? this.element.find("." + this.$ITEM_CONTENT_STYLE_CLASS$ + ":visible").first().closest("." + this.$getItemElementStyleClass$()) : this.element.find("." + this.$ITEM_CONTENT_STYLE_CLASS$ + ":visible").last().closest("." + this.$getItemElementStyleClass$());
      $item$$103_key$$107_processed$$4$$ = this.$GetKey$($item$$103_key$$107_processed$$4$$[0]);
      this.$SetOption$("currentItem", $item$$103_key$$107_processed$$4$$);
      $event$$330$$.preventDefault();
    } else {
      $item$$103_key$$107_processed$$4$$ = this.$HandleSelectionOrActiveKeyDown$($event$$330$$), $keyCode$$16_processExpansion$$ = this.$m_listHandler$.$HandleExpandAndCollapseKeys$($event$$330$$, $keyCode$$16_processExpansion$$, $current$$16$$, $currentItemKey$$2$$), !0 !== $item$$103_key$$107_processed$$4$$ && !0 !== $keyCode$$16_processExpansion$$ || $event$$330$$.preventDefault();
    }
  ...
  }, $HighlightUnhighlightElem$:function($elem$$64$$, $style$$7$$, $highlight$$4$$) {
    var $group$$4$$;
    $elem$$64$$ = $$$$19$$($elem$$64$$);
    "oj-selected" === $style$$7$$ && this.$m_listHandler$.$UpdateAriaPropertiesOnSelectedItem$(this.$getFocusItem$($elem$$64$$), $highlight$$4$$);
    $group$$4$$ = $elem$$64$$.children("." + this.$getGroupItemStyleClass$());
    0 < $group$$4$$.length && ($elem$$64$$ = $$$$19$$($group$$4$$[0]));
    $highlight$$4$$ ? $elem$$64$$.addClass($style$$7$$) : $elem$$64$$.removeClass($style$$7$$);
    $elem$$64$$.hasClass("oj-selected") || $elem$$64$$.hasClass("oj-hover") || $elem$$64$$.hasClass("oj-active") || $elem$$64$$.hasClass("oj-disabled") ? $elem$$64$$.removeClass("oj-default") : $elem$$64$$.addClass("oj-default");
  }, $IsSelectable$:function($item$$105$$) {
    return!$$$$19$$($item$$105$$).hasClass("oj-disabled") && this.$m_listHandler$.$IsSelectable$($$$$19$$($item$$105$$));
  }, $Trigger$:function($type$$85$$, $event$$332$$, $ui$$17$$) {
    return "ready" !== $type$$85$$ ? this.$ojContext$._trigger($type$$85$$, $event$$332$$, $ui$$17$$) : !0;
  }, $SetOption$:function($key$$108$$, $value$$251$$, $flags$$29$$) {
    if ("selection" === $key$$108$$) {
      var $context$$102$$ = $flags$$29$$._context, $selectedItem$$ = $context$$102$$ && $context$$102$$.$extraData$ && $context$$102$$.$extraData$.items;
      $selectedItem$$ && ($context$$102$$.$extraData$.item = $selectedItem$$, $context$$102$$.$extraData$.items = void 0);
      $value$$251$$ && 0 < $value$$251$$.length ? this.$ojContext$.option($key$$108$$, $value$$251$$[0], $flags$$29$$) : this.$ojContext$.option($key$$108$$, null, $flags$$29$$);
    } else {
      this.$ojContext$.option($key$$108$$, $value$$251$$, $flags$$29$$);
    }
    this.options[$key$$108$$] = $value$$251$$;
    ...
    var $optionValue$$4$$ = this.$ojContext$.option($key$$109$$);
    return "selection" === $key$$109$$ ? $optionValue$$4$$ ? [$optionValue$$4$$] : [] : null === $optionValue$$4$$ ? this.options[$key$$109$$] : $optionValue$$4$$;
    ...
    if (!$item$$107$$.hasClass("oj-disabled") && this.$IsSelectable$($item$$107$$[0])) {
      var $key$$110$$ = this.$GetKey$($item$$107$$[0]);
      this.$SetOption$("currentItem", $key$$110$$);
    ...
    var $key$$111$$ = this.$GetKey$($item$$108$$[0]);
    return this.$Trigger$("beforeSelect", $event$$334$$, {item:$item$$108$$, key:$key$$111$$});
  ...
  }, $_isSelected$:function($item$$110_key$$112$$) {
    var $selection$$13$$;
    $selection$$13$$ = this.$GetOption$("selection");
    $item$$110_key$$112$$ = this.$GetKey$($item$$110_key$$112$$[0]);
    return-1 < $selection$$13$$.indexOf($item$$110_key$$112$$) ? !0 : !1;
  ...
  }, $itemRenderComplete$:function($elem$$65$$, $context$$103$$) {
    var $$item$$3$$ = $$$$19$$($elem$$65$$);
  ...
  }, getNodeBySubId:function($item$$111_key$$113_locator$$28$$) {
    var $subId$$33$$;
    if (null === $item$$111_key$$113_locator$$28$$) {
      return this.element ? this.element[0] : null;
    }
    $subId$$33$$ = $item$$111_key$$113_locator$$28$$.subId;
    return "oj-navigationlist-item" === $subId$$33$$ ? ($item$$111_key$$113_locator$$28$$ = $item$$111_key$$113_locator$$28$$.key, $item$$111_key$$113_locator$$28$$ = this.$FindElementByKey$($item$$111_key$$113_locator$$28$$)) : "oj-navigationlist-previous-link" === $subId$$33$$ ? this.$m_listHandler$.$_previousLink$ ? this.$m_listHandler$.$_previousLink$[0] : null : "oj-navigationlist-hierarchical-button" === $subId$$33$$ ? this.$m_listHandler$.$_hviewBtn$ ? this.$m_listHandler$.$_hviewBtn$[0] : 
  ...
  }, getSubIdByNode:function($item$$112_key$$114_node$$75$$) {
    if (this.$m_listHandler$.$_previousLink$ && this.$m_listHandler$.$_previousLink$[0] === $item$$112_key$$114_node$$75$$) {
      return{subId:"oj-navigationlist-previous-link"};
    }
    if (this.$m_listHandler$.$_hviewBtn$ && this.$m_listHandler$.$_hviewBtn$[0] === $item$$112_key$$114_node$$75$$) {
      return{subId:"oj-navigationlist-hierarchical-button"};
    }
    if (this.$m_listHandler$.$_hviewMenu$ && this.$m_listHandler$.$_hviewMenu$[0] === $item$$112_key$$114_node$$75$$) {
      return{subId:"oj-navigationlist-hierarchical-menu"};
    }
    $item$$112_key$$114_node$$75$$ = this.$FindItem$($item$$112_key$$114_node$$75$$);
    return null != $item$$112_key$$114_node$$75$$ && 0 < $item$$112_key$$114_node$$75$$.length && ($item$$112_key$$114_node$$75$$ = this.$GetKey$($item$$112_key$$114_node$$75$$[0]), null != $item$$112_key$$114_node$$75$$) ? {subId:"oj-navigationlist-item", key:$item$$112_key$$114_node$$75$$} : null;
  }, getContextByNode:function($context$$104_node$$76$$) {
    return($context$$104_node$$76$$ = $_ojNavigationListView$$.$superclass$.getContextByNode.call(this, $context$$104_node$$76$$)) && "oj-listview-item" == $context$$104_node$$76$$.subId ? ($context$$104_node$$76$$.subId = "oj-navigationlist-item", $context$$104_node$$76$$) : null;
  }, refresh:function() {
    this.$_resetNavlist$();
    this.$_initListHandler$();
  ...
  (function() {
    $oj$$20$$.$__registerWidget$("oj.ojNavigationList", $$$$19$$.oj.baseComponent, {widgetEventPrefix:"oj", options:{currentItem:null, drillMode:"none", edge:"start", hierarchyMenuDisplayThresholdLevel:0, rootLabel:null, selection:null, expanded:"auto", data:null, display:"all", navigationLevel:"page", item:{renderer:null, selectable:!0}, beforeSelect:null, beforeCollapse:null, beforeCurrentItem:null, collapse:null, beforeExpand:null, expand:null, optionChange:null}, _ComponentCreate:function() {
      ...
      for (var $key$$115_opts$$29$$ in this.options) {
        this.$_validateOptionValues$($key$$115_opts$$29$$, this.options[$key$$115_opts$$29$$]);
      }
      ...
      $key$$115_opts$$29$$ = {$ojContext$:this};
      $key$$115_opts$$29$$ = $$$$19$$.extend(this.options, $key$$115_opts$$29$$);
      this.$navlist$.$init$($key$$115_opts$$29$$);
    ...
    }, expand:function($key$$116$$, $vetoable$$2$$) {
      this.$navlist$.$expandKey$($key$$116$$, $vetoable$$2$$, !0, !0);
    }, collapse:function($key$$117$$, $vetoable$$3$$) {
      this.$navlist$.$collapseKey$($key$$117$$, $vetoable$$3$$, !0);
    ...
    }, $_validateOptionValues$:function($key$$118$$, $value$$252$$) {
      var $valid$$9$$ = !0;
      "drillMode" === $key$$118$$ ? $valid$$9$$ = "none" === $value$$252$$ || "collapsible" === $value$$252$$ || "sliding" === $value$$252$$ : "display" === $key$$118$$ ? $valid$$9$$ = "all" === $value$$252$$ || "icons" === $value$$252$$ : "edge" === $key$$118$$ && ($valid$$9$$ = "top" === $value$$252$$ || "start" === $value$$252$$);
      if (!$valid$$9$$) {
        throw "Invalid value: " + $value$$252$$ + " for key: " + $key$$118$$;
      }
    }, _setOption:function($key$$119$$, $value$$253$$) {
      this.$_validateOptionValues$($key$$119$$, $value$$253$$);
      switch($key$$119$$) {
        case "drillMode":
          this.$_validateOptionsForIconsOnlyAndHorizontalList$($value$$253$$, this.options.display, this.options.edge);
          break;
        case "display":
          this.$_validateOptionsForIconsOnlyAndHorizontalList$(this.options.drillMode, $value$$253$$, this.options.edge);
          break;
        case "edge":
          this.$_validateOptionsForIconsOnlyAndHorizontalList$(this.options.drillMode, this.options.display, $value$$253$$);
      }
      return this._super($key$$119$$, $value$$253$$);
    }, _setOptions:function($options$$265$$, $flags$$31$$) {
      var $result$$50$$ = this.$navlist$.$setOptions$($options$$265$$, $flags$$31$$), $key$$120$$;
      for ($key$$120$$ in $options$$265$$) {
        0 > $result$$50$$.$skipOptions$.indexOf($key$$120$$) && this._setOption($key$$120$$, $options$$265$$[$key$$120$$], $flags$$31$$);
      }
