...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojpopupcore"], function($oj$$61$$, $$$$55$$) {
  (function() {
    ...
    $oj$$61$$.$__registerWidget$("oj.ojPopup", $$$$55$$.oj.baseComponent, {widgetEventPrefix:"oj", options:{autoDismiss:"focusLoss", chrome:"default", initialFocus:"auto", position:{my:"start top", at:"start bottom", of:"", collision:"flip"}, tail:"none", modality:"modeless", role:"tooltip", beforeOpen:null, open:null, beforeClose:null, close:null, focus:null}, _ComponentCreate:function() {
    ...
    }, _setOption:function($key$$175$$, $value$$302$$) {
      var $options$$380_psOptions$$9$$ = this.options;
      switch($key$$175$$) {
        case "tail":
          $value$$302$$ !== $options$$380_psOptions$$9$$.tail && this.$_setTail$($value$$302$$);
          break;
        case "chrome":
          $value$$302$$ !== $options$$380_psOptions$$9$$.chrome && this.$_setChrome$($value$$302$$);
          break;
        case "position":
          this.$_setPosition$($value$$302$$);
          this.refresh();
          return;
        case "autoDismiss":
          this.isOpen() && $value$$302$$ !== $options$$380_psOptions$$9$$.autoDismiss && this.$_setAutoDismiss$($value$$302$$);
          break;
        case "modality":
          this.isOpen() && ($options$$380_psOptions$$9$$ = {}, $options$$380_psOptions$$9$$[$oj$$61$$.$PopupService$.$OPTION$.$POPUP$] = this.$_rootElement$, $options$$380_psOptions$$9$$[$oj$$61$$.$PopupService$.$OPTION$.$MODALITY$] = $value$$302$$, $oj$$61$$.$PopupService$.$getInstance$().$changeOptions$($options$$380_psOptions$$9$$));
      }
      ...
      if ($launcher$$12$$ instanceof jQuery && 1 < $launcher$$12$$.length) {
        for (var $rootElement$$9$$ = this.$_rootElement$, $i$$425$$ = 0;$i$$425$$ < $launcher$$12$$.length;$i$$425$$++) {
      ...
      if ($pos$$13$$.top !== $leftPercent_origUsing$$1_rootElement$$10_rootHeight_rootWidth_topPercent$$.css("top") || $pos$$13$$.left !== $leftPercent_origUsing$$1_rootElement$$10_rootHeight_rootWidth_topPercent$$.css("left")) {
        ...
        if ($options$$384_tail$$3$$) {
          ...
          for (var $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ = 0;$i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ < $_TAIL_STYLES$$.length;$i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$++) {
            $options$$384_tail$$3$$.removeClass($_TAIL_STYLES$$[$i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$]), $leftPercent_origUsing$$1_rootElement$$10_rootHeight_rootWidth_topPercent$$.removeClass($_TAIL_STYLES$$[$i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$]);
          }
          $options$$384_tail$$3$$.removeAttr("style");
          if ($props$$27$$.target && 0 === $props$$27$$.target.height && 0 === $props$$27$$.target.width && ($i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ = "rtl" === this.$_GetReadingDirection$(), $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ = $oj$$61$$.$PositionUtils$.$normalizeHorizontalAlignment$(this.options.position, $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$).my, !$oj$$61$$.$StringUtils$.$isEmptyOrUndefined$($i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$))) {
            var $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ = $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$.split(" "), $suggestedHrule$$ = $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$[0], $suggestedVrule$$ = "middle";
            1 < $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$.length && ($suggestedVrule$$ = "center" === $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$[1] ? "middle" : $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$[1]);
            $props$$27$$.horizontal = $suggestedHrule$$;
            $props$$27$$.vertical = $suggestedVrule$$;
          }
          $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ = $_TAIL_ALIGN_RULES$$[[$props$$27$$.horizontal, $props$$27$$.vertical].join("-")];
          $options$$384_tail$$3$$.addClass($i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$);
          $leftPercent_origUsing$$1_rootElement$$10_rootHeight_rootWidth_topPercent$$.addClass($i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$);
          $options$$384_tail$$3$$.show();
          "left" === $props$$27$$.horizontal ? ($i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ = $options$$384_tail$$3$$.outerWidth(), $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ -= $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ + $oj$$61$$.$DomUtils$.$getCSSLengthAsInt$($options$$384_tail$$3$$.css("left")), $pos$$13$$.left += $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ - 2) : "right" === $props$$27$$.horizontal && 
          ($i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ = $options$$384_tail$$3$$.outerWidth(), $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ -= $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ + $oj$$61$$.$DomUtils$.$getCSSLengthAsInt$($options$$384_tail$$3$$.css("right")), $pos$$13$$.left -= $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ - 2);
          "top" === $props$$27$$.vertical ? ($i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ = $options$$384_tail$$3$$.outerHeight(), $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ -= $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ + $oj$$61$$.$DomUtils$.$getCSSLengthAsInt$($options$$384_tail$$3$$.css($props$$27$$.vertical)), $pos$$13$$.top += $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ - 2) : "bottom" === 
          $props$$27$$.vertical && ($i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ = $options$$384_tail$$3$$.outerHeight(), $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ -= $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ + $oj$$61$$.$DomUtils$.$getCSSLengthAsInt$($options$$384_tail$$3$$.css($props$$27$$.vertical)), $pos$$13$$.top -= $i$$426_isRtl$$5_myrule_myrules_tailHOffset_tailStyle$$2_tailVOffset$$ - 2);
      ...
      var $callback$$119_isIOSVOSupported$$ = $oj$$61$$.$AgentUtils$.$getAgentInfo$().os === $oj$$61$$.$AgentUtils$.$OS$.$IOS$, $closeSkipLinkId_focusSkipLinkId_liveRegion$$ = this.$_liveRegion$;
      ...
      var $message$$34$$;
      $message$$34$$ = $callback$$119_isIOSVOSupported$$ ? this.$getTranslatedString$("none" === this.options.initialFocus ? "ariaLiveRegionInitialFocusNoneTouch" : "ariaLiveRegionInitialFocusFirstFocusableTouch") : this.$getTranslatedString$("none" === this.options.initialFocus ? "ariaLiveRegionInitialFocusNone" : "ariaLiveRegionInitialFocusFirstFocusable");
      $closeSkipLinkId_focusSkipLinkId_liveRegion$$.$announce$($message$$34$$);
      if ($callback$$119_isIOSVOSupported$$) {
        if (!this.$_focusSkipLink$) {
          var $closeSkipLinkId_focusSkipLinkId_liveRegion$$ = this.$_getSubId$("focusSkipLink"), $element$$154_launcher$$20$$ = this.$_launcher$, $callback$$119_isIOSVOSupported$$ = $$$$55$$.proxy(this.$_intialFocus$, this, !0);
          $message$$34$$ = this.$getTranslatedString$("ariaFocusSkipLink");
          this.$_focusSkipLink$ = new $oj$$61$$.$PopupSkipLink$($element$$154_launcher$$20$$, $message$$34$$, $callback$$119_isIOSVOSupported$$, $closeSkipLinkId_focusSkipLinkId_liveRegion$$);
        }
        this.$_closeSkipLink$ || ($closeSkipLinkId_focusSkipLinkId_liveRegion$$ = this.$_getSubId$("closeSkipLink"), $element$$154_launcher$$20$$ = this.element, $callback$$119_isIOSVOSupported$$ = $$$$55$$.proxy(this.$_closeImplicitly$, this), $message$$34$$ = this.$getTranslatedString$("ariaCloseSkipLink"), this.$_closeSkipLink$ = new $oj$$61$$.$PopupSkipLink$($element$$154_launcher$$20$$, $message$$34$$, $callback$$119_isIOSVOSupported$$, $closeSkipLinkId_focusSkipLinkId_liveRegion$$));
      }
