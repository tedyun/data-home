...
define(["ojs/ojcore", "jquery", "knockout", "jqueryui-amd/widget"], function($oj$$7$$, $$$$7$$, $ko$$1$$) {
  ...
  function $_getTableColumnTemplateRenderer$$($bindingContext$$17$$, $type$$77$$, $template$$9$$) {
    ...
    (function($template$$10$$, $type$$78$$) {
      $rendererOption$$ = function $$rendererOption$$$($params$$14$$) {
        ...
        "header" == $type$$78$$ ? ($childContext$$4$$ = $bindingContext$$17$$.extend({$columnIndex:$params$$14$$.columnIndex, $headerContext:$params$$14$$.headerContext, $data:$params$$14$$.data}), $parentElement$$ = $params$$14$$.headerContext.parentElement) : "cell" == $type$$78$$ && ($childContext$$4$$ = $bindingContext$$17$$.createChildContext($params$$14$$.row, null, function($binding$$4$$) {
        ...
        "footer" == $type$$78$$ && ($childContext$$4$$ = $bindingContext$$17$$.extend({$columnIndex:$params$$14$$.columnIndex, $footerContext:$params$$14$$.footerContext}), $parentElement$$ = $params$$14$$.footerContext.parentElement);
  ...
  function $_getTableRowTemplateRenderer$$($bindingContext$$18$$, $template$$11$$) {
    return function($params$$15$$) {
      var $childContext$$5$$ = $bindingContext$$18$$.createChildContext($params$$15$$.row, null, function($binding$$5$$) {
        $binding$$5$$.$rowContext = $params$$15$$.rowContext;
      });
  ...
  $oj$$7$$.$ComponentBinding$ = function $$oj$$7$$$$ComponentBinding$$($name$$88$$, $options$$209$$) {
    this.Init($name$$88$$, $options$$209$$);
  };
  ...
  $oj$$7$$.$ComponentBinding$.create = function $$oj$$7$$$$ComponentBinding$$create$($name$$89$$, $options$$210$$) {
    if (null == $name$$89$$) {
      throw "Binding name is required!";
    }
    var $instance$$14$$ = new $oj$$7$$.$ComponentBinding$($name$$89$$, $options$$210$$), $handlers$$5$$ = $ko$$1$$.bindingHandlers, $i$$128$$, $names$$1$$ = Array.isArray($name$$89$$) ? $name$$89$$ : [$name$$89$$];
  ...
  $oj$$7$$.$ComponentBinding$.prototype._init = function $$oj$$7$$$$ComponentBinding$$$_init$($element$$43$$, $valueAccessor$$, $allBindingsAccessor$$, $viewModel$$1$$, $bindingContext$$21$$) {
    $ko$$1$$.applyBindingsToDescendants($bindingContext$$21$$, $element$$43$$);
    return{controlsDescendantBindings:!0};
  };
  $oj$$7$$.$ComponentBinding$.prototype.$_update$ = function $$oj$$7$$$$ComponentBinding$$$$_update$$($element$$44$$, $valueAccessor$$1$$, $allBindingsAccessor$$1$$, $viewModel$$2$$, $bindingContext$$22$$) {
    ...
    function $createComponent$$($componentName$$3$$, $nameOption$$, $bindingValue$$) {
      if (null != $componentName$$3$$) {
        ...
        if ("function" !== typeof $comp$$2$$) {
          ...
          var $specifiedOptions$$ = Object.keys($bindingValue$$).filter(function($value$$158$$) {
            return!(null == $value$$158$$ || $value$$158$$ === $nameOption$$);
          });
          $component$$7$$ = this.$_initComponent$($element$$44$$, {$component$:$comp$$2$$, $changeTracker$:$changeTracker$$, $componentName$:$componentName$$3$$, $specifiedOptions$:$specifiedOptions$$, $computeds$:$componentComputeds$$, $valueAccessor$:function() {
            return $bindingValue$$;
          }, $allBindingsAccessor$:$allBindingsAccessor$$1$$, $bindingContext$:$bindingContext$$22$$, $destroyCallback$:function() {
            $component$$7$$ = null;
          }});
        }
      }
  ...
  $oj$$7$$.$ComponentBinding$.prototype.$_initComponent$ = function $$oj$$7$$$$ComponentBinding$$$$_initComponent$$($element$$45$$, $ctx$$) {
    function $propertyReadFunc$$() {
      var $initProps_prop$$57_updateProps$$ = this.$_property$, $updateKeys_value$$159$$ = $oj$$7$$.$ComponentBinding$.$_toJS$($ctx$$.$valueAccessor$()[$initProps_prop$$57_updateProps$$]);
      if (0 === $stage$$1$$) {
        var $initFunc_k$$5_managedPropEntry_updateFunc$$ = $managedAttrMap$$[$initProps_prop$$57_updateProps$$];
        null != $initFunc_k$$5_managedPropEntry_updateFunc$$ ? ($specifiedManagedAttrs$$[$initProps_prop$$57_updateProps$$] = $initFunc_k$$5_managedPropEntry_updateFunc$$, $initFunc_k$$5_managedPropEntry_updateFunc$$ = $initFunc_k$$5_managedPropEntry_updateFunc$$.$init$, null != $initFunc_k$$5_managedPropEntry_updateFunc$$ && ($initProps_prop$$57_updateProps$$ = $initFunc_k$$5_managedPropEntry_updateFunc$$($initProps_prop$$57_updateProps$$, $updateKeys_value$$159$$, $element$$45$$, $comp$$3$$, $ctx$$.$valueAccessor$, 
        $ctx$$.$allBindingsAccessor$, $ctx$$.$bindingContext$) || {}, $oj$$7$$.$CollectionUtils$.$copyInto$($resolvedInitialOptions$$, $initProps_prop$$57_updateProps$$))) : $resolvedInitialOptions$$[$initProps_prop$$57_updateProps$$] = $updateKeys_value$$159$$;
      } else {
        if (!$disposed$$) {
          if (null != $managedAttrMap$$[$initProps_prop$$57_updateProps$$]) {
            if ($initFunc_k$$5_managedPropEntry_updateFunc$$ = $managedAttrMap$$[$initProps_prop$$57_updateProps$$].update, null != $initFunc_k$$5_managedPropEntry_updateFunc$$) {
              for ($initProps_prop$$57_updateProps$$ = $initFunc_k$$5_managedPropEntry_updateFunc$$($initProps_prop$$57_updateProps$$, $updateKeys_value$$159$$, $element$$45$$, $comp$$3$$, $ctx$$.$valueAccessor$, $ctx$$.$allBindingsAccessor$, $ctx$$.$bindingContext$) || {}, $updateKeys_value$$159$$ = Object.keys($initProps_prop$$57_updateProps$$), $initFunc_k$$5_managedPropEntry_updateFunc$$ = 0;$initFunc_k$$5_managedPropEntry_updateFunc$$ < $updateKeys_value$$159$$.length;$initFunc_k$$5_managedPropEntry_updateFunc$$++) {
                var $p$$3$$ = $updateKeys_value$$159$$[$initFunc_k$$5_managedPropEntry_updateFunc$$];
                $ctx$$.$changeTracker$.$addChange$($p$$3$$, $initProps_prop$$57_updateProps$$[$p$$3$$]);
              }
            }
          } else {
            $ctx$$.$changeTracker$.$addChange$($initProps_prop$$57_updateProps$$, $updateKeys_value$$159$$);
          }
        }
      }
    }
  ...
  $oj$$7$$.$ComponentBinding$.$_resolveManagedAttributes$ = function $$oj$$7$$$$ComponentBinding$$$_resolveManagedAttributes$$($optionMap$$, $specifiedOptions$$2$$, $componentName$$7_k$$6_proto$$4_widgetClass$$) {
    function $traverseOptions$$($name$$90$$, $followLinks$$) {
      var $managers$$1$$ = $optionMap$$[$name$$90$$];
      if (null != $managers$$1$$) {
      ...
      if ($ctx$$1$$.$componentName$.match($pattern$$12$$)) {
        ...
        for ($i$$130_keys$$9$$ = 0;$i$$130_keys$$9$$ < $eventInfos_writablePropMap$$.length;$i$$130_keys$$9$$++) {
          $info$$2_k$$7$$ = $eventInfos_writablePropMap$$[$i$$130_keys$$9$$], $jelem$$6$$.on($info$$2_k$$7$$.event + $oj$$7$$.$ComponentBinding$.$_HANDLER_NAMESPACE$, {$getter$:$info$$2_k$$7$$.getter}, function($evt$$20$$, $data$$53$$) {
            ...
            var $nameValues$$ = $evt$$20$$.data.$getter$($evt$$20$$, $data$$53$$), $accessor$$1$$ = $ctx$$1$$.$valueAccessor$(), $name$$91$$;
            for ($name$$91$$ in $nameValues$$) {
              $ctx$$1$$.$changeTracker$.$suspend$($name$$91$$);
              try {
                if (0 <= $ctx$$1$$.$specifiedOptions$.indexOf($name$$91$$)) {
                  var $optionMap$$1$$ = $accessor$$1$$[$oj$$7$$.$ComponentBinding$.$_OPTION_MAP$];
                  $oj$$7$$.$ComponentBinding$.$_writeValueToProperty$($name$$91$$, $accessor$$1$$[$name$$91$$], $nameValues$$[$name$$91$$], null == $optionMap$$1$$ ? null : $optionMap$$1$$[$name$$91$$], $ctx$$1$$.$bindingContext$, $cachedWriterFunctionEvaluators$$);
                }
              } finally {
                $ctx$$1$$.$changeTracker$.$resume$($name$$91$$);
              }
            }
          });
        }
  ...
  $oj$$7$$.$ComponentBinding$.$_writeValueToProperty$ = function $$oj$$7$$$$ComponentBinding$$$_writeValueToProperty$$($func$$7_name$$92$$, $inContextWriter_target$$78$$, $value$$160$$, $propertyExpression_writerExpr$$, $bindingContext$$23$$, $cachedWriterFunctionEvaluators$$1$$) {
    null != $inContextWriter_target$$78$$ && $ko$$1$$.isObservable($inContextWriter_target$$78$$) ? $ko$$1$$.isWriteableObservable($inContextWriter_target$$78$$) && $inContextWriter_target$$78$$($value$$160$$) : ($func$$7_name$$92$$ in $cachedWriterFunctionEvaluators$$1$$ || ($inContextWriter_target$$78$$ = null, $propertyExpression_writerExpr$$ = $oj$$7$$.$ExpressionUtils$.$getPropertyWriterExpression$($propertyExpression_writerExpr$$), null != $propertyExpression_writerExpr$$ && ($inContextWriter_target$$78$$ = 
    $oj$$7$$.$ComponentBinding$.$__CreateEvaluator$($propertyExpression_writerExpr$$)), $cachedWriterFunctionEvaluators$$1$$[$func$$7_name$$92$$] = $inContextWriter_target$$78$$), ($func$$7_name$$92$$ = $cachedWriterFunctionEvaluators$$1$$[$func$$7_name$$92$$]) && $func$$7_name$$92$$($bindingContext$$23$$)($value$$160$$));
  };
  ...
  $oj$$7$$.$ComponentBinding$.$_deliverCreateDestroyEventToManagedProps$ = function $$oj$$7$$$$ComponentBinding$$$_deliverCreateDestroyEventToManagedProps$$($isCreate$$, $managedAttrMap$$2$$, $element$$46$$, $comp$$4$$, $valueAccessor$$2$$, $allBindingsAccessor$$2$$, $bindingContext$$24$$) {
    for (var $props$$7$$ = Object.keys($managedAttrMap$$2$$), $i$$131$$ = 0;$i$$131$$ < $props$$7$$.length;$i$$131$$++) {
      ...
      ($callback$$84_entry$$1$$ = $isCreate$$ ? $callback$$84_entry$$1$$.$afterCreate$ : $callback$$84_entry$$1$$.$beforeDestroy$) && $callback$$84_entry$$1$$($prop$$59$$, $element$$46$$, $comp$$4$$, $valueAccessor$$2$$, $allBindingsAccessor$$2$$, $bindingContext$$24$$);
    }
  };
  ...
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["pieCenter"], init:function($name$$94$$, $value$$161$$, $element$$47$$, $widgetConstructor$$, $valueAccessor$$3$$, $allBindingsAccessor$$3$$, $bindingContext$$25$$) {
    return $_handleAttributes$$($name$$94$$, $value$$161$$, $bindingContext$$25$$);
  }, update:function($name$$95$$, $value$$162$$, $element$$48$$, $widgetConstructor$$1$$, $valueAccessor$$4$$, $allBindingsAccessor$$4$$, $bindingContext$$26$$) {
    return $_handleAttributes$$($name$$95$$, $value$$162$$, $bindingContext$$26$$);
  }, "for":"ojChart"});
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["optionTemplate"], init:function($name$$96_result$$16$$, $value$$163$$, $element$$49$$, $widgetConstructor$$2$$, $valueAccessor$$5$$, $allBindingsAccessor$$5$$, $bindingContext$$27$$) {
    $name$$96_result$$16$$ = $_handleComboboxManagedAttributes$$($name$$96_result$$16$$, $value$$163$$, $bindingContext$$27$$);
    if (null !== $name$$96_result$$16$$) {
      return $name$$96_result$$16$$;
    }
  }, update:function($name$$97$$, $value$$164$$, $element$$50$$, $widgetConstructor$$3$$, $valueAccessor$$6$$, $allBindingsAccessor$$6$$, $bindingContext$$28$$) {
    return $_handleComboboxManagedAttributes$$($name$$97$$, $value$$164$$, $bindingContext$$28$$);
  ...
  $ComponentChangeTracker$$.prototype.$addChange$ = function $$ComponentChangeTracker$$$$$addChange$$($property$$17$$, $value$$165$$) {
    this.$_isSuspended$($property$$17$$) || this.$_disposed$ || (this.$_changes$[$property$$17$$] = $value$$165$$, this.$_queue$.$registerComponentChanges$(this));
  };
  ...
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["header", "cell"], init:function($cellTemplate_column_name$$98_row$$, $value$$166$$, $columnTemplate_element$$52_rowTemplate$$, $widgetConstructor$$4$$, $valueAccessor$$8$$, $allBindingsAccessor$$7$$, $bindingContext$$30$$) {
    if ("header" === $cellTemplate_column_name$$98_row$$) {
      return $cellTemplate_column_name$$98_row$$ = $value$$166$$.row, null != $cellTemplate_column_name$$98_row$$ && ($columnTemplate_element$$52_rowTemplate$$ = $cellTemplate_column_name$$98_row$$.template, null != $columnTemplate_element$$52_rowTemplate$$ && ($cellTemplate_column_name$$98_row$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$30$$, $columnTemplate_element$$52_rowTemplate$$))), $cellTemplate_column_name$$98_row$$ = $value$$166$$.column, null != $cellTemplate_column_name$$98_row$$ && 
      ($columnTemplate_element$$52_rowTemplate$$ = $cellTemplate_column_name$$98_row$$.template, null != $columnTemplate_element$$52_rowTemplate$$ && ($cellTemplate_column_name$$98_row$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$30$$, $columnTemplate_element$$52_rowTemplate$$))), {header:$value$$166$$};
    }
    if ("cell" === $cellTemplate_column_name$$98_row$$) {
      return $cellTemplate_column_name$$98_row$$ = $value$$166$$.template, null != $cellTemplate_column_name$$98_row$$ && ($value$$166$$.renderer = $_getDataGridCellRenderer$$($bindingContext$$30$$, $cellTemplate_column_name$$98_row$$)), {cell:$value$$166$$};
    }
  }, update:function($cellTemplate$$1_column$$1_name$$99_row$$1$$, $value$$167$$, $columnTemplate$$1_element$$53_rowTemplate$$1$$, $widgetConstructor$$5$$, $valueAccessor$$9$$, $allBindingsAccessor$$8$$, $bindingContext$$31$$) {
    return "header" === $cellTemplate$$1_column$$1_name$$99_row$$1$$ ? ($cellTemplate$$1_column$$1_name$$99_row$$1$$ = $value$$167$$.row, null != $cellTemplate$$1_column$$1_name$$99_row$$1$$ && ($columnTemplate$$1_element$$53_rowTemplate$$1$$ = $cellTemplate$$1_column$$1_name$$99_row$$1$$.template, null != $columnTemplate$$1_element$$53_rowTemplate$$1$$ && ($cellTemplate$$1_column$$1_name$$99_row$$1$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$31$$, $columnTemplate$$1_element$$53_rowTemplate$$1$$))), 
    $cellTemplate$$1_column$$1_name$$99_row$$1$$ = $value$$167$$.column, null != $cellTemplate$$1_column$$1_name$$99_row$$1$$ && ($columnTemplate$$1_element$$53_rowTemplate$$1$$ = $cellTemplate$$1_column$$1_name$$99_row$$1$$.template, null != $columnTemplate$$1_element$$53_rowTemplate$$1$$ && ($cellTemplate$$1_column$$1_name$$99_row$$1$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$31$$, $columnTemplate$$1_element$$53_rowTemplate$$1$$))), {header:$value$$167$$}) : "cell" === $cellTemplate$$1_column$$1_name$$99_row$$1$$ ? 
    ($cellTemplate$$1_column$$1_name$$99_row$$1$$ = $value$$167$$.template, null != $cellTemplate$$1_column$$1_name$$99_row$$1$$ && ($value$$167$$.renderer = $_getDataGridCellRenderer$$($bindingContext$$31$$, $cellTemplate$$1_column$$1_name$$99_row$$1$$)), {cell:$value$$167$$}) : null;
  }, "for":"ojDataGrid"});
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["template"], init:function($name$$100$$, $value$$168$$, $element$$54$$, $widgetConstructor$$6$$, $valueAccessor$$10$$, $allBindingsAccessor$$9$$, $bindingContext$$32$$) {
    return "template" === $name$$100$$ ? {_templateFunction:$_getDiagramNodeRenderer$$($bindingContext$$32$$, $value$$168$$)} : null;
  }, update:function($name$$101$$, $value$$169$$, $element$$55$$, $widgetConstructor$$7$$, $valueAccessor$$11$$, $allBindingsAccessor$$10$$, $bindingContext$$33$$) {
    return "template" === $name$$101$$ ? {_templateFunction:$_getDiagramNodeRenderer$$($bindingContext$$33$$, $value$$169$$)} : null;
  }, "for":"ojDiagram"});
  (function() {
  ...
  $oj$$7$$.$koStringTemplateEngine$.$install$ = function $$oj$$7$$$$koStringTemplateEngine$$$install$$() {
    if (!$ko$$1$$.templates) {
      var $_templateText$$ = {}, $_templateData$$ = {}, $_engine$$ = new $ko$$1$$.nativeTemplateEngine, $StringTemplate$$ = function $$StringTemplate$$$($template$$14$$) {
        this.$_templateName$ = $template$$14$$;
        this.text = function $this$text$($value$$170$$) {
          if (!$value$$170$$) {
            return $_templateText$$[this.$_templateName$];
          }
          $_templateText$$[this.$_templateName$] = $value$$170$$;
        };
        this.data = function $this$data$($key$$46$$, $value$$171$$) {
          $_templateData$$[this.$_templateName$] || ($_templateData$$[this.$_templateName$] = {});
          if (1 === arguments.length) {
            return $_templateData$$[this.$_templateName$][$key$$46$$];
          }
          $_templateData$$[this.$_templateName$][$key$$46$$] = $value$$171$$;
        };
      };
      $_engine$$.makeTemplateSource = function $$_engine$$$makeTemplateSource$($template$$15$$, $templateDocument$$) {
        if ("string" == typeof $template$$15$$) {
          $templateDocument$$ = $templateDocument$$ || document;
          var $elem$$21$$ = $templateDocument$$.getElementById($template$$15$$);
          return $elem$$21$$ ? new $ko$$1$$.templateSources.domElement($elem$$21$$) : new $StringTemplate$$($template$$15$$);
        }
        if ($template$$15$$ && 1 == $template$$15$$.nodeType || 8 == $template$$15$$.nodeType) {
          return new $ko$$1$$.templateSources.anonymousTemplate($template$$15$$);
        }
      };
  ...
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["item"], init:function($name$$102_result$$17$$, $value$$172$$, $element$$56$$, $widgetConstructor$$8$$, $valueAccessor$$12$$, $allBindingsAccessor$$11$$, $bindingContext$$34$$) {
    $name$$102_result$$17$$ = $_handleListViewManagedAttributes$$($name$$102_result$$17$$, $value$$172$$, $bindingContext$$34$$);
    if (null != $name$$102_result$$17$$) {
      return $name$$102_result$$17$$;
    }
  }, update:function($name$$103$$, $value$$173$$, $element$$57$$, $widgetConstructor$$9$$, $valueAccessor$$13$$, $allBindingsAccessor$$12$$, $bindingContext$$35$$) {
    return $_handleListViewManagedAttributes$$($name$$103$$, $value$$173$$, $bindingContext$$35$$);
  ...
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["center"], init:function($name$$104$$, $value$$174$$, $element$$58$$, $widgetConstructor$$10$$, $valueAccessor$$14$$, $allBindingsAccessor$$13$$, $bindingContext$$36$$) {
    return $_handleManagedGaugeAttributes$$($name$$104$$, $value$$174$$, $bindingContext$$36$$);
  }, update:function($name$$105$$, $value$$175$$, $element$$59$$, $widgetConstructor$$11$$, $valueAccessor$$15$$, $allBindingsAccessor$$14$$, $bindingContext$$37$$) {
    return $_handleManagedGaugeAttributes$$($name$$105$$, $value$$175$$, $bindingContext$$37$$);
  }, "for":"ojStatusMeterGauge"});
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["columns", "columnsDefault", "rowTemplate"], init:function($name$$106$$, $value$$176$$, $element$$60_i$$132$$, $template$$16_widgetConstructor$$12$$, $footerTemplate_valueAccessor$$16$$, $allBindingsAccessor$$15_headerTemplate$$, $bindingContext$$38$$) {
    if ("columns" == $name$$106$$ || "columnsDefault" == $name$$106$$) {
      for ($element$$60_i$$132$$ = 0;$element$$60_i$$132$$ < $value$$176$$.length;$element$$60_i$$132$$++) {
        var $column$$2$$ = $value$$176$$[$element$$60_i$$132$$];
        $template$$16_widgetConstructor$$12$$ = $column$$2$$.template;
        $footerTemplate_valueAccessor$$16$$ = $column$$2$$.footerTemplate;
        $allBindingsAccessor$$15_headerTemplate$$ = $column$$2$$.headerTemplate;
        null != $template$$16_widgetConstructor$$12$$ && ($column$$2$$.renderer = $_getTableColumnTemplateRenderer$$($bindingContext$$38$$, "cell", $template$$16_widgetConstructor$$12$$));
        null != $footerTemplate_valueAccessor$$16$$ && ($column$$2$$.footerRenderer = $_getTableColumnTemplateRenderer$$($bindingContext$$38$$, "footer", $footerTemplate_valueAccessor$$16$$));
        null != $allBindingsAccessor$$15_headerTemplate$$ && ($column$$2$$.headerRenderer = $_getTableColumnTemplateRenderer$$($bindingContext$$38$$, "header", $allBindingsAccessor$$15_headerTemplate$$));
      }
      return "columns" == $name$$106$$ ? {columns:$value$$176$$} : {columnsDefault:$value$$176$$};
    }
    if ("rowTemplate" == $name$$106$$) {
      return{rowRenderer:$_getTableRowTemplateRenderer$$($bindingContext$$38$$, $value$$176$$)};
    }
  }, update:function($name$$107$$, $value$$177$$, $element$$61_i$$133$$, $widgetConstructor$$13$$, $template$$17_valueAccessor$$17$$, $allBindingsAccessor$$16_footerTemplate$$1$$, $bindingContext$$39$$) {
    if ("columns" == $name$$107$$ || "columnsDefault" == $name$$107$$) {
      var $headerTemplate$$1$$;
      for ($element$$61_i$$133$$ = 0;$element$$61_i$$133$$ < $value$$177$$.length;$element$$61_i$$133$$++) {
        var $column$$3$$ = $value$$177$$[$element$$61_i$$133$$];
        $template$$17_valueAccessor$$17$$ = $column$$3$$.template;
        $allBindingsAccessor$$16_footerTemplate$$1$$ = $column$$3$$.footerTemplate;
        $headerTemplate$$1$$ = $column$$3$$.headerTemplate;
        null != $template$$17_valueAccessor$$17$$ && ($column$$3$$.renderer = $_getTableColumnTemplateRenderer$$($bindingContext$$39$$, "cell", $template$$17_valueAccessor$$17$$));
        null != $allBindingsAccessor$$16_footerTemplate$$1$$ && ($column$$3$$.footerRenderer = $_getTableColumnTemplateRenderer$$($bindingContext$$39$$, "footer", $allBindingsAccessor$$16_footerTemplate$$1$$));
        null != $headerTemplate$$1$$ && ($column$$3$$.headerRenderer = $_getTableColumnTemplateRenderer$$($bindingContext$$39$$, "header", $headerTemplate$$1$$));
      }
      "columns" == $name$$107$$ ? $widgetConstructor$$13$$({columns:$value$$177$$}) : $widgetConstructor$$13$$({columnsDefault:$value$$177$$});
    } else {
      if ("rowTemplate" == $name$$107$$) {
        return{rowRenderer:$_getTableRowTemplateRenderer$$($bindingContext$$39$$, $value$$177$$)};
      }
    }
    return null;
  }, "for":"ojTable"});
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["areaLayers", "pointDataLayers"], init:function($name$$108$$, $value$$178$$, $element$$62$$, $widgetConstructor$$14$$, $valueAccessor$$18$$, $allBindingsAccessor$$17$$, $bindingContext$$40$$) {
    return $_handleManagedAttributes$$($name$$108$$, $value$$178$$, $bindingContext$$40$$);
  }, update:function($name$$109$$, $value$$179$$, $element$$63$$, $widgetConstructor$$15$$, $valueAccessor$$19$$, $allBindingsAccessor$$18$$, $bindingContext$$41$$) {
    return $_handleManagedAttributes$$($name$$109$$, $value$$179$$, $bindingContext$$41$$);
  }, "for":"ojThematicMap"});
});
