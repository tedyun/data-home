...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "ojs/ojradiocheckbox"], function($oj$$28$$, $$$$27$$) {
  (function() {
    $oj$$28$$.$__registerWidget$("oj.ojCheckboxset", $$$$27$$.oj.editableValue, {version:"1.0.0", defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{disabled:!1, value:void 0}, refresh:function() {
      ...
      var $allcheckboxes_first$$6_name$$120$$ = this.element.find("input[type\x3dcheckbox]:first");
      0 === $allcheckboxes_first$$6_name$$120$$.length && $oj$$28$$.$Logger$.warn("Could not find any input type\x3dcheckbox within this element");
      $allcheckboxes_first$$6_name$$120$$ = $allcheckboxes_first$$6_name$$120$$.attr("name");
      return void 0 === $allcheckboxes_first$$6_name$$120$$ ? ($allcheckboxes_first$$6_name$$120$$ = this.element.find("input[type\x3dcheckbox]"), $allcheckboxes_first$$6_name$$120$$.not("[name]")) : this.element.find("input[type\x3dcheckbox][name\x3d" + $allcheckboxes_first$$6_name$$120$$ + "]");
    ...
    }, _setOption:function($key$$141$$, $value$$261$$, $flags$$36$$) {
      this._super($key$$141$$, $value$$261$$, $flags$$36$$);
      "disabled" === $key$$141$$ && this.$_propagateDisabled$($value$$261$$);
