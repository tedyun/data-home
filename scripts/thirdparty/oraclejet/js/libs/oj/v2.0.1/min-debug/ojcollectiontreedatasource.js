...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common", "ojs/ojmodel"], function($oj$$33$$) {
  ...
  $oj$$33$$.$CollectionNodeSet$.prototype.$FetchChildNodeSet$ = function $$oj$$33$$$$CollectionNodeSet$$$$FetchChildNodeSet$$($index$$202$$, $callbacks$$36$$) {
    var $model$$73_parentKey$$7$$ = this.$collection$.at($index$$202$$);
    if (this.$treeDataSource$.$parseMetadata$($model$$73_parentKey$$7$$).leaf) {
      this.$childNodeSet$[$index$$202$$] = null, $callbacks$$36$$.success(null);
    } else {
      var $collection$$38$$ = this.$treeDataSource$.$GetChildCollection$($model$$73_parentKey$$7$$), $model$$73_parentKey$$7$$ = this.$treeDataSource$.$parseMetadata$($model$$73_parentKey$$7$$).key, $self$$166$$ = this;
  ...
  $oj$$33$$.$CollectionNodeSet$.prototype.getMetadata = function $$oj$$33$$$$CollectionNodeSet$$$getMetadata$($index$$205_model$$74_parse$$6$$) {
    this.$_checkRange$($index$$205_model$$74_parse$$6$$);
    var $metadata$$13$$ = {};
    $index$$205_model$$74_parse$$6$$ = this.$collection$.at($index$$205_model$$74_parse$$6$$);
    $index$$205_model$$74_parse$$6$$ = this.$treeDataSource$.$parseMetadata$($index$$205_model$$74_parse$$6$$);
    $metadata$$13$$.key = $index$$205_model$$74_parse$$6$$.key;
    $metadata$$13$$.leaf = $index$$205_model$$74_parse$$6$$.leaf;
    $metadata$$13$$.depth = $index$$205_model$$74_parse$$6$$.depth;
    return $metadata$$13$$;
  };
  ...
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$parseMetadata$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$parseMetadata$$($model$$75$$) {
    return{key:$model$$75$$.idAttribute + "\x3d" + $model$$75$$.id};
  };
  ...
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$getChildCollection$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$getChildCollection$$($key$$147$$, $callbacks$$37$$) {
    this.$fetchChildren$($key$$147$$, null, {success:function($nodeSet$$24$$) {
  ...
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$ModelAdded$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$ModelAdded$$($event$$409_model$$76$$, $collection$$40_parents$$4$$, $options$$314$$) {
    var $index$$207$$ = 0;
    $options$$314$$ && $options$$314$$.at && ($index$$207$$ = $options$$314$$.at);
    $collection$$40_parents$$4$$ = this.$_getParentChain$($collection$$40_parents$$4$$);
    $event$$409_model$$76$$ = this.$_createEvent$(this, "insert", $index$$207$$, $collection$$40_parents$$4$$, this.$_putModelInNodeSet$(null != $collection$$40_parents$$4$$ && 0 < $collection$$40_parents$$4$$.length ? $collection$$40_parents$$4$$[$collection$$40_parents$$4$$.length - 1] : null, $event$$409_model$$76$$));
    this.handleEvent("change", $event$$409_model$$76$$);
  };
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$ModelRemoved$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$ModelRemoved$$($event$$410_model$$77$$, $collection$$41$$, $options$$315$$) {
    var $index$$208$$ = 0;
    $options$$315$$ && $options$$315$$.index && ($index$$208$$ = $options$$315$$.index);
    this.$_removeCollectionFromCache$($event$$410_model$$77$$);
    $event$$410_model$$77$$ = this.$_createEvent$(this, "delete", $index$$208$$, this.$_getParentChain$($collection$$41$$), null);
    this.handleEvent("change", $event$$410_model$$77$$);
  };
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$ModelUpdated$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$ModelUpdated$$($event$$411_model$$78$$) {
    var $collectionForModel$$ = this.$_getCollectionForModel$($event$$411_model$$78$$), $index$$209$$ = null, $parents$$5$$ = null;
    $collectionForModel$$ && ($index$$209$$ = $collectionForModel$$.index, $parents$$5$$ = this.$_getParentChain$($collectionForModel$$.$collection$));
    $event$$411_model$$78$$ = this.$_createEvent$(this, "update", $index$$209$$, $parents$$5$$, this.$_putModelInNodeSet$(null != $parents$$5$$ && 0 < $parents$$5$$.length ? $parents$$5$$[$parents$$5$$.length - 1] : null, $event$$411_model$$78$$));
    this.handleEvent("change", $event$$411_model$$78$$);
  };
  ...
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$_putModelInNodeSet$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$_putModelInNodeSet$$($parent$$36$$, $model$$79$$) {
    var $collection$$43$$ = new $oj$$33$$.$Collection$;
    $collection$$43$$.add($model$$79$$);
  ...
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$_getCacheKey$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$_getCacheKey$$($model$$80$$) {
    var $key$$148$$ = $model$$80$$ instanceof $oj$$33$$.$Model$ ? this.$parseMetadata$($model$$80$$).key : $model$$80$$;
    return $model$$80$$ ? $key$$148$$ : $oj$$33$$.$CollectionTreeDataSource$.$ROOT_CACHE_KEY$;
  };
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$__getParentsChildCollectionFromCache$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$__getParentsChildCollectionFromCache$$($model$$81$$) {
    return this.$cache$[this.$_getCacheKey$($model$$81$$)];
  };
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$_setCollectionInCache$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$_setCollectionInCache$$($model$$82$$, $collection$$45$$) {
    ...
    this.$cache$[this.$_getCacheKey$($model$$82$$)] = $collection$$45$$;
  };
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$_removeCollectionFromCache$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$_removeCollectionFromCache$$($key$$149_model$$83$$) {
    $key$$149_model$$83$$ = this.$_getCacheKey$($key$$149_model$$83$$);
    for (var $prop$$66$$ in this.$cache$) {
      if (this.$cache$.hasOwnProperty($prop$$66$$) && $prop$$66$$ === $key$$149_model$$83$$) {
        this.$cache$[$key$$149_model$$83$$].off(null, null, this);
        delete this.$cache$[$key$$149_model$$83$$];
        break;
      }
    }
  };
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$_keyInCollection$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$_keyInCollection$$($key$$150$$, $collection$$46$$) {
  ...
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$_getCollectionForModel$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$_getCollectionForModel$$($model$$84$$) {
    for (var $prop$$67$$ in this.$cache$) {
      if (this.$cache$.hasOwnProperty($prop$$67$$)) {
        for (var $collection$$47$$ = this.$cache$[$prop$$67$$], $i$$334$$ = 0;$i$$334$$ < $collection$$47$$.length;$i$$334$$++) {
          if ($collection$$47$$.at($i$$334$$) === $model$$84$$) {
  ...
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$_getCollectionOfKey$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$_getCollectionOfKey$$($key$$151$$) {
    for (var $prop$$68$$ in this.$cache$) {
      if (this.$cache$.hasOwnProperty($prop$$68$$)) {
        var $collection$$48$$ = this.$cache$[$prop$$68$$];
        if (this.$_keyInCollection$($key$$151$$, $collection$$48$$)) {
  ...
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$_scanForKey$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$_scanForKey$$($collection$$53$$, $key$$152$$) {
    var $self$$169$$ = this;
    return new Promise(function($resolve$$47$$) {
      function $checkNext$$($index$$211$$, $collection$$54$$, $key$$153$$) {
        $index$$211$$ < $collection$$54$$.length ? $collection$$54$$.at($index$$211$$, {deferred:!0}).then(function($model$$85$$) {
          if ($model$$85$$) {
            var $parse$$7$$ = $self$$169$$.$parseMetadata$($model$$85$$);
            if ($key$$153$$ === $parse$$7$$.key) {
              $resolve$$47$$($model$$85$$);
              return;
            }
          }
          $index$$211$$++;
          $checkNext$$($index$$211$$, $collection$$54$$, $key$$153$$);
        }) : $resolve$$47$$(null);
      }
      $checkNext$$(0, $collection$$53$$, $key$$152$$);
    });
  };
  $oj$$33$$.$CollectionTreeDataSource$.prototype.$_getModelForId$ = function $$oj$$33$$$$CollectionTreeDataSource$$$$_getModelForId$$($collection$$55$$, $key$$154$$, $depth$$25$$) {
    var $self$$170$$ = this;
    return new Promise(function($resolve$$48$$) {
      $self$$170$$.$_scanForKey$($collection$$55$$, $key$$154$$).then(function($model$$86$$) {
        function $getNextCollection$$($index$$212$$, $tds$$) {
          if ($index$$212$$ < $max$$7$$) {
            ...
            $childColl$$1$$.$collection$ ? $tds$$.$_fetch$($childColl$$1$$, function($fetchColl$$) {
              $tds$$.$_getModelForId$($fetchColl$$, $key$$154$$, $depth$$25$$ + 1).then(function($childModel$$) {
        ...
        if ($model$$86$$) {
          $resolve$$48$$({$model$:$model$$86$$, depth:$depth$$25$$});
        } else {
  ...
  $oj$$33$$.$CollectionTreeDataSource$.prototype.sort = function $$oj$$33$$$$CollectionTreeDataSource$$$sort$($criteria$$6$$, $callbacks$$41$$) {
    var $key$$155$$ = $criteria$$6$$.key, $dir$$1$$ = $criteria$$6$$.direction, $needSort$$2$$ = !1;
    $key$$155$$ !== this.$sortkey$ && (this.$sortkey$ = $key$$155$$, $needSort$$2$$ = !0);
