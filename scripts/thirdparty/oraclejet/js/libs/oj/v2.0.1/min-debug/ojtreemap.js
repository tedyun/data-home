 ...
 */
"use strict";
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtTreeView"], function($oj$$81$$, $$$$74$$, $comp$$20$$, $base$$15$$, $dvt$$12$$) {
  $oj$$81$$.$__registerWidget$("oj.ojTreemap", $$$$74$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{optionChange:null}, $_CreateDvtComponent$:function($context$$176$$, $callback$$134$$, $callbackObj$$15$$) {
    return $dvt$$12$$.Treemap.newInstance($context$$176$$, $callback$$134$$, $callbackObj$$15$$);
  ...
  }, getContextByNode:function($context$$177_node$$182$$) {
    return($context$$177_node$$182$$ = this.getSubIdByNode($context$$177_node$$182$$)) && "oj-treemap-tooltip" !== $context$$177_node$$182$$.subId ? $context$$177_node$$182$$ : null;
