...
define(["ojs/ojcore", "jquery", "ojs/internal-deps/datagrid/DvtDataGrid", "promise", "ojs/ojcomponentcore", "ojs/ojdatasource-common", "ojs/ojarraydatagriddatasource", "ojs/ojflattenedtreedatagriddatasource", "ojs/ojpagingdatagriddatasource", "ojs/ojinputnumber", "ojs/ojmenu", "ojs/ojdialog", "ojs/ojpagingcontrol"], function($oj$$11$$, $$$$11$$, $DvtDataGrid$$1$$) {
  ...
  height:"disable"}, sortable:"auto", style:null}}, cell:{className:null, renderer:null, style:null}, resize:null, sort:null, optionChange:null, ready:null, scroll:null, beforeCurrentCell:null}, _ComponentCreate:function() {
    ...
    var $i$$138$$, $key$$52$$, $isRefresh$$1$$, $elm$$, $itm$$, $opt$$19$$;
    $isRefresh$$1$$ = !1;
    ...
    var $value$$185$$ = $$$$11$$("#" + this.$rootId$ + "spinner").ojInputNumber("option", "value");
    $$$$11$$("#" + this.$rootId$ + "dialog").ojDialog("close");
    this.grid.handleContextMenuReturn(this.$contextMenuEvent$, this.$menuItemFunction$, $value$$185$$);
  ...
  }, $_findCellIndex$:function($columnIndex_element$$69$$) {
    var $row$$2$$;
    $row$$2$$ = $columnIndex_element$$69$$.parent();
    $columnIndex_element$$69$$ = $columnIndex_element$$69$$.index();
    return{rowIndex:$row$$2$$.index(), columnIndex:$columnIndex_element$$69$$};
  ...
  }, $_modifyContext$:function($context$$51$$) {
    $context$$51$$.component = $oj$$11$$.Components.$getWidgetConstructor$(this.element, "ojDataGrid");
  }, $_setAccessibleContext$:function($context$$52$$) {
    this.grid.SetAccessibleContext($context$$52$$);
  }, $_unregisterResizeListener$:function($element$$70$$) {
    $element$$70$$ && this.$_resizeHandler$ && $oj$$11$$.$DomUtils$.$removeResizeListener$($element$$70$$, this.$_resizeHandler$);
  }, $_registerResizeListener$:function($element$$71$$) {
    $element$$71$$ && (null == this.$_resizeHandler$ && (this.$_resizeHandler$ = this.$_handleResize$.bind(this)), $oj$$11$$.$DomUtils$.$addResizeListener$($element$$71$$, this.$_resizeHandler$));
    ...
    var $cell_context$$53$$, $header$$5$$;
    $cell_context$$53$$ = $$$$11$$($indexes_node$$30_subId$$7$$).closest("." + this.$_getMappedStyle$("cell"));
    if (0 < $cell_context$$53$$.length) {
      return $indexes_node$$30_subId$$7$$ = this.$_findCellIndex$($cell_context$$53$$), {subId:"oj-datagrid-cell", rowIndex:$indexes_node$$30_subId$$7$$.rowIndex + this.grid.getStartRow(), columnIndex:$indexes_node$$30_subId$$7$$.columnIndex + this.grid.getStartColumn()};
    }
    $header$$5$$ = $$$$11$$($indexes_node$$30_subId$$7$$).closest("." + this.$_getMappedStyle$("headercell"));
    return 0 < $header$$5$$.length ? ($cell_context$$53$$ = $header$$5$$[0][this.$_getMappedAttribute$("context")], $indexes_node$$30_subId$$7$$ = $$$$11$$($indexes_node$$30_subId$$7$$).hasClass(this.$_getMappedStyle$("sortascending")) ? "oj-datagrid-sort-ascending" : $$$$11$$($indexes_node$$30_subId$$7$$).hasClass(this.$_getMappedStyle$("sortdescending")) ? "oj-datagrid-sort-descending" : "oj-datagrid-header", {subId:$indexes_node$$30_subId$$7$$, axis:$cell_context$$53$$.axis, index:this.$_getHeaderIndex$($header$$5$$), 
    level:$cell_context$$53$$.level}) : null;
  }, getContextByNode:function($context$$54_node$$31$$) {
    var $cell$$1_header$$6_index$$99$$;
    $cell$$1_header$$6_index$$99$$ = $$$$11$$($context$$54_node$$31$$).closest("." + this.$_getMappedStyle$("cell"));
    if (0 < $cell$$1_header$$6_index$$99$$.length) {
      return $context$$54_node$$31$$ = $cell$$1_header$$6_index$$99$$[0][this.$_getMappedAttribute$("context")], $cell$$1_header$$6_index$$99$$ = this.$_findCellIndex$($cell$$1_header$$6_index$$99$$), {subId:"oj-datagrid-cell", component:$context$$54_node$$31$$.component, data:$context$$54_node$$31$$.data, datasource:$context$$54_node$$31$$.datasource, indexes:{row:$cell$$1_header$$6_index$$99$$.rowIndex + this.grid.getStartRow(), column:$cell$$1_header$$6_index$$99$$.columnIndex + this.grid.getStartColumn()}, 
      keys:{row:$context$$54_node$$31$$.keys.row, column:$context$$54_node$$31$$.keys.column}};
    }
    $cell$$1_header$$6_index$$99$$ = $$$$11$$($context$$54_node$$31$$).closest("." + this.$_getMappedStyle$("headercell"));
    return 0 < $cell$$1_header$$6_index$$99$$.length ? ($context$$54_node$$31$$ = $cell$$1_header$$6_index$$99$$[0][this.$_getMappedAttribute$("context")], {subId:"oj-datagrid-header", axis:$context$$54_node$$31$$.axis, component:$context$$54_node$$31$$.component, data:$context$$54_node$$31$$.data, datasource:$context$$54_node$$31$$.datasource, depth:$context$$54_node$$31$$.depth, extent:$context$$54_node$$31$$.extent, index:this.$_getHeaderIndex$($cell$$1_header$$6_index$$99$$), key:$context$$54_node$$31$$.key, 
    level:$context$$54_node$$31$$.level}) : null;
  ...
  }, $_remove$:function($element$$72$$) {
    $$$$11$$($element$$72$$).remove();
