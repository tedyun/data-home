...
define(["ojs/ojcore", "jquery", "hammerjs", "promise", "ojs/ojjquery-hammer", "ojs/ojcomponentcore"], function($oj$$45$$, $$$$42$$, $Hammer$$3$$) {
  ...
  $oj$$45$$.$ListViewIndexerModel$.prototype.$_getAvailablePrefixes$ = function $$oj$$45$$$$ListViewIndexerModel$$$$_getAvailablePrefixes$$() {
    ...
    if (null != $groupItems$$5$$) {
      for (var $prefixes$$1$$ = this.getIndexablePrefixes(), $i$$374$$ = 0;$i$$374$$ < $prefixes$$1$$.length;$i$$374$$++) {
        var $prefix$$19$$ = $prefixes$$1$$[$i$$374$$];
  ...
  $oj$$45$$.$ListViewIndexerModel$.prototype.$_setOtherPrefix$ = function $$oj$$45$$$$ListViewIndexerModel$$$$_setOtherPrefix$$() {
    var $prefixes$$2$$, $self$$191$$ = this, $match$$24$$, $groupItems$$6$$, $content$$26$$, $i$$375$$, $prefix$$21$$;
    ...
    return new Promise(function($resolve$$59$$) {
      ...
      null != $groupItems$$6$$ && $groupItems$$6$$.each(function() {
        ...
        for ($i$$375$$ = 0;$i$$375$$ < $prefixes$$2$$.length;$i$$375$$++) {
          if ($prefix$$21$$ = $prefixes$$2$$[$i$$375$$], 0 == $content$$26$$.indexOf($prefix$$21$$)) {
            return!0;
          }
        }
        $match$$24$$ = this;
  ...
  (function() {
    $oj$$45$$.$__registerWidget$("oj.ojIndexer", $$$$42$$.oj.baseComponent, {defaultElement:"\x3cul\x3e", version:"1.2", widgetEventPrefix:"oj", options:{data:null}, _ComponentCreate:function() {
      ...
      $model$$91$$ = this.$_getIndexerModel$();
      null != $model$$91$$ && this.$m_indexerModelListener$ && $model$$91$$.off($oj$$45$$.$IndexerModel$.$EventType$.$CHANGE$, this.$m_indexerModelListener$);
      $oj$$45$$.$DomUtils$.unwrap(this.element, $$$$42$$($container$$29$$));
    }, _setOption:function($key$$162$$, $value$$283$$) {
      this._superApply(arguments);
      "data" == $key$$162$$ && this.refresh();
    }, widget:function() {
      ...
      var $prefixes$$4$$, $i$$376$$, $j$$44$$, $node$$99$$, $includes$$;
      if (null == $locator$$41_prefix$$24$$) {
        return this.element ? this.element[0] : null;
      }
      if ("oj-indexer-prefix" === $locator$$41_prefix$$24$$.subId) {
        for ($locator$$41_prefix$$24$$ = $locator$$41_prefix$$24$$.prefix, $prefixes$$4$$ = this.element.children("li"), $i$$376$$ = 0;$i$$376$$ < $prefixes$$4$$.length;$i$$376$$++) {
          $node$$99$$ = $prefixes$$4$$.get($i$$376$$);
      ...
      var $key$$163$$, $text$$18$$;
      $key$$163$$ = $oj$$45$$.$DomUtils$.$isTouchSupported$() ? "ariaTouchInstructionText" : "ariaKeyboardInstructionText";
      $text$$18$$ = $$$$42$$(document.createElement("div"));
      $text$$18$$.prop("id", this.element.prop("id") + ":desc");
      $text$$18$$.addClass("oj-helper-hidden-accessible").text(this.$getTranslatedString$($key$$163$$));
      ...
      var $model$$92_prefixOthers$$, $root$$13$$, $last$$5_others_prefixes$$5$$, $availablePrefixes$$, $height$$28_max$$8_skip$$2$$, $first$$8_i$$377_itemHeight$$, $item$$115_prefix$$26$$;
      $model$$92_prefixOthers$$ = this.$_getIndexerModel$();
      if (null != $model$$92_prefixOthers$$) {
        $root$$13$$ = this.element;
        $last$$5_others_prefixes$$5$$ = $model$$92_prefixOthers$$.getIndexablePrefixes();
        $availablePrefixes$$ = $model$$92_prefixOthers$$.getPrefixes();
        $model$$92_prefixOthers$$ = this.$getTranslatedString$("indexerOthers");
        $height$$28_max$$8_skip$$2$$ = this.widget().outerHeight();
        $first$$8_i$$377_itemHeight$$ = this.$_createItem$($last$$5_others_prefixes$$5$$[0], $availablePrefixes$$);
        $root$$13$$.append($first$$8_i$$377_itemHeight$$);
        $first$$8_i$$377_itemHeight$$ = $first$$8_i$$377_itemHeight$$.outerHeight();
        $height$$28_max$$8_skip$$2$$ = Math.floor($height$$28_max$$8_skip$$2$$ / $first$$8_i$$377_itemHeight$$);
        ...
        for ($first$$8_i$$377_itemHeight$$ = 1 + $height$$28_max$$8_skip$$2$$;$first$$8_i$$377_itemHeight$$ < $last$$5_others_prefixes$$5$$.length;$first$$8_i$$377_itemHeight$$ = $first$$8_i$$377_itemHeight$$ + $height$$28_max$$8_skip$$2$$ + 1) {
          1 < $height$$28_max$$8_skip$$2$$ ? ($item$$115_prefix$$26$$ = this.$_createSeparator$($last$$5_others_prefixes$$5$$, $first$$8_i$$377_itemHeight$$ - $height$$28_max$$8_skip$$2$$, $first$$8_i$$377_itemHeight$$ - 1), $root$$13$$.append($item$$115_prefix$$26$$)) : $first$$8_i$$377_itemHeight$$--, $item$$115_prefix$$26$$ = $last$$5_others_prefixes$$5$$[$first$$8_i$$377_itemHeight$$], $item$$115_prefix$$26$$ = this.$_createItem$($item$$115_prefix$$26$$, $availablePrefixes$$), $root$$13$$.append($item$$115_prefix$$26$$)
          ;
        }
        ...
        $last$$5_others_prefixes$$5$$ = this.$_createItem$($model$$92_prefixOthers$$);
      ...
      return $item$$116$$;
    }, $_createSeparator$:function($indexString$$, $from$$3_i$$378$$, $to$$3$$) {
      var $item$$117$$, $includes$$1$$ = "";
      $item$$117$$ = $$$$42$$(document.createElement("li"));
      for ($item$$117$$.addClass("oj-indexer-ellipsis").attr("data-range", $indexString$$[$from$$3_i$$378$$ + Math.round(($to$$3$$ - $from$$3_i$$378$$) / 2)]);$from$$3_i$$378$$ < $to$$3$$;$from$$3_i$$378$$++) {
        $includes$$1$$ = $includes$$1$$ + $indexString$$[$from$$3_i$$378$$] + "|";
      }
      $includes$$1$$ += $indexString$$[$to$$3$$];
      $item$$117$$.attr("data-includes", $includes$$1$$);
      return $item$$117$$;
    }, $_setup$:function() {
      var $self$$193$$ = this, $model$$93$$;
      ...
      $model$$93$$ = this.$_getIndexerModel$();
      null != $model$$93$$ && (this.$m_indexerModelListener$ = function $this$$m_indexerModelListener$$() {
        $self$$193$$.refresh();
      }, $model$$93$$.on($oj$$45$$.$IndexerModel$.$EventType$.$CHANGE$, this.$m_indexerModelListener$));
      ...
      var $model$$94$$ = this.option("data");
      if (null != $model$$94$$ && (void 0 == $model$$94$$.setPrefix || void 0 == $model$$94$$.getIndexablePrefixes || void 0 == $model$$94$$.getPrefixes)) {
      ...
      var $children$$11$$, $i$$379$$, $item$$122$$, $value$$284$$, $includes$$3$$;
      $children$$11$$ = this.element.children();
      for ($i$$379$$ = 0;$i$$379$$ < $children$$11$$.length;$i$$379$$++) {
        if ($item$$122$$ = $children$$11$$.get($i$$379$$), $value$$284$$ = $$$$42$$($item$$122$$).attr("data-range"), $includes$$3$$ = $$$$42$$($item$$122$$).attr("data-includes"), null != $value$$284$$ && $value$$284$$ == $prefix$$30$$ || null != $includes$$3$$ && -1 < $includes$$3$$.indexOf($prefix$$30$$)) {
          return $$$$42$$($item$$122$$);
        }
      }
      return null;
    }, $_unregisterResizeListener$:function($element$$141$$) {
      $element$$141$$ && this.$_resizeHandler$ && $oj$$45$$.$DomUtils$.$removeResizeListener$($element$$141$$, this.$_resizeHandler$);
    }, $_registerResizeListener$:function($element$$142$$) {
      $element$$142$$ && (null == this.$_resizeHandler$ && (this.$_resizeHandler$ = this.$_handleResize$.bind(this)), $oj$$45$$.$DomUtils$.$addResizeListener$($element$$142$$, this.$_resizeHandler$));
    }, $_unregisterTouchHandler$:function($element$$143$$) {
      $$$$42$$($element$$143$$).off("panstart panmove panend");
    }, $_registerTouchHandler$:function($element$$144$$) {
      ...
      $$$$42$$($element$$144$$).$ojHammer$($options$$347$$).on("panstart", function($event$$499$$) {
