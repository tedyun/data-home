...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "ojs/ojradiocheckbox"], function($oj$$66$$, $$$$60$$) {
  (function() {
    $oj$$66$$.$__registerWidget$("oj.ojRadioset", $$$$60$$.oj.editableValue, {version:"1.0.0", defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{disabled:!1, value:void 0}, refresh:function() {
      ...
      var $element$$162$$ = this.element;
      this._super();
      if ($element$$162$$.is("fieldset")) {
        throw Error("ojRadioset cannot be bound to a fieldset. Use a div instead.");
      }
      this.$$radios$._ojRadioCheckbox();
      this.$uiRadioset$ = $element$$162$$.addClass("oj-radioset oj-component").attr("role", "radiogroup").wrapInner("\x3cdiv class\x3d'oj-radioset-wrapper'\x3e\x3c/div\x3e");
      ...
      var $allradios_element$$163$$ = this.element, $first$$11_name$$143$$ = $allradios_element$$163$$.find("input[type\x3dradio]:first");
      0 === $first$$11_name$$143$$.length && $oj$$66$$.$Logger$.warn("Could not find any input type\x3dradio within this element");
      $first$$11_name$$143$$ = $first$$11_name$$143$$.attr("name");
      return void 0 === $first$$11_name$$143$$ ? ($allradios_element$$163$$ = $allradios_element$$163$$.find("input[type\x3dradio]"), $allradios_element$$163$$.not("[name]")) : $allradios_element$$163$$.find("input[type\x3dradio][name\x3d" + $first$$11_name$$143$$ + "]");
    ...
    }, _setOption:function($key$$180$$, $value$$309$$) {
      this._superApply(arguments);
      "disabled" === $key$$180$$ && this.$_propagateDisabled$($value$$309$$);
