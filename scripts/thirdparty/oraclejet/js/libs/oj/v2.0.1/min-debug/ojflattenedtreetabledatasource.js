...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common"], function($oj$$44$$) {
  $oj$$44$$.$FlattenedTreeTableDataSource$ = function $$oj$$44$$$$FlattenedTreeTableDataSource$$($data$$161$$, $options$$340$$) {
    ...
    var $self$$187$$ = this;
    this.$_data$.$insertRows$ = function $this$$_data$$$insertRows$$($insertAtIndex$$2$$, $i$$367_insertAtKey$$1$$, $nodeSet$$33$$) {
      var $row$$48$$, $rowIdx$$40$$, $rowKey$$41$$, $rowArray$$14$$ = [], $keyArray$$6$$ = [], $indexArray$$5$$ = [];
      for ($i$$367_insertAtKey$$1$$ = 0;$i$$367_insertAtKey$$1$$ < $nodeSet$$33$$.$getCount$();$i$$367_insertAtKey$$1$$++) {
        $row$$48$$ = $nodeSet$$33$$.getData($i$$367_insertAtKey$$1$$), $rowKey$$41$$ = $nodeSet$$33$$.getMetadata($i$$367_insertAtKey$$1$$).key, $rowIdx$$40$$ = $insertAtIndex$$2$$ + $i$$367_insertAtKey$$1$$, $self$$187$$.$_nodeSetList$[$rowIdx$$40$$] = {}, $self$$187$$.$_nodeSetList$[$rowIdx$$40$$].nodeSet = $nodeSet$$33$$, $self$$187$$.$_nodeSetList$[$rowIdx$$40$$].startIndex = $insertAtIndex$$2$$, $rowArray$$14$$.push($row$$48$$), $keyArray$$6$$.push($rowKey$$41$$), $indexArray$$5$$.push($rowIdx$$40$$), 
    ...
    this.$_data$.$removeRows$ = function $this$$_data$$$removeRows$$($rowKeys$$2$$) {
      var $i$$368$$, $rowIdx$$41$$, $rowArray$$15$$ = [], $keyArray$$7$$ = [], $indexArray$$6$$ = [];
      for ($i$$368$$ = 0;$i$$368$$ < $rowKeys$$2$$.length;$i$$368$$++) {
        $rowIdx$$41$$ = $rowKeys$$2$$[$i$$368$$].index - $i$$368$$, $rowArray$$15$$.push(""), $keyArray$$7$$.push(""), $indexArray$$6$$.push($rowIdx$$41$$), $self$$187$$.$_rows$.data.splice($rowIdx$$41$$, 1), $self$$187$$.$_rows$.keys.splice($rowIdx$$41$$, 1), $self$$187$$.$_rows$.indexes.splice($rowIdx$$41$$, 1);
      }
  ...
  $oj$$44$$.$FlattenedTreeTableDataSource$.prototype.at = function $$oj$$44$$$$FlattenedTreeTableDataSource$$$at$($index$$222$$) {
    var $row$$50$$;
    $row$$50$$ = 0 > $index$$222$$ || $index$$222$$ >= this.$_rows$.length ? null : {data:this.$_rows$.data[$index$$222$$], index:$index$$222$$, key:this.$_rows$.keys[$index$$222$$]};
  ...
  $oj$$44$$.$FlattenedTreeTableDataSource$.prototype.sort = function $$oj$$44$$$$FlattenedTreeTableDataSource$$$sort$($criteria$$8$$) {
    ...
    return new Promise(function($resolve$$57$$, $reject$$53$$) {
      $self$$189$$.$_data$.getWrappedDataSource().sort($criteria$$8$$, {success:function() {
        setTimeout(function() {
          ...
          $oj$$44$$.$TableDataSource$.$superclass$.handleEvent.call($self$$189$$, $oj$$44$$.$TableDataSource$.$EventType$.SORT, $result$$71$$);
          $resolve$$57$$($result$$71$$);
        }, 0);
  ...
  $oj$$44$$.$FlattenedTreeTableDataSource$.prototype.$_fetchInternal$ = function $$oj$$44$$$$FlattenedTreeTableDataSource$$$$_fetchInternal$$($options$$344$$) {
    ...
    if (null != this.$_rows$) {
      if (null != this.$_pageSize$) {
        ...
        if (this.$_startIndex$ + this.$_pageSize$ - 1 <= $endIndex$$8_result$$72$$) {
          var $endIndex$$8_result$$72$$ = $oj$$44$$.$FlattenedTreeTableDataSource$.$_getEndIndex$(this.$_rows$, this.$_startIndex$, this.$_pageSize$), $rangeCount$$1_rowArray$$16$$ = [], $keyArray$$8$$ = [], $i$$369$$;
          for ($i$$369$$ = this.$_startIndex$;$i$$369$$ <= $endIndex$$8_result$$72$$;$i$$369$$++) {
            $rangeCount$$1_rowArray$$16$$[$i$$369$$ - this.$_startIndex$] = this.$_rows$.data[$i$$369$$], $keyArray$$8$$[$i$$369$$ - this.$_startIndex$] = this.$_getMetadata$($i$$369$$).key;
          }
          $endIndex$$8_result$$72$$ = {data:$rangeCount$$1_rowArray$$16$$, keys:$keyArray$$8$$, startIndex:this.$_startIndex$};
          this.$_endFetch$($options$$344$$, $endIndex$$8_result$$72$$, null);
          return Promise.resolve($endIndex$$8_result$$72$$);
        }
        this.$_startIndex$ <= $endIndex$$8_result$$72$$ && ($startIndex$$30$$ = $endIndex$$8_result$$72$$ + 1);
      } else {
    ...
    return new Promise(function($resolve$$58$$, $reject$$54$$) {
      $self$$190$$.$_data$.$fetchRows$($rangeOption$$, {success:function($endIndex$$9_nodeSet$$35_result$$73$$) {
        $self$$190$$.$_handleFetchRowsSuccess$($endIndex$$9_nodeSet$$35_result$$73$$, $startIndex$$30$$);
        $options$$344$$.refresh = !0;
        $endIndex$$9_nodeSet$$35_result$$73$$ = $oj$$44$$.$FlattenedTreeTableDataSource$.$_getEndIndex$($self$$190$$.$_rows$, $self$$190$$.$_startIndex$, $self$$190$$.$_pageSize$);
        var $rowArray$$17$$ = [], $keyArray$$9$$ = [], $i$$370$$;
        for ($i$$370$$ = $self$$190$$.$_startIndex$;$i$$370$$ <= $endIndex$$9_nodeSet$$35_result$$73$$;$i$$370$$++) {
          $rowArray$$17$$[$i$$370$$ - $self$$190$$.$_startIndex$] = $self$$190$$.$_rows$.data[$i$$370$$], $keyArray$$9$$[$i$$370$$ - $self$$190$$.$_startIndex$] = $self$$190$$.$_getMetadata$($i$$370$$).key;
        }
        $endIndex$$9_nodeSet$$35_result$$73$$ = {data:$rowArray$$17$$, keys:$keyArray$$9$$, startIndex:$self$$190$$.$_startIndex$};
        $self$$190$$.$_endFetch$($options$$344$$, $endIndex$$9_nodeSet$$35_result$$73$$, null);
        $resolve$$58$$($endIndex$$9_nodeSet$$35_result$$73$$);
      }.bind(this), error:function($error$$49$$) {
        $self$$190$$.$_endFetch$($options$$344$$, null, $error$$49$$);
        $reject$$54$$($error$$49$$);
      }.bind(this)});
    });
  };
  $oj$$44$$.$FlattenedTreeTableDataSource$.prototype.$_handleFetchRowsSuccess$ = function $$oj$$44$$$$FlattenedTreeTableDataSource$$$$_handleFetchRowsSuccess$$($nodeSet$$36$$, $startIndex$$31$$) {
    var $i$$371$$, $rowIdx$$42$$;
    for ($i$$371$$ = 0;$i$$371$$ < $nodeSet$$36$$.$getCount$();$i$$371$$++) {
      $rowIdx$$42$$ = $startIndex$$31$$ + $i$$371$$, this.$_nodeSetList$[$rowIdx$$42$$] = {}, this.$_nodeSetList$[$rowIdx$$42$$].nodeSet = $nodeSet$$36$$, this.$_nodeSetList$[$rowIdx$$42$$].startIndex = $startIndex$$31$$;
    }
  ...
  $oj$$44$$.$FlattenedTreeTableDataSource$.prototype.$_endFetch$ = function $$oj$$44$$$$FlattenedTreeTableDataSource$$$$_endFetch$$($options$$346$$, $result$$74$$, $error$$50$$) {
    null != $error$$50$$ ? $oj$$44$$.$TableDataSource$.$superclass$.handleEvent.call(this, $oj$$44$$.$TableDataSource$.$EventType$.ERROR, $error$$50$$) : $options$$346$$.silent || $oj$$44$$.$TableDataSource$.$superclass$.handleEvent.call(this, $oj$$44$$.$TableDataSource$.$EventType$.SYNC, $result$$74$$);
  };
  ...
  $oj$$44$$.$FlattenedTreeTableDataSource$.$_getRowArray$ = function $$oj$$44$$$$FlattenedTreeTableDataSource$$$_getRowArray$$($nodeSet$$37$$, $endIndex$$11_rowSet$$, $rows$$8$$) {
    ...
    var $i$$372$$;
    for ($i$$372$$ = $nodeSet$$37$$.$getStart$();$i$$372$$ <= $endIndex$$11_rowSet$$;$i$$372$$++) {
      var $row$$51$$ = $nodeSet$$37$$.getData($i$$372$$);
      $rows$$8$$.data[$i$$372$$] = $row$$51$$;
      $rows$$8$$.keys[$i$$372$$] = "";
      $rows$$8$$.indexes[$i$$372$$] = $i$$372$$;
    }
  };
  $oj$$44$$.$FlattenedTreeTableDataSource$.prototype.$_realignRowIndices$ = function $$oj$$44$$$$FlattenedTreeTableDataSource$$$$_realignRowIndices$$() {
    for (var $i$$373$$ = 0;$i$$373$$ < this.$_rows$.data.length;$i$$373$$++) {
      this.$_rows$.indexes[$i$$373$$] = $i$$373$$;
    }
  };
});
