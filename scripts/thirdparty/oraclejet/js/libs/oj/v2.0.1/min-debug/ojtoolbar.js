...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$76$$, $$$$69$$) {
  (function() {
    $oj$$76$$.$__registerWidget$("oj.ojToolbar", $$$$69$$.oj.baseComponent, {widgetEventPrefix:"oj", options:{chroming:"half"}, $_InitOptions$:function($originalDefaults$$20$$, $constructorOptions$$22$$) {
    ...
    }, _setOption:function($key$$185$$, $value$$316$$) {
      this._superApply(arguments);
      "disabled" === $key$$185$$ ? $oj$$76$$.$Logger$.warn("Caller attempted to set the 'disabled' option on Toolbar, but Toolbar does not support the 'disabled' option.  See API doc.  Ignoring the call.") : "chroming" === $key$$185$$ && (this.$$buttonsets$.ojButtonset("refresh"), this.$$topLevelButtons$.ojButton("refresh"));
    }, refresh:function() {
      this._super();
      this.$_setup$(!1);
      ...
      return $$button$$3$$.map(function($index$$295$$, $elem$$165$$) {
        if ("radio" != $elem$$165$$.type || $elem$$165$$.checked || "" == $elem$$165$$.name) {
          return $elem$$165$$;
        }
        var $$checkedRadio$$1_$radios$$inline_1096_name$$inline_1095$$ = $elem$$165$$.name;
        $$checkedRadio$$1_$radios$$inline_1096_name$$inline_1095$$ ? ($$checkedRadio$$1_$radios$$inline_1096_name$$inline_1095$$ = $$checkedRadio$$1_$radios$$inline_1096_name$$inline_1095$$.replace(/'/g, "\\'"), $$checkedRadio$$1_$radios$$inline_1096_name$$inline_1095$$ = $$enabledButtons$$2$$.filter(":radio[name\x3d'" + $$checkedRadio$$1_$radios$$inline_1096_name$$inline_1095$$ + "']:oj-button")) : $$checkedRadio$$1_$radios$$inline_1096_name$$inline_1095$$ = $$enabledButtons$$2$$.filter($elem$$165$$).filter(":oj-button");
        $$checkedRadio$$1_$radios$$inline_1096_name$$inline_1095$$ = $$checkedRadio$$1_$radios$$inline_1096_name$$inline_1095$$.filter(":checked");
        return $$checkedRadio$$1_$radios$$inline_1096_name$$inline_1095$$.length ? $$checkedRadio$$1_$radios$$inline_1096_name$$inline_1095$$[0] : $elem$$165$$;
      });
