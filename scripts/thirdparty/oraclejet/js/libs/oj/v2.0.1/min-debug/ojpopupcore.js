...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "jqueryui-amd/position"], function($oj$$62$$, $$$$56$$) {
  ...
  $oj$$62$$.$PopupServiceImpl$.prototype.$triggerOnDescendents$ = function $$oj$$62$$$$PopupServiceImpl$$$$triggerOnDescendents$$($layer$$3_popup$$7$$, $event$$585$$, $argsArray$$1$$) {
    var $context$$145$$ = {};
    $context$$145$$.event = $event$$585$$;
    $context$$145$$.argsArray = $argsArray$$1$$;
    $layer$$3_popup$$7$$ = $oj$$62$$.$ZOrderUtils$.$getFirstAncestorLayer$($layer$$3_popup$$7$$);
    $oj$$62$$.$ZOrderUtils$.$postOrderVisit$($layer$$3_popup$$7$$, this.$_triggerOnDescendentsVisitCallback$, $context$$145$$);
  };
  $oj$$62$$.$PopupServiceImpl$.prototype.$_triggerOnDescendentsVisitCallback$ = function $$oj$$62$$$$PopupServiceImpl$$$$_triggerOnDescendentsVisitCallback$$($layer$$4$$, $context$$146$$) {
    var $event$$586$$ = $context$$146$$.event, $argsArray$$2$$ = $context$$146$$.argsArray, $events$$10$$ = $oj$$62$$.$ZOrderUtils$.$getEvents$($layer$$4$$);
  ...
  $oj$$62$$.$PopupServiceImpl$.prototype.$_assertEventSink$ = function $$oj$$62$$$$PopupServiceImpl$$$$_assertEventSink$$() {
    ...
    if (!$docElement_hasPopupsOpen$$ && $callbackEventFilter_simpleTapRecognizer$$) {
      ...
      for (var $i$$427$$ = 0;$i$$427$$ < $oj$$62$$.$PopupServiceImpl$.$_REDISTRIBUTE_EVENTS$.length;$i$$427$$++) {
        var $event$$587$$ = $oj$$62$$.$PopupServiceImpl$.$_REDISTRIBUTE_EVENTS$[$i$$427$$];
      ...
      if ($docElement_hasPopupsOpen$$ && !$callbackEventFilter_simpleTapRecognizer$$) {
        ...
        for ($i$$427$$ = 0;$i$$427$$ < $oj$$62$$.$PopupServiceImpl$.$_REDISTRIBUTE_EVENTS$.length;$i$$427$$++) {
          $event$$587$$ = $oj$$62$$.$PopupServiceImpl$.$_REDISTRIBUTE_EVENTS$[$i$$427$$], $docElement_hasPopupsOpen$$.addEventListener($event$$587$$, $callbackEventFilter_simpleTapRecognizer$$, !0);
        }
  ...
  $oj$$62$$.$PopupServiceImpl$.prototype.$_eventFilterCallback$ = function $$oj$$62$$$$PopupServiceImpl$$$$_eventFilterCallback$$($event$$588$$) {
    var $context$$147_target$$102$$ = $$$$56$$($event$$588$$.target);
    if (!$oj$$62$$.$ZOrderUtils$.$hasPopupsOpen$()) {
      this.$_assertEventSink$();
    } else {
      if (!$oj$$62$$.$DomUtils$.$isChromeEvent$($event$$588$$) && ("focus" !== $event$$588$$.type || $context$$147_target$$102$$.is(":focusable"))) {
        var $defaultLayer$$ = $oj$$62$$.$ZOrderUtils$.$getDefaultLayer$();
        if ("keydown" === $event$$588$$.type && $oj$$62$$.$ZOrderUtils$.$hasModalDialogOpen$() && !$oj$$62$$.$DomUtils$.$isAncestor$($defaultLayer$$[0], $context$$147_target$$102$$[0])) {
          $oj$$62$$.$ZOrderUtils$.$eatEvent$($$$$56$$.Event($event$$588$$));
        } else {
          var $props$$28_targetWitinLayer$$ = $oj$$62$$.$ZOrderUtils$.$getFirstAncestorLayer$($context$$147_target$$102$$);
          ...
          if ("focus" !== $event$$588$$.type || "-1" !== $context$$147_target$$102$$.attr("tabindex")) {
            var $context$$147_target$$102$$ = {}, $props$$28_targetWitinLayer$$ = {}, $key$$176$$;
            for ($key$$176$$ in $event$$588$$) {
              $oj$$62$$.$PopupServiceImpl$.$_COPY_SAFE_EVENT_PROPERTIES$[$key$$176$$] && !$$$$56$$.isFunction($event$$588$$[$key$$176$$]) && ($props$$28_targetWitinLayer$$[$key$$176$$] = $event$$588$$[$key$$176$$]);
            }
            $context$$147_target$$102$$.event = $$$$56$$.Event($event$$588$$, $props$$28_targetWitinLayer$$);
            $oj$$62$$.$ZOrderUtils$.$postOrderVisit$($defaultLayer$$, $oj$$62$$.$PopupServiceImpl$.$_redistributeVisitCallback$, $context$$147_target$$102$$);
          }
        }
      }
    }
  };
  $oj$$62$$.$PopupServiceImpl$.$_redistributeVisitCallback$ = function $$oj$$62$$$$PopupServiceImpl$$$_redistributeVisitCallback$$($layer$$5$$, $context$$148$$) {
    var $events$$11$$ = $oj$$62$$.$ZOrderUtils$.$getEvents$($layer$$5$$), $event$$589$$ = $context$$148$$.event;
  ...
  $oj$$62$$.$PopupServiceImpl$.$_refreshVisitCallback$ = function $$oj$$62$$$$PopupServiceImpl$$$_refreshVisitCallback$$($layer$$6$$, $context$$149$$) {
    if (0 < $context$$149$$.level) {
  ...
  $oj$$62$$.$ZOrderUtils$.$_closeDescendantPopupsCallback$ = function $$oj$$62$$$$ZOrderUtils$$$_closeDescendantPopupsCallback$$($layer$$13$$, $context$$150$$) {
  ...
  $oj$$62$$.$ZOrderUtils$.$hasModalDialogOpen$ = function $$oj$$62$$$$ZOrderUtils$$$hasModalDialogOpen$$() {
    for (var $children$$30$$ = $oj$$62$$.$ZOrderUtils$.$getDefaultLayer$().children(), $i$$428$$ = $children$$30$$.length - 1;-1 < $i$$428$$;$i$$428$$--) {
      if ($$$$56$$($children$$30$$[$i$$428$$]).hasClass($oj$$62$$.$ZOrderUtils$.$_OVERLAY_SELECTOR$)) {
        return!0;
      }
    }
    return!1;
  ...
  $oj$$62$$.$ZOrderUtils$.$postOrderVisit$ = function $$oj$$62$$$$ZOrderUtils$$$postOrderVisit$$($layer$$17$$, $callback$$120$$, $context$$151$$) {
    $context$$151$$ || ($context$$151$$ = {});
    $context$$151$$.level = 0;
    $context$$151$$.type = $oj$$62$$.$ZOrderUtils$.$_VISIT_TRAVERSAL$.$POST_ORDER$;
    $oj$$62$$.$ZOrderUtils$.$_visitTree$($layer$$17$$, $callback$$120$$, $context$$151$$);
  };
  $oj$$62$$.$ZOrderUtils$.$preOrderVisit$ = function $$oj$$62$$$$ZOrderUtils$$$preOrderVisit$$($layer$$18$$, $callback$$121$$, $context$$152$$) {
    $context$$152$$ || ($context$$152$$ = {});
    $context$$152$$.level = 0;
    $context$$152$$.type = $oj$$62$$.$ZOrderUtils$.$_VISIT_TRAVERSAL$.$PRE_ORDER$;
    $oj$$62$$.$ZOrderUtils$.$_visitTree$($layer$$18$$, $callback$$121$$, $context$$152$$);
  };
  $oj$$62$$.$ZOrderUtils$.$_visitTree$ = function $$oj$$62$$$$ZOrderUtils$$$_visitTree$$($children$$31_layer$$19$$, $callback$$122$$, $context$$153$$) {
    var $level$$44$$ = $context$$153$$.level;
    $children$$31_layer$$19$$ = $children$$31_layer$$19$$.children();
    for (var $i$$429$$ = $children$$31_layer$$19$$.length - 1;-1 < $i$$429$$;$i$$429$$--) {
      var $child$$26$$ = $$$$56$$($children$$31_layer$$19$$[$i$$429$$]);
      if ($oj$$62$$.$ZOrderUtils$.$_hasSurrogate$($child$$26$$[0])) {
        var $vrtn$$;
        if ($context$$153$$.type === $oj$$62$$.$ZOrderUtils$.$_VISIT_TRAVERSAL$.$PRE_ORDER$) {
          $vrtn$$ = $callback$$122$$($child$$26$$, $context$$153$$);
        ...
        $context$$153$$.level = $level$$44$$ + 1;
        $vrtn$$ = $oj$$62$$.$ZOrderUtils$.$_visitTree$($child$$26$$, $callback$$122$$, $context$$153$$);
        $context$$153$$.level = $level$$44$$;
        if ($vrtn$$ === $oj$$62$$.$ZOrderUtils$.$VISIT_RESULT$.$COMPLETE$) {
          return $vrtn$$;
        }
        if ($context$$153$$.type === $oj$$62$$.$ZOrderUtils$.$_VISIT_TRAVERSAL$.$POST_ORDER$) {
          $vrtn$$ = $callback$$122$$($child$$26$$, $context$$153$$);
          if ($vrtn$$ === $oj$$62$$.$ZOrderUtils$.$VISIT_RESULT$.$COMPLETE$) {
            return $vrtn$$;
          }
  ...
  $oj$$62$$.$ZOrderUtils$.$_hasSurrogate$ = function $$oj$$62$$$$ZOrderUtils$$$_hasSurrogate$$($element$$156$$) {
    return 1 === $element$$156$$.nodeType && $element$$156$$.hasAttribute($oj$$62$$.$ZOrderUtils$.$_SURROGATE_ATTR$) ? !0 : !1;
  };
  ...
  $oj$$62$$.$ZOrderUtils$.$getOpenPopupCount$ = function $$oj$$62$$$$ZOrderUtils$$$getOpenPopupCount$$() {
    var $context$$154$$ = {popupCount:0}, $defaultLayer$$5$$ = $oj$$62$$.$ZOrderUtils$.$getDefaultLayer$();
    $oj$$62$$.$ZOrderUtils$.$preOrderVisit$($defaultLayer$$5$$, $oj$$62$$.$ZOrderUtils$.$_openPopupCountCallback$, $context$$154$$);
    return $context$$154$$.popupCount;
  };
  $oj$$62$$.$ZOrderUtils$.$_openPopupCountCallback$ = function $$oj$$62$$$$ZOrderUtils$$$_openPopupCountCallback$$($layer$$20$$, $context$$155$$) {
    $context$$155$$.popupCount += 1;
    return $oj$$62$$.$ZOrderUtils$.$VISIT_RESULT$.$ACCEPT$;
  };
  $oj$$62$$.$ZOrderUtils$.$findOpenPopups$ = function $$oj$$62$$$$ZOrderUtils$$$findOpenPopups$$() {
    var $context$$156$$ = {}, $defaultLayer$$6_popups$$2$$ = [];
    $context$$156$$.popups = $defaultLayer$$6_popups$$2$$;
    $defaultLayer$$6_popups$$2$$ = $oj$$62$$.$ZOrderUtils$.$getDefaultLayer$();
    $oj$$62$$.$ZOrderUtils$.$preOrderVisit$($defaultLayer$$6_popups$$2$$, $oj$$62$$.$ZOrderUtils$.$_openPopupsCallback$, $context$$156$$);
    $defaultLayer$$6_popups$$2$$ = $context$$156$$.popups;
    return $$$$56$$($defaultLayer$$6_popups$$2$$);
  };
  $oj$$62$$.$ZOrderUtils$.$_openPopupsCallback$ = function $$oj$$62$$$$ZOrderUtils$$$_openPopupsCallback$$($layer$$21$$, $context$$157$$) {
    $context$$157$$.popups.push($layer$$21$$[0]);
    return $oj$$62$$.$ZOrderUtils$.$VISIT_RESULT$.$ACCEPT$;
  };
  $oj$$62$$.$ZOrderUtils$.$compareStackingContexts$ = function $$oj$$62$$$$ZOrderUtils$$$compareStackingContexts$$($el1$$1$$, $el2$$1$$) {
    function $describeStackingContext$$($element$$157$$, $allLevels$$) {
      for (var $positions$$ = ["absolute", "relative", "fixed"], $parents$$7$$ = $element$$157$$.parents(), $stack_tmp$$2$$ = [], $i$$431$$ = $parents$$7$$.length - 1;-1 < $i$$431$$;$i$$431$$--) {
        $stack_tmp$$2$$.push($$$$56$$($parents$$7$$[$i$$431$$]));
      }
      $parents$$7$$ = $stack_tmp$$2$$;
      $parents$$7$$.push($element$$157$$);
      for (var $stack_tmp$$2$$ = [], $level$$45$$ = 0, $i$$431$$ = 0;$i$$431$$ < $parents$$7$$.length;$i$$431$$++) {
        var $order_parent$$52$$ = $parents$$7$$[$i$$431$$], $position$$39$$ = $order_parent$$52$$.css("position"), $opacity$$1$$ = $oj$$62$$.$DomUtils$.$getCSSLengthAsFloat$($order_parent$$52$$.css("opacity")), $zindex$$ = $oj$$62$$.$DomUtils$.$getCSSLengthAsInt$($order_parent$$52$$.css("z-index")), $order_parent$$52$$ = $$$$56$$.inArray($order_parent$$52$$[0], $order_parent$$52$$.parent().children());
    ...
    function $compareSets$$($n1$$3$$, $n2$$3$$) {
      for (var $maxLen$$1$$ = Math.max($n1$$3$$.length, $n2$$3$$.length), $i$$432$$ = 0;$i$$432$$ < $maxLen$$1$$;$i$$432$$++) {
        var $e1$$1$$ = $i$$432$$ < $n1$$3$$.length ? $n1$$3$$[$i$$432$$] : -1, $e2$$1$$ = $i$$432$$ < $n2$$3$$.length ? $n2$$3$$[$i$$432$$] : -1;
        if ($e1$$1$$ !== $e2$$1$$) {
    ...
    for (var $n1$$2$$ = $describeStackingContext$$($el1$$1$$, !1), $n2$$2$$ = $describeStackingContext$$($el2$$1$$, !1), $maxLen$$ = Math.max($n1$$2$$.length, $n2$$2$$.length), $i$$430$$ = 0;$i$$430$$ < $maxLen$$;$i$$430$$++) {
      var $c$$51_e1$$ = $i$$430$$ < $n1$$2$$.length ? $n1$$2$$[$i$$430$$].weight : [-1], $e2$$ = $i$$430$$ < $n2$$2$$.length ? $n2$$2$$[$i$$430$$].weight : [-1], $c$$51_e1$$ = $compareSets$$($c$$51_e1$$, $e2$$);
      if (0 !== $c$$51_e1$$) {
        return $c$$51_e1$$;
      }
    }
    ...
    for ($i$$430$$ = 0;$i$$430$$ < $maxLen$$;$i$$430$$++) {
      if ($c$$51_e1$$ = $i$$430$$ < $n1$$2$$.length ? $n1$$2$$[$i$$430$$].order : [-1], $e2$$ = $i$$430$$ < $n2$$2$$.length ? $n2$$2$$[$i$$430$$].order : [-1], $c$$51_e1$$ = $compareSets$$($c$$51_e1$$, $e2$$), 0 !== $c$$51_e1$$) {
        return $c$$51_e1$$;
      }
    }
    return 0;
  ...
  $oj$$62$$.$SimpleTapRecognizer$.prototype.Init = function $$oj$$62$$$$SimpleTapRecognizer$$$Init$() {
    ...
    for (var $eventHandlerCallback$$ = this.$_eventHandlerCallback$ = $$$$56$$.proxy(this.$_eventHandler$, this), $docElement$$1$$ = document.documentElement, $i$$433$$ = 0;$i$$433$$ < $oj$$62$$.$SimpleTapRecognizer$.$_TOUCHEVENTS$.length;$i$$433$$++) {
      $docElement$$1$$.addEventListener($oj$$62$$.$SimpleTapRecognizer$.$_TOUCHEVENTS$[$i$$433$$], $eventHandlerCallback$$, !0);
    }
  };
  ...
  $oj$$62$$.$SimpleTapRecognizer$.prototype.destroy = function $$oj$$62$$$$SimpleTapRecognizer$$$destroy$() {
    ...
    for (var $docElement$$2$$ = document.documentElement, $i$$434$$ = 0;$i$$434$$ < $oj$$62$$.$SimpleTapRecognizer$.$_TOUCHEVENTS$.length;$i$$434$$++) {
      $docElement$$2$$.removeEventListener($oj$$62$$.$SimpleTapRecognizer$.$_TOUCHEVENTS$[$i$$434$$], $eventHandlerCallback$$1$$, !0);
    }
  };
  ...
  $oj$$62$$.$PopupSkipLink$ = function $$oj$$62$$$$PopupSkipLink$$($sibling$$, $message$$36$$, $callback$$123$$, $id$$51$$) {
    $oj$$62$$.$Assert$.$assertPrototype$($sibling$$, jQuery);
    $oj$$62$$.$Assert$.$assertString$($message$$36$$);
    $oj$$62$$.$Assert$.$assertFunction$($callback$$123$$);
    $oj$$62$$.$Assert$.$assertStringOrNull$($id$$51$$);
    this.$_sibling$ = $sibling$$;
    this.$_message$ = $message$$36$$;
    this.$_callback$ = $callback$$123$$;
  ...
  $oj$$62$$.$PopupSkipLink$.prototype.Init = function $$oj$$62$$$$PopupSkipLink$$$Init$() {
    ...
    var $sibling$$1$$ = this.$_sibling$, $callback$$124$$ = this.$_callback$, $message$$37$$ = this.$_message$;
  ...
  $oj$$62$$.$PositionUtils$.$normalizeHorizontalAlignment$ = function $$oj$$62$$$$PositionUtils$$$normalizeHorizontalAlignment$$($position$$40$$, $isRtl$$7$$) {
    for (var $target$$103$$ = $$$$56$$.extend({}, $position$$40$$), $i$$435$$ = 0;$i$$435$$ < $oj$$62$$.$PositionUtils$.$_ALIGN_RULE_PROPERTIES$.length;$i$$435$$++) {
      var $propName$$11$$ = $oj$$62$$.$PositionUtils$.$_ALIGN_RULE_PROPERTIES$[$i$$435$$], $align$$ = $target$$103$$[$propName$$11$$];
  ...
  $oj$$62$$.$PositionUtils$.$_normalizeEventForPosition$ = function $$oj$$62$$$$PositionUtils$$$_normalizeEventForPosition$$($event$$594$$) {
    $$$$56$$.each(["pageX", "pageY"], function($index$$256$$, $pagePos$$) {
      if ($event$$594$$ && void 0 === $event$$594$$[$pagePos$$] && $event$$594$$.originalEvent) {
        var $firstTouch$$6_originalEvent$$11$$ = $event$$594$$.originalEvent, $touchList_type$$102$$ = $firstTouch$$6_originalEvent$$11$$.type;
        ($touchList_type$$102$$ = "touchstart" === $touchList_type$$102$$ || "touchmove" === $touchList_type$$102$$ ? "touches" : "touchend" === $touchList_type$$102$$ ? "changedTouches" : null) && ($firstTouch$$6_originalEvent$$11$$ = $firstTouch$$6_originalEvent$$11$$[$touchList_type$$102$$][0]) && ($event$$594$$[$pagePos$$] = $firstTouch$$6_originalEvent$$11$$[$pagePos$$]);
      }
    });
  };
