 ...
 */
"use strict";
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtTagCloud"], function($oj$$73$$, $$$$66$$, $comp$$16$$, $base$$12$$, $dvt$$9$$) {
  $oj$$73$$.$__registerWidget$("oj.ojTagCloud", $$$$66$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{optionChange:null}, $_CreateDvtComponent$:function($context$$161$$, $callback$$127$$, $callbackObj$$12$$) {
    return $dvt$$9$$.TagCloud.newInstance($context$$161$$, $callback$$127$$, $callbackObj$$12$$);
  ...
  }, getContextByNode:function($context$$162_node$$128$$) {
    return($context$$162_node$$128$$ = this.getSubIdByNode($context$$162_node$$128$$)) && "oj-tagcloud-tooltip" !== $context$$162_node$$128$$.subId ? $context$$162_node$$128$$ : null;
