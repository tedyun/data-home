...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdatasource-common"], function($oj$$21$$, $$$$20$$) {
  ...
  $oj$$21$$.$MergedNodeSet$.prototype.$_findIndex$ = function $$oj$$21$$$$MergedNodeSet$$$$_findIndex$$($key$$121$$) {
    ...
    for ($end$$13$$ = $i$$292_start$$43$$ + this.$m_nodeSet1$.$getCount$();$i$$292_start$$43$$ < $end$$13$$;$i$$292_start$$43$$++) {
      if ($rowKey$$11$$ = this.$m_nodeSet1$.getMetadata($i$$292_start$$43$$).key, $key$$121$$ === $rowKey$$11$$) {
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_processNodeSet$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_processNodeSet$$($nodeSet$$14$$, $parent$$24$$, $depth$$16$$, $toExpand$$1$$) {
    var $nodeStart$$1$$, $nodeCount$$1$$, $i$$294$$, $key$$122_metadata$$7$$;
    $nodeStart$$1$$ = $nodeSet$$14$$.$getStart$();
    $nodeCount$$1$$ = $nodeSet$$14$$.$getCount$();
    for ($i$$294$$ = 0;$i$$294$$ < $nodeCount$$1$$;$i$$294$$++) {
      $key$$122_metadata$$7$$ = $nodeSet$$14$$.getMetadata($nodeStart$$1$$ + $i$$294$$), $key$$122_metadata$$7$$ = $key$$122_metadata$$7$$.key, this.$_addEntry$($key$$122_metadata$$7$$, $depth$$16$$, $nodeStart$$1$$ + $i$$294$$, $parent$$24$$), this.$_isExpanded$($key$$122_metadata$$7$$) && $toExpand$$1$$.push($key$$122_metadata$$7$$);
    }
  };
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$insertMetadata$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$insertMetadata$$($key$$123$$, $metadata$$8$$) {
    this.$_isExpanded$($key$$123$$) && !$metadata$$8$$.leaf ? $metadata$$8$$.state = "expanded" : $metadata$$8$$.state = $metadata$$8$$.leaf ? "leaf" : "collapsed";
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_processDescendantsNodeSet$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_processDescendantsNodeSet$$($nodeSet$$17$$, $parent$$25$$, $depth$$17$$, $lastEntry$$2$$, $maxCount$$1$$, $options$$270$$) {
    var $nodeStart$$2$$, $nodeCount$$2$$, $i$$295$$, $childNodeSet_metadata$$9$$, $key$$124$$;
    ...
    for ($i$$295$$ = 0;$i$$295$$ < $nodeCount$$2$$ && $options$$270$$.count != $maxCount$$1$$;$i$$295$$++) {
      ...
      $key$$124$$ = $childNodeSet_metadata$$9$$.key;
      ...
      if (null == $lastEntry$$2$$ || $options$$270$$.found) {
        this.$_addEntry$($key$$124$$, $depth$$17$$, $nodeStart$$2$$ + $i$$295$$, $parent$$25$$), $options$$270$$.count += 1, $childNodeSet_metadata$$9$$.state = $childNodeSet_metadata$$9$$.leaf ? "leaf" : "expanded";
      }
      null == $lastEntry$$2$$ || $options$$270$$.found || ($key$$124$$ === $lastEntry$$2$$.key ? $childNodeSet_metadata$$9$$.leaf || this.$_isExpanded$($key$$124$$) ? $options$$270$$.found = !0 : $options$$270$$.checkDepth = !0 : $options$$270$$.index += 1);
      $nodeSet$$17$$.$getChildNodeSet$ && this.$_isExpanded$($key$$124$$) && ($childNodeSet_metadata$$9$$ = $nodeSet$$17$$.$getChildNodeSet$($i$$295$$), null != $childNodeSet_metadata$$9$$ && this.$_processDescendantsNodeSet$($childNodeSet_metadata$$9$$, $key$$124$$, $depth$$17$$ + 1, $lastEntry$$2$$, $maxCount$$1$$, $options$$270$$));
    }
  };
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.collapse = function $$oj$$21$$$$FlattenedTreeDataSource$$$collapse$($rowKey$$15$$) {
    var $rowIndex$$5$$, $depth$$18_i$$296_parent$$26$$, $count$$46$$, $keys$$32_lastIndex$$, $j$$37$$;
    ...
    if (0 != $count$$46$$) {
      ...
      for ($depth$$18_i$$296_parent$$26$$ = 0;$depth$$18_i$$296_parent$$26$$ < $count$$46$$;$depth$$18_i$$296_parent$$26$$++) {
        $keys$$32_lastIndex$$.push({key:this.$_getEntry$($rowIndex$$5$$ + $depth$$18_i$$296_parent$$26$$).key, index:$rowIndex$$5$$ + $depth$$18_i$$296_parent$$26$$});
      }
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$handleExpandSuccess$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$handleExpandSuccess$$($rowKey$$23$$, $maxCount$$3_nodeSet$$19$$, $childCount_j$$38$$, $callbacks$$16_options$$272$$) {
    var $refIndex$$1$$, $rangeStart$$, $metadata$$10_rowStart$$, $rowCount$$5$$, $parent$$27$$, $depth$$19$$, $key$$125$$, $toExpand$$2$$, $i$$298$$, $queue$$4$$, $prevNodeSetInfo$$2$$;
    ...
    for ($i$$298$$ = $metadata$$10_rowStart$$;$i$$298$$ < $rowCount$$5$$;$i$$298$$++) {
      $metadata$$10_rowStart$$ = $maxCount$$3_nodeSet$$19$$.getMetadata($i$$298$$), $key$$125$$ = $metadata$$10_rowStart$$.key, this.$_isExpanded$($key$$125$$) && $toExpand$$2$$.push($key$$125$$), this.$_insertRow$($refIndex$$1$$, $metadata$$10_rowStart$$, $parent$$27$$.key, $i$$298$$, $depth$$19$$), $refIndex$$1$$++;
    }
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_syncExpandRows$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_syncExpandRows$$($queue$$5$$, $prevNodeSetInfo$$3$$) {
    ...
    $key$$126$$ = $last$$1$$.shift();
    0 === $last$$1$$.length && $queue$$5$$.pop();
    this.$_expand$($key$$126$$, {prevNodeSetInfo:$prevNodeSetInfo$$3$$, queue:$queue$$5$$});
  };
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_insertRow$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_insertRow$$($index$$165$$, $key$$127_metadata$$11$$, $parentKey$$1$$, $childIndex$$, $depth$$20$$) {
    $key$$127_metadata$$11$$ = $key$$127_metadata$$11$$.key;
    $index$$165$$ <= this.$_getLastIndex$() ? this.$_addEntry$($key$$127_metadata$$11$$, $depth$$20$$, $childIndex$$, $parentKey$$1$$, $index$$165$$) : this.$_addEntry$($key$$127_metadata$$11$$, $depth$$20$$, $childIndex$$, $parentKey$$1$$);
  };
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_deleteAllRowsBelow$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_deleteAllRowsBelow$$($index$$166$$, $count$$47$$) {
    ...
    for (var $i$$300$$ = 0;$i$$300$$ < $count$$47$$;$i$$300$$++) {
      $keys$$34$$.push({row:this.$_getEntry$($index$$166$$ + $i$$300$$).key, index:$index$$166$$ + $i$$300$$});
    }
  ...
  $oj$$21$$.$FlattenedTreeDataSource$.prototype.$_addEntry$ = function $$oj$$21$$$$FlattenedTreeDataSource$$$$_addEntry$$($key$$128$$, $depth$$22$$, $index$$174$$, $parent$$31$$, $insertAt$$) {
    var $rowData$$3$$ = {};
    $rowData$$3$$.key = $key$$128$$;
  ...
  depth0:"oj-rowexpander-depth-0", depth1:"oj-rowexpander-depth-1", depth2:"oj-rowexpander-depth-2", depth3:"oj-rowexpander-depth-3", depth4:"oj-rowexpander-depth-4", depth5:"oj-rowexpander-depth-5", depth6:"oj-rowexpander-depth-6", depth7:"oj-rowexpander-depth-7"}, $constants$:{$MAX_STYLE_DEPTH$:7, $NUM5_KEY$:53}, _ComponentCreate:function() {
    ...
    var $self$$138$$ = this, $context$$105$$;
    $context$$105$$ = this.options.context;
    this.$component$ = "function" === typeof $context$$105$$.component ? $context$$105$$.component("instance") : $context$$105$$.component;
    this.$datasource$ = $context$$105$$.datasource;
    this.depth = $context$$105$$.depth;
    this.$iconState$ = $context$$105$$.state;
    this.$rowKey$ = $context$$105$$.key;
    this.index = $context$$105$$.index;
    this.$parentKey$ = $context$$105$$.parentKey;
    ...
    this.element.empty();
  }, _setOption:function($key$$129$$, $value$$254$$, $flags$$32$$) {
    this._super($key$$129$$, $value$$254$$, $flags$$32$$);
    "context" == $key$$129$$ && this.refresh();
    ...
    var $context$$106_rowKey$$26$$, $previousRowKey_state$$9$$;
    null != $ui$$18$$.currentCell && ($context$$106_rowKey$$26$$ = "cell" == $ui$$18$$.currentCell.type ? $ui$$18$$.currentCell.keys.row : $ui$$18$$.currentCell.key, null != $ui$$18$$.previousValue && ($previousRowKey_state$$9$$ = "cell" == $ui$$18$$.previousCurrentCell.type ? $ui$$18$$.previousCurrentCell.keys.row : $ui$$18$$.previousCurrentCell.key), this.$rowKey$ === $context$$106_rowKey$$26$$ && $previousRowKey_state$$9$$ != $context$$106_rowKey$$26$$ && this.$component$.$_setAccessibleContext$ && 
    ($context$$106_rowKey$$26$$ = this.$getTranslatedString$("accessibleRowDescription", {level:this.depth, num:this.index + 1, total:this.$datasource$.getWrappedDataSource().$getChildCount$(this.$parentKey$)}), $previousRowKey_state$$9$$ = "collapsed" === this.$iconState$ ? this.$getTranslatedString$("accessibleStateCollapsed") : "expanded" === this.$iconState$ ? this.$getTranslatedString$("accessibleStateExpanded") : "", this.$component$.$_setAccessibleContext$({context:$context$$106_rowKey$$26$$, 
    state:$previousRowKey_state$$9$$})));
  }, $_handleKeyDownEvent$:function($event$$343$$, $ui$$19$$) {
    var $ancestors$$2_code$$8_context$$107$$, $ancestorInfo$$, $i$$303$$;
    if (this.$rowKey$ === $ui$$19$$.rowKey && ($event$$343$$ = $event$$343$$.originalEvent, $ancestors$$2_code$$8_context$$107$$ = $event$$343$$.keyCode || $event$$343$$.which, $oj$$21$$.$DomUtils$.$isMetaKeyPressed$($event$$343$$))) {
      if ($ancestors$$2_code$$8_context$$107$$ == $$$$20$$.ui.keyCode.RIGHT && "collapsed" === this.$iconState$) {
        this.$_loading$(), this.$datasource$.expand(this.$rowKey$), $event$$343$$.preventDefault();
      } else {
        if ($ancestors$$2_code$$8_context$$107$$ == $$$$20$$.ui.keyCode.LEFT && "expanded" === this.$iconState$) {
          this.$_loading$(), this.$datasource$.collapse(this.$rowKey$), $event$$343$$.preventDefault();
        } else {
          if ($event$$343$$.altKey && $ancestors$$2_code$$8_context$$107$$ == this.$constants$.$NUM5_KEY$ && this.$component$.$_setAccessibleContext$) {
            $ancestors$$2_code$$8_context$$107$$ = this.$datasource$.$getAncestors$(this.$rowKey$);
            if (null != $ancestors$$2_code$$8_context$$107$$ && 0 < $ancestors$$2_code$$8_context$$107$$.length) {
              for ($ancestorInfo$$ = [], $i$$303$$ = 0;$i$$303$$ < $ancestors$$2_code$$8_context$$107$$.length;$i$$303$$++) {
                $ancestorInfo$$.push({key:$ancestors$$2_code$$8_context$$107$$[$i$$303$$], label:this.$getTranslatedString$("accessibleLevelDescription", {level:$i$$303$$ + 1})});
              }
            }
            $ancestors$$2_code$$8_context$$107$$ = this.$getTranslatedString$("accessibleRowDescription", {level:this.depth, num:this.index + 1, total:this.$datasource$.getWrappedDataSource().$getChildCount$(this.$parentKey$)});
            this.$component$.$_setAccessibleContext$({context:$ancestors$$2_code$$8_context$$107$$, state:"", ancestors:$ancestorInfo$$});
