...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "ojs/ojbutton"], function($oj$$46$$, $$$$43$$) {
  $oj$$46$$.$__registerWidget$("oj.ojInputNumber", $$$$43$$.oj.editableValue, {version:"1.0.0", defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{converter:$oj$$46$$.$Validation$.$converterFactory$($oj$$46$$.$ConverterFactory$.CONVERTER_TYPE_NUMBER).createConverter(), max:null, min:null, placeholder:void 0, rawValue:void 0, readOnly:!1, step:1, value:null}, getNodeBySubId:function($locator$$42$$) {
    ...
    $oj$$46$$.$EditableValueUtils$.$initializeOptionsFromDom$([{$attribute$:"disabled", $validateOption$:!0}, {$attribute$:"placeholder"}, {$attribute$:"value"}, {$attribute$:"readonly", option:"readOnly", $validateOption$:!0}, {$attribute$:"required", $coerceDomValue$:!0, $validateOption$:!0}, {$attribute$:"title"}, {$attribute$:"min"}, {$attribute$:"max"}, {$attribute$:"step"}], $constructorOptions$$15$$, this, function($initializedOptions$$1$$) {
      for (var $toParse$$ = ["value", "step", "min", "max"], $i$$380$$ = 0;$i$$380$$ < $toParse$$.length;$i$$380$$++) {
        var $opt$$20$$ = $toParse$$[$i$$380$$], $value$$285$$ = $opt$$20$$ in $initializedOptions$$1$$ ? $initializedOptions$$1$$[$opt$$20$$] : $opts$$35$$[$opt$$20$$];
        null != $value$$285$$ && ($initializedOptions$$1$$[$opt$$20$$] = "step" === $opt$$20$$ ? $self$$196$$.$_parseStep$($value$$285$$) : $self$$196$$.$_parse$($opt$$20$$, $value$$285$$));
      }
    });
  ...
  }, _setOption:function($key$$164$$, $value$$286$$, $flags$$42$$) {
    var $coercedValue$$;
    $coercedValue$$ = "value" === $key$$164$$ || "max" === $key$$164$$ || "min" === $key$$164$$ ? this.$_parse$($key$$164$$, $value$$286$$) : "step" === $key$$164$$ ? this.$_parseStep$($value$$286$$) : $value$$286$$;
    this._super($key$$164$$, $coercedValue$$, $flags$$42$$);
    if ("max" === $key$$164$$ || "min" === $key$$164$$) {
      this.$_createRangeValidator$(), this.$_AfterSetOptionValidators$();
    }
    "disabled" === $key$$164$$ && this.element.prop("disabled", !!$value$$286$$);
    "readOnly" === $key$$164$$ && (this.element.prop("readonly", !!$value$$286$$), this.$_refreshStateTheming$("readOnly", this.options.readOnly), this.$_refreshRoleSpinbutton$("readOnly", this.options.readOnly));
  }, _destroy:function() {
    ...
    return $ret$$42$$;
  }, $_Refresh$:function($name$$140$$, $value$$287$$, $forceDisplayValueRefresh$$1$$) {
    this._superApply(arguments);
    var $valueMinMax$$ = "value" === $name$$140$$ || "max" === $name$$140$$ || "min" === $name$$140$$, $valueMinMaxDisabled$$ = $valueMinMax$$ || "disabled" === $name$$140$$, $valuenow$$;
    $valueMinMaxDisabled$$ && ($valuenow$$ = this.$_getConvertedDisplayValue$());
    $valueMinMax$$ && this.$_refreshAriaMinMaxValue$($valuenow$$);
    "converter" === $name$$140$$ && this.$_refreshAriaText$($valuenow$$);
    ...
    var $element$$145$$ = this.element, $uiInputNumber$$ = this.$uiInputNumber$ = $element$$145$$.addClass("oj-inputnumber-input").wrap("\x3cspan class\x3d'oj-inputnumber-wrapper'\x3e\x3c/span\x3e").parent().append("\x3cbutton type\x3d'button' class\x3d'oj-inputnumber-button oj-inputnumber-down'\x3e\x3c/button\x3e\x3cbutton type\x3d'button' class\x3d'oj-inputnumber-button oj-inputnumber-up'\x3e\x3c/button\x3e").wrap("\x3cdiv class\x3d'oj-inputnumber oj-component'\x3e\x3c/div\x3e").parent();
    this.saveType = $element$$145$$.prop("type");
    $element$$145$$.attr("type", "text");
  ...
  }, $_repeat$:function($i$$381$$, $steps$$2$$, $event$$511$$) {
    $i$$381$$ = $i$$381$$ || 500;
    clearTimeout(this.$timer$);
    ...
    var $value$$288$$ = this.$_getConvertedDisplayValue$(), $value$$288$$ = this.$_adjustValue$($value$$288$$, $step$$);
    this.$_SetValue$($value$$288$$, $event$$512$$, this.$_VALIDATION_MODE$.$VALIDATORS_ONLY$);
  }, $_precision$:function() {
  ...
  }, $_adjustValue$:function($value$$289$$, $step$$1$$) {
    ...
    $aboveMin_newValue$$21$$ = $value$$289$$ - $stepBase$$;
    ...
    $rounded$$1$$ !== $aboveMin_newValue$$21$$ ? ($aboveMin_newValue$$21$$ = 0 > $step$$1$$ ? Math.ceil($aboveMin_newValue$$21$$ / $stepOpt$$) * $stepOpt$$ : Math.floor($aboveMin_newValue$$21$$ / $stepOpt$$) * $stepOpt$$, $aboveMin_newValue$$21$$ = $stepBase$$ + $aboveMin_newValue$$21$$ + $step$$1$$) : $aboveMin_newValue$$21$$ = $value$$289$$ + $step$$1$$;
    ...
    var $value$$290$$, $displayValue$$11$$;
    try {
      $displayValue$$11$$ = this.$_GetDisplayValue$() || 0, $value$$290$$ = this.$_parseValue$($displayValue$$11$$);
    } catch ($e$$100$$) {
      $value$$290$$ = void 0;
    }
    return $value$$290$$;
  ...
  }, $_refreshStateTheming$:function($option$$36$$, $value$$291$$) {
    -1 != Object.keys(this.$_OPTION_TO_CSS_MAPPING$).indexOf($option$$36$$) && this.widget().toggleClass(this.$_OPTION_TO_CSS_MAPPING$[$option$$36$$], !!$value$$291$$);
    ...
    var $element$$147$$ = this.element, $valuetext$$ = $element$$147$$.val();
    this.$_CompareOptionValues$("value", "" + $valuenow$$5$$, $valuetext$$) || $element$$147$$.attr({"aria-valuetext":$valuetext$$});
