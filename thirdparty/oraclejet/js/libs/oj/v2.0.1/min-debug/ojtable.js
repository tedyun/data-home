...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "promise", "ojdnd", "ojs/ojdomscroller", "ojs/ojeditablevalue", "ojs/ojmenu", "ojs/ojdatasource-common", "ojs/ojpagingtabledatasource", "ojs/ojflattenedtreetabledatasource"], function($oj$$14$$, $$$$14$$) {
  (function() {
    ...
    $_KEYBOARD_CODE_ENTER$:13, $_KEYBOARD_CODE_UP$:38, $_KEYBOARD_CODE_DOWN$:40, $_KEYBOARD_CODE_LEFT$:37, $_KEYBOARD_CODE_RIGHT$:39, $_KEYBOARD_CODE_HOME$:36, $_KEYBOARD_CODE_END$:35, $_KEYBOARD_CODE_TAB$:9, $_KEYBOARD_CODE_ESC$:27, $_KEYBOARD_MODIFIER_SHIFT$:"shiftKey"}, getContextByNode:function($node$$54$$) {
        ...
        if ($focused$$2_lastSelectedRowIdx_rowSelected$$1$$ = this.$_getLastRowSelection$(), null != $focused$$2_lastSelectedRowIdx_rowSelected$$1$$) {
          if (window.getSelection().removeAllRanges(), $rowIdx$$5$$ < $focused$$2_lastSelectedRowIdx_rowSelected$$1$$) {
            ...
            for ($i$$176$$ = $rowIdx$$5$$;$i$$176$$ <= $focused$$2_lastSelectedRowIdx_rowSelected$$1$$;$i$$176$$++) {
              this.$_setRowSelection$($i$$176$$, !0, $event$$171$$.currentTarget, $event$$171$$, !0);
            }
          } else {
        ...
        if (null != $lastSelectedColumnIdx$$) {
          if ($columnIdx$$10$$ < $lastSelectedColumnIdx$$) {
            ...
            for ($i$$177$$ = $columnIdx$$10$$;$i$$177$$ <= $lastSelectedColumnIdx$$;$i$$177$$++) {
              this.$_setHeaderColumnSelection$($i$$177$$, !0, $event$$173$$.currentTarget, $event$$173$$, !0);
            }
          } else {
    ...
    }, _setOption:function($key$$68$$, $value$$214$$) {
      this._superApply(arguments);
      this.$_isTableRefreshNeeded$($key$$68$$, $value$$214$$) ? this.$_refresh$() : "selection" == $key$$68$$ ? (this.$_clearSelectedRows$(), this.$_clearSelectedHeaderColumns$(), this.$_setSelection$($value$$214$$)) : "currentRow" == $key$$68$$ && this.$_setCurrentRow$($value$$214$$, null, !0);
      ...
      return null;
    }, $_getTabbableElements$:function($element$$93_tabbableElements$$) {
      $element$$93_tabbableElements$$ = $element$$93_tabbableElements$$.find(":tabbable");
      return null != $element$$93_tabbableElements$$ && 0 < $element$$93_tabbableElements$$.length ? $element$$93_tabbableElements$$ : null;
      ...
      try {
        ...
        this.$_queueTask$(function() {
          ...
          var $data$$111_indexArray$$ = [], $i$$194$$, $eventDataCount$$ = $event$$195$$[$self$$100$$.$_CONST_DATA$].length;
          for ($i$$194$$ = 0;$i$$194$$ < $eventDataCount$$;$i$$194$$++) {
            $data$$111_indexArray$$[$i$$194$$] = $i$$194$$ + $offset$$22$$ + $event$$195$$[$self$$100$$.$_CONST_STARTINDEX$];
          }
      ...
      try {
        ...
        for ($i$$195$$ = 0;$i$$195$$ < $eventDataCount$$1$$;$i$$195$$++) {
          var $rowIdx$$11$$ = $eventIndexes$$[$i$$195$$] - $event$$198_startIndex$$19$$;
      ...
      try {
        ...
        for ($i$$196$$ = 0;$i$$196$$ < $eventDataCount$$2$$;$i$$196$$++) {
          var $rowIdx$$12$$ = $eventIndexes$$1$$[$i$$196$$] - $event$$199_startIndex$$20$$;
      ...
      try {
        ...
        for ($i$$197$$ = $eventData$$7$$.length - 1;0 <= $i$$197$$;$i$$197$$--) {
          var $rowIdx$$13$$ = $eventIndexes$$2$$[$i$$197$$] - $event$$200_startIndex$$21$$;
      ...
      try {
        ...
        if (null != $clearSelection_event$$201$$) {
          ...
          for ($i$$198$$ = 0;$i$$198$$ < $columnsCount$$2$$;$i$$198$$++) {
            if ($column$$6$$ = $columns$$4$$[$i$$198$$], $sortField$$ = null == $column$$6$$.sortProperty ? $column$$6$$.field : $column$$6$$.sortProperty, $clearSelection_event$$201$$.header == $sortField$$) {
              $columnIdx$$19$$ = $i$$198$$;
              break;
            }
          }
      ...
      null, $event$$209$$, !0)));
    }, $_handleMouseEnterSelection$:function($element$$94$$) {
      var $rowIdx$$14$$ = this.$_getTableDomUtils$().$getElementRowIdx$($$$$14$$($element$$94$$));
      if (null != $rowIdx$$14$$ && null != this.$_mouseDownRowIdx$ && this.$_mouseDownRowIdx$ != $rowIdx$$14$$) {
        ...
        if ($rowIdx$$14$$ < $lastSelectedRowIdx$$1$$) {
          ...
          for ($i$$199$$ = 0;$i$$199$$ < $selectedRowIdxs$$2$$.length;$i$$199$$++) {
            ($selectedRowIdxs$$2$$[$i$$199$$] < $rowIdx$$14$$ || $selectedRowIdxs$$2$$[$i$$199$$] > $lastSelectedRowIdx$$1$$) && this.$_setRowSelection$($selectedRowIdxs$$2$$[$i$$199$$], !1, $element$$94$$, null, !0);
          }
          for ($i$$199$$ = $lastSelectedRowIdx$$1$$;$i$$199$$ >= $rowIdx$$14$$;$i$$199$$--) {
            this.$_setRowSelection$($i$$199$$, !0, $element$$94$$, null, !0), this.$_getTableDomUtils$().$moveTableBodyRowTouchSelectionAffordanceTop$($i$$199$$);
          }
        } else {
          for ($i$$199$$ = 0;$i$$199$$ < $selectedRowIdxs$$2$$.length;$i$$199$$++) {
            ($selectedRowIdxs$$2$$[$i$$199$$] > $rowIdx$$14$$ || $selectedRowIdxs$$2$$[$i$$199$$] < $lastSelectedRowIdx$$1$$) && this.$_setRowSelection$($selectedRowIdxs$$2$$[$i$$199$$], !1, $element$$94$$, null, !0);
          ...
          for ($i$$199$$ = $lastSelectedRowIdx$$1$$;$i$$199$$ <= $rowIdx$$14$$;$i$$199$$++) {
            this.$_setRowSelection$($i$$199$$, !0, $element$$94$$, null, !0), this.$_getTableDomUtils$().$moveTableBodyRowTouchSelectionAffordanceBottom$($i$$199$$);
          }
        }
      }
    ...
    }, $_isTableRefreshNeeded$:function($key$$69$$, $value$$215$$) {
      var $currentOptions$$ = this.$_cachedOptions$, $refresh$$ = !1;
      "contextMenu" == $key$$69$$ && $value$$215$$ == "#" + this.$_getTableDomUtils$().$getTableId$() + "_contextmenu" ? $refresh$$ = !1 : "selection" == $key$$69$$ || "currentRow" == $key$$69$$ || $oj$$14$$.$Object$.$compareValues$($value$$215$$, $currentOptions$$[$key$$69$$]) || ($refresh$$ = !0);
      this.$_cachedOptions$ = $$$$14$$.extend(!0, {}, this.options);
      return $refresh$$;
    ...
    }, $_refreshTableBodyRow$:function($moveTableBodyCell_rowIdx$$16$$, $row$$11_swapTableBodyCell$$, $tableBodyRow$$7$$, $docFrag$$1_i$$209$$, $docFragStartIdx$$1_tableBodyCells$$, $context$$64_isNew$$) {
      ...
      if (null == $tableBodyRow$$7$$) {
        if ($tableBodyRow$$7$$ = this.$_getTableDomUtils$().$getTableBodyRow$($moveTableBodyCell_rowIdx$$16$$)) {
          $tableBodyRow$$7$$.empty(), $context$$64_isNew$$ = !0, this.$_getTableDomUtils$().$createTableBodyCellAccSelect$($moveTableBodyCell_rowIdx$$16$$, $row$$11_swapTableBodyCell$$[this.$_CONST_KEY$], $rowHashCode$$, $tableBodyRow$$7$$, $context$$64_isNew$$);
        } else {
          return;
        }
      }
      ...
      $context$$64_isNew$$ = {rowContext:$oj$$14$$.$TableRendererUtils$.$getRendererContextObject$(this, $row$$11_swapTableBodyCell$$, $tableBodyRow$$7$$[0]), row:$$$$14$$.extend({}, $row$$11_swapTableBodyCell$$[this.$_CONST_DATA$])};
      if ($rowContent_rowRenderer$$1_tableBodyCell$$2$$) {
        $rowContent_rowRenderer$$1_tableBodyCell$$2$$ = $rowContent_rowRenderer$$1_tableBodyCell$$2$$($context$$64_isNew$$);
        ...
        $oj$$14$$.$TableRendererUtils$.$tableBodyRowDefaultRenderer$($moveTableBodyCell_rowIdx$$16$$, $row$$11_swapTableBodyCell$$, $context$$64_isNew$$);
      }
      ...
      if ($columns$$13$$ && 0 < $columns$$13$$.length) {
        ...
        for (var $column$$10_headerColumnContent$$, $headerRenderer$$, $headerColumn$$3$$, $context$$65_headerContext$$, $columnsCount$$9$$ = $columns$$13$$.length, $i$$211_tableHeaderAccSelectRowColumn$$ = 0;$i$$211_tableHeaderAccSelectRowColumn$$ < $columnsCount$$9$$;$i$$211_tableHeaderAccSelectRowColumn$$++) {
          $column$$10_headerColumnContent$$ = $columns$$13$$[$i$$211_tableHeaderAccSelectRowColumn$$], $headerRenderer$$ = this.$_getColumnRenderer$($i$$211_tableHeaderAccSelectRowColumn$$, "header"), $headerColumn$$3$$ = this.$_getTableDomUtils$().$createTableHeaderColumn$($i$$211_tableHeaderAccSelectRowColumn$$), $headerRenderer$$ && ($context$$65_headerContext$$ = $oj$$14$$.$TableRendererUtils$.$getRendererContextObject$(this, null, $headerColumn$$3$$[0]), $context$$65_headerContext$$ = {headerContext:$context$$65_headerContext$$, 
          columnIndex:$i$$211_tableHeaderAccSelectRowColumn$$, data:$column$$10_headerColumnContent$$.headerText}, $column$$10_headerColumnContent$$.sortable == $oj$$14$$.$TableDomUtils$.$_OPTION_ENABLED$ ? $context$$65_headerContext$$.columnHeaderSortableIconRenderer = function $$context$$65_headerContext$$$columnHeaderSortableIconRenderer$($options$$240$$, $delegateRenderer$$) {
            $oj$$14$$.$TableRendererUtils$.$columnHeaderSortableIconRenderer$(this, $delegateRenderer$$);
          } : $context$$65_headerContext$$.columnHeaderDefaultRenderer = function $$context$$65_headerContext$$$columnHeaderDefaultRenderer$($options$$241$$, $delegateRenderer$$1$$) {
            $oj$$14$$.$TableRendererUtils$.$columnHeaderDefaultRenderer$(this, $delegateRenderer$$1$$);
          }, $column$$10_headerColumnContent$$ = $headerRenderer$$($context$$65_headerContext$$), null != $column$$10_headerColumnContent$$ ? ($headerColumn$$3$$.empty(), $headerColumn$$3$$.append($column$$10_headerColumnContent$$)) : ($headerColumn$$3$$ = $$$$14$$($tableHeader$$1_tableHeaderRow$$1$$.children(":not(." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_ACC_SELECT_ROW_CLASS$ + ")")[$i$$211_tableHeaderAccSelectRowColumn$$]), this.$_getTableDomUtils$().$setTableHeaderColumnAttributes$($i$$211_tableHeaderAccSelectRowColumn$$, 
      ...
      var $element$$95$$ = this.$_getTableDomUtils$().$getTableContainer$();
      ...
      this.$_isResizeListenerAdded$ || ($oj$$14$$.$DomUtils$.$addResizeListener$($element$$95$$[0], this.$_resizeListener$, 50), this.$_isResizeListenerAdded$ = !0);
      ...
      var $element$$96$$ = null;
      null != $event$$216$$ && ($element$$96$$ = $event$$216$$.currentTarget);
      if ($focused$$4$$) {
      ...
      this.$_setHeaderColumnState$($columnIdx$$25$$, {$focused$:$focused$$4$$}, $element$$96$$);
    }, $_setHeaderColumnSelection$:function($accSelectionColumn_columnIdx$$26$$, $selected$$17_selection$$3$$, $element$$97$$, $event$$217$$, $updateSelection$$) {
    ...
    }, $_setRowFocus$:function($rowIdx$$20$$, $focused$$6$$, $rowKey$$6_updateCurrentRow$$2$$, $element$$99$$, $event$$219_updateRowFocus$$) {
      if (-1 == $rowIdx$$20$$) {
      ...
      if ($focused$$6$$) {
        ...
        null != $focusedRowIdx$$8$$ && $focusedRowIdx$$8$$ != $rowIdx$$20$$ && this.$_setRowFocus$($focusedRowIdx$$8$$, !1, $rowKey$$6_updateCurrentRow$$2$$, $element$$99$$, null);
      ...
      return!0;
    }, $_setRowSelection$:function($accSelectionCell_rowIdx$$21$$, $selected$$21_selection$$4$$, $element$$100_tableBodyRow$$11$$, $event$$220_selectionChanged$$, $updateSelection$$1$$) {
      if (this.$_getRowSelectionMode$() == this.$_OPTION_SELECTION_MODES$.$_SINGLE$ || this.$_getRowSelectionMode$() == this.$_OPTION_SELECTION_MODES$.$_MULTIPLE$) {
        if ((isNaN($accSelectionCell_rowIdx$$21$$) || 0 > $accSelectionCell_rowIdx$$21$$) && $oj$$14$$.$Logger$.error("Error: Invalid row selection value: " + $accSelectionCell_rowIdx$$21$$), this.$_getRowSelectionMode$() == this.$_OPTION_SELECTION_MODES$.$_SINGLE$ && $selected$$21_selection$$4$$ && this.$_clearSelectedRows$(), $element$$100_tableBodyRow$$11$$ = this.$_getTableDomUtils$().$getTableBodyRow$($accSelectionCell_rowIdx$$21$$), null != $element$$100_tableBodyRow$$11$$) {
          $event$$220_selectionChanged$$ = !1;
          if ($element$$100_tableBodyRow$$11$$.hasClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_SELECTED$) != $selected$$21_selection$$4$$) {
            $selected$$21_selection$$4$$ ? $element$$100_tableBodyRow$$11$$.addClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_SELECTED$) : $element$$100_tableBodyRow$$11$$.removeClass($oj$$14$$.$TableDomUtils$.$MARKER_STYLE_CLASSES$.$_SELECTED$);
            $event$$220_selectionChanged$$ = !0;
            var $dragOption$$ = this.options.dnd.drag;
            $dragOption$$ && ("rows" === $dragOption$$ || $dragOption$$.rows) && $element$$100_tableBodyRow$$11$$.prop("draggable", $selected$$21_selection$$4$$);
          }
          ...
          $accSelectionCell_rowIdx$$21$$ = this.$_getTableDomUtils$().$getTableBodyCellAccSelect$($element$$100_tableBodyRow$$11$$);
    ...
    }, $_setTableNavigationMode$:function($value$$216$$) {
      this.$_tableNavMode$ = $value$$216$$;
      ...
      var $element$$101$$ = this.$_getTableDomUtils$().$getTableContainer$();
      $oj$$14$$.$DomUtils$.$removeResizeListener$($element$$101$$[0], this.$_resizeListener$);
  ...
  $oj$$14$$.$TableDndContext$.prototype.$_getOverRowIndex$ = function $$oj$$14$$$$TableDndContext$$$$_getOverRowIndex$$($context$$66_event$$222$$) {
    var $newRowIndex_overRow_tableBodyRows$$9$$;
    $newRowIndex_overRow_tableBodyRows$$9$$ = $$$$14$$($context$$66_event$$222$$.target).closest("tr");
    $newRowIndex_overRow_tableBodyRows$$9$$ = ($context$$66_event$$222$$ = this.$component$.getContextByNode($context$$66_event$$222$$.target)) && "oj-table-cell" == $context$$66_event$$222$$.subId ? $context$$66_event$$222$$.rowIndex : $newRowIndex_overRow_tableBodyRows$$9$$ && $newRowIndex_overRow_tableBodyRows$$9$$.hasClass($oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_DRAG_INDICATOR_BEFORE_CLASS$) ? this.$_dropRowIndex$ : ($newRowIndex_overRow_tableBodyRows$$9$$ = this.$_getTableDomUtils$().$getTableBodyRows$()) ? 
  ...
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnDragStart$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnDragStart$$($event$$223$$) {
    if (this.$_isColumnReorderEnabled$()) {
      var $columnIdx$$32$$ = this.$_getEventColumnIndex$($event$$223$$);
      this.$_dragStartColumnIdx$ = $columnIdx$$32$$;
      this.$_setReorderColumnsDataTransfer$($event$$223$$, $columnIdx$$32$$);
  ...
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnDragEnter$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnDragEnter$$($event$$225$$) {
    if (!this.$_isColumnReordering$()) {
      var $columnIdx$$33$$ = this.$_getEventColumnIndex$($event$$225$$);
      return this.$_invokeDropCallback$("columns", "dragEnter", $event$$225$$, {columnIndex:$columnIdx$$33$$});
    }
  };
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnReorderDragOver$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnReorderDragOver$$($event$$226$$) {
    var $columnIdx$$34$$ = this.$_getEventColumnIndex$($event$$226$$), $dragStartColumnIdx$$ = this.$_dragStartColumnIdx$;
    null != $dragStartColumnIdx$$ && $dragStartColumnIdx$$ != $columnIdx$$34$$ && ((this.$_currentDropColumnBefore$ = this.$_isDragOverBeforeColumn$($event$$226$$)) && $dragStartColumnIdx$$ == $columnIdx$$34$$ - 1 || !this.$_currentDropColumnBefore$ && $dragStartColumnIdx$$ == $columnIdx$$34$$ + 1 || this.$_getTableDomUtils$().$displayDragOverIndicatorColumn$($columnIdx$$34$$, this.$_currentDropColumnBefore$), $event$$226$$.preventDefault());
  };
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnDragOver$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnDragOver$$($event$$227$$) {
    ...
    var $columnIdx$$35$$ = this.$_getEventColumnIndex$($event$$227$$);
    this.$_currentDropColumnBefore$ = this.$_isDragOverBeforeColumn$($event$$227$$);
    var $returnValue$$1$$ = this.$_invokeDropCallback$("columns", "dragOver", $event$$227$$, {columnIndex:$columnIdx$$35$$});
    (!1 === $returnValue$$1$$ || $event$$227$$.isDefaultPrevented()) && this.$_getTableDomUtils$().$displayDragOverIndicatorColumn$($columnIdx$$35$$, this.$_isDragOverBeforeColumn$($event$$227$$));
  ...
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnDragLeave$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnDragLeave$$($event$$228$$) {
    if (!this.$_isColumnReordering$()) {
      ...
      var $columnIdx$$36$$ = this.$_getEventColumnIndex$($event$$228$$);
      return this.$_invokeDndCallback$("drop", "columns", "dragLeave", $event$$228$$, {columnIndex:$columnIdx$$36$$});
    }
  };
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnReorderDrop$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnReorderDrop$$($event$$229$$) {
    var $columnIdx$$37$$ = this.$_getEventColumnIndex$($event$$229$$);
    this.$_currentDropColumnBefore$ || $columnIdx$$37$$++;
    this.$component$.$_columnsDestMap$ = this.$_getTableDomUtils$().$moveTableHeaderColumn$(this.$_dragStartColumnIdx$, $columnIdx$$37$$, $event$$229$$);
  ...
  $oj$$14$$.$TableDndContext$.prototype.$handleColumnDrop$ = function $$oj$$14$$$$TableDndContext$$$$handleColumnDrop$$($event$$230$$) {
    ...
    this.$_getTableDomUtils$().$removeDragOverIndicatorColumn$();
    var $columnIdx$$38$$ = this.$_getEventColumnIndex$($event$$230$$);
    this.$_currentDropColumnBefore$ || $columnIdx$$38$$++;
    return this.$_invokeDropCallback$("columns", "drop", $event$$230$$, {columnIndex:$columnIdx$$38$$});
  };
  ...
  $oj$$14$$.$TableDndContext$.prototype.$_setReorderColumnsDataTransfer$ = function $$oj$$14$$$$TableDndContext$$$$_setReorderColumnsDataTransfer$$($event$$244$$, $columnIdx$$39$$) {
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$getElementColumnIdx$ = function $$oj$$14$$$$TableDomUtils$$$$getElementColumnIdx$$($element$$103_tableFooterCell$$2$$) {
    var $tableBodyCell$$5_tableHeaderColumn$$9$$ = this.$getFirstAncestor$($element$$103_tableFooterCell$$2$$, $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_CELL_CLASS$);
    ...
    $tableBodyCell$$5_tableHeaderColumn$$9$$ = this.$getFirstAncestor$($element$$103_tableFooterCell$$2$$, $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_COLUMN_HEADER_CELL_CLASS$);
    if (null != $tableBodyCell$$5_tableHeaderColumn$$9$$) {
    ...
    $element$$103_tableFooterCell$$2$$ = this.$getFirstAncestor$($element$$103_tableFooterCell$$2$$, $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_FOOTER_CELL_CLASS$);
    return null != $element$$103_tableFooterCell$$2$$ ? $element$$103_tableFooterCell$$2$$.parent().children("." + $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_FOOTER_CELL_CLASS$).index($element$$103_tableFooterCell$$2$$) : null;
  };
  $oj$$14$$.$TableDomUtils$.prototype.$getElementRowIdx$ = function $$oj$$14$$$$TableDomUtils$$$$getElementRowIdx$$($element$$104_tableBodyRow$$15$$) {
    $element$$104_tableBodyRow$$15$$ = this.$getFirstAncestor$($element$$104_tableBodyRow$$15$$, $oj$$14$$.$TableDomUtils$.$CSS_CLASSES$.$_TABLE_DATA_ROW_CLASS$);
    return null != $element$$104_tableBodyRow$$15$$ ? $element$$104_tableBodyRow$$15$$.index() : null;
  };
  $oj$$14$$.$TableDomUtils$.prototype.$getFirstAncestor$ = function $$oj$$14$$$$TableDomUtils$$$$getFirstAncestor$$($element$$105$$, $className$$8$$) {
    var $parents$$1$$;
    if (null == $element$$105$$) {
      return null;
    }
    $element$$105$$ = $$$$14$$($element$$105$$);
    if ($element$$105$$.hasClass($className$$8$$)) {
      return $element$$105$$;
    }
    $parents$$1$$ = $element$$105$$.parents("." + $className$$8$$);
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$getScrollLeft$ = function $$oj$$14$$$$TableDomUtils$$$$getScrollLeft$$($element$$106$$) {
    $element$$106$$ = $$$$14$$($element$$106$$);
    var $scrollLeft$$3$$ = $element$$106$$[0].scrollLeft;
    "rtl" === this.$component$.$_GetReadingDirection$() && ($scrollLeft$$3$$ = Math.abs($scrollLeft$$3$$), this.$_isWebkit$() && ($scrollLeft$$3$$ = $element$$106$$[0].scrollWidth - $element$$106$$[0].clientWidth - $scrollLeft$$3$$));
    return $scrollLeft$$3$$;
  };
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$moveTableHeaderColumn$ = function $$oj$$14$$$$TableDomUtils$$$$moveTableHeaderColumn$$($columnIdx$$54_columnsDestMapItem$$, $destColIdx_destIdx$$, $columnDef_event$$246$$) {
    ...
    this.$component$.option("columns", $colSpan_columnsOption$$, {_context:{$writeback$:!0, originalEvent:$columnDef_event$$246$$, $internalSet$:!0}});
    $columnDef_event$$246$$ = this.$component$.$_columnDefArray$.splice($columnIdx$$54_columnsDestMapItem$$, 1);
    this.$component$.$_columnDefArray$.splice($destColIdx_destIdx$$, 0, $columnDef_event$$246$$[0]);
  ...
  $oj$$14$$.$TableDomUtils$.prototype.$setScrollLeft$ = function $$oj$$14$$$$TableDomUtils$$$$setScrollLeft$$($element$$107$$, $scrollLeft$$4$$) {
    $element$$107$$ = $$$$14$$($element$$107$$);
    "rtl" === this.$component$.$_GetReadingDirection$() && ($scrollLeft$$4$$ = Math.abs($scrollLeft$$4$$), this.$_isWebkit$() ? $scrollLeft$$4$$ = $element$$107$$[0].scrollWidth - $element$$107$$[0].clientWidth - $scrollLeft$$4$$ : this.$_isFF$() && ($scrollLeft$$4$$ *= -1));
    $element$$107$$[0].scrollLeft != $scrollLeft$$4$$ && ($element$$107$$[0].scrollLeft = $scrollLeft$$4$$);
  };
  ...
  $oj$$14$$.$TableRendererUtils$.$columnHeaderDefaultRenderer$ = function $$oj$$14$$$$TableRendererUtils$$$columnHeaderDefaultRenderer$$($context$$67$$, $delegateRenderer$$2$$) {
    var $headerContentDiv_parentElement$$1$$ = $$$$14$$($context$$67$$.headerContext.parentElement), $headerColumnDiv$$2$$ = $$$$14$$(document.createElement("div"));
    ...
    null != $delegateRenderer$$2$$ ? $delegateRenderer$$2$$($headerContentDiv_parentElement$$1$$) : this.$columnHeaderDefaultTextRenderer$($headerContentDiv_parentElement$$1$$, $context$$67$$);
  };
  $oj$$14$$.$TableRendererUtils$.$columnHeaderSortableIconRenderer$ = function $$oj$$14$$$$TableRendererUtils$$$columnHeaderSortableIconRenderer$$($context$$68$$, $delegateRenderer$$3$$) {
    var $component$$18_headerContentDiv$$1$$ = $context$$68$$.headerContext.component, $headerColumnAscDiv_headerColumnDscDiv_headerColumnSortPlaceholderDiv_parentElement$$2$$ = $$$$14$$($context$$68$$.headerContext.parentElement), $headerColumnDiv$$3$$ = $$$$14$$(document.createElement("div"));
    ...
    null != $delegateRenderer$$3$$ ? $delegateRenderer$$3$$($component$$18_headerContentDiv$$1$$) : this.$columnHeaderDefaultTextRenderer$($component$$18_headerContentDiv$$1$$, $context$$68$$);
  };
  $oj$$14$$.$TableRendererUtils$.$columnHeaderDefaultTextRenderer$ = function $$oj$$14$$$$TableRendererUtils$$$columnHeaderDefaultTextRenderer$$($headerContentDiv$$2$$, $context$$69$$) {
    var $column$$19_columnIdx$$61$$ = $context$$69$$.columnIndex, $column$$19_columnIdx$$61$$ = $context$$69$$.headerContext.component.$_getColumnDefs$()[$column$$19_columnIdx$$61$$];
    $headerContentDiv$$2$$.text($column$$19_columnIdx$$61$$.headerText);
  };
  $oj$$14$$.$TableRendererUtils$.$tableBodyRowDefaultRenderer$ = function $$oj$$14$$$$TableRendererUtils$$$tableBodyRowDefaultRenderer$$($rowIdx$$38$$, $row$$15$$, $context$$70$$) {
    var $component$$20_j$$34$$ = $context$$70$$.rowContext.component, $columnsCount$$12_tableBodyRow$$27$$ = $$$$14$$($context$$70$$.rowContext.parentElement), $rowHashCode$$4$$ = $component$$20_j$$34$$.$_getTableDomUtils$().$hashCode$($row$$15$$.key), $columns$$20$$ = $component$$20_j$$34$$.$_getColumnDefs$();
    ...
    for ($component$$20_j$$34$$ = 0;$component$$20_j$$34$$ < $columnsCount$$12_tableBodyRow$$27$$;$component$$20_j$$34$$++) {
      this.$tableBodyCellDefaultRenderer$($rowIdx$$38$$, $component$$20_j$$34$$, $row$$15$$, $rowHashCode$$4$$, $context$$70$$);
    }
  };
  $oj$$14$$.$TableRendererUtils$.$tableBodyCellDefaultRenderer$ = function $$oj$$14$$$$TableRendererUtils$$$tableBodyCellDefaultRenderer$$($rowIdx$$39$$, $columnIdx$$62$$, $row$$16$$, $rowHashCode$$5$$, $context$$71_tableBodyRow$$28$$) {
    var $component$$21$$ = $context$$71_tableBodyRow$$28$$.rowContext.component;
    $context$$71_tableBodyRow$$28$$ = $$$$14$$($context$$71_tableBodyRow$$28$$.rowContext.parentElement);
    ...
    $component$$21$$.$_getTableDomUtils$().$insertTableBodyCell$($rowIdx$$39$$, $row$$16$$.key, $rowHashCode$$5$$, $columnIdx$$62$$, $tableBodyCell$$13$$, $context$$71_tableBodyRow$$28$$);
  ...
  $oj$$14$$.$TableRendererUtils$.$getRendererContextObject$ = function $$oj$$14$$$$TableRendererUtils$$$getRendererContextObject$$($component$$22_rowContext$$1$$, $row$$17$$, $parentElement$$3$$) {
    var $context$$72$$ = {};
    $context$$72$$.component = $component$$22_rowContext$$1$$;
    ...
    $context$$72$$.datasource = $dataSource$$;
    $context$$72$$.parentElement = $parentElement$$3$$;
    if (null != $row$$17$$ && ($context$$72$$.status = this.$getRendererStatusObject$($component$$22_rowContext$$1$$, $row$$17$$), $dataSource$$ instanceof $oj$$14$$.$FlattenedTreeTableDataSource$)) {
      $component$$22_rowContext$$1$$ = $dataSource$$.$_getMetadata$($row$$17$$.index);
      for (var $i$$239$$ in $component$$22_rowContext$$1$$) {
        $component$$22_rowContext$$1$$.hasOwnProperty($i$$239$$) && ($context$$72$$[$i$$239$$] = $component$$22_rowContext$$1$$[$i$$239$$]);
      }
    }
    return $context$$72$$;
  };
