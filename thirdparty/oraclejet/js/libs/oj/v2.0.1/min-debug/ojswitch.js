...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue"], function($oj$$70$$) {
  (function() {
    $oj$$70$$.$__registerWidget$("oj.ojSwitch", $.oj.editableValue, {version:"1.1.0", defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{disabled:!1, readOnly:!1, required:!1, title:"", value:!1}, refresh:function() {
      ...
      null != $node$$126$$ && ($($node$$126$$).hasClass("oj-switch-track") || $($node$$126$$).hasClass("oj-switch-thumb")) && ($nodeId$$1$$ = $($node$$126$$).parents("div.oj-switch").find("input.oj-component-initnode").attr("id"), $originalId$$ === $nodeId$$1$$ && $($node$$126$$).hasClass("oj-switch-track") ? $result$$80$$ = {subId:"oj-switch-track"} : $originalId$$ === $nodeId$$1$$ && $($node$$126$$).hasClass("oj-switch-thumb") && ($result$$80$$ = {subId:"oj-switch-thumb"}));
      return $result$$80$$;
      ...
      this.$_setup$();
    }, $_setAriaLabel$:function($elem$$161$$, $target$$104$$) {
      var $id$$56_switchLabel$$ = $elem$$161$$.prop("id"), $ariaLabelledBy$$ = $elem$$161$$.attr("aria-labelledby"), $ariaLabel$$ = $elem$$161$$.attr("aria-label");
      ...
      return this.$_element2$;
    }, _setOption:function($key$$182$$, $coercedValue$$2_value$$313$$, $flags$$47$$) {
      switch($key$$182$$) {
        case "disabled":
        ;
        case "readOnly":
        ;
        case "value":
          $coercedValue$$2_value$$313$$ = !!$coercedValue$$2_value$$313$$;
          break;
        case "required":
          $coercedValue$$2_value$$313$$ = !1;
          break;
      }
      this._super($key$$182$$, $coercedValue$$2_value$$313$$, $flags$$47$$);
      this.$_setup$();
    }});
  })();
});
