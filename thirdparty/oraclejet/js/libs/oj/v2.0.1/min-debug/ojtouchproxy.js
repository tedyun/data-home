...
define(["ojs/ojcore", "jquery"], function($oj$$77$$, $$$$70$$) {
  $oj$$77$$.$_TouchProxy$ = function $$oj$$77$$$$_TouchProxy$$($elem$$166$$) {
    this._init($elem$$166$$);
  };
  $oj$$77$$.$_TouchProxy$.prototype._init = function $$oj$$77$$$$_TouchProxy$$$_init$($elem$$167$$) {
    this.$_elem$ = $elem$$167$$;
  ...
  $oj$$77$$.$_TouchProxy$.$addTouchListeners$ = function $$oj$$77$$$$_TouchProxy$$$addTouchListeners$$($elem$$168_jelem$$9$$) {
    $elem$$168_jelem$$9$$ = $$$$70$$($elem$$168_jelem$$9$$);
    var $proxy$$ = $elem$$168_jelem$$9$$.data($oj$$77$$.$_TouchProxy$.$_TOUCH_PROXY_KEY$);
    $proxy$$ || ($proxy$$ = new $oj$$77$$.$_TouchProxy$($elem$$168_jelem$$9$$), $elem$$168_jelem$$9$$.data($oj$$77$$.$_TouchProxy$.$_TOUCH_PROXY_KEY$, $proxy$$));
    return $proxy$$;
  };
  $oj$$77$$.$_TouchProxy$.$removeTouchListeners$ = function $$oj$$77$$$$_TouchProxy$$$removeTouchListeners$$($elem$$169_jelem$$10$$) {
    $elem$$169_jelem$$10$$ = $$$$70$$($elem$$169_jelem$$10$$);
    var $proxy$$1$$ = $elem$$169_jelem$$10$$.data($oj$$77$$.$_TouchProxy$.$_TOUCH_PROXY_KEY$);
    $proxy$$1$$ && ($proxy$$1$$._destroy(), $elem$$169_jelem$$10$$.removeData($oj$$77$$.$_TouchProxy$.$_TOUCH_PROXY_KEY$));
  };
});
