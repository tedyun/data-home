...
define(["ojs/ojcore", "jquery"], function($oj$$41$$, $$$$38$$) {
  $oj$$41$$.$DomScroller$ = function $$oj$$41$$$$DomScroller$$($element$$139$$, $datasource$$, $options$$323$$) {
    $options$$323$$ = $options$$323$$ || {};
    this.$_data$ = $datasource$$;
    this.$_element$ = $element$$139$$;
  ...
  $oj$$41$$.$DomScroller$.prototype.$_checkOverflow$ = function $$oj$$41$$$$DomScroller$$$$_checkOverflow$$() {
    var $element$$140$$ = this.$_element$;
    return $element$$140$$[0].scrollHeight > $element$$140$$[0].clientHeight + 1 ? !0 : !1;
  };
  ...
  $oj$$41$$.$DomScroller$.prototype.$_fetchNext$ = function $$oj$$41$$$$DomScroller$$$$_fetchNext$$($options$$324$$) {
    ...
    if (-1 == this.$_data$.totalSize() || this.$_data$.totalSize() > this.$_currentStartIndex$) {
      ...
      return new Promise(function($resolve$$52$$, $reject$$48$$) {
        $self$$180$$.$_data$.fetch({startIndex:$self$$180$$.$_currentStartIndex$, pageSize:$pageSize$$9$$}).then(function($result$$70$$) {
          $resolve$$52$$($result$$70$$);
        }, function() {
          $reject$$48$$(null);
        });
      });
  ...
  $oj$$41$$.$DomScroller$.prototype.$_registerDataSourceEventListeners$ = function $$oj$$41$$$$DomScroller$$$$_registerDataSourceEventListeners$$() {
    ...
    if (null != $data$$158$$) {
      ...
      for ($i$$355$$ = 0;$i$$355$$ < this.$_dataSourceEventHandlers$.length;$i$$355$$++) {
        ($ev$$2$$ = $data$$158$$.on(this.$_dataSourceEventHandlers$[$i$$355$$].eventType, this.$_dataSourceEventHandlers$[$i$$355$$].eventHandler)) && (this.$_dataSourceEventHandlers$[$i$$355$$].eventHandler = $ev$$2$$);
      }
    }
  };
  $oj$$41$$.$DomScroller$.prototype.$_unregisterDataSourceEventListeners$ = function $$oj$$41$$$$DomScroller$$$$_unregisterDataSourceEventListeners$$() {
    ...
    if (null != this.$_dataSourceEventHandlers$ && null != $data$$159$$) {
      var $i$$356$$;
      for ($i$$356$$ = 0;$i$$356$$ < this.$_dataSourceEventHandlers$.length;$i$$356$$++) {
        $data$$159$$.off(this.$_dataSourceEventHandlers$[$i$$356$$].eventType, this.$_dataSourceEventHandlers$[$i$$356$$].eventHandler);
      }
    }
  };
});
