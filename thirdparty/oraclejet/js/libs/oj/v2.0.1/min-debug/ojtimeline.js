 ...
 */
"use strict";
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtTimeline"], function($oj$$75$$, $$$$68$$, $comp$$18$$, $base$$14$$, $dvt$$11$$) {
  $oj$$75$$.$__registerWidget$("oj.ojTimeline", $$$$68$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{viewportChange:null}, $_CreateDvtComponent$:function($context$$171$$, $callback$$129$$, $callbackObj$$14$$) {
    return $dvt$$11$$.Timeline.newInstance($context$$171$$, $callback$$129$$, $callbackObj$$14$$);
