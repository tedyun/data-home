...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common"], function($oj$$23$$) {
  ...
  $oj$$23$$.$ArrayDataGridDataSource$.prototype.$_getHeaderMetadata$ = function $$oj$$23$$$$ArrayDataGridDataSource$$$$_getHeaderMetadata$$($axis$$32$$, $index$$181$$) {
    ...
    if ("column" === $axis$$32$$) {
      return $key$$131$$ = this.$_getHeaderData$($axis$$32$$, $index$$181$$), null != this.$_sortInfo$ && this.$_sortInfo$.key === $key$$131$$ ? {key:this.$_getHeaderData$($axis$$32$$, $index$$181$$), sortDirection:this.$_sortInfo$.direction} : {key:$key$$131$$};
    }
  };
  ...
  $oj$$23$$.$ArrayDataGridDataSource$.prototype.$_naturalSort$ = function $$oj$$23$$$$ArrayDataGridDataSource$$$$_naturalSort$$($direction$$6$$, $key$$132$$) {
    if ("ascending" === $direction$$6$$) {
      return function($a$$107$$, $b$$64$$) {
        var $as$$, $bs$$;
        void 0 != $key$$132$$ && ($a$$107$$ instanceof Array ? ($a$$107$$ = $a$$107$$[parseInt($key$$132$$, 10)], $b$$64$$ = $b$$64$$[parseInt($key$$132$$, 10)]) : ($a$$107$$ = $a$$107$$[$key$$132$$], $b$$64$$ = $b$$64$$[$key$$132$$]));
        $as$$ = isNaN($a$$107$$);
        $bs$$ = isNaN($b$$64$$);
    ...
    if ("descending" === $direction$$6$$) {
      return function($a$$108$$, $b$$65$$) {
        var $as$$1$$, $bs$$1$$;
        void 0 != $key$$132$$ && ($a$$108$$ instanceof Array ? ($a$$108$$ = $a$$108$$[parseInt($key$$132$$, 10)], $b$$65$$ = $b$$65$$[parseInt($key$$132$$, 10)]) : ($a$$108$$ = $a$$108$$[$key$$132$$], $b$$65$$ = $b$$65$$[$key$$132$$]));
        $as$$1$$ = isNaN($a$$108$$);
        $bs$$1$$ = isNaN($b$$65$$);
  ...
  $oj$$23$$.$ArrayDataGridDataSource$.prototype.move = function $$oj$$23$$$$ArrayDataGridDataSource$$$move$($moveKey$$, $atKey$$) {
    var $event$$355_moveKeyIndex$$, $moveData$$, $atKeyIndex$$;
    $event$$355_moveKeyIndex$$ = this.$_getRowIndexByKey$($moveKey$$);
    $moveData$$ = this.data.splice($event$$355_moveKeyIndex$$, 1)[0];
    this.data instanceof Array && ($event$$355_moveKeyIndex$$ = this.$_getModelEvent$("delete", $moveKey$$, null, $event$$355_moveKeyIndex$$, -1, !0), this.handleEvent("change", $event$$355_moveKeyIndex$$));
    null === $atKey$$ ? this.data.push($moveData$$) : ($atKeyIndex$$ = this.$_getRowIndexByKey$($atKey$$), this.data.splice($atKeyIndex$$, 0, $moveData$$));
    this.data instanceof Array && ($event$$355_moveKeyIndex$$ = this.$_getModelEvent$("insert", $moveKey$$, null, $atKeyIndex$$, -1), this.handleEvent("change", $event$$355_moveKeyIndex$$));
  ...
  $oj$$23$$.$ArrayDataGridDataSource$.prototype.$_getRowIndexByKey$ = function $$oj$$23$$$$ArrayDataGridDataSource$$$$_getRowIndexByKey$$($key$$133$$) {
    var $i$$306$$, $data$$144$$ = this.$getDataArray$();
    for ($i$$306$$ = 0;$i$$306$$ < $data$$144$$.length;$i$$306$$++) {
      if ($data$$144$$[$i$$306$$].ojKey === $key$$133$$) {
        return $i$$306$$;
      }
    }
    return-1;
  ...
  $oj$$23$$.$ArrayDataGridDataSource$.prototype.$_subscribe$ = function $$oj$$23$$$$ArrayDataGridDataSource$$$$_subscribe$$($changes$$5$$) {
    var $i$$307$$, $move_rowData$$4_rowKey$$32$$, $change$$5_event$$357_rowIndex$$8$$, $added$$1$$ = !1;
    $move_rowData$$4_rowKey$$32$$ = !1;
    var $keys$$37$$ = [], $indexes$$11$$ = [];
    for ($i$$307$$ = 0;$i$$307$$ < $changes$$5$$.length;$i$$307$$++) {
      $change$$5_event$$357_rowIndex$$8$$ = $changes$$5$$[$i$$307$$];
