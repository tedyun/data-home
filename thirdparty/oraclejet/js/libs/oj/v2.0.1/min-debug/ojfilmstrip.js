...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "promise"], function($oj$$42$$, $$$$39$$) {
  ...
  (function() {
    ...
    $oj$$42$$.$__registerWidget$("oj.ojFilmStrip", $$$$39$$.oj.baseComponent, {defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{maxItemsPerPage:0, orientation:"horizontal", currentItem:0, arrowPlacement:"adjacent", arrowVisibility:"auto"}, _ComponentCreate:function() {
      this._super();
      var $elem$$93_options$$326$$ = this.element;
      $elem$$93_options$$326$$.addClass("oj-filmstrip oj-component").attr("tabindex", 0).attr("role", "region");
      $elem$$93_options$$326$$.uniqueId();
      $elem$$93_options$$326$$ = this.options;
      $elem$$93_options$$326$$.disabled && $oj$$42$$.$Logger$.warn($_WARNING_DISABLED_OPTION$$1$$);
      if ($elem$$93_options$$326$$.orientation !== $_HORIZONTAL$$ && $elem$$93_options$$326$$.orientation !== $_VERTICAL$$) {
        throw Error($_ERROR_INVALID_ORIENTATION$$ + $elem$$93_options$$326$$.orientation);
      }
      if ($elem$$93_options$$326$$.arrowPlacement !== $_ADJACENT$$ && $elem$$93_options$$326$$.arrowPlacement !== $_OVERLAY$$) {
        throw Error($_ERROR_INVALID_NAV_ARROW_PLACEMENT$$ + $elem$$93_options$$326$$.arrowPlacement);
      }
      if ($elem$$93_options$$326$$.arrowVisibility !== $_VISIBLE$$ && $elem$$93_options$$326$$.arrowVisibility !== $_HIDDEN$$ && $elem$$93_options$$326$$.arrowVisibility !== $_HOVER$$ && $elem$$93_options$$326$$.arrowVisibility !== $_AUTO$$) {
        throw Error($_ERROR_INVALID_NAV_ARROW_VISIBILITY$$ + $elem$$93_options$$326$$.arrowVisibility);
      }
      ...
      if (this.$_canCalculateSizes$()) {
        ...
        var $elem$$94_oldIsInit$$1$$ = this.element, $self$$182$$ = this;
        ...
        }, this.$_pagingModel$ = new $oj$$42$$.$FilmStripPagingModel$, this.$_componentSize$ = 0, this.$_itemSize$ = -1, this.$_handleTransitionEndFunc$ = function $this$$_handleTransitionEndFunc$$() {
        ...
        for (var $originalItems$$ = $elem$$94_oldIsInit$$1$$.children(), $i$$357$$ = 0;$i$$357$$ < $originalItems$$.length;$i$$357$$++) {
          $oj$$42$$.Components.$subtreeDetached$($originalItems$$[$i$$357$$]);
        }
        ...
        this.$_wrapChildren$();
        this.$_adjustSizes$();
        for ($i$$357$$ = 0;$i$$357$$ < $originalItems$$.length;$i$$357$$++) {
          $oj$$42$$.Components.$subtreeAttached$($originalItems$$[$i$$357$$]);
        }
        $oj$$42$$.$DomUtils$.$addResizeListener$($elem$$94_oldIsInit$$1$$[0], this.$_handleResizeFunc$);
      } else {
        $elem$$94_oldIsInit$$1$$ = !1, this.$_needsSetup$ && ($elem$$94_oldIsInit$$1$$ = this.$_needsSetup$[0]), this.$_needsSetup$ = [$isInit$$1_pagingModel$$ || $elem$$94_oldIsInit$$1$$];
      }
    }, _destroy:function() {
      ...
      $elem$$95$$.removeClass("oj-filmstrip oj-component " + $_OJ_FILMSTRIP_HOVER$$).removeAttr("tabindex role");
      $elem$$95$$.removeUniqueId();
      this._super();
      ...
      for (var $originalItems$$1$$ = this.$_getItems$(), $i$$358$$ = 0;$i$$358$$ < $originalItems$$1$$.length;$i$$358$$++) {
        $oj$$42$$.Components.$subtreeDetached$($originalItems$$1$$[$i$$358$$]);
      }
      this.$_clearCalculatedSizes$();
      this.$_getItemContainers$().unwrap();
      this.$_unwrapChildren$();
      for ($i$$358$$ = 0;$i$$358$$ < $originalItems$$1$$.length;$i$$358$$++) {
        $oj$$42$$.Components.$subtreeAttached$($originalItems$$1$$[$i$$358$$]);
      }
    }, _setOption:function($key$$160$$, $value$$282$$, $flags$$40$$) {
      ...
      switch($key$$160$$) {
        case "disabled":
          ...
          break;
        case "orientation":
          if ($value$$282$$ !== $_HORIZONTAL$$ && $value$$282$$ !== $_VERTICAL$$) {
            throw Error($_ERROR_INVALID_ORIENTATION$$ + $value$$282$$);
          }
          $bRefresh$$ = $options$$327$$.orientation != $value$$282$$;
          break;
        case "maxItemsPerPage":
          $bRefresh$$ = $options$$327$$.maxItemsPerPage != $value$$282$$;
          break;
        case "arrowPlacement":
          if ($value$$282$$ !== $_ADJACENT$$ && $value$$282$$ !== $_OVERLAY$$) {
            throw Error($_ERROR_INVALID_NAV_ARROW_PLACEMENT$$ + $value$$282$$);
          }
          $bRefresh$$ = $options$$327$$.arrowPlacement != $value$$282$$;
          break;
        case "arrowVisibility":
          if ($value$$282$$ !== $_VISIBLE$$ && $value$$282$$ !== $_HIDDEN$$ && $value$$282$$ !== $_HOVER$$ && $value$$282$$ !== $_AUTO$$) {
            throw Error($_ERROR_INVALID_NAV_ARROW_VISIBILITY$$ + $value$$282$$);
          }
          $bRefresh$$ = $options$$327$$.arrowVisibility != $value$$282$$;
          break;
        case $_CURRENT_ITEM$$:
          if ($options$$327$$.currentItem != $value$$282$$ && ($newPageIndex$$ = this.$_findPage$($value$$282$$), 0 > $newPageIndex$$ || $newPageIndex$$ >= $pagingModel$$1$$.getPageCount())) {
            throw Error($_ERROR_CURRENT_ITEM_NOT_FOUND$$ + $value$$282$$);
          }
        ;
      }
      this._super($key$$160$$, $value$$282$$, $flags$$40$$);
      switch($key$$160$$) {
        case $_CURRENT_ITEM$$:
      ...
      var $div$$4$$ = document.createElement("div"), $elem$$97_style$$20$$ = $div$$4$$.style;
      $elem$$97_style$$20$$.position = "absolute";
      $elem$$97_style$$20$$.width = "10px";
      $elem$$97_style$$20$$.height = "10px";
      $elem$$97_style$$20$$ = this.element[0];
      $elem$$97_style$$20$$.appendChild($div$$4$$);
      var $bCanCalcSizes$$1$$ = !1;
      try {
        $bCanCalcSizes$$1$$ = 0 < $div$$4$$.offsetWidth && 0 < $div$$4$$.offsetHeight;
      } catch ($e$$99$$) {
      }
      $elem$$97_style$$20$$.removeChild($div$$4$$);
      return $bCanCalcSizes$$1$$;
    }, $_wrapChildren$:function() {
      var $elem$$98$$ = this.element, $bHorizontal$$2$$ = this.$_isHorizontal$();
      $elem$$98$$.children().addClass($_OJ_FILMSTRIP_ITEM$$).wrap("\x3cdiv class\x3d'" + $_OJ_FILMSTRIP_CONTAINER$$ + " " + $_OJ_FILMSTRIP_ITEM_CONTAINER$$ + "'\x3e\x3c/div\x3e");
      var $cssAttr_pagesWrapper$$ = this.$_getCssPositionAttr$();
      this.$_pagesWrapper$ = $cssAttr_pagesWrapper$$ = $elem$$98$$.children().wrapAll("\x3cdiv class\x3d'" + $_OJ_FILMSTRIP_CONTAINER$$ + " " + $_OJ_FILMSTRIP_PAGES_CONTAINER$$ + "' style\x3d'" + $cssAttr_pagesWrapper$$ + ": 0px;'\x3e\x3c/div\x3e").parent();
      ...
      $elem$$98$$.addClass($_OJ_FILMSTRIP_CONTAINER$$);
      $bHorizontal$$2$$ || $elem$$98$$.addClass($_OJ_FILMSTRIP_VERTICAL$$);
      ...
      var $elem$$99$$ = this.element, $originalItems$$3$$ = this.$_getItems$();
      ...
      var $navArrowContainers$$ = $elem$$99$$.children($_PERIOD$$ + $_OJ_FILMSTRIP_ARROW_CONTAINER$$);
      ...
      $elem$$99$$.removeClass($_OJ_FILMSTRIP_CONTAINER$$ + " " + $_OJ_FILMSTRIP_VERTICAL$$);
      ...
      var $elem$$102_label$$13$$ = this.element, $locationMarker_navArrow$$ = this.$_isHorizontal$() ? $_OJ_START$$ : $_OJ_TOP$$, $container$$25$$ = this.$_createNavigationArrowContainer$($locationMarker_navArrow$$);
      this.options.arrowPlacement === $_OVERLAY$$ ? $elem$$102_label$$13$$.append($container$$25$$) : $elem$$102_label$$13$$.prepend($container$$25$$);
      var $elem$$102_label$$13$$ = $_escapeHtml$$(this.$getTranslatedString$("labelAccArrowPreviousPage")), $tooltip$$ = $_escapeHtml$$(this.$getTranslatedString$("tipArrowPreviousPage")), $locationMarker_navArrow$$ = this.$_createNavigationArrow$($container$$25$$, $locationMarker_navArrow$$, $elem$$102_label$$13$$, $tooltip$$), $self$$184$$ = this;
      $locationMarker_navArrow$$.on("click", function() {
        $self$$184$$.$_prevPage$();
      });
      return $locationMarker_navArrow$$;
    }, $_createNextNavArrow$:function() {
      var $elem$$103_label$$14$$ = this.element, $locationMarker$$1_navArrow$$1$$ = this.$_isHorizontal$() ? $_OJ_END$$ : $_OJ_BOTTOM$$, $container$$26$$ = this.$_createNavigationArrowContainer$($locationMarker$$1_navArrow$$1$$);
      $elem$$103_label$$14$$.append($container$$26$$);
      var $elem$$103_label$$14$$ = $_escapeHtml$$(this.$getTranslatedString$("labelAccArrowNextPage")), $tooltip$$1$$ = $_escapeHtml$$(this.$getTranslatedString$("tipArrowNextPage")), $locationMarker$$1_navArrow$$1$$ = this.$_createNavigationArrow$($container$$26$$, $locationMarker$$1_navArrow$$1$$, $elem$$103_label$$14$$, $tooltip$$1$$), $self$$185$$ = this;
      ...
      $componentSize_optionItemContainer_optionItemIndex$$ = $arrowSize_bCreatePages_bHorizontal$$5_calcFitCount$$ ? $elem$$105_firstArrowContainer_pagingModel$$7$$.width() : $elem$$105_firstArrowContainer_pagingModel$$7$$.height();
      $currPage_options$$336$$.arrowVisibility !== $_HIDDEN$$ && $currPage_options$$336$$.arrowPlacement === $_ADJACENT$$ && ($elem$$105_firstArrowContainer_pagingModel$$7$$ = $elem$$105_firstArrowContainer_pagingModel$$7$$.children($_PERIOD$$ + $_OJ_FILMSTRIP_ARROW_CONTAINER$$).eq(0), $arrowSize_bCreatePages_bHorizontal$$5_calcFitCount$$ = $arrowSize_bCreatePages_bHorizontal$$5_calcFitCount$$ ? $elem$$105_firstArrowContainer_pagingModel$$7$$.width() : $elem$$105_firstArrowContainer_pagingModel$$7$$.height(), 
      ...
      $elem$$105_firstArrowContainer_pagingModel$$7$$ = this.$_pagingModel$;
      if ($elem$$105_firstArrowContainer_pagingModel$$7$$.getPageCount() != $bCalcItemsPerPage_fitItemSize_newPageCount$$1$$ || this.$_itemsPerPage$ != $fitCount_itemsPerPage$$ || !$optionItem_pages$$2$$ || 1 > $optionItem_pages$$2$$.length) {
        $arrowSize_bCreatePages_bHorizontal$$5_calcFitCount$$ = !0;
        if ($bNotifyAttach_contentWrapper_newPageIndex$$1$$) {
          for (var $i$$359$$ = 0;$i$$359$$ < $items$$11$$.length;$i$$359$$++) {
            $oj$$42$$.Components.$subtreeDetached$($items$$11$$[$i$$359$$]);
          }
        }
        $optionItem_pages$$2$$ && 0 < $optionItem_pages$$2$$.length && $items$$11$$.unwrap();
        for ($i$$359$$ = 0;$i$$359$$ < $items$$11$$.length;$i$$359$$ += $fitCount_itemsPerPage$$) {
          $items$$11$$.slice($i$$359$$, $i$$359$$ + $fitCount_itemsPerPage$$).wrapAll("\x3cdiv class\x3d'" + $_OJ_FILMSTRIP_CONTAINER$$ + " " + $_OJ_FILMSTRIP_PAGE$$ + "' style\x3d'" + $_DISPLAY$$ + ": " + $_NONE$$ + ";' " + $_ARIA_HIDDEN$$ + "\x3d'true'\x3e\x3c/div\x3e");
        }
        if ($bNotifyAttach_contentWrapper_newPageIndex$$1$$) {
          for ($i$$359$$ = 0;$i$$359$$ < $items$$11$$.length;$i$$359$$++) {
            $oj$$42$$.Components.$subtreeAttached$($items$$11$$[$i$$359$$]);
          }
        }
      }
      $optionItem_pages$$2$$ = this.$_getPages$();
      ...
      $elem$$105_firstArrowContainer_pagingModel$$7$$.getPageCount() != $bCalcItemsPerPage_fitItemSize_newPageCount$$1$$ || this.$_itemsPerPage$ != $fitCount_itemsPerPage$$ || $elem$$105_firstArrowContainer_pagingModel$$7$$.getPage() != $bNotifyAttach_contentWrapper_newPageIndex$$1$$ ? $elem$$105_firstArrowContainer_pagingModel$$7$$.setPage($bNotifyAttach_contentWrapper_newPageIndex$$1$$, {pageSize:$fitCount_itemsPerPage$$}) : $arrowSize_bCreatePages_bHorizontal$$5_calcFitCount$$ && ($currPage_options$$336$$ = 
      $elem$$105_firstArrowContainer_pagingModel$$7$$.getPage(), this.$_handlePage$({previousPage:$currPage_options$$336$$, page:$currPage_options$$336$$}));
      ...
      var $newFirstItem_pageIndex$$3_pagesWrapper$$8$$ = this.$_pagesWrapper$, $cssAttr$$2_elem$$106_focusElem$$ = this.$_getCssPositionAttr$();
      $newFirstItem_pageIndex$$3_pagesWrapper$$8$$.off(this.eventNamespace).css(this.$_getCssSizeAttr$(), this.$_componentSize$).css($cssAttr$$2_elem$$106_focusElem$$, "0px");
      $cssAttr$$2_elem$$106_focusElem$$ = null;
      if ($oj$$42$$.$FocusUtils$.$containsFocus$($newFirstItem_pageIndex$$3_pagesWrapper$$8$$[0]) || this.$_nextButton$ && $oj$$42$$.$FocusUtils$.$containsFocus$(this.$_nextButton$[0]) || this.$_prevButton$ && $oj$$42$$.$FocusUtils$.$containsFocus$(this.$_prevButton$[0])) {
        $cssAttr$$2_elem$$106_focusElem$$ = document.activeElement;
      }
      for (var $newFirstItem_pageIndex$$3_pagesWrapper$$8$$ = this.$_pagingModel$.getPage(), $firstTabStop_pages$$5$$ = this.$_getPages$(), $i$$360$$ = 0;$i$$360$$ < $firstTabStop_pages$$5$$.length;$i$$360$$++) {
        $i$$360$$ != $newFirstItem_pageIndex$$3_pagesWrapper$$8$$ && this.$_hidePage$($$$$39$$($firstTabStop_pages$$5$$[$i$$360$$]));
      }
      ...
      $cssAttr$$2_elem$$106_focusElem$$ && $$$$39$$($cssAttr$$2_elem$$106_focusElem$$).is($_HIDDEN_SELECTOR$$) && ($cssAttr$$2_elem$$106_focusElem$$ = this.element, ($firstTabStop_pages$$5$$ = $oj$$42$$.$FocusUtils$.$getFirstTabStop$($firstTabStop_pages$$5$$[$newFirstItem_pageIndex$$3_pagesWrapper$$8$$])) ? $oj$$42$$.$FocusUtils$.$focusElement$($firstTabStop_pages$$5$$) : $oj$$42$$.$FocusUtils$.$focusElement$($cssAttr$$2_elem$$106_focusElem$$[0]));
      ...
      if ("number" === typeof $item$$113$$) {
        ...
        if ("string" === typeof $item$$113$$ && $oj$$42$$.$DomUtils$.$isValidIdentifier$($item$$113$$)) {
          for (var $i$$361$$ = 0;$i$$361$$ < $items$$12$$.length;$i$$361$$++) {
            var $itemId$$ = $items$$12$$[$i$$361$$].id;
      ...
      if (this.$_bTouch$) {
        ...
        if (this.$_bDragInit$) {
          ...
          if ($bNext$$2$$ && $pageIndex$$7_pageToHide$$ < $pagingModel$$14_scrollVal_transform$$.getPageCount() - 1 || !$bNext$$2$$ && 0 < $pageIndex$$7_pageToHide$$) {
            var $currScroll$$4_elem$$113_pages$$7$$ = this.element[0], $threshold$$2$$ = Math.min($_DRAG_SCROLL_THRESHOLD$$ * ($bHorizontal$$8_newPageIndex$$3$$ ? $currScroll$$4_elem$$113_pages$$7$$.offsetWidth : $currScroll$$4_elem$$113_pages$$7$$.offsetHeight), $_DRAG_SCROLL_MAX_THRESHOLD$$), $cssAttr$$4$$ = this.$_getCssPositionAttr$(), $pagesWrapper$$10$$ = this.$_pagesWrapper$, $currScroll$$4_elem$$113_pages$$7$$ = this.$_getPages$();
            Math.abs($diff$$1$$) >= $threshold$$2$$ ? ($bHorizontal$$8_newPageIndex$$3$$ = $bNext$$2$$ ? $pageIndex$$7_pageToHide$$ + 1 : $pageIndex$$7_pageToHide$$ - 1, this.$_getFirstItemOnPage$($bHorizontal$$8_newPageIndex$$3$$), $pageIndex$$7_pageToHide$$ = $bNext$$2$$ ? $pageIndex$$7_pageToHide$$ - 1 : $pageIndex$$7_pageToHide$$ + 1, -1 < $pageIndex$$7_pageToHide$$ && $pageIndex$$7_pageToHide$$ < $pagingModel$$14_scrollVal_transform$$.getPageCount() && this.$_hidePage$($$$$39$$($currScroll$$4_elem$$113_pages$$7$$[$pageIndex$$7_pageToHide$$])), 
            $bNext$$2$$ && -1 < $pageIndex$$7_pageToHide$$ && ($currScroll$$4_elem$$113_pages$$7$$ = parseInt($pagesWrapper$$10$$.css($cssAttr$$4$$), 10), $pagesWrapper$$10$$.css($cssAttr$$4$$, $currScroll$$4_elem$$113_pages$$7$$ + this.$_componentSize$ + $_PX$$)), $pagesWrapper$$10$$.css(this.$_getCssSizeAttr$(), 2 * this.$_componentSize$), this.$_bTouch$ = !1, $pagingModel$$14_scrollVal_transform$$.setPage($bHorizontal$$8_newPageIndex$$3$$)) : ($pagingModel$$14_scrollVal_transform$$ = $bHorizontal$$8_newPageIndex$$3$$ && 
            this.$_bRTL$ ? -$diff$$1$$ : $diff$$1$$, $pagingModel$$14_scrollVal_transform$$ = $bHorizontal$$8_newPageIndex$$3$$ ? "translate3d(" + $pagingModel$$14_scrollVal_transform$$ + "px, 0, 0)" : "translate3d(0, " + $pagingModel$$14_scrollVal_transform$$ + "px, 0)", $_applyTransform$$($currScroll$$4_elem$$113_pages$$7$$.filter($_VISIBLE_SELECTOR$$), $pagingModel$$14_scrollVal_transform$$));
