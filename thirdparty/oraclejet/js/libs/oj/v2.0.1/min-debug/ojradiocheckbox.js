...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue"], function($oj$$65$$, $$$$59$$) {
  $oj$$65$$.$__registerWidget$("oj._ojRadioCheckbox", $$$$59$$.oj.baseComponent, {version:"1.0.0", defaultElement:"\x3cinput\x3e", widgetEventPrefix:"oj", options:{disabled:null, checked:null, type:null}, label:function() {
    ...
    this._super();
    var $type$$103$$ = this.options.type;
    "checkbox" == $type$$103$$ ? (this.$uiRadioCheckbox$ = this.element.addClass("oj-checkbox oj-component"), this.$$label$ = this.$_getLabelsForElement$(), this.$$label$.addClass("oj-checkbox-label")) : "radio" == $type$$103$$ && (this.$uiRadioCheckbox$ = this.element.addClass("oj-radio oj-component"), this.$$label$ = this.$_getLabelsForElement$(), this.$$label$.addClass("oj-radio-label"));
    ...
    this.$_setup$();
  }, $_SaveAttributes$:function($element$$161$$) {
    this.$_savedClasses$ = $element$$161$$.attr("class");
  ...
  }, _setOption:function($key$$179$$, $value$$306$$) {
    this._superApply(arguments);
    "disabled" === $key$$179$$ && ($value$$306$$ = !!$value$$306$$, this.$_renderDisabled$($value$$306$$));
    "checked" === $key$$179$$ && (this.$_setCheckedOnDom$($value$$306$$), this.element.toggleClass("oj-selected", $value$$306$$), this.$$label$.toggleClass("oj-selected", $value$$306$$), this.$$choiceRow$ && this.$$choiceRow$.toggleClass("oj-selected", $value$$306$$));
    ...
    var $ret$$54$$ = this._super(), $type$$104$$ = this.options.type;
    "checkbox" == $type$$104$$ ? this.$$label$.removeClass("oj-enabled oj-disabled oj-selected oj-checkbox-label") : "radio" == $type$$104$$ && this.$$label$.removeClass("oj-enabled oj-disabled oj-selected oj-radio-label");
