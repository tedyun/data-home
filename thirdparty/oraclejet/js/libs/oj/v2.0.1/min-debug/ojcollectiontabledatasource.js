...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common", "ojs/ojmodel"], function($oj$$32$$, $$$$31$$) {
  ...
  $oj$$32$$.$CollectionTableDataSource$.prototype.at = function $$oj$$32$$$$CollectionTableDataSource$$$at$($index$$200$$, $options$$305$$) {
    ...
    var $model$$71$$ = this.$_collection$.at($index$$200$$, $options$$305$$), $self$$161$$ = this;
    $self$$161$$.$_isFetchingForAt$ = !0;
    var $row$$42$$;
    return new Promise(function($resolve$$42$$, $reject$$39$$) {
      null != $model$$71$$ ? $model$$71$$.then(function($resolvedModel$$) {
  ...
  $oj$$32$$.$CollectionTableDataSource$.prototype.get = function $$oj$$32$$$$CollectionTableDataSource$$$get$($id$$34$$, $options$$307$$) {
    ...
    var $model$$72$$ = this.$_collection$.get($id$$34$$, $options$$307$$), $self$$162$$ = this, $row$$43$$;
    return new Promise(function($resolve$$43$$, $reject$$40$$) {
      null != $model$$72$$ ? $model$$72$$.then(function($resolvedModel$$1$$) {
  ...
  $oj$$32$$.$CollectionTableDataSource$.prototype.$_addCollectionEventListeners$ = function $$oj$$32$$$$CollectionTableDataSource$$$$_addCollectionEventListeners$$() {
    var $self$$164$$ = this;
    this.$_collection$.on($oj$$32$$.$Events$.$EventType$.SYNC, function($event$$401_result$$64$$) {
      if ($event$$401_result$$64$$ instanceof $oj$$32$$.$Collection$ && !$self$$164$$.$_isFetchingForAt$ && !$self$$164$$.$_isFetching$) {
        var $startIndex$$29$$ = $event$$401_result$$64$$.offset, $pageSize$$6$$ = $event$$401_result$$64$$.lastFetchCount;
        0 < $pageSize$$6$$ ? ($self$$164$$.$_startIndex$ = $startIndex$$29$$, $self$$164$$.$_pageSize$ = $pageSize$$6$$, $self$$164$$.$_isFetchingForAt$ = !0, $event$$401_result$$64$$.$IterativeAt$($startIndex$$29$$, $startIndex$$29$$ + $pageSize$$6$$).then(function($modelArray$$2$$) {
        ...
        })) : ($event$$401_result$$64$$ = $self$$164$$.$_getRowArray$(), $self$$164$$.$_endFetch$.call($self$$164$$, {silent:!1}, $event$$401_result$$64$$, null));
      }
    });
  ...
  $oj$$32$$.$CollectionTableDataSource$.prototype.$_setComparator$ = function $$oj$$32$$$$CollectionTableDataSource$$$$_setComparator$$($criteria$$5_direction$$11$$) {
    if (null == $criteria$$5_direction$$11$$) {
      ...
      var $key$$146$$ = $criteria$$5_direction$$11$$.key;
      $criteria$$5_direction$$11$$ = $criteria$$5_direction$$11$$.direction;
      var $comparator$$15$$ = null;
      this.$_collection$.$IsVirtual$() ? (this.$_collection$.comparator = $key$$146$$, this.$_collection$.sortDirection = "ascending" === $criteria$$5_direction$$11$$ ? 1 : -1) : ("ascending" == $criteria$$5_direction$$11$$ ? $comparator$$15$$ = function $$comparator$$15$$$($row$$44$$) {
        return $$$$31$$.isFunction($row$$44$$.get) ? $row$$44$$.get($key$$146$$) : $row$$44$$[$key$$146$$]();
      } : "descending" == $criteria$$5_direction$$11$$ && ($comparator$$15$$ = function $$comparator$$15$$$($rowA$$1$$, $rowB$$1$$) {
        var $a$$115$$, $b$$72$$;
        $$$$31$$.isFunction($rowA$$1$$.get) ? ($a$$115$$ = $rowA$$1$$.get($key$$146$$), $b$$72$$ = $rowB$$1$$.get($key$$146$$)) : ($a$$115$$ = $rowA$$1$$[$key$$146$$](), $b$$72$$ = $rowB$$1$$[$key$$146$$]());
