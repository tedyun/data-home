...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common"], function($oj$$48$$) {
  ...
  $oj$$48$$.$JsonNodeSet$.prototype.$_updateDepth$ = function $$oj$$48$$$$JsonNodeSet$$$$_updateDepth$$($currChild$$2$$, $offset$$26$$) {
    ...
    if ($currChild$$2$$.children && 0 != $currChild$$2$$.children.length) {
      for ($i$$382$$ = 0;$i$$382$$ < $currChild$$2$$.children.length;$i$$382$$++) {
        this.$_updateDepth$($currChild$$2$$.children[$i$$382$$], $offset$$26$$);
      }
    }
  };
  $oj$$48$$.$JsonNodeSet$.prototype.$getChildNodeSet$ = function $$oj$$48$$$$JsonNodeSet$$$$getChildNodeSet$$($index$$231_key$$165$$) {
    var $results$$12$$, $depth$$27$$, $i$$383$$;
    $oj$$48$$.$Assert$.assert($index$$231_key$$165$$ <= this.$m_endNode$ && $index$$231_key$$165$$ >= this.$m_startNode$);
    $index$$231_key$$165$$ -= this.$m_startNode$;
    $depth$$27$$ = this.$m_nodes$[$index$$231_key$$165$$].depth;
    $results$$12$$ = this.$m_nodes$[$index$$231_key$$165$$].children;
    if (0 == $results$$12$$.length) {
      return null;
    }
    $index$$231_key$$165$$ = this.$m_nodes$[$index$$231_key$$165$$].id ? this.$m_nodes$[$index$$231_key$$165$$].id : this.$m_nodes$[$index$$231_key$$165$$].attr.id;
    for ($i$$383$$ = 0;$i$$383$$ < $results$$12$$.length;$i$$383$$++) {
      this.$_updateDepth$($results$$12$$[$i$$383$$], $depth$$27$$);
    }
    return new $oj$$48$$.$JsonNodeSet$(0, $results$$12$$.length, $results$$12$$, $index$$231_key$$165$$);
  };
  ...
  $oj$$48$$.$_JsonTreeNodeDataSource$.prototype.$_ascending$ = function $$oj$$48$$$$_JsonTreeNodeDataSource$$$$_ascending$$($key$$166$$) {
    return function($a$$120$$, $b$$74$$) {
      return $a$$120$$.attr && $b$$74$$.attr && $a$$120$$.attr[$key$$166$$] && $b$$74$$.attr[$key$$166$$] ? $a$$120$$.attr[$key$$166$$] < $b$$74$$.attr[$key$$166$$] ? -1 : $a$$120$$.attr[$key$$166$$] === $b$$74$$.attr[$key$$166$$] ? 0 : 1 : $a$$120$$[$key$$166$$] < $b$$74$$[$key$$166$$] ? -1 : $a$$120$$[$key$$166$$] === $b$$74$$[$key$$166$$] ? 0 : 1;
    };
  };
  $oj$$48$$.$_JsonTreeNodeDataSource$.prototype.$_descending$ = function $$oj$$48$$$$_JsonTreeNodeDataSource$$$$_descending$$($key$$167$$) {
    return function($a$$121$$, $b$$75$$) {
      return $a$$121$$.attr && $b$$75$$.attr && $a$$121$$.attr[$key$$167$$] && $b$$75$$.attr[$key$$167$$] ? $a$$121$$.attr[$key$$167$$] < $b$$75$$.attr[$key$$167$$] ? 1 : $a$$121$$.attr[$key$$167$$] === $b$$75$$.attr[$key$$167$$] ? 0 : -1 : $a$$121$$[$key$$167$$] < $b$$75$$[$key$$167$$] ? 1 : $a$$121$$[$key$$167$$] === $b$$75$$[$key$$167$$] ? 0 : -1;
    };
  };
  $oj$$48$$.$_JsonTreeNodeDataSource$.prototype.$_sortRecursive$ = function $$oj$$48$$$$_JsonTreeNodeDataSource$$$$_sortRecursive$$($criteria$$9$$) {
    var $i$$384_key$$168$$ = $criteria$$9$$.key;
    "ascending" === $criteria$$9$$.direction ? this.children.sort(this.$_ascending$($i$$384_key$$168$$)) : "descending" === $criteria$$9$$.direction && this.children.sort(this.$_descending$($i$$384_key$$168$$));
    for (var $i$$384_key$$168$$ = 0, $l$$11$$ = this.children.length;$i$$384_key$$168$$ < $l$$11$$;$i$$384_key$$168$$++) {
      this.children[$i$$384_key$$168$$].$_sortRecursive$($criteria$$9$$);
    }
  };
  ...
  $oj$$48$$.$JsonTreeDataSource$.prototype.$fetchChildren$ = function $$oj$$48$$$$JsonTreeDataSource$$$$fetchChildren$$($nodeSet$$38_parentKey$$9$$, $i$$385_range$$20$$, $callbacks$$52$$) {
    var $childStart$$, $childEnd$$, $results$$13$$, $parent$$44$$, $node$$105$$;
    $results$$13$$ = [];
    ...
    $i$$385_range$$20$$ || ($i$$385_range$$20$$ = [], $i$$385_range$$20$$.start = 0, $i$$385_range$$20$$.count = $parent$$44$$.children.length);
    $i$$385_range$$20$$.count || ($i$$385_range$$20$$.count = $parent$$44$$.children.length);
    $i$$385_range$$20$$.start || ($i$$385_range$$20$$.start = 0);
    $childStart$$ = $i$$385_range$$20$$.start;
    $childEnd$$ = Math.min($parent$$44$$.children.length, $childStart$$ + $i$$385_range$$20$$.count);
    for ($i$$385_range$$20$$ = $childStart$$;$i$$385_range$$20$$ < $childEnd$$;$i$$385_range$$20$$ += 1) {
      $node$$105$$ = new $oj$$48$$.$_JsonTreeNodeDataSource$, $parent$$44$$.children[$i$$385_range$$20$$].attr && ($node$$105$$.attr = $parent$$44$$.children[$i$$385_range$$20$$].attr), $parent$$44$$.children[$i$$385_range$$20$$].id && ($node$$105$$.id = $parent$$44$$.children[$i$$385_range$$20$$].id), $parent$$44$$.children[$i$$385_range$$20$$].depth && ($node$$105$$.depth = $parent$$44$$.children[$i$$385_range$$20$$].depth), $parent$$44$$.children[$i$$385_range$$20$$].title && ($node$$105$$.title = 
      $parent$$44$$.children[$i$$385_range$$20$$].title), $parent$$44$$.children[$i$$385_range$$20$$].parent && ($node$$105$$.parent = $parent$$44$$.children[$i$$385_range$$20$$].parent), $node$$105$$.$leaf$ = 0 < $parent$$44$$.children[$i$$385_range$$20$$].children.length ? !1 : !0, $results$$13$$.push($node$$105$$);
    }
    $nodeSet$$38_parentKey$$9$$ = new $oj$$48$$.$JsonNodeSet$($childStart$$, $childEnd$$, $results$$13$$, $nodeSet$$38_parentKey$$9$$);
  ...
  $oj$$48$$.$JsonTreeDataSource$.prototype.$fetchDescendants$ = function $$oj$$48$$$$JsonTreeDataSource$$$$fetchDescendants$$($parentKey$$10$$, $callbacks$$53$$) {
    var $childEnd$$1_range$$21$$, $childStart$$1_i$$386$$, $nodeSet$$39_results$$14$$, $parent$$45$$;
    ...
    $childStart$$1_i$$386$$ = $childEnd$$1_range$$21$$.start;
    for ($childEnd$$1_range$$21$$ = Math.min($parent$$45$$.children.length, $childStart$$1_i$$386$$ + $childEnd$$1_range$$21$$.count);$childStart$$1_i$$386$$ < $childEnd$$1_range$$21$$;$childStart$$1_i$$386$$ += 1) {
      $parent$$45$$.children[$childStart$$1_i$$386$$].$leaf$ = 0 < $parent$$45$$.children[$childStart$$1_i$$386$$].children.length ? !1 : !0, $nodeSet$$39_results$$14$$.push($parent$$45$$.children[$childStart$$1_i$$386$$]);
    }
    $nodeSet$$39_results$$14$$ = new $oj$$48$$.$JsonNodeSet$(0, $nodeSet$$39_results$$14$$.length, $nodeSet$$39_results$$14$$, $parentKey$$10$$);
  ...
  $oj$$48$$.$JsonTreeDataSource$.prototype.$_getParentById$ = function $$oj$$48$$$$JsonTreeDataSource$$$$_getParentById$$($refNodeKey$$1$$, $currNode$$4$$) {
    var $i$$387$$, $parent$$48$$ = null;
    if ($refNodeKey$$1$$ == this.data.id) {
      return null;
    }
    $currNode$$4$$ || ($currNode$$4$$ = this.data);
    if ($currNode$$4$$.children && 0 < $currNode$$4$$.children.length) {
      for ($i$$387$$ = 0;$i$$387$$ < $currNode$$4$$.children.length;$i$$387$$++) {
        if ($currNode$$4$$.children[$i$$387$$].id && $currNode$$4$$.children[$i$$387$$].id == $refNodeKey$$1$$ || $currNode$$4$$.children[$i$$387$$].attr && $currNode$$4$$.children[$i$$387$$].attr.id == $refNodeKey$$1$$) {
          return $currNode$$4$$;
        }
      }
      for ($i$$387$$ = 0;$i$$387$$ < $currNode$$4$$.children.length && !($parent$$48$$ = this.$_getParentById$($refNodeKey$$1$$, $currNode$$4$$.children[$i$$387$$]));$i$$387$$++) {
      }
    }
    return $parent$$48$$;
  };
  $oj$$48$$.$JsonTreeDataSource$.prototype.$_searchTreeById$ = function $$oj$$48$$$$JsonTreeDataSource$$$$_searchTreeById$$($currChild$$3$$, $parentKey$$12$$) {
    ...
    if (null != $currChild$$3$$.children) {
      for ($i$$388$$ = 0;$i$$388$$ < $currChild$$3$$.children.length && !$result$$75$$;$i$$388$$++) {
        $result$$75$$ = $currChild$$3$$.children[$i$$388$$].id && $currChild$$3$$.children[$i$$388$$].id == $parentKey$$12$$ || $currChild$$3$$.children[$i$$388$$].attr && $currChild$$3$$.children[$i$$388$$].attr.id == $parentKey$$12$$ ? $currChild$$3$$.children[$i$$388$$] : this.$_searchTreeById$($currChild$$3$$.children[$i$$388$$], $parentKey$$12$$);
      }
    }
    return $result$$75$$;
  };
  $oj$$48$$.$JsonTreeDataSource$.prototype.$_updateDepth$ = function $$oj$$48$$$$JsonTreeDataSource$$$$_updateDepth$$($currChild$$4$$, $offset$$27$$) {
    ...
    if ($currChild$$4$$.children && 0 != $currChild$$4$$.children.length) {
      for ($i$$389$$ = 0;$i$$389$$ < $currChild$$4$$.children.length;$i$$389$$++) {
        this.$_updateDepth$($currChild$$4$$.children[$i$$389$$], $offset$$27$$);
      }
    }
  };
  $oj$$48$$.$JsonTreeDataSource$.prototype.$_removeFromTree$ = function $$oj$$48$$$$JsonTreeDataSource$$$$_removeFromTree$$($currChild$$5_index$$233$$) {
    var $key$$169_parent$$49$$;
    $currChild$$5_index$$233$$.id ? $key$$169_parent$$49$$ = $currChild$$5_index$$233$$.id : $currChild$$5_index$$233$$.attr && ($key$$169_parent$$49$$ = $currChild$$5_index$$233$$.attr.id);
    ($key$$169_parent$$49$$ = this.$_getParentById$($key$$169_parent$$49$$)) || ($key$$169_parent$$49$$ = this.data);
    $currChild$$5_index$$233$$ = $key$$169_parent$$49$$.children.indexOf($currChild$$5_index$$233$$);
    -1 < $currChild$$5_index$$233$$ && $key$$169_parent$$49$$.children.splice($currChild$$5_index$$233$$, 1);
  };
