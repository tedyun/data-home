...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "jqueryui-amd/draggable", "ojs/ojtouchproxy"], function($oj$$67$$, $$$$61$$) {
  (function() {
    $oj$$67$$.$__registerWidget$("oj.ojSlider", $$$$61$$.oj.editableValue, {defaultElement:"\x3cinput\x3e", version:"1.0.1", widgetEventPrefix:"oj", options:{distance:0, max:100, min:0, orientation:"horizontal", readOnly:!1, disabled:!1, step:1, type:"fromMin", value:0, rawValue:void 0}, $_numPages$:5, $_sliderDisplayValue$:null, $_isRTL$:function() {
      ...
      var $i$$436$$, $thumbCount$$, $thumb$$1$$ = "", $thumbClasses$$ = "class\x3d'oj-slider-thumb ui-state-default' tabindex\x3d'0' role\x3d'slider'" + ("aria-valuemin \x3d '" + this.$_valueMin$() + "' ") + ("aria-valuemax \x3d '" + this.$_valueMax$() + "' ") + "\x3e\x3c/span\x3e", $thumbs$$ = [];
      $thumbCount$$ = this.$_multipleThumbs$ ? this.options.value.length : 1;
      for ($i$$436$$ = 0;$i$$436$$ < $thumbCount$$;$i$$436$$++) {
        $thumb$$1$$ = "\x3cspan " + ("id\x3d'" + this.$_getThumbId$($i$$436$$) + "' ") + $thumbClasses$$, $thumbs$$.push($thumb$$1$$);
      }
      this.$_thumbs$ = $$$$61$$($thumbs$$.join("")).appendTo(this.$_sliderContainer$);
      this.$_thumb$ = this.$_thumbs$.eq(0);
      var $that$$11$$ = this;
      this.$_thumbs$.each(function($i$$437$$) {
        $$$$61$$(this).data("oj-slider-thumb-index", $i$$437$$);
      ...
      this.$_touchProxy$ = $oj$$67$$.$_TouchProxy$.$addTouchListeners$($e$$112$$);
    }, $_tearDownTouch$:function($e$$113$$) {
      $oj$$67$$.$_TouchProxy$.$removeTouchListeners$($e$$113$$);
      ...
      this.$_multipleThumbs$ && this.$_thumbs$.each(function($i$$440$$) {
        var $thisDistance$$ = Math.abs($normValue$$ - $that$$14$$.$_getMultiValues$($i$$440$$));
        if ($distance$$1$$ > $thisDistance$$ || $distance$$1$$ === $thisDistance$$ && ($i$$440$$ === $that$$14$$.$_lastChangedValueIndex$ || $that$$14$$.$_getMultiValues$($i$$440$$) === $o$$11$$.min)) {
          $distance$$1$$ = $thisDistance$$, this.$_closestThumb$ = $$$$61$$(this), $index$$261$$ = $i$$440$$;
        }
      });
      ...
      for ($i$$441$$ = 0;$i$$441$$ < $vals$$.length;$i$$441$$ += 1) {
        $vals$$[$i$$441$$] = this.$_trimAlignValue$($vals$$[$i$$441$$]);
      }
    ...
    }, _setOption:function($key$$181$$, $coercedValue$$1_value$$310$$, $flags$$46$$) {
      "value" === $key$$181$$ && (Array.isArray($coercedValue$$1_value$$310$$) ? isNaN($coercedValue$$1_value$$310$$[0]) ? (this.$_multipleThumbs$ = !1, this.$_parse$($key$$181$$, $coercedValue$$1_value$$310$$[0])) : this.$_multipleThumbs$ = !0 : (this.$_multipleThumbs$ = !1, this.$_parse$($key$$181$$, $coercedValue$$1_value$$310$$)));
      $coercedValue$$1_value$$310$$ = "max" === $key$$181$$ || "min" === $key$$181$$ ? this.$_parse$($key$$181$$, $coercedValue$$1_value$$310$$) : "step" === $key$$181$$ ? this.$_parseStep$($coercedValue$$1_value$$310$$) : $coercedValue$$1_value$$310$$;
      "disabled" != $key$$181$$ && this._super($key$$181$$, $coercedValue$$1_value$$310$$, $flags$$46$$);
      "readOnly" === $key$$181$$ && (this.options.$readonly$ = $coercedValue$$1_value$$310$$);
      "disabled" === $key$$181$$ && (this.options.disabled = $coercedValue$$1_value$$310$$);
      switch($key$$181$$) {
        case "value":
          this.$_updateUI$();
          this.$_makeDraggable$();
      ...
      var $valPercent$$, $value$$311$$, $valueMin$$, $valueMax$$;
      this.$_multipleThumbs$ ? this.$_thumbs$.toArray().forEach(function($current$$22$$, $i$$443$$) {
        var $thumb$$12$$ = $$$$61$$($current$$22$$);
        $valPercent$$ = 100 * this.$_getThumbsValueFrac$($i$$443$$);
        ...
        $$$$61$$($thumb$$12$$).attr("aria-valuenow", this.$_getMultiValues$($i$$443$$));
        this.$_setRangeMultiThumb$($valPercent$$, $i$$443$$);
      }, this) : ($value$$311$$ = this.$_getValueAligned$(), $valueMin$$ = this.$_valueMin$(), $valueMax$$ = this.$_valueMax$(), $valPercent$$ = $valueMax$$ !== $valueMin$$ ? ($value$$311$$ - $valueMin$$) / ($valueMax$$ - $valueMin$$) * 100 : 0, this.$_isRTL$() && !this.$_isVertical$() && ($valPercent$$ = 100 - $valPercent$$), this.$_isVertical$() ? this.$_thumb$.css({top:100 - $valPercent$$ + "%"}) : this.$_thumb$.css({left:$valPercent$$ + "%"}), $$$$61$$(this.$_thumb$).attr("aria-valuenow", $value$$311$$), 
      ...
      $oj$$67$$.$EditableValueUtils$.$initializeOptionsFromDom$([{$attribute$:"disabled", $validateOption$:!0}, {$attribute$:"value"}, {$attribute$:"title"}, {$attribute$:"min"}, {$attribute$:"max"}, {$attribute$:"step"}], $constructorOptions$$19$$, this, function($initializedOptions$$2$$) {
        for (var $toParse$$1$$ = ["value", "step", "min", "max"], $i$$444$$ = 0;$i$$444$$ < $toParse$$1$$.length;$i$$444$$++) {
          var $opt$$21$$ = $toParse$$1$$[$i$$444$$], $value$$312$$ = $opt$$21$$ in $initializedOptions$$2$$ ? $initializedOptions$$2$$[$opt$$21$$] : $opts$$37$$[$opt$$21$$];
          null != $value$$312$$ && ("step" === $opt$$21$$ ? $initializedOptions$$2$$[$opt$$21$$] = $self$$213$$.$_parseStep$($value$$312$$) : "min" === $opt$$21$$ || "max" === $opt$$21$$ ? $initializedOptions$$2$$[$opt$$21$$] = $self$$213$$.$_parse$($opt$$21$$, $value$$312$$) : "value" === $opt$$21$$ && (Array.isArray($value$$312$$) ? $initializedOptions$$2$$[$opt$$21$$] = $value$$312$$ : $initializedOptions$$2$$[$opt$$21$$] = $self$$213$$.$_parse$($opt$$21$$, $value$$312$$)));
        }
      });
