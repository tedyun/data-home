...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common", "ojs/ojmodel"], function($oj$$30$$) {
  ...
  $oj$$30$$.$CollectionCellSet$.prototype.getData = function $$oj$$30$$$$CollectionCellSet$$$getData$($indexes$$12$$) {
    var $model$$60$$;
    $model$$60$$ = this.$_getModel$($indexes$$12$$);
    return null == $model$$60$$ ? null : $model$$60$$.get(this.$m_columns$[$indexes$$12$$.column]);
  };
  ...
  $oj$$30$$.$CollectionCellSet$.prototype.getMetadata = function $$oj$$30$$$$CollectionCellSet$$$getMetadata$($indexes$$13$$) {
    var $model$$61$$;
    $model$$61$$ = this.$_getModel$($indexes$$13$$);
    return null == $model$$61$$ ? null : {keys:{row:$oj$$30$$.$CollectionDataGridUtils$.$_getModelKey$($model$$61$$), column:this.$m_columns$[$indexes$$13$$.column]}};
  };
  ...
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.$_fetchCells$ = function $$oj$$30$$$$CollectionDataGridDataSource$$$$_fetchCells$$($cellRanges$$5_ranges$$2$$) {
    ...
    this.$collection$.$setRangeLocal$($rowStart$$5$$, $cellRanges$$5_ranges$$2$$.rowCount).then(function($actual$$5$$) {
      ...
      void 0 === this.columns ? this.$collection$.at($rowStart$$5$$, {deferred:!0}).then(function($model$$62$$) {
        null != $model$$62$$ && this.$_setupColumns$($model$$62$$);
  ...
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.$_setupColumns$ = function $$oj$$30$$$$CollectionDataGridDataSource$$$$_setupColumns$$($model$$63$$) {
  ...
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.$indexes$ = function $$oj$$30$$$$CollectionDataGridDataSource$$$$indexes$$($keys$$39$$) {
    ...
    return new Promise(function($resolve$$39$$) {
      $self$$155$$.$collection$.indexOf($rowKey$$34$$, {deferred:!0}).then(function($rowIndex$$10$$) {
        -1 === $rowIndex$$10$$ ? $resolve$$39$$({row:-1, column:-1}) : null == $self$$155$$.columns ? $self$$155$$.$collection$.at($rowIndex$$10$$, {deferred:!0}).then(function($model$$64$$) {
          $self$$155$$.$_setupColumns$($model$$64$$);
  ...
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.sort = function $$oj$$30$$$$CollectionDataGridDataSource$$$sort$($axis$$43_criteria$$3$$, $callbacks$$32$$, $callbackObjects$$18$$) {
    ...
    function $$comparator$$13$$$($a$$113$$, $b$$70$$) {
      ...
      var $as$$3$$, $bs$$3$$;
      $a$$114$$ = $a$$114$$.get($key$$143$$);
      $b$$71$$ = $b$$71$$.get($key$$143$$);
      $as$$3$$ = isNaN($a$$114$$);
      $bs$$3$$ = isNaN($b$$71$$);
    ...
    }), this.$collection$.comparator = $comparator$$13$$), this.$collection$.sort(), this.$_setSortInfo$($key$$143$$), null != $callbacks$$32$$ && null != $callbacks$$32$$.success && $callbacks$$32$$.success.call($callbackObjects$$18$$.success)) : null != $callbacks$$32$$ && null != $callbacks$$32$$.error && $callbacks$$32$$.error.call($callbackObjects$$18$$.error, "Axis value not supported"));
  };
  ...
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.$_setSortInfo$ = function $$oj$$30$$$$CollectionDataGridDataSource$$$$_setSortInfo$$($key$$144$$) {
    ...
    null == $key$$144$$ && "function" === typeof $comparator$$14$$ ? this.$_sortInfo$ = {} : (this.$_sortInfo$ = {}, this.$_sortInfo$.axis = "column", this.$_sortInfo$.direction = $direction$$10$$, this.$_sortInfo$.key = null == $key$$144$$ ? $comparator$$14$$ : null);
  };
  ...
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.$_handleModelAdded$ = function $$oj$$30$$$$CollectionDataGridDataSource$$$$_handleModelAdded$$($model$$65$$) {
    this.handleEvent("change", this.$_getModelEvent$("insert", $oj$$30$$.$CollectionDataGridUtils$.$_getModelKey$($model$$65$$), null, $model$$65$$.index, -1));
  };
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.$_handleModelDeleted$ = function $$oj$$30$$$$CollectionDataGridDataSource$$$$_handleModelDeleted$$($model$$66$$, $collection$$33$$, $args$$20$$) {
    this.handleEvent("change", this.$_getModelEvent$("delete", $oj$$30$$.$CollectionDataGridUtils$.$_getModelKey$($model$$66$$), null, $args$$20$$.index, -1));
  };
  $oj$$30$$.$CollectionDataGridDataSource$.prototype.$_handleModelChanged$ = function $$oj$$30$$$$CollectionDataGridDataSource$$$$_handleModelChanged$$($model$$67$$) {
    this.handleEvent("change", this.$_getModelEvent$("update", $oj$$30$$.$CollectionDataGridUtils$.$_getModelKey$($model$$67$$), null, $model$$67$$.index, -1));
  };
  ...
  $oj$$30$$.$CollectionDataGridUtils$.$_getModelKey$ = function $$oj$$30$$$$CollectionDataGridUtils$$$_getModelKey$$($model$$68$$) {
    var $key$$145$$;
    $key$$145$$ = $model$$68$$.$GetId$();
    null == $key$$145$$ && ($key$$145$$ = $model$$68$$.$GetCid$());
    return $key$$145$$;
  };
  ...
  $oj$$30$$.$CollectionHeaderSet$.prototype.getData = function $$oj$$30$$$$CollectionHeaderSet$$$getData$($index$$196$$, $level$$30$$) {
    ...
    if (null != this.$m_rowHeader$) {
      ...
      $model$$69$$ = this.$m_models$[$index$$196$$ - this.$m_start$];
      return $model$$69$$.get(this.$m_rowHeader$);
    }
  ...
  $oj$$30$$.$CollectionHeaderSet$.prototype.getMetadata = function $$oj$$30$$$$CollectionHeaderSet$$$getMetadata$($index$$197$$, $level$$31$$) {
    ...
    if (null != this.$m_rowHeader$) {
      ...
      $data$$150_model$$70$$ = this.$m_models$[$index$$197$$ - this.$m_start$];
      return{key:$oj$$30$$.$CollectionDataGridUtils$.$_getModelKey$($data$$150_model$$70$$)};
    }
    $data$$150_model$$70$$ = this.getData($index$$197$$, $level$$31$$);
    return this.$m_sortInfo$.key === $data$$150_model$$70$$ ? {key:$data$$150_model$$70$$, sortDirection:this.$m_sortInfo$.direction} : {key:$data$$150_model$$70$$};
  };
