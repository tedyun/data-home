 ...
 */
"use strict";
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtNBox"], function($oj$$55$$, $$$$49$$, $comp$$13$$, $base$$9$$, $dvt$$6$$) {
  $oj$$55$$.$__registerWidget$("oj.ojNBox", $$$$49$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{optionChange:null}, $_CreateDvtComponent$:function($context$$141$$, $callback$$113$$, $callbackObj$$9$$) {
    return $dvt$$6$$.NBox.newInstance($context$$141$$, $callback$$113$$, $callbackObj$$9$$);
    ...
    if ("adfPropertyChange" === $event$$566_properties$$8$$.type) {
      ...
      for (var $key$$173$$ in $event$$566_properties$$8$$) {
        var $value$$298$$ = $event$$566_properties$$8$$[$key$$173$$];
        "_drawer" == $key$$173$$ ? this.options[$key$$173$$] = $value$$298$$ ? {id:$value$$298$$} : null : "maximizedRow" != $key$$173$$ && "maximizedColumn" != $key$$173$$ || this.$_UserOptionChange$($key$$173$$, $value$$298$$);
      }
    } else {
    ...
    return $ret$$53$$;
  }, getContextByNode:function($context$$142_node$$117$$) {
    return($context$$142_node$$117$$ = this.getSubIdByNode($context$$142_node$$117$$)) && "oj-nbox-tooltip" !== $context$$142_node$$117$$.subId && "oj-nbox-dialog-close-button" !== $context$$142_node$$117$$.subId && "oj-nbox-overflow" !== $context$$142_node$$117$$.subId ? $context$$142_node$$117$$ : null;
