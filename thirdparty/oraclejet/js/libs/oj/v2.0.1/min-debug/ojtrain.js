...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$78$$, $$$$71$$) {
  (function() {
    $oj$$78$$.$__registerWidget$("oj.ojTrain", $$$$71$$.oj.baseComponent, {version:"1.0.0", defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{steps:[], selected:"", optionChange:null, beforeDeselect:null, deselect:null, beforeSelect:null, select:null}, $_stepNum$:0, $_stepArray$:null, _ComponentCreate:function() {
      ...
      var $i$$454_options$$408$$ = this.options, $stepTag_steps$$4$$ = $i$$454_options$$408$$.steps;
      ...
      this.$_setupArray$();
      this.$_selectedIndex$ = this.$_getStepIndex$($i$$454_options$$408$$.selected);
      -1 === this.$_selectedIndex$ && $stepTag_steps$$4$$[0] && $stepTag_steps$$4$$[0].id && (this.$_selectedIndex$ = 0, $i$$454_options$$408$$.selected = $stepTag_steps$$4$$[0].id);
      for ($i$$454_options$$408$$ = 0;$i$$454_options$$408$$ < this.$_stepNum$;$i$$454_options$$408$$++) {
        $stepTag_steps$$4$$ = $$$$71$$("\x3cli\x3e").addClass("oj-train-step-list-item").attr({id:this.$_stepArray$[$i$$454_options$$408$$][1]}), $stepTag_steps$$4$$.appendTo(this.$_stepList$), this.$_drawLabel$($i$$454_options$$408$$), this.$_drawStepFill$($i$$454_options$$408$$), this.$_drawButton$($i$$454_options$$408$$), this.$_drawMessageType$($i$$454_options$$408$$), this.$_stretch$ && $stepTag_steps$$4$$.css("width", 100 / this.$_stepNum$ + "%");
      }
      ...
      for (var $i$$455$$ = 0;$i$$455$$ < this.$_stepNum$;$i$$455$$++) {
        var $step$$4$$ = $options$$409$$.steps[$i$$455$$];
        this.$_stepArray$[$i$$455$$] = Array(5);
        this.$_stepArray$[$i$$455$$][0] = $step$$4$$.label ? $step$$4$$.label : null;
        this.$_stepArray$[$i$$455$$][1] = $step$$4$$.id ? $step$$4$$.id : null;
        this.$_stepArray$[$i$$455$$][2] = $step$$4$$.disabled ? !0 : !1;
        this.$_stepArray$[$i$$455$$][3] = $step$$4$$.visited ? !0 : !1;
        this.$_stepArray$[$i$$455$$][4] = $step$$4$$.messageType ? $step$$4$$.messageType : null;
      }
    ...
    }, $_fireOptionChange$:function($eventData$$29_key$$186$$, $previousValue$$3_stepIndex$$, $value$$317$$, $originalEvent$$13$$) {
      $eventData$$29_key$$186$$ = {option:$eventData$$29_key$$186$$, fromStep:this.getStep($previousValue$$3_stepIndex$$), toStep:this.getStep($value$$317$$), optionMetadata:{writeback:$originalEvent$$13$$ ? "shouldWrite" : "shouldNotWrite"}};
      !1 !== this._trigger("beforeDeselect", $originalEvent$$13$$, $eventData$$29_key$$186$$) && !1 !== this._trigger("beforeSelect", $originalEvent$$13$$, $eventData$$29_key$$186$$) && ($previousValue$$3_stepIndex$$ = this.$_getStepIndex$($previousValue$$3_stepIndex$$), -1 !== $previousValue$$3_stepIndex$$ && (this.options.steps[$previousValue$$3_stepIndex$$].visited = !0), this._trigger("deselect", $originalEvent$$13$$, $eventData$$29_key$$186$$), this.option("selected", $value$$317$$, {_context:{originalEvent:$originalEvent$$13$$, 
      $internalSet$:!0}}), this._trigger("select", $originalEvent$$13$$, $eventData$$29_key$$186$$));
    ...
    }, $_getStepIndex$:function($id$$62$$) {
      for (var $i$$456$$ = 0;$i$$456$$ < this.$_stepNum$;$i$$456$$++) {
        if (this.$_stepArray$[$i$$456$$] && this.$_stepArray$[$i$$456$$][1] === $id$$62$$) {
          return $i$$456$$;
        }
      }
      return-1;
    }, getStep:function($id$$63$$) {
      for (var $i$$457$$ = 0;$i$$457$$ < this.$_stepNum$;$i$$457$$++) {
        if (this.$_stepArray$[$i$$457$$] && this.$_stepArray$[$i$$457$$][1] === $id$$63$$) {
          return jQuery.extend({}, this.options.steps[$i$$457$$]);
        }
      }
      return null;
    }, nextSelectableStep:function() {
      for (var $i$$458$$ = this.$_getStepIndex$(this.options.selected);$i$$458$$ < this.$_stepNum$;$i$$458$$++) {
        if ($i$$458$$ + 1 < this.$_stepNum$ && this.$_stepArray$[$i$$458$$ + 1] && !this.$_stepArray$[$i$$458$$ + 1][2]) {
          return this.$_stepArray$[$i$$458$$ + 1][1];
        }
      }
      return null;
    }, previousSelectableStep:function() {
      for (var $i$$459$$ = this.$_getStepIndex$(this.options.selected);0 <= $i$$459$$;$i$$459$$--) {
        if (this.$_stepArray$[$i$$459$$ - 1] && !this.$_stepArray$[$i$$459$$ - 1][2]) {
          return this.$_stepArray$[$i$$459$$ - 1][1];
        }
      }
      return null;
      ...
      this.refresh();
    }, _setOption:function($key$$187$$, $value$$318$$, $flags$$54$$) {
      "selected" === $key$$187$$ && this.options.selected && this.$_stepArray$ && this.$_stepArray$[this.$_selectedIndex$] && this.$_fireOptionChange$("selected", this.$_stepArray$[this.$_selectedIndex$][1], $value$$318$$, null);
      this._super($key$$187$$, $value$$318$$, $flags$$54$$);
    }, refresh:function() {
      this._super();
      this._destroy();
      this.$_setupTrain$();
      ...
      this.element.find(".oj-train-step-list").remove();
      this._super();
    }, $_setFocus$:function($id$$64_index$$300$$) {
      $id$$64_index$$300$$ = this.$_getStepIndex$($id$$64_index$$300$$);
      for (var $i$$460$$ = 0;$i$$460$$ < this.$_stepNum$;$i$$460$$++) {
        if (this.$_stepArray$[($id$$64_index$$300$$ + $i$$460$$ + 1) % this.$_stepNum$] && !this.$_stepArray$[($id$$64_index$$300$$ + $i$$460$$ + 1) % this.$_stepNum$][2]) {
          this.$_stepList$.children().eq(($id$$64_index$$300$$ + $i$$460$$ + 1) % this.$_stepNum$).find(".oj-train-label").focus();
          break;
        }
      }
