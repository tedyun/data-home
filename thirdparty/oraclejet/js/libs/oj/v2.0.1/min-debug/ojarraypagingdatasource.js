...
define(["ojs/ojcore", "jquery", "knockout", "ojs/ojdatasource-common"], function($oj$$24$$, $$$$23$$, $ko$$4$$) {
  ...
  $oj$$24$$.$ArrayPagingDataSource$.prototype.setPage = function $$oj$$24$$$$ArrayPagingDataSource$$$setPage$($value$$256$$, $options$$278$$) {
    $options$$278$$ = $options$$278$$ || {};
    $value$$256$$ = parseInt($value$$256$$, 10);
    try {
      $oj$$24$$.$ArrayPagingDataSource$.$superclass$.handleEvent.call(this, $oj$$24$$.$PagingModel$.$EventType$.BEFOREPAGE, {page:$value$$256$$, previousPage:this.$_page$});
    } catch ($err$$22$$) {
      return Promise.reject(null);
    }
    this.pageSize = null != $options$$278$$.pageSize ? $options$$278$$.pageSize : this.pageSize;
    $options$$278$$.startIndex = $value$$256$$ * this.pageSize;
    var $previousPage$$1$$ = this.$_page$;
    this.$_page$ = $value$$256$$;
