...
define(["ojs/ojcore", "jquery", "ojs/ojpagingtabledatasource"], function($oj$$58$$) {
  ...
  $oj$$58$$.$PagingDataGridDataSource$.prototype.setPage = function $$oj$$58$$$$PagingDataGridDataSource$$$setPage$($value$$299$$, $options$$369$$) {
    $options$$369$$ = $options$$369$$ || {};
    $value$$299$$ = parseInt($value$$299$$, 10);
    try {
      $oj$$58$$.$PagingDataGridDataSource$.$superclass$.handleEvent.call(this, $oj$$58$$.$PagingModel$.$EventType$.BEFOREPAGE, {page:$value$$299$$, previousPage:this.$_page$});
    } catch ($err$$25$$) {
      return Promise.reject(null);
    }
    this.$_pageSize$ = null != $options$$369$$.pageSize ? $options$$369$$.pageSize : this.$_pageSize$;
    $options$$369$$.startIndex = $value$$299$$ * this.$_pageSize$;
    var $previousPage$$3$$ = this.$_page$;
    this.$_page$ = $value$$299$$;
    this.$_startIndex$ = $options$$369$$.startIndex;
    var $self$$206$$ = this;
    return new Promise(function($resolve$$66$$, $reject$$62$$) {
  ...
  $oj$$58$$.$PagingDataGridDataSource$.prototype.$_handleRowHeaderFetchSuccess$ = function $$oj$$58$$$$PagingDataGridDataSource$$$$_handleRowHeaderFetchSuccess$$($headerSet$$6$$, $headerRange$$11$$) {
    var $pagingHeaderSet$$, $callback$$114$$, $callbackObject$$;
    ...
    $callback$$114$$ = this.$_pendingRowHeaderCallback$.callbacks.success;
    $callbackObject$$ = this.$_pendingRowHeaderCallback$.callbackObjects.success;
    this.$_pendingRowHeaderCallback$ = null;
    $callback$$114$$.call($callbackObject$$, $pagingHeaderSet$$, $headerRange$$11$$);
  };
  $oj$$58$$.$PagingDataGridDataSource$.prototype.$_handleRowHeaderFetchError$ = function $$oj$$58$$$$PagingDataGridDataSource$$$$_handleRowHeaderFetchError$$($error$$52$$) {
    var $callback$$115$$, $callbackObject$$1$$;
    $callback$$115$$ = this.$_pendingRowHeaderCallback$.callbacks.error;
    $callbackObject$$1$$ = this.$_pendingRowHeaderCallback$.callbackObjects.error;
    this.$_pendingRowHeaderCallback$ = null;
    $callback$$115$$.call($callbackObject$$1$$, $error$$52$$);
  };
  $oj$$58$$.$PagingDataGridDataSource$.prototype.$fetchCells$ = function $$oj$$58$$$$PagingDataGridDataSource$$$$fetchCells$$($cellRanges$$9$$, $callbacks$$57$$, $callbackObjects$$29$$) {
    ...
    if (null == this.$_initialized$) {
      $cellSet$$5_i$$422$$ = new $oj$$58$$.$ArrayCellSet$(0, 0, 0, 0, null), null != $callbacks$$57$$ && $callbacks$$57$$.success && $callbacks$$57$$.success.call($callbackObjects$$29$$.success, $cellSet$$5_i$$422$$, $cellRanges$$9$$);
    } else {
      for ($cellSet$$5_i$$422$$ = 0;$cellSet$$5_i$$422$$ < $cellRanges$$9$$.length;$cellSet$$5_i$$422$$ += 1) {
        "row" === $cellRanges$$9$$[$cellSet$$5_i$$422$$].axis && ($cellRanges$$9$$[$cellSet$$5_i$$422$$].start += this.$_startIndex$, $cellRanges$$9$$[$cellSet$$5_i$$422$$].start + $cellRanges$$9$$[$cellSet$$5_i$$422$$].count > this.$_startIndex$ + this.$_pageSize$ && ($cellRanges$$9$$[$cellSet$$5_i$$422$$].count = this.$_pageSize$ - $cellRanges$$9$$[$cellSet$$5_i$$422$$].start));
      }
  ...
  $oj$$58$$.$PagingDataGridDataSource$.prototype.$_handleCellsFetchSuccess$ = function $$oj$$58$$$$PagingDataGridDataSource$$$$_handleCellsFetchSuccess$$($cellSet$$6$$, $cellRanges$$10$$) {
    var $i$$423_pagedCellSet$$, $callback$$116$$, $callbackObject$$2$$;
    for ($i$$423_pagedCellSet$$ = 0;$i$$423_pagedCellSet$$ < $cellRanges$$10$$.length;$i$$423_pagedCellSet$$ += 1) {
      "row" === $cellRanges$$10$$[$i$$423_pagedCellSet$$].axis && ($cellRanges$$10$$[$i$$423_pagedCellSet$$].start -= this.$_startIndex$, $cellRanges$$10$$[$i$$423_pagedCellSet$$].count += 1);
    }
    $i$$423_pagedCellSet$$ = new $oj$$58$$.$PagingCellSet$($cellSet$$6$$, this.$_startIndex$);
    $callback$$116$$ = this.$_pendingCellCallback$.callbacks.success;
    ...
    $callback$$116$$.call($callbackObject$$2$$, $i$$423_pagedCellSet$$, $cellRanges$$10$$);
  };
  $oj$$58$$.$PagingDataGridDataSource$.prototype.$_handleCellsFetchError$ = function $$oj$$58$$$$PagingDataGridDataSource$$$$_handleCellsFetchError$$($error$$53$$) {
    var $callback$$117$$, $callbackObject$$3$$;
    $callback$$117$$ = this.$_pendingCellCallback$.callbacks.error;
    $callbackObject$$3$$ = this.$_pendingCellCallback$.callbackObjects.error;
    this.$_pendingCellCallback$ = null;
    $callback$$117$$.call($callbackObject$$3$$, $error$$53$$);
  };
