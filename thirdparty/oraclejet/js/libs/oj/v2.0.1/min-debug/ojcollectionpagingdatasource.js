...
define(["ojs/ojcore", "jquery", "knockout", "ojs/ojdatasource-common", "ojs/ojmodel", "ojs/ojknockout-model"], function($oj$$31$$, $$$$30$$, $ko$$5$$) {
  ...
  $oj$$31$$.$CollectionPagingDataSource$.prototype.setPage = function $$oj$$31$$$$CollectionPagingDataSource$$$setPage$($value$$264$$, $options$$300$$) {
    $options$$300$$ = $options$$300$$ || {};
    $value$$264$$ = parseInt($value$$264$$, 10);
    try {
      $oj$$31$$.$CollectionPagingDataSource$.$superclass$.handleEvent.call(this, $oj$$31$$.$PagingModel$.$EventType$.BEFOREPAGE, {page:$value$$264$$, previousPage:this.$_page$});
    } catch ($err$$24$$) {
      return Promise.reject(null);
    }
    this.pageSize = null != $options$$300$$.pageSize ? $options$$300$$.pageSize : this.pageSize;
    $options$$300$$.startIndex = $value$$264$$ * this.pageSize;
