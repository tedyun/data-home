...
define(["ojs/ojcore", "jquery", "promise", "ojs/ojdatasource-common"], function($oj$$18$$, $$$$17$$) {
  ...
  $oj$$18$$.$Cube$.prototype.$_getValue$ = function $$oj$$18$$$$Cube$$$$_getValue$$($indices$$4$$) {
    var $hash$$2_key$$80_obj$$51$$ = this.$_createCubeKeys$($indices$$4$$);
    return $hash$$2_key$$80_obj$$51$$ && ($hash$$2_key$$80_obj$$51$$ = $hash$$2_key$$80_obj$$51$$.$GetHashCodes$(), 0 < $hash$$2_key$$80_obj$$51$$.length && ($hash$$2_key$$80_obj$$51$$ = this.$_data$[$hash$$2_key$$80_obj$$51$$[0].key])) ? new $oj$$18$$.$CubeDataValue$($hash$$2_key$$80_obj$$51$$.value, $indices$$4$$, $hash$$2_key$$80_obj$$51$$.$aggType$, $hash$$2_key$$80_obj$$51$$.rows, $hash$$2_key$$80_obj$$51$$.$square$) : new $oj$$18$$.$CubeDataValue$(null, $indices$$4$$, void 0, []);
  };
      ...
      for (var $row$$19$$ = 0;$row$$19$$ < this.$_rows$.length;$row$$19$$++) {
        ...
        for (var $pageHashObj_pageKey$$ = $pageHashObj_pageKey$$.$GetHashCodes$(), $ph$$ = 0;$ph$$ < $pageHashObj_pageKey$$.length;$ph$$++) {
          ...
          for (var $dataHash_keys$$12$$ = new $oj$$18$$.$CubeKeys$, $h$$5_maxAxes$$ = $cube$$2$$.$_axes$.length, $axis$$7_hash$$3_pageHash$$ = 0;$axis$$7_hash$$3_pageHash$$ < $h$$5_maxAxes$$;$axis$$7_hash$$3_pageHash$$++) {
            $dataHash_keys$$12$$ = $cube$$2$$.$_axes$[$axis$$7_hash$$3_pageHash$$].$ProcessRow$(this.$_rows$[$row$$19$$], $dataHash_keys$$12$$);
          }
          ...
          $cube$$2$$.$_storeData$($axis$$7_hash$$3_pageHash$$, $dataHash_keys$$12$$, this.$_rows$[$row$$19$$]);
        }
      }
    }
  };
  ...
  $oj$$18$$.$Cube$.prototype.$_getHashFromPin$ = function $$oj$$18$$$$Cube$$$$_getHashFromPin$$($pin$$1$$) {
    ...
    if ($pin$$1$$ && 0 < $pin$$1$$.length) {
      ...
      for (var $axes$$1$$ = this.$_axes$, $i$$266$$ = 0;$i$$266$$ < $pin$$1$$.length;$i$$266$$++) {
        $keys$$13$$ = $axes$$1$$[$pin$$1$$[$i$$266$$].axis].$GetCubeKeys$($pin$$1$$[$i$$266$$].index, $keys$$13$$);
      }
    }
    return $keys$$13$$.$GetHashCodes$()[0].key;
  };
  $oj$$18$$.$Cube$.$_isValid$ = function $$oj$$18$$$$Cube$$$_isValid$$($value$$234$$) {
    return $value$$234$$ ? void 0 !== $value$$234$$.value && null !== $value$$234$$.value : !1;
  };
  $oj$$18$$.$Cube$.prototype.$_createAggValue$ = function $$oj$$18$$$$Cube$$$$_createAggValue$$($value$$235$$, $aggType$$, $rows$$4$$, $retObj$$12_row$$21$$, $props$$14$$) {
    $rows$$4$$.push($retObj$$12_row$$21$$);
    $retObj$$12_row$$21$$ = {};
    for (var $p$$4$$ in $props$$14$$) {
      $props$$14$$.hasOwnProperty($p$$4$$) && ($retObj$$12_row$$21$$[$p$$4$$] = $props$$14$$[$p$$4$$]);
    }
    $retObj$$12_row$$21$$.value = $value$$235$$;
    $retObj$$12_row$$21$$.$aggType$ = $aggType$$;
    $retObj$$12_row$$21$$.rows = $rows$$4$$;
    return $retObj$$12_row$$21$$;
  };
  $oj$$18$$.$Cube$.$_isNumber$ = function $$oj$$18$$$$Cube$$$_isNumber$$($value$$236$$) {
    return $oj$$18$$.$StringUtils$.$isString$($value$$236$$.value) ? !1 : !isNaN($value$$236$$.value);
  };
  ...
  $oj$$18$$.$CubeAxisValue$ = function $$oj$$18$$$$CubeAxisValue$$($value$$237$$, $label$$10$$, $level$$14$$, $parent$$12$$) {
    this.Init();
    this.$_children$ = [];
    this.$_parent$ = $parent$$12$$;
    this.$_cubeLevel$ = $level$$14$$;
    this.$_data$ = {};
    this.$_data$.value = $value$$237$$;
  ...
  $oj$$18$$.$CubeAxisValue$.prototype.$GetChild$ = function $$oj$$18$$$$CubeAxisValue$$$$GetChild$$($key$$81_val$$42$$) {
    var $c$$41_childLevel$$ = this.$_getChildLevel$();
    if (null === $c$$41_childLevel$$) {
      return null;
    }
    if ($c$$41_childLevel$$.$isDataValue$()) {
      return this.$_getDataValueChild$($key$$81_val$$42$$);
    }
    if ($key$$81_val$$42$$ = $key$$81_val$$42$$[$c$$41_childLevel$$.attribute]) {
      for ($c$$41_childLevel$$ = 0;$c$$41_childLevel$$ < this.$_children$.length;$c$$41_childLevel$$++) {
        if (this.$_children$[$c$$41_childLevel$$].$getValue$() === $key$$81_val$$42$$) {
  ...
  $oj$$18$$.$CubeAxisValue$.prototype.$_getDataValueChild$ = function $$oj$$18$$$$CubeAxisValue$$$$_getDataValueChild$$($key$$82$$) {
    for (var $c$$42$$ = 0;$c$$42$$ < this.$_children$.length;$c$$42$$++) {
      var $val$$43$$ = this.$_children$[$c$$42$$].$getValue$();
      if ($key$$82$$.hasOwnProperty($val$$43$$) && $key$$82$$[$val$$43$$] === $val$$43$$) {
  ...
  $oj$$18$$.$CubeAxisValue$.prototype.$_findChild$ = function $$oj$$18$$$$CubeAxisValue$$$$_findChild$$($index$$115$$, $start$$33$$, $end$$10$$) {
    ...
    var $mid$$1$$ = Math.floor(($start$$33$$ + $end$$10$$) / 2), $value$$238$$ = this.$_children$[$mid$$1$$], $valStart$$ = $value$$238$$.$getStart$();
    return $valStart$$ > $index$$115$$ ? this.$_findChild$($index$$115$$, $start$$33$$, $mid$$1$$ - 1) : $valStart$$ + $value$$238$$.$getExtent$() - 1 < $index$$115$$ ? this.$_findChild$($index$$115$$, $mid$$1$$ + 1, $end$$10$$) : $value$$238$$;
  };
  $oj$$18$$.$CubeAxisValue$.prototype.$AddNode$ = function $$oj$$18$$$$CubeAxisValue$$$$AddNode$$($newValue$$19_value$$239$$, $label$$11$$, $level$$15$$) {
    for (var $c$$43$$ = 0;$c$$43$$ < this.$_children$.length;$c$$43$$++) {
      if (this.$_children$[$c$$43$$].$getValue$() === $newValue$$19_value$$239$$) {
        return this.$_children$[$c$$43$$];
      }
    }
    $newValue$$19_value$$239$$ = new $oj$$18$$.$CubeAxisValue$($newValue$$19_value$$239$$, $label$$11$$, $level$$15$$, this);
    this.$_children$.push($newValue$$19_value$$239$$);
    return $newValue$$19_value$$239$$;
  };
  ...
  $oj$$18$$.$CubeAxis$.prototype.$getIndex$ = function $$oj$$18$$$$CubeAxis$$$$getIndex$$($key$$83_keyVal$$) {
    $key$$83_keyVal$$ = $key$$83_keyVal$$ ? JSON.parse($key$$83_keyVal$$) : {};
    for (var $node$$62$$ = this.$_values$, $lastNode$$ = null;$node$$62$$;) {
      $lastNode$$ = $node$$62$$, $node$$62$$ = $node$$62$$.$GetChild$($key$$83_keyVal$$);
    }
  ...
  $oj$$18$$.$CubeAxis$.prototype.$ProcessRow$ = function $$oj$$18$$$$CubeAxis$$$$ProcessRow$$($row$$24$$, $keys$$18$$) {
    return this.$_cube$.$ProcessLevel$(this, 0, this.$_values$, $row$$24$$, $keys$$18$$, !0);
  };
  ...
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$_getKey$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$_getKey$$($indexes$$5_item$$14$$, $axis$$16$$, $retObj$$14$$) {
    ...
    var $keys$$20$$ = new $oj$$18$$.$CubeKeys$, $keys$$20$$ = $axisObj$$1$$ ? $axisObj$$1$$.$GetCubeKeys$($indexes$$5_item$$14$$, $keys$$20$$) : "";
    $retObj$$14$$[$axis$$16$$] = $keys$$20$$.$GetHashCodes$()[0].key;
    return $retObj$$14$$;
  };
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$indexes$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$indexes$$($keys$$21$$) {
    var $retObj$$15$$ = {}, $retObj$$15$$ = this.$_getIndex$($keys$$21$$, "row", $retObj$$15$$), $retObj$$15$$ = this.$_getIndex$($keys$$21$$, "column", $retObj$$15$$);
  ...
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$_getIndex$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$_getIndex$$($keys$$22$$, $axis$$17$$, $retObj$$16$$) {
    $retObj$$16$$[$axis$$17$$] = this.$_getAxis$($axis$$17$$).$getIndex$($keys$$22$$[$axis$$17$$]);
    return $retObj$$16$$;
  };
  ...
  $oj$$18$$.$CubeDataValue$ = function $$oj$$18$$$$CubeDataValue$$($value$$240$$, $indices$$7$$, $aggType$$2$$, $rows$$5$$, $square$$) {
    this.Init();
    this.$_data$ = {};
  ...
  $oj$$18$$.$CubeHeaderSet$.prototype.getMetadata = function $$oj$$18$$$$CubeHeaderSet$$$getMetadata$($index$$120$$, $level$$18$$) {
    var $hash$$6_keys$$23$$ = new $oj$$18$$.$CubeKeys$, $hash$$6_keys$$23$$ = this.$_axis$.$GetPartialCubeKeys$($index$$120$$, $level$$18$$, $hash$$6_keys$$23$$);
    return($hash$$6_keys$$23$$ = $hash$$6_keys$$23$$.$GetHashCodes$()) && 0 < $hash$$6_keys$$23$$.length ? {key:$hash$$6_keys$$23$$[0].key} : null;
  };
  ...
  $oj$$18$$.$CubeKeys$.prototype.$UpdateKeys$ = function $$oj$$18$$$$CubeKeys$$$$UpdateKeys$$($node$$63$$) {
    this.$_key$.push($node$$63$$);
  };
  $oj$$18$$.$CubeKeys$.prototype.$AddDataValue$ = function $$oj$$18$$$$CubeKeys$$$$AddDataValue$$($name$$115$$, $value$$241$$) {
    this.$_data$.push({name:$name$$115$$, value:$value$$241$$});
  };
  ...
  $oj$$18$$.$DataColumnCube$.prototype.$ProcessLevel$ = function $$oj$$18$$$$DataColumnCube$$$$ProcessLevel$$($axis$$23$$, $levelNum$$1$$, $currNode$$1_node$$64$$, $row$$26$$, $keys$$24$$, $addKeys$$1$$) {
    if ($levelNum$$1$$ >= $axis$$23$$.$getLevels$().length) {
      return $keys$$24$$;
    }
    var $level$$23$$ = $axis$$23$$.$getLevels$()[$levelNum$$1$$], $value$$242$$ = $row$$26$$[$level$$23$$.attribute];
    $currNode$$1_node$$64$$ = $currNode$$1_node$$64$$.$AddNode$($value$$242$$, null, $level$$23$$);
    $level$$23$$.$isDataValue$() ? $keys$$24$$.$AddDataValue$($value$$242$$, $row$$26$$[this.$_valueAttr$]) : $keys$$24$$.$UpdateKeys$($currNode$$1_node$$64$$);
    return this.$ProcessLevel$($axis$$23$$, $levelNum$$1$$ + 1, $currNode$$1_node$$64$$, $row$$26$$, $keys$$24$$, $addKeys$$1$$);
  };
  ...
  $oj$$18$$.$DataValueAttributeCube$.prototype.$ProcessLevel$ = function $$oj$$18$$$$DataValueAttributeCube$$$$ProcessLevel$$($axis$$25$$, $levelNum$$2$$, $currNode$$2_node$$65$$, $row$$27$$, $keys$$25$$, $addKeys$$2$$) {
    if ($levelNum$$2$$ >= $axis$$25$$.$getLevels$().length) {
      return $keys$$25$$;
    }
    var $level$$25$$ = $axis$$25$$.$getLevels$()[$levelNum$$2$$];
    if ($level$$25$$.$isDataValue$()) {
      return this.$_processDataValue$($axis$$25$$, $currNode$$2_node$$65$$, $row$$27$$, $levelNum$$2$$, $keys$$25$$);
    }
    $currNode$$2_node$$65$$ = $currNode$$2_node$$65$$.$AddNode$($row$$27$$[$level$$25$$.attribute], null, $level$$25$$);
    $addKeys$$2$$ && $keys$$25$$.$UpdateKeys$($currNode$$2_node$$65$$);
    return this.$ProcessLevel$($axis$$25$$, $levelNum$$2$$ + 1, $currNode$$2_node$$65$$, $row$$27$$, $keys$$25$$, $addKeys$$2$$);
  };
  $oj$$18$$.$DataValueAttributeCube$.prototype.$_processDataValue$ = function $$oj$$18$$$$DataValueAttributeCube$$$$_processDataValue$$($axis$$26$$, $node$$66$$, $row$$28$$, $levelNum$$3$$, $keys$$26$$) {
    for (var $dsKeysAdded$$ = !0, $d$$7$$ = 0;$d$$7$$ < this.$_dataValues$.length;$d$$7$$++) {
      ...
      $row$$28$$.hasOwnProperty($dvAttr$$) && ($currNode$$3_dvLabel$$ = $node$$66$$.$AddNode$($dvAttr$$, $currNode$$3_dvLabel$$, $axis$$26$$.$getLevels$()[$levelNum$$3$$]), $keys$$26$$.$AddDataValue$($dvAttr$$, $row$$28$$[$dvAttr$$]), this.$ProcessLevel$($axis$$26$$, $levelNum$$3$$ + 1, $currNode$$3_dvLabel$$, $row$$28$$, $keys$$26$$, $dsKeysAdded$$), $dsKeysAdded$$ = !1);
    }
    return $keys$$26$$;
  };
