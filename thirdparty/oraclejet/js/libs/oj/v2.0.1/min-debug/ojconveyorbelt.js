...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore"], function($oj$$36$$, $$$$33$$) {
  function $ConveyorBeltCommon$$($agentName$$1_elem$$69$$, $orientation$$, $contentParent$$, $bRtl$$, $buttonInfo$$, $callbackInfo$$) {
    this.$_elem$ = $agentName$$1_elem$$69$$;
    ...
    $agentName$$1_elem$$69$$ = navigator.userAgent.toLowerCase();
    if (-1 !== $agentName$$1_elem$$69$$.indexOf("gecko/")) {
      this.$_bAgentGecko$ = !0;
    } else {
      if (-1 !== $agentName$$1_elem$$69$$.indexOf("opera")) {
        this.$_bAgentOpera$ = !0;
      } else {
        if (-1 !== $agentName$$1_elem$$69$$.indexOf("applewebkit") || -1 !== $agentName$$1_elem$$69$$.indexOf("safari")) {
  ...
  $ConveyorBeltCommon$$.prototype.destroy = function $$ConveyorBeltCommon$$$$destroy$() {
    var $elem$$70$$ = this.$_elem$;
    $ConveyorBeltCommon$$.$_removeBubbleEventListener$($elem$$70$$, "mousewheel", this.$_mouseWheelListener$);
    $ConveyorBeltCommon$$.$_removeBubbleEventListener$($elem$$70$$, "wheel", this.$_mouseWheelListener$);
    ...
    this.$_removeResizeListenerFunc$ && this.$_handleResizeFunc$ && (this.$_removeResizeListenerFunc$.call(this.$_callbackObj$, $elem$$70$$, this.$_handleResizeFunc$), this.$_removeResizeListenerFunc$.call(this.$_callbackObj$, this.$_contentContainer$, this.$_handleResizeFunc$));
    this.$_handleResizeFunc$ = null;
    $ConveyorBeltCommon$$.$_reparentChildrenFromTable$(this.$_contentTableDiv$, $elem$$70$$);
    this.$_arContentElements$ = null;
    this.$_tableDiv$ ? $elem$$70$$.removeChild(this.$_tableDiv$) : ($elem$$70$$.removeChild(this.$_overflowContainer$), $elem$$70$$.removeChild(this.$_vertDivNextButton$), $elem$$70$$.removeChild(this.$_vertDivPrevButton$));
  ...
  $ConveyorBeltCommon$$.$_getComputedStyle$ = function $$ConveyorBeltCommon$$$$_getComputedStyle$$($elem$$71$$) {
    var $defView$$ = $elem$$71$$.ownerDocument.defaultView, $computedStyle$$ = null;
    return $computedStyle$$ = $defView$$ ? $defView$$.getComputedStyle($elem$$71$$, null) : $elem$$71$$.currentStyle;
  };
  $ConveyorBeltCommon$$.$_getElemInnerWidth$ = function $$ConveyorBeltCommon$$$$_getElemInnerWidth$$($computedStyle$$1_elem$$72$$) {
    $computedStyle$$1_elem$$72$$ = $ConveyorBeltCommon$$.$_getComputedStyle$($computedStyle$$1_elem$$72$$);
    return $ConveyorBeltCommon$$.$_getCSSLengthAsInt$($computedStyle$$1_elem$$72$$.width);
  };
  $ConveyorBeltCommon$$.$_getElemInnerHeight$ = function $$ConveyorBeltCommon$$$$_getElemInnerHeight$$($computedStyle$$2_elem$$73$$) {
    $computedStyle$$2_elem$$73$$ = $ConveyorBeltCommon$$.$_getComputedStyle$($computedStyle$$2_elem$$73$$);
    return $ConveyorBeltCommon$$.$_getCSSLengthAsInt$($computedStyle$$2_elem$$73$$.height);
  };
  ...
  $ConveyorBeltCommon$$.$_addBubbleEventListener$ = function $$ConveyorBeltCommon$$$$_addBubbleEventListener$$($node$$93$$, $type$$92$$, $listener$$38$$) {
    $node$$93$$.addEventListener ? $node$$93$$.addEventListener($type$$92$$, $listener$$38$$, !1) : $node$$93$$.attachEvent && $node$$93$$.attachEvent("on" + $type$$92$$, $listener$$38$$);
  };
  $ConveyorBeltCommon$$.$_removeBubbleEventListener$ = function $$ConveyorBeltCommon$$$$_removeBubbleEventListener$$($node$$94$$, $type$$93$$, $listener$$39$$) {
    $node$$94$$.removeEventListener ? $node$$94$$.removeEventListener($type$$93$$, $listener$$39$$, !1) : $node$$94$$.detachEvent && $node$$94$$.detachEvent("on" + $type$$93$$, $listener$$39$$);
  };
  ...
  $ConveyorBeltCommon$$.$_wrapAndRestrictSize$ = function $$ConveyorBeltCommon$$$$_wrapAndRestrictSize$$($elem$$74$$, $parentElem$$3$$, $bWidth$$, $bHeight$$) {
    var $wrapperDiv$$ = document.createElement("div"), $wrapperDivStyle$$ = $wrapperDiv$$.style;
    $wrapperDivStyle$$.display = "inline-block";
    $wrapperDiv$$.appendChild($elem$$74$$);
  ...
  $ConveyorBeltCommon$$.prototype.$_createInnerContainers$ = function $$ConveyorBeltCommon$$$$$_createInnerContainers$$() {
    ...
    var $elem$$75$$ = this.$_elem$, $contentContainer$$2_contentHeight$$ = document.createElement("div");
    ...
    if ($bHoriz$$3_overflowHeight$$) {
      ...
      var $i$$342_tableCellDivNextButtonStyle$$ = $numContentChildren_tableCellDivNextButton$$1$$.style;
      $arContentElements_tableCellDivPrevButton$$.style.verticalAlign = "top";
      $i$$342_tableCellDivNextButtonStyle$$.verticalAlign = "top";
    ...
    $arContentElements_tableCellDivPrevButton$$ = $ConveyorBeltCommon$$.$_reparentChildrenToTable$($elem$$75$$, $contentTableDiv_tableRowDiv$$1_vertDivNextButton$$1$$, $bHoriz$$3_overflowHeight$$);
    if (this.$_contentParent$) {
      for ($arContentElements_tableCellDivPrevButton$$ = [], $contentChildren_tableCellDivOverflow$$ = this.$_contentParent$.children, $numContentChildren_tableCellDivNextButton$$1$$ = $contentChildren_tableCellDivOverflow$$.length, $i$$342_tableCellDivNextButtonStyle$$ = 0;$i$$342_tableCellDivNextButtonStyle$$ < $numContentChildren_tableCellDivNextButton$$1$$;$i$$342_tableCellDivNextButtonStyle$$++) {
        var $child$$11$$ = $contentChildren_tableCellDivOverflow$$[$i$$342_tableCellDivNextButtonStyle$$];
    ...
    $contentContainerStyle_tableDiv$$1_vertDivPrevButton$$ ? $elem$$75$$.appendChild($contentContainerStyle_tableDiv$$1_vertDivPrevButton$$) : (this.$_vertDivPrevButton$ = $contentContainerStyle_tableDiv$$1_vertDivPrevButton$$ = document.createElement("div"), this.$_vertDivNextButton$ = $contentTableDiv_tableRowDiv$$1_vertDivNextButton$$1$$ = document.createElement("div"), $elem$$75$$.appendChild($contentContainerStyle_tableDiv$$1_vertDivPrevButton$$), $elem$$75$$.appendChild($overflowContainer$$), 
    $elem$$75$$.appendChild($contentTableDiv_tableRowDiv$$1_vertDivNextButton$$1$$));
  ...
  $ConveyorBeltCommon$$.prototype.$_measureContents$ = function $$ConveyorBeltCommon$$$$$_measureContents$$() {
    ...
    if (this.$_getContentParent$().hasChildNodes() && $bHoriz$$6_contentTableDiv$$1$$ && $arContentElements$$1$$ && 0 < $arContentElements$$1$$.length) {
      for (var $bHoriz$$6_contentTableDiv$$1$$ = this.$_isHorizontal$(), $contentWidth$$1$$ = 0, $contentWidth$$1$$ = this.$_contentContainer$.offsetWidth, $startOffset$$ = 0, $prevSizeObj$$ = null, $i$$343$$ = 0;$i$$343$$ < $arContentElements$$1$$.length;$i$$343$$++) {
        var $child$$12_childParent$$ = $arContentElements$$1$$[$i$$343$$];
        if (1 === $child$$12_childParent$$.nodeType) {
          ...
          if ($bHoriz$$6_contentTableDiv$$1$$) {
            ...
            0 === $i$$343$$ && ($startOffset$$ = $sizeObj$$1$$.start);
  ...
  $ConveyorBeltCommon$$.prototype.$_calcFirstVisibleItemIndex$ = function $$ConveyorBeltCommon$$$$$_calcFirstVisibleItemIndex$$() {
    var $i$$344$$ = this.$_calcItemIndex$(this.$_getCurrScroll$());
    return 0 > $i$$344$$ ? 0 : $i$$344$$;
  };
  $ConveyorBeltCommon$$.prototype.$_calcLastVisibleItemIndex$ = function $$ConveyorBeltCommon$$$$$_calcLastVisibleItemIndex$$() {
    var $i$$345$$ = this.$_calcItemIndex$(this.$_getCurrScroll$() + this.$_getCurrViewportSize$() - 1), $sizes$$5$$ = this.$_getSizes$();
    return 0 > $i$$345$$ ? $sizes$$5$$.length - 1 : $i$$345$$;
  };
  $ConveyorBeltCommon$$.prototype.$_calcPrevVisibleItemIndex$ = function $$ConveyorBeltCommon$$$$$_calcPrevVisibleItemIndex$$() {
    var $i$$346$$ = this.$_calcItemIndex$(this.$_getCurrScroll$() - 1);
    return 0 > $i$$346$$ ? 0 : $i$$346$$;
  };
  $ConveyorBeltCommon$$.prototype.$_calcNextVisibleItemIndex$ = function $$ConveyorBeltCommon$$$$$_calcNextVisibleItemIndex$$() {
    var $i$$347$$ = this.$_calcItemIndex$(this.$_getCurrScroll$() + this.$_getCurrViewportSize$()), $sizes$$6$$ = this.$_getSizes$();
    return 0 > $i$$347$$ ? $sizes$$6$$.length - 1 : $i$$347$$;
  };
  $ConveyorBeltCommon$$.prototype.$_calcItemIndex$ = function $$ConveyorBeltCommon$$$$$_calcItemIndex$$($scroll$$9$$) {
    for (var $sizes$$7$$ = this.$_getSizes$(), $i$$348$$ = 0;$i$$348$$ < $sizes$$7$$.length;$i$$348$$++) {
      if ($scroll$$9$$ <= $sizes$$7$$[$i$$348$$].end) {
        return $i$$348$$;
      }
    }
    return-1;
  ...
  (function() {
    $oj$$36$$.$__registerWidget$("oj.ojConveyorBelt", $$$$33$$.oj.baseComponent, {defaultElement:"\x3cdiv\x3e", widgetEventPrefix:"oj", options:{orientation:"horizontal", contentParent:null}, _ComponentCreate:function() {
      ...
      if (this.$_canCalculateSizes$()) {
        ...
        var $elem$$85_oldIsInit$$ = this.element, $options$$320$$ = this.options;
        if ($children$$9_isInit$$ && !this.$_cbCommon$) {
          ...
          this.$_cbCommon$ = new $ConveyorBeltCommon$$($elem$$85_oldIsInit$$[0], $orientation$$1$$, $animateScrollFunc_contentParentElem$$, this.$_bRTL$, $buttonInfo$$1$$, $callbackInfo$$1_prevStyleClass$$);
        }
        this.$_cbCommon$.$setup$($children$$9_isInit$$);
        $children$$9_isInit$$ && ($children$$9_isInit$$ = $elem$$85_oldIsInit$$.find(".oj-conveyorbelt-overflow-indicator"), this.$_setupButtonMouseStyles$($children$$9_isInit$$));
      } else {
        $elem$$85_oldIsInit$$ = !1, this.$_needsSetup$ && ($elem$$85_oldIsInit$$ = this.$_needsSetup$[0]), this.$_needsSetup$ = [$children$$9_isInit$$ || $elem$$85_oldIsInit$$];
      }
    }, _destroy:function() {
      this.$_destroyCBCommon$();
      this.element.removeClass("oj-conveyorbelt oj-component");
      this._super();
    }, _setOption:function($key$$158$$, $value$$275$$, $flags$$38$$) {
      var $bRecreate$$1$$ = !1;
      switch($key$$158$$) {
      ...
      this._super($key$$158$$, $value$$275$$, $flags$$38$$);
      ...
      var $div$$3$$ = document.createElement("div"), $elem$$88_style$$18$$ = $div$$3$$.style;
      $elem$$88_style$$18$$.width = "10px";
      $elem$$88_style$$18$$.height = "10px";
      $elem$$88_style$$18$$ = this.element[0];
      $elem$$88_style$$18$$.appendChild($div$$3$$);
      var $bCanCalcSizes$$ = !1;
      try {
        $bCanCalcSizes$$ = 0 < $div$$3$$.offsetWidth && 0 < $div$$3$$.offsetHeight;
      } catch ($e$$96$$) {
      }
      $elem$$88_style$$18$$.removeChild($div$$3$$);
      return $bCanCalcSizes$$;
    }, $_setupButtonMouseStyles$:function($element$$135$$) {
      $element$$135$$.on("mousedown" + this.eventNamespace, function($event$$426$$) {
      ...
      return $span$$;
    }, $_animateScrollLeft$:function($elem$$89$$, $value$$276$$, $duration$$11$$, $onEndFunc$$1$$) {
      var $props$$22$$ = {};
      $props$$22$$.scrollLeft = $value$$276$$;
      $$$$33$$($elem$$89$$).animate($props$$22$$, $duration$$11$$, "swing", $onEndFunc$$1$$);
    }, $_animateScrollTop$:function($elem$$90$$, $value$$277$$, $duration$$12$$, $onEndFunc$$2$$) {
      var $props$$23$$ = {};
      $props$$23$$.scrollTop = $value$$277$$;
      $$$$33$$($elem$$90$$).animate($props$$23$$, $duration$$12$$, "swing", $onEndFunc$$2$$);
