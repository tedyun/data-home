...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common", "ojs/ojrowexpander"], function($oj$$43$$) {
  ...
  $oj$$43$$.$FlattenedTreeCellSet$.prototype.getData = function $$oj$$43$$$$FlattenedTreeCellSet$$$getData$($indexes$$16_row$$45_rowData$$5$$) {
    ...
    $oj$$43$$.$Assert$.assert($indexes$$16_row$$45_rowData$$5$$ < this.$m_nodeSet$.$getStart$() + this.$m_nodeSet$.$getCount$() && $column$$26_columnKey$$6_relIndex$$2$$ < this.$m_columns$.length);
  ...
  $oj$$43$$.$FlattenedTreeCellSet$.prototype.getMetadata = function $$oj$$43$$$$FlattenedTreeCellSet$$$getMetadata$($indexes$$17_metadata$$23_row$$46$$) {
    var $column$$27_columnKey$$7_relIndex$$3$$;
    $column$$27_columnKey$$7_relIndex$$3$$ = this.$_getRelIndexes$($indexes$$17_metadata$$23_row$$46$$);
    if (null == $column$$27_columnKey$$7_relIndex$$3$$) {
      return null;
    }
    $indexes$$17_metadata$$23_row$$46$$ = $column$$27_columnKey$$7_relIndex$$3$$[0];
    $column$$27_columnKey$$7_relIndex$$3$$ = $column$$27_columnKey$$7_relIndex$$3$$[1];
    $oj$$43$$.$Assert$.assert($indexes$$17_metadata$$23_row$$46$$ < this.$m_nodeSet$.$getStart$() + this.$m_nodeSet$.$getCount$() && $column$$27_columnKey$$7_relIndex$$3$$ < this.$m_columns$.length);
    $column$$27_columnKey$$7_relIndex$$3$$ = this.$m_columns$[$column$$27_columnKey$$7_relIndex$$3$$];
    $indexes$$17_metadata$$23_row$$46$$ = this.$m_nodeSet$.getMetadata($indexes$$17_metadata$$23_row$$46$$);
    $indexes$$17_metadata$$23_row$$46$$.keys = {row:$indexes$$17_metadata$$23_row$$46$$.key, column:$column$$27_columnKey$$7_relIndex$$3$$};
    return $indexes$$17_metadata$$23_row$$46$$;
  };
  ...
  $oj$$43$$.$FlattenedTreeCellSet$.prototype.$_getRelIndexes$ = function $$oj$$43$$$$FlattenedTreeCellSet$$$$_getRelIndexes$$($column$$28_indexes$$18$$) {
    ...
    $oj$$43$$.$Assert$.$assertNumber$($row$$47$$, null);
    $oj$$43$$.$Assert$.$assertNumber$($column$$28_indexes$$18$$, null);
    $oj$$43$$.$Assert$.assert(0 <= $row$$47$$ && 0 <= $column$$28_indexes$$18$$);
  ...
  $oj$$43$$.$FlattenedTreeDataGridDataSource$.prototype.$fetchCells$ = function $$oj$$43$$$$FlattenedTreeDataGridDataSource$$$$fetchCells$$($cellRanges$$7$$, $callbacks$$44$$, $callbackObjects$$22$$) {
    var $i$$362$$, $cellRange$$4$$, $rowStart$$6$$, $rowCount$$8$$;
    for ($i$$362$$ = 0;$i$$362$$ < $cellRanges$$7$$.length;$i$$362$$++) {
      if ($cellRange$$4$$ = $cellRanges$$7$$[$i$$362$$], "row" == $cellRange$$4$$.axis) {
  ...
  $oj$$43$$.$FlattenedTreeDataGridDataSource$.prototype.$indexes$ = function $$oj$$43$$$$FlattenedTreeDataGridDataSource$$$$indexes$$($keys$$40$$) {
    var $rowIndex$$13$$, $colIndex$$1$$, $rowKey$$40$$, $colKey$$, $i$$363$$;
    ...
    return new Promise(function($resolve$$55$$) {
      ...
      for ($i$$363$$ = 0;$i$$363$$ < this.$m_columns$.length;$i$$363$$++) {
        if (this.$m_columns$[$i$$363$$] === $colKey$$) {
          $colIndex$$1$$ = $i$$363$$;
          break;
        }
      }
  ...
  $oj$$43$$.$FlattenedTreeDataGridDataSource$.prototype.$insertMetadata$ = function $$oj$$43$$$$FlattenedTreeDataGridDataSource$$$$insertMetadata$$($key$$161$$, $metadata$$24$$) {
    $oj$$43$$.$FlattenedTreeDataGridDataSource$.$superclass$.$insertMetadata$.call(this, $key$$161$$, $metadata$$24$$);
  };
  $oj$$43$$.$FlattenedTreeDataGridDataSource$.prototype.$_handleFetchRowsSuccess$ = function $$oj$$43$$$$FlattenedTreeDataGridDataSource$$$$_handleFetchRowsSuccess$$($cellSet$$2_nodeSet$$29$$, $cellRanges$$8$$, $callbacks$$48$$, $callbackObjects$$25$$) {
    var $headerRange$$7_i$$364$$, $cellRange$$5$$, $rowStart$$7$$, $rowCount$$9$$, $columnStart$$, $columnCount$$4$$;
    for ($headerRange$$7_i$$364$$ = 0;$headerRange$$7_i$$364$$ < $cellRanges$$8$$.length;$headerRange$$7_i$$364$$++) {
      $cellRange$$5$$ = $cellRanges$$8$$[$headerRange$$7_i$$364$$], "row" == $cellRange$$5$$.axis ? ($rowStart$$7$$ = $cellRange$$5$$.start, $rowCount$$9$$ = $cellRange$$5$$.count) : "column" == $cellRange$$5$$.axis && ($columnStart$$ = $cellRange$$5$$.start, $columnCount$$4$$ = $cellRange$$5$$.count, $columnStart$$ + $columnCount$$4$$ > this.$getCount$("column") && ($columnCount$$4$$ = this.$getCount$("column") - $columnStart$$));
    }
    this.$m_fetchHeaderRequest$ && ($headerRange$$7_i$$364$$ = this.$m_fetchHeaderRequest$.range, $headerRange$$7_i$$364$$.start == $rowStart$$7$$ && $headerRange$$7_i$$364$$.count == $rowCount$$9$$ && this.$_handleRowHeaderFetchSuccess$($cellSet$$2_nodeSet$$29$$, $headerRange$$7_i$$364$$, this.$m_fetchHeaderRequest$.callbacks, this.$m_fetchHeaderRequest$.callbackObjects), this.$m_fetchHeaderRequest$ = null);
  ...
  $oj$$43$$.$FlattenedTreeDataGridDataSource$.prototype.$insertRows$ = function $$oj$$43$$$$FlattenedTreeDataGridDataSource$$$$insertRows$$($event$$489_insertAtIndex$$1$$, $cellSet$$3_insertAtRowKey$$, $nodeSet$$31$$) {
    var $headerSet$$4$$, $i$$365$$, $keys$$41$$, $indexes$$20$$;
    $headerSet$$4$$ = null;
    ...
    $keys$$41$$ = [];
    $indexes$$20$$ = [];
    for ($i$$365$$ = 0;$i$$365$$ < $nodeSet$$31$$.$getCount$();$i$$365$$++) {
      $keys$$41$$.push({row:this.$_getEntry$($event$$489_insertAtIndex$$1$$ + $i$$365$$).key}), $indexes$$20$$.push({row:$event$$489_insertAtIndex$$1$$ + $i$$365$$, column:-1});
    }
  ...
  $oj$$43$$.$FlattenedTreeDataGridDataSource$.prototype.$removeRows$ = function $$oj$$43$$$$FlattenedTreeDataGridDataSource$$$$removeRows$$($event$$490_rowKeys$$1$$) {
    var $keys$$42$$, $i$$366$$, $indexes$$21$$;
    $keys$$42$$ = [];
    $indexes$$21$$ = [];
    for ($i$$366$$ = 0;$i$$366$$ < $event$$490_rowKeys$$1$$.length;$i$$366$$++) {
      $keys$$42$$.push({row:$event$$490_rowKeys$$1$$[$i$$366$$].key}), $indexes$$21$$.push({row:$event$$490_rowKeys$$1$$[$i$$366$$].index, column:-1});
    }
