...
define(["ojs/ojcore", "jquery", "hammerjs", "promise", "ojs/ojjquery-hammer", "ojs/ojoffcanvas"], function($oj$$69$$, $$$$63$$) {
  ...
  $oj$$69$$.$SwipeToRevealUtils$.$setupSwipeActions$ = function $$oj$$69$$$$SwipeToRevealUtils$$$setupSwipeActions$$($elem$$159$$, $options$$402$$) {
    var $drawer$$21$$, $direction$$14$$, $offcanvas$$24$$, $outerWrapper$$4$$, $threshold$$4$$, $minimum$$2$$, $drawerShown$$, $evt$$30$$, $checkpoint$$, $defaultAction$$, $distance$$2$$;
    $drawer$$21$$ = $$$$63$$($elem$$159$$);
    $drawer$$21$$.hasClass("oj-swipetoreveal") || ($drawer$$21$$.addClass("oj-swipetoreveal"), $direction$$14$$ = $drawer$$21$$.hasClass("oj-offcanvas-start") ? "end" : "start", $offcanvas$$24$$ = {}, $offcanvas$$24$$.selector = $drawer$$21$$, $oj$$69$$.$OffcanvasUtils$.$setupPanToReveal$($offcanvas$$24$$), $outerWrapper$$4$$ = $oj$$69$$.$OffcanvasUtils$.$_getOuterWrapper$($drawer$$21$$), null != $options$$402$$ && ($threshold$$4$$ = $options$$402$$.threshold), null != $threshold$$4$$ ? ($threshold$$4$$ = 
    parseInt($threshold$$4$$, 10), /%$/.test($options$$402$$.threshold) && ($threshold$$4$$ = $threshold$$4$$ / 100 * $outerWrapper$$4$$.outerWidth())) : $threshold$$4$$ = .55 * $outerWrapper$$4$$.outerWidth(), $minimum$$2$$ = Math.min(.3 * $outerWrapper$$4$$.outerWidth(), $drawer$$21$$.outerWidth()), $drawerShown$$ = !1, $outerWrapper$$4$$.on("click.swipetoreveal", function($event$$623$$) {
      ...
      null != $defaultAction$$ && $distance$$2$$ > $threshold$$4$$ && ($evt$$30$$ = $$$$63$$.Event("ojdefaultaction"), $drawer$$21$$.trigger($evt$$30$$, $offcanvas$$24$$), $event$$626$$.preventDefault());
  ...
  $oj$$69$$.$SwipeToRevealUtils$.$tearDownSwipeActions$ = function $$oj$$69$$$$SwipeToRevealUtils$$$tearDownSwipeActions$$($elem$$160_offcanvas$$25$$) {
    var $drawer$$22_outerWrapper$$5$$;
    $drawer$$22_outerWrapper$$5$$ = $$$$63$$($elem$$160_offcanvas$$25$$);
    $elem$$160_offcanvas$$25$$ = {};
    $elem$$160_offcanvas$$25$$.selector = $drawer$$22_outerWrapper$$5$$;
    $drawer$$22_outerWrapper$$5$$ = $oj$$69$$.$OffcanvasUtils$.$_getOuterWrapper$($drawer$$22_outerWrapper$$5$$);
    null != $drawer$$22_outerWrapper$$5$$ && $drawer$$22_outerWrapper$$5$$.off("click.swipetoreveal");
    $oj$$69$$.$OffcanvasUtils$.$tearDownPanToReveal$($elem$$160_offcanvas$$25$$);
  };
