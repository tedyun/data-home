...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojdnd"], function($oj$$79$$, $$$$72$$) {
  ...
  (function() {
    ...
    function $_KeyFilterHandler$$($e$$116$$) {
      var $s$$10$$ = "";
      $oj$$79$$.$DomUtils$.$isMetaKeyPressed$($e$$116$$) ? $s$$10$$ += "ctrl+" : $e$$116$$.shiftKey && ($s$$10$$ += "shift+");
      var $key$$188$$ = $e$$116$$.which;
      switch($key$$188$$) {
        case 32:
          $s$$10$$ += "space";
          break;
        ...
        ;
        case 121:
          $s$$10$$ += "f" + (1 - (112 - $key$$188$$));
      }
      if (0 === $s$$10$$.length || "shift+" == $s$$10$$ || "ctrl+" == $s$$10$$) {
        return!0;
      }
      var $retHandler$$ = null;
      $$$$72$$.each($_aKeyHandlerStack$$, function($i$$461$$, $obj$$62$$) {
        if ($obj$$62$$.$_this$.$_data$.ui.$focused$) {
          return $obj$$62$$.$_this$.$_data$.ui.$touchEvent$ = !1, "shift+f10" == $s$$10$$ ? $obj$$62$$.$_this$.$_data$.menu.$activenode$ = $obj$$62$$.$_this$.$_data$.ui.$hovered$ : $obj$$62$$.$_handler$[$s$$10$$] && ($e$$116$$.preventDefault(), $retHandler$$ = $obj$$62$$.$_handler$[$s$$10$$].call($obj$$62$$.$_this$, $e$$116$$)), !1;
        }
      });
      if (null != $retHandler$$) {
        return $retHandler$$;
    ...
    function $_removeKeyFilter$$($selector$$47$$) {
      $$$$72$$.each($_aKeyHandlerStack$$, function($i$$462$$) {
        if ($_aKeyHandlerStack$$[$i$$462$$].$_selector$ === $selector$$47$$) {
          return $$$$72$$($selector$$47$$).off("keydown"), $_aKeyHandlerStack$$[$i$$462$$] = null, $_aKeyHandlerStack$$.splice($i$$462$$, 1), !1;
        }
      });
    }
    ...
    expandAll:null, hover:null, loaded:null, move:null, optionChange:null, paste:null, refresh:null, rename:null}, collapse:function($node$$132$$, $skipAnim$$) {
      ...
      var $node$$134$$ = $$ul$$2_e$$117$$.closest("li");
      ...
      this.$_transitionEnd$($$ul$$2_e$$117$$, $node$$134$$);
      ...
      if ($nodes$$6$$ && "array" === $$$$72$$.type($nodes$$6$$)) {
        ...
        $$$$72$$.each($nodes$$6$$, function($i$$463$$, $val$$70$$) {
    ...
    }, deselectAll:function($context$$173$$) {
      if (!this.$_data$.$core$.locked) {
        var $prevSelections$$1$$ = this.options.selection.slice(0);
        this.$_deselectAll$($context$$173$$);
      ...
      var $node$$147$$, $ar$$1$$, $i$$464$$;
      $ar$$1$$ = $$$$72$$.isArray($data$$174$$);
      if (!$ar$$1$$ || 1 == $data$$174$$.length) {
        return $node$$147$$ = this.$_createNode$($refnode$$, $position$$48$$, $ar$$1$$ ? $data$$174$$[0] : $data$$174$$), this.$_getDndContext$().$_dndFinishSelection$($node$$147$$), $node$$147$$;
      }
      $ar$$1$$ = [];
      if ("before" != $position$$48$$) {
        for ($i$$464$$ = $data$$174$$.length - 1;0 <= $i$$464$$;$i$$464$$--) {
          $node$$147$$ = this.$_createNode$($refnode$$, $position$$48$$, $data$$174$$[$i$$464$$]), $ar$$1$$.unshift($node$$147$$[0]), this.$_getDndContext$().$_dndFinishSelection$($node$$147$$);
        }
      } else {
        for ($i$$464$$ = 0;$i$$464$$ < $data$$174$$.length;$i$$464$$++) {
          $node$$147$$ = this.$_createNode$($refnode$$, $position$$48$$, $data$$174$$[$i$$464$$]), $ar$$1$$.push($node$$147$$[0]), this.$_getDndContext$().$_dndFinishSelection$($node$$147$$);
        }
      }
      return $$$$72$$($ar$$1$$);
      ...
      this._super();
    }, _setOption:function($key$$189$$, $newval$$, $flags$$55$$) {
      var $val$$71$$;
      if ("selection" === $key$$189$$) {
          ...
          if ("icons" === $key$$189$$) {
            ...
            if ("contextMenu" === $key$$189$$) {
              ...
              if ("disabled" === $key$$189$$) {
                ...
                if ("data" === $key$$189$$) {
                  this._super($key$$189$$, $newval$$, $flags$$55$$);
                  this.$_initDSOpts$();
                ...
                "emptyText" == $key$$189$$ && ($newval$$ = this.$_escapeHtml$($newval$$));
              }
            }
          }
        }
      ...
      var $i$$465$$, $j$$46$$, $id$$65$$, $len$$21$$, $len2$$, $bDiff$$ = !1, $bInList$$ = !1;
      ...
      if ($len$$21$$ !== $len2$$) {
        ...
        if (0 == $len$$21$$ && 0 === $len2$$) {
          ...
          for ($i$$465$$ = 0;$i$$465$$ < $len$$21$$;$i$$465$$++) {
            $id$$65$$ = $$$$72$$($value1$$11$$[$i$$465$$]).attr("id");
            $bInList$$ = !1;
            for ($j$$46$$ = 0;$j$$46$$ < $len2$$;$j$$46$$++) {
              if ($id$$65$$ == $$$$72$$($value2$$10$$[$j$$46$$]).attr("id")) {
                $bInList$$ = !0;
                break;
              }
            }
      ...
      var $sels$$ = $aSelected_newSels$$.slice(0), $cur$$2$$ = [], $_this$$5$$ = this, $$elem$$3$$, $id$$66$$, $inList$$, $len$$22$$;
      $$$$72$$.grep($sels$$, function($node$$167$$, $i$$466$$) {
        if ($$elem$$3$$ = $_this$$5$$.$_getNodeElem$($node$$167$$)) {
          $cur$$2$$.push($$elem$$3$$), $sels$$[$i$$466$$] = $$elem$$3$$[0];
        } else {
          return!1;
        }
        return!0;
      ...
      $$$$72$$.each($aSelected_newSels$$, function($i$$467$$, $node$$168$$) {
        $len$$22$$ = $cur$$2$$.length;
        $id$$66$$ = $$$$72$$($node$$168$$).attr("id");
        $inList$$ = !1;
        for ($i$$467$$ = 0;$i$$467$$ < $len$$22$$;$i$$467$$++) {
          if ($id$$66$$ == $cur$$2$$[$i$$467$$].attr("id")) {
            $inList$$ = !0;
            break;
          }
        }
      ...
      var $v$$2$$ = !1, $ty$$ = this.$_getType$($obj$$72$$), $s$$12$$ = this.$_getOptions$().types, $data$$175$$ = !1;
      if (-1 === $obj$$72$$) {
        if ($s$$12$$[$rule$$3$$]) {
          $v$$2$$ = $s$$12$$[$rule$$3$$];
        } else {
    ...
    }, $_createNode$:function($obj$$74$$, $position$$51$$, $js$$, $callback$$130$$, $d$$10_is_loaded$$) {
      $obj$$74$$ = $obj$$74$$ || -1;
      ...
      if (!$d$$10_is_loaded$$ && !this.$_is_loaded$($obj$$74$$)) {
        return this.$_load_node$($obj$$74$$, function() {
          this.$_createNode$($obj$$74$$, $position$$51$$, $js$$, $callback$$130$$, !0);
        }), null;
      }
      this.$__rollback$();
      ...
      if (!$obj$$75$$.hasClass($TreeUtils$$.$_OJ_DISABLED$) && !this.$_data$.$core$.locked) {
        if (!$obj$$75$$.hasClass($TreeUtils$$.$_OJ_COLLAPSED$)) {
          return $callback$$131$$ && $callback$$131$$.call(), !1;
        }
        ...
        if ("boolean" != typeof $dur$$1_rslt$$4$$ || $dur$$1_rslt$$4$$) {
          ...
          }), $obj$$75$$.removeClass($TreeUtils$$.$_OJ_COLLAPSED$).addClass($TreeUtils$$.$_OJ_EXPANDED$).attr("aria-expanded", "true").children("a").removeClass("oj-tree-loading"), $$$$72$$($obj$$75$$.children()[0]).removeClass($TreeUtils$$.$_OJ_SELECTED$).addClass("oj-default"), !$skipAnim$$4$$ && $dur$$1_rslt$$4$$ ? this.$_slide$($obj$$75$$, !1) : this.$_transitionEnd$($$$$72$$($obj$$75$$.children("UL")[0]), $obj$$75$$), $callback$$131$$ && $callback$$131$$.call()) : ($obj$$75$$.children("a").addClass("oj-tree-loading"), 
          this.$_load_node$($obj$$75$$, function() {
            $t$$7$$.$_expand$($obj$$75$$, $callback$$131$$, $skipAnim$$4$$);
          }, $callback$$131$$));
        }
      }
    ...
    }, $_select$:function($node$$172$$, $bRet_check$$, $e$$119$$) {
      ...
      }), $ui$$42$$.selected = $ui$$42$$.selected.add($node$$172$$), this.$_fix_scroll$($node$$172$$.eq(0)), $core$$.$suppressSelectEvent$ || this.$_fireOptionChangeEvent$("selection", $prevSelections$$2_rslt$$5$$, null, $e$$119$$));
      return $bRet_check$$;
    ...
    }, $_deselectAll$:function($context$$174_ret$$67$$) {
      if (!this.$_data$.$core$.locked && ($context$$174_ret$$67$$ = $context$$174_ret$$67$$ ? $$$$72$$($context$$174_ret$$67$$).find("a.oj-selected").parent() : this.$_$container$.find("a.oj-selected").parent(), $context$$174_ret$$67$$.not(".oj-disabled"), 0 !== $context$$174_ret$$67$$.length)) {
        var $_this$$8$$ = this;
        $$$$72$$.each($context$$174_ret$$67$$, function() {
      ...
      if ($nodes$$8$$ && 0 < $nodes$$8$$.length) {
        var $_this$$9$$ = this;
        $$$$72$$.each($nodes$$8$$, function($i$$469$$, $val$$74$$) {
          $val$$74$$ && $_this$$9$$.$_select$($val$$74$$, !0, $e$$120$$);
        });
      }
    ...
    }, $_disclosureHover$:function($elem$$170$$, $bHover$$) {
      $elem$$170$$ = $$$$72$$($elem$$170$$);
      if (!$elem$$170$$.hasClass($TreeUtils$$.$_OJ_DISABLED$) && !this.$_data$.$core$.locked) {
        var $par$$ = $elem$$170$$.parent(), $bClosed$$ = $par$$.hasClass($TreeUtils$$.$_OJ_COLLAPSED$);
        if ($par$$.hasClass($TreeUtils$$.$_OJ_EXPANDED$) || $bClosed$$) {
          $bHover$$ ? ($elem$$170$$.addClass($TreeUtils$$.$_OJ_HOVER$), $elem$$170$$.removeClass("oj-default"), $elem$$170$$.removeClass($TreeUtils$$.$_OJ_SELECTED$)) : ($elem$$170$$.removeClass($TreeUtils$$.$_OJ_HOVER$), $elem$$170$$.addClass("oj-default"));
        }
      }
      ...
      var $_this$$11$$ = this;
      this.$_data$.$core$.$toExpand$.length && $$$$72$$.each(this.$_data$.$core$.$toExpand$, function($i$$470$$, $val$$75$$) {
        $_this$$11$$.$_expand$($val$$75$$, !1, !0);
      });
      this.$_emitEvent$({}, "reopen", !0);
    }, $_getSelected$:function($context$$175_sel$$2$$) {
      var $ar$$2$$, $i$$471$$, $len$$23$$;
      $context$$175_sel$$2$$ = $context$$175_sel$$2$$ ? $$$$72$$($context$$175_sel$$2$$).find("a.oj-selected").parent() : this.$_data$.ui.selected;
      $ar$$2$$ = [];
      $len$$23$$ = $context$$175_sel$$2$$.length;
      for ($i$$471$$ = 0;$i$$471$$ < $len$$23$$;$i$$471$$++) {
        $ar$$2$$.push($context$$175_sel$$2$$[$i$$471$$]);
      }
      return $ar$$2$$;
      ...
      return-1 == $obj$$88$$ || !$obj$$88$$ || !$ajax$$ && !$$$$72$$.isFunction($data$$176$$) || $obj$$88$$.is(".oj-expanded, .oj-tree-leaf") || 0 < $obj$$88$$.children("ul").children("li").size();
    }, reselect:function() {
      ...
      $$$$72$$.each($s$$17$$, function($i$$472$$, $val$$77$$) {
      ...
      0 < $cc$$ && ($range$$22$$.count = $cc$$, $ds$$.$fetchChildren$($parentKey$$14$$, $range$$22$$, {success:$$$$72$$.proxy(function($jns$$) {
        for (var $c$$53$$ = $jns$$.$getCount$(), $attr$$20_n$$33_r$$7$$, $i$$473$$ = 0;$i$$473$$ < $c$$53$$;$i$$473$$++) {
          $node$$176$$ = {};
          ($attr$$20_n$$33_r$$7$$ = $jns$$.getData($i$$473$$)) && ($node$$176$$.attr = $attr$$20_n$$33_r$$7$$);
          $node$$176$$.title = $jns$$.$m_nodes$[$i$$473$$].title;
          $attr$$20_n$$33_r$$7$$.$metadata$ && ($node$$176$$.metadata = $jns$$.$m_nodes$[$i$$473$$].metadata);
          var $key$$190$$ = $node$$176$$.attr.id;
          $attr$$20_n$$33_r$$7$$ = $ds$$.$getChildCount$($key$$190$$);
          0 < $attr$$20_n$$33_r$$7$$ && ($attr$$20_n$$33_r$$7$$ = this.$_JsonDSToJson$($key$$190$$, $node$$176$$), $node$$176$$.children = $attr$$20_n$$33_r$$7$$.$js$);
      ...
      if (($obj$$91$$ = this.$_getNode$($obj$$91$$)) && -1 !== $obj$$91$$ && (this.$_data$.$ds$.$progressiveRender$ || this.$_data$.$ds$.$progressiveUnload$) && !$obj$$91$$.is(".oj-expanded, .oj-tree-leaf") && 0 === $obj$$91$$.children("ul").children("li").length && $obj$$91$$.data("oj-tree-children")) {
        ...
        switch(!0) {
          ...
          case $$$$72$$.isFunction($data$$177$$):
            $data$$177$$.call(this, $obj$$91$$, $$$$72$$.proxy(function($d$$13$$) {
            ...
            break;
          case !!$data$$177$$ && !$ajax$$1$$ || !!$data$$177$$ && !!$ajax$$1$$ && (!$obj$$91$$ || -1 === $obj$$91$$):
            $obj$$91$$ && -1 != $obj$$91$$ || (($d$$12_s$$20$$ = this.$_parseJson$($data$$177$$, $obj$$91$$)) ? (this.$_$container_ul$.empty().append($d$$12_s$$20$$.children()), this.$_cleanNode$()) : this.$_data$.$ds$.$correctState$ && this.$_$container_ul$.empty());
            $s_call$$4$$ && $s_call$$4$$.call(this);
            break;
          case !$data$$177$$ && !!$ajax$$1$$ || !!$data$$177$$ && !!$ajax$$1$$ && $obj$$91$$ && -1 !== $obj$$91$$:
      ...
      var $d$$15$$ = !1, $tmp$$5$$, $i$$474$$, $j$$47$$, $title$$12$$;
      if (!$js$$1$$) {
        return $d$$15$$;
      }
      ...
      if ($$$$72$$.isArray($js$$1$$)) {
        ...
        $i$$474$$ = 0;
        for ($j$$47$$ = $js$$1$$.length;$i$$474$$ < $j$$47$$;$i$$474$$++) {
          $tmp$$5$$ = this.$_parseJson$($js$$1$$[$i$$474$$], $obj$$92_ul2$$, !0), $tmp$$5$$.length && ($d$$15$$ = $d$$15$$.append($tmp$$5$$));
        }
        $d$$15$$ = $d$$15$$.children();
      } else {
        ...
        $$$$72$$.each($js$$1$$.data, function($i$$475$$, $m$$25$$) {
          $$$$72$$.isFunction($m$$25$$) && ($m$$25$$ = $m$$25$$.call(this, $js$$1$$));
          "string" != typeof $m$$25$$ && ("attr" == $i$$475$$ ? $tmp$$5$$.attr($m$$25$$) : "style" == $i$$475$$ && $tmp$$5$$.css($m$$25$$), "language" == $i$$475$$ && $tmp$$5$$.addClass($m$$25$$));
      ...
      var $result$$81$$ = [], $s$$21$$ = this.options, $_this$$17$$ = this, $tmp1$$, $tmp2$$, $val$$78$$, $li$$3$$, $a$$126$$, $t$$9$$, $sAttr$$, $title$$13$$;
      ...
      $obj$$93$$.each(function() {
        ...
        $$$$72$$.each($li_attr$$, function($i$$476$$, $v$$3$$) {
      ...
      switch(!0) {
        ...
        case $$$$72$$.isFunction($data$$178$$):
          $data$$178$$.call(this, $obj$$95$$, $$$$72$$.proxy(function($d$$17$$) {
        ...
        case !$data$$178$$ && !$ajax$$2$$:
          ...
          break;
        case !!$data$$178$$ && !$ajax$$2$$ || !!$data$$178$$ && !!$ajax$$2$$ && (!$obj$$95$$ || -1 === $obj$$95$$):
          $obj$$95$$ && -1 != $obj$$95$$ || ($d$$16_s$$22$$ = $$$$72$$($data$$178$$), $d$$16_s$$22$$.is("ul") || ($d$$16_s$$22$$ = $$$$72$$("\x3cul /\x3e").append($d$$16_s$$22$$)), this.$_$container_ul$.empty().append($d$$16_s$$22$$.children()).find("li, a").filter(function() {
            return!this.firstChild || !this.firstChild.tagName || "INS" !== this.firstChild.tagName;
          ...
          break;
        case !$data$$178$$ && !!$ajax$$2$$ || !!$data$$178$$ && !!$ajax$$2$$ && $obj$$95$$ && -1 !== $obj$$95$$:
          $obj$$95$$ = this.$_getNode$($obj$$95$$), $error_func$$1$$ = function $$error_func$$1$$$($x$$58$$, $t$$10$$, $e$$122$$) {
          ...
          }, $success_func$$1$$ = function $$success_func$$1$$$($d$$18_parent$$54$$, $nodes$$9_t$$11$$, $x$$59$$) {
            var $sf$$1$$ = this.$_getOptions$().data.ajax.success;
            $sf$$1$$ && ($d$$18_parent$$54$$ = $sf$$1$$.call(this, $d$$18_parent$$54$$, $nodes$$9_t$$11$$, $x$$59$$) || $d$$18_parent$$54$$);
            ...
            if ($d$$18_parent$$54$$) {
              ...
              $nodes$$9_t$$11$$ = $d$$18_parent$$54$$.children("UL");
    ...
    }, $_loadHtmlString$:function($nodes$$10_parent$$57_s$$23$$, $obj$$96$$, $s_call$$6$$) {
      if ($nodes$$10_parent$$57_s$$23$$ && "" !== $nodes$$10_parent$$57_s$$23$$ && $nodes$$10_parent$$57_s$$23$$.toString && "" !== $nodes$$10_parent$$57_s$$23$$.toString().replace(/^[\s\n]+$/, "")) {
        $nodes$$10_parent$$57_s$$23$$ = $$$$72$$($nodes$$10_parent$$57_s$$23$$);
        $nodes$$10_parent$$57_s$$23$$.is("ul") || ($nodes$$10_parent$$57_s$$23$$ = $$$$72$$("\x3cul /\x3e").append($nodes$$10_parent$$57_s$$23$$));
        -1 != $obj$$96$$ && $obj$$96$$ ? ($obj$$96$$.children("a.oj-tree-loading").removeClass("oj-tree-loading"), $obj$$96$$.append($nodes$$10_parent$$57_s$$23$$).children("ul").find("li, a").filter(function() {
          return!this.firstChild || !this.firstChild.tagName || "INS" !== this.firstChild.tagName;
        }).prepend("\x3cins class\x3d'oj-tree-icon'\x3e\x26#160;\x3c/ins\x3e").end().filter("a").children("ins:first-child").not(".oj-tree-node-icon").addClass("oj-tree-node-icon").addClass("oj-tree-icon"), $obj$$96$$.removeData("oj-tree-is-loading"), $nodes$$10_parent$$57_s$$23$$ = $obj$$96$$, this.$_addDefType$(this.$obj$)) : (this.$_$container_ul$.empty().append($nodes$$10_parent$$57_s$$23$$.children()).find("li, a").filter(function() {
          return!this.firstChild || !this.firstChild.tagName || "INS" !== this.firstChild.tagName;
        }).prepend("\x3cins class\x3d'oj-tree-icon oj-tree-disclosure-icon'\x3e\x26#160;\x3c/ins\x3e").end().filter("a").children("ins:first-child").not(".oj-tree-node-icon").addClass("oj-tree-node-icon").addClass("oj-tree-icon"), this.$_$container_ul$.find("li.oj-tree-leaf ins:first-child").removeClass("oj-tree-icon oj-tree-disclosure-icon oj-component-icon oj-clickable-icon oj-default").removeClass("oj-tree-node-icon").addClass("oj-tree-icon"), $nodes$$10_parent$$57_s$$23$$ = this.$_$container_ul$, 
        this.$_addDefType$(this.$_$container_ul$));
        $nodes$$10_parent$$57_s$$23$$ && this.$_insertHtmlTextSpan$($nodes$$10_parent$$57_s$$23$$);
        $nodes$$10_parent$$57_s$$23$$ = $nodes$$10_parent$$57_s$$23$$.children("UL");
        if (1 <= $nodes$$10_parent$$57_s$$23$$.length) {
          $nodes$$10_parent$$57_s$$23$$ = $nodes$$10_parent$$57_s$$23$$.first().find("span.oj-tree-title");
          var $_this$$19$$ = this;
          $$$$72$$.each($nodes$$10_parent$$57_s$$23$$, function() {
    ...
    }, $_insertHtmlTextSpan$:function($elem$$171$$) {
      $$$$72$$.each($elem$$171$$.find("li a"), function($i$$477$$, $val$$79$$) {
      ...
      var $s$$24$$, $typeAttr$$1$$;
      this.$_data$.types.$defType$ && ($typeAttr$$1$$ = ($s$$24$$ = this.options.types) ? $s$$24$$.attr : this.$_data$.types.$defaults$.attr, $$$$72$$.each($obj$$97$$.find("li"), function($i$$478$$, $val$$80$$) {
        $val$$80$$ = $$$$72$$($val$$80$$);
      ...
      var $_this$$21$$ = this, $bDone$$ = !0, $current$$25$$ = [], $remaining$$1$$ = [], $n$$34$$, $id$$67$$;
      ...
      this.$_isOptExpandAll$() && (this.$_data$.$core$.$toExpand$ = [], this.$_$container_ul$.find("li.oj-collapsed").each(function() {
        $id$$67$$ = "#" + $$$$72$$(this).attr("id");
        $_this$$21$$.isExpanded($id$$67$$) || $_this$$21$$.$_data$.$core$.$toExpand$.push($id$$67$$);
      }));
      ...
      this.$_data$.$core$.$toLoad$.length && ($$$$72$$.each(this.$_data$.$core$.$toLoad$, function($i$$479$$, $val$$81$$) {
        if ("#" == $val$$81$$) {
          return!0;
        }
      ...
      }), $current$$25$$.length && (this.$_data$.$core$.$toLoad$ = $remaining$$1$$, $$$$72$$.each($current$$25$$, function($i$$480$$, $val$$82$$) {
      ...
      this.$_data$.$core$.$toExpand$.length && $$$$72$$.each(this.$_data$.$core$.$toExpand$, function($i$$481$$, $val$$83$$) {
      ...
      if ($evname$$ && "string" === $$$$72$$.type($evname$$) && (!0 !== this.$_data$.$core$.locked || "unlock" === $evname$$ || "isLocked" === $evname$$ || "lock" === $evname$$)) {
        ...
        $isBefore$$ ? ($func$$12_inst$$ = $data$$179$$.func, $eventdata$$.func = $func$$12_inst$$, $eventdata$$.args = $args$$23_bContinue$$, "rename" === $func$$12_inst$$ && ($eventdata$$.title = $data$$179$$.title, $eventdata$$.prevTitle = $data$$179$$.prevTitle)) : $isPublic$$ && ("move" == $evname$$ ? ($eventdata$$.position = $data$$179$$.$p$, $eventdata$$.reference = $data$$179$$.$r$, $eventdata$$.data = $data$$179$$) : "rename" == $evname$$ ? ($eventdata$$.title = $data$$179$$.title, $eventdata$$.prevTitle = 
    ...
    }, $_fireOptionChangeEvent$:function($key$$191$$, $prevVal$$, $newVal$$6$$, $origEvent$$) {
      "selection" === $key$$191$$ && (null == $newVal$$6$$ && ($newVal$$6$$ = this.$_getSelected$()), this.$_compareSelectionValues$($prevVal$$, $newVal$$6$$) || this.option($key$$191$$, $newVal$$6$$, {_context:{originalEvent:$origEvent$$, $internalSet$:!0}, changed:!0}));
    }, $__rollback$:function() {
      ...
      $s$$27$$ && this.$_$container$.bind("_treeinit", $$$$72$$.proxy(function() {
        ...
        $$$$72$$.each($types$$, function($i$$482$$, $tp$$) {
      ...
      if (!$ui$$48$$.inst && this.$_data$.menu.$treeDivId$ == this.$_elemId$.substr(1)) {
        var $id$$68$$ = $ui$$48$$ ? $ui$$48$$.item.attr("id") : void 0;
        "ojtreecopy" === $id$$68$$ ? this.$_crrm_copy$(this.$_data$.menu.$node$) : "ojtreecut" === $id$$68$$ ? this.$_crrm_cut$(this.$_data$.menu.$node$) : "ojtreepaste" === $id$$68$$ ? this.$_crrm_paste$(this.$_data$.menu.$node$) : "ojtreeremove" === $id$$68$$ ? this.isSelected(this.$_data$.menu.$node$) ? this.$_crrm_remove$() : this.$_crrm_remove$(this.$_data$.menu.$node$) : "ojtreerename" === $id$$68$$ ? this.$_crrm_rename$(this.$_data$.menu.$node$) : "ojtreecreate" === $id$$68$$ && this.$_crrm_create$(this.$_data$.menu.$node$);
      }
      ...
      if ($hover$$1$$) {
        ...
        $hover$$1$$ = $hover$$1$$[0];
        $$$$72$$.each($nodes$$11$$, function($i$$483$$, $node$$177$$) {
      ...
      if ($hover$$2$$) {
        ...
        $hover$$2$$ = $hover$$2$$[0];
        $$$$72$$.each($l$$17$$, function($i$$484$$, $node$$178$$) {
      ...
      this.$_emitEvent$({obj:$obj$$103$$, nodes:$nodes$$12$$}, "paste");
    ...
    }, $_crrm_showInput$:function($obj$$108$$, $callback$$132$$) {
      ...
      "relative").append($$$$72$$("\x3cinput /\x3e", {value:$t$$15$$, "class":"oj-tree-rename-input", css:{padding:"0", border:"1px solid silver", position:"absolute", left:$rtl$$4$$ ? "auto" : $w1$$ + $w2$$ + 4 + "px", right:$rtl$$4$$ ? $w1$$ + $w2$$ + 4 + "px" : "auto", top:"0px", height:this.$_data$.$core$.$li_height$ - 2 + "px", lineHeight:this.$_data$.$core$.$li_height$ - 2 + "px", width:"150px"}, blur:$$$$72$$.proxy(function() {
        var $i$$485$$ = $obj$$108$$.children(".oj-tree-rename-input"), $v$$5$$ = $i$$485$$.val();
        "" === $v$$5$$ && ($v$$5$$ = $t$$15$$);
        $h1$$.remove();
        $i$$485$$.remove();
        this.$_set_text$($obj$$108$$, $t$$15$$);
        this.$_renameNode$($obj$$108$$, $v$$5$$);
        $callback$$132$$.call(this, $obj$$108$$, $v$$5$$, $t$$15$$);
        $obj$$108$$.css("position", "");
      }, this), keyup:function($event$$680_key$$193$$) {
        $event$$680_key$$193$$ = $event$$680_key$$193$$.keyCode || $event$$680_key$$193$$.which;
        if (!$_this$$28$$.$_done$) {
          return $_this$$28$$.$_done$ = !0, !1;
        }
        27 == $event$$680_key$$193$$ ? ($_this$$28$$.$_done$ = !1, this.value = $t$$15$$, this.blur()) : 13 == $event$$680_key$$193$$ ? ($_this$$28$$.$_done$ = !1, this.blur()) : $h2$$.width(Math.min($h1$$.text("pW" + this.value).width(), $w$$9$$));
    ...
    }, $_crrm_create$:function($obj$$109$$, $position$$53$$, $js$$2$$, $callback$$133$$, $skip_rename$$) {
      var $_this$$29$$ = this;
      ...
      return this.$_createNode$($obj$$109$$, $position$$53$$, $js$$2$$, function($t$$17$$) {
        ...
        $callback$$133$$ && $callback$$133$$.call(this, $t$$17$$);
      ...
      var $c$$55_i$$486_subId$$69$$, $node$$179$$, $a$$130_sKey$$;
      $a$$130_sKey$$ = null;
      var $ret$$69$$;
      $locator$$66_sNode$$ && ($c$$55_i$$486_subId$$69$$ = $locator$$66_sNode$$.subId);
      if (!$c$$55_i$$486_subId$$69$$) {
        return null;
      }
      $a$$130_sKey$$ = $c$$55_i$$486_subId$$69$$.split("[");
      if (3 === $a$$130_sKey$$.length && ($a$$130_sKey$$[0] = $a$$130_sKey$$[0].trim(), "oj-tree-node" === $a$$130_sKey$$[0] && ($a$$130_sKey$$[1] = $a$$130_sKey$$[1].trim(), $c$$55_i$$486_subId$$69$$ = $a$$130_sKey$$[1].charAt(0), $c$$55_i$$486_subId$$69$$ = $a$$130_sKey$$[1].indexOf($c$$55_i$$486_subId$$69$$, 1), 0 <= $c$$55_i$$486_subId$$69$$ && ($locator$$66_sNode$$ = $a$$130_sKey$$[1].substring(1, $c$$55_i$$486_subId$$69$$).trim(), $a$$130_sKey$$[2] = $a$$130_sKey$$[2].trim(), $c$$55_i$$486_subId$$69$$ = 
      $a$$130_sKey$$[2].charAt(0), $c$$55_i$$486_subId$$69$$ = $a$$130_sKey$$[2].indexOf($c$$55_i$$486_subId$$69$$, 1), 0 <= $c$$55_i$$486_subId$$69$$)))) {
        $a$$130_sKey$$ = $a$$130_sKey$$[2].substring(1, $c$$55_i$$486_subId$$69$$).trim();
        try {
    ...
    }, $_getSubIdFromNodeElem$:function($elem$$172$$) {
      var $node$$180_type$$108$$ = $elem$$172$$ ? this.$_getNode$($elem$$172$$) : null, $parent$$58_parentType$$, $subid$$ = null;
      $node$$180_type$$108$$ && -1 != $node$$180_type$$108$$ && $node$$180_type$$108$$.length && $node$$180_type$$108$$.hasClass("oj-tree-node") && $elem$$172$$.tagName && $elem$$172$$.parentNode && ($node$$180_type$$108$$ = $elem$$172$$.tagName, $parent$$58_parentType$$ = $elem$$172$$.parentNode, $parent$$58_parentType$$ = $parent$$58_parentType$$.tagName, "SPAN" === $node$$180_type$$108$$ ? $subid$$ = "title" : "A" === $node$$180_type$$108$$ ? $subid$$ = "link" : "INS" === $node$$180_type$$108$$ && 
      ($elem$$172$$ = $$$$72$$($elem$$172$$), "LI" === $parent$$58_parentType$$ && $elem$$172$$.hasClass("oj-tree-disclosure-icon") ? $subid$$ = "disclosure" : "A" === $parent$$58_parentType$$ && $elem$$172$$.hasClass("oj-tree-node-icon") && ($subid$$ = "icon")));
      return $subid$$;
    }, $_hideDots$:function() {
    ...
    }, $_getString$:function($key$$195$$) {
      var $oStrings$$ = this.$_data$.$core$.$strings$, $s$$33$$;
      $s$$33$$ = $oStrings$$[$key$$195$$];
      $s$$33$$ || ($s$$33$$ = this.$getTranslatedString$($key$$195$$), $s$$33$$ = this.$_escapeHtml$($s$$33$$), $oStrings$$[$key$$195$$] = $s$$33$$);
      return $s$$33$$;
  ...
  $oj$$79$$.$TreeDndContext$.prototype.$_dragStart$ = function $$oj$$79$$$$TreeDndContext$$$$_dragStart$$($e$$131$$) {
    var $dnd$$5$$, $$nodes_vars$$1$$, $$node$$ = $$$$72$$($e$$131$$.target).closest("li"), $dt$$1$$ = $e$$131$$.originalEvent.dataTransfer, $ret$$71$$;
    $dnd$$5$$ = this.$_dnd$;
    ...
    if (!$dnd$$5$$.reorder && !$dnd$$5$$.$dragFromEnabled$ || $$node$$.hasClass($TreeUtils$$.$_OJ_DISABLED$) || this.$component$.$_data$.$core$.locked) {
      ...
      if ($dnd$$5$$.$dragStartCallback$) {
        $ret$$71$$ = $dnd$$5$$.$dragStartCallback$($e$$131$$, {item:void 0});
        if ($e$$131$$.isDefaultPrevented() || "boolean" === typeof $ret$$71$$ && !$ret$$71$$) {
          return $ret$$71$$;
        }
      ...
      "uninitialized" === $dt$$1$$.effectAllowed && ($dt$$1$$.effectAllowed = $dnd$$5$$.$pureReorder$ ? "move" : $oj$$79$$.$DomUtils$.$isMetaKeyPressed$($e$$131$$) ? "copy" : "move");
      this.$_dndStartDrag$($$nodes_vars$$1$$, $$node$$, $e$$131$$);
    }
  };
  $oj$$79$$.$TreeDndContext$.prototype.$_drag$ = function $$oj$$79$$$$TreeDndContext$$$$_drag$$($e$$132$$) {
    var $dnd$$6$$ = this.$_dnd$;
    $dnd$$6$$.$dragDragCallback$ && $dnd$$6$$.$dragDragCallback$($e$$132$$);
  };
  $oj$$79$$.$TreeDndContext$.prototype.$_dragEnter$ = function $$oj$$79$$$$TreeDndContext$$$$_dragEnter$$($e$$133$$) {
    this.$component$.$_$container_ul$[0].firstChild || this.$_addInternalNode$();
    var $$targ$$1$$ = $$$$72$$($e$$133$$.target), $$node$$1$$ = this.$component$.$_getNode$($$targ$$1$$), $dnd$$7$$ = this.$_dnd$, $vars$$2$$ = $dnd$$7$$.$vars$, $bNode$$1$$ = $$node$$1$$ && 0 < $$node$$1$$.length && $$node$$1$$.hasClass("oj-tree-node"), $dt$$2$$ = $e$$133$$.originalEvent.dataTransfer, $cons$$5$$ = $oj$$79$$.$TreeDndContext$, $bForeignTree$$ = !1, $bClean$$ = !1, $ret$$72$$;
      ...
      if ($dnd$$7$$.$foreign$ = !$dnd$$7$$.$dragStarted$, !$dnd$$7$$.$foreign$ && !$dnd$$7$$.reorder || $dnd$$7$$.$foreign$ && this.$_isDtType$($dt$$2$$, $cons$$5$$.$_DND_INTERNAL_DT_REORDER$)) {
        ...
        if (!$$node$$1$$ || !$$node$$1$$.length || $$node$$1$$.attr("id") != $dnd$$7$$.$nodeDraggedId$) {
          ...
          if (this.$_dndEnter$()) {
            ...
            $dnd$$7$$.$dropDragEnterCallback$ && ($ret$$72$$ = $dnd$$7$$.$dropDragEnterCallback$($e$$133$$, {item:$dnd$$7$$.$bInternalNode$ ? null : $$node$$1$$, position:$dnd$$7$$.$bInternalNode$ ? "first" : $dnd$$7$$.$place$, reference:$dnd$$7$$.$bInternalNode$ ? null : $vars$$2$$.$r$}));
            if (void 0 === $ret$$72$$) {
              this.$_isDtAcceptDataTypes$($dt$$2$$) ? ($e$$133$$.preventDefault(), $e$$133$$.stopPropagation()) : $bClean$$ = $dnd$$7$$.$foreign$ || !$dnd$$7$$.reorder;
            } else {
              if (!1 === $ret$$72$$ || $e$$133$$.isDefaultPrevented()) {
  ...
  $oj$$79$$.$TreeDndContext$.prototype.$_dragOver$ = function $$oj$$79$$$$TreeDndContext$$$$_dragOver$$($e$$134$$) {
    var $dnd$$8$$ = this.$_dnd$, $vars$$3$$ = $dnd$$8$$.$vars$, $dt$$3$$ = $e$$134$$.originalEvent.dataTransfer, $bClean$$1$$ = !1, $elemId$$2$$, $$node$$2$$, $ret$$73$$;
    if ($vars$$3$$.$r$ && $vars$$3$$.$r$.length && ($$node$$2$$ = $vars$$3$$.$r$, $$node$$2$$.hasClass("oj-tree-node") && ($elemId$$2$$ = $$node$$2$$.attr("id"), $elemId$$2$$ != $dnd$$8$$.$nodeDraggedId$ && (this.$_dndPlacement$($e$$134$$, $$node$$2$$), this.$_dndPrepare$())))) {
      $dnd$$8$$.$dropDragOverCallback$ && ($ret$$73$$ = $dnd$$8$$.$dropDragOverCallback$($e$$134$$, {item:$dnd$$8$$.$bInternalNode$ ? null : $$node$$2$$, reference:$dnd$$8$$.$bInternalNode$ ? null : $vars$$3$$.$r$, position:$dnd$$8$$.$bInternalNode$ ? "first" : $vars$$3$$.$last_pos$}));
      if (void 0 === $ret$$73$$) {
        this.$_isDtAcceptDataTypes$($dt$$3$$) ? ($e$$134$$.preventDefault(), $e$$134$$.stopPropagation()) : $bClean$$1$$ = $dnd$$8$$.$foreign$ || !$dnd$$8$$.reorder;
      } else {
        if (!1 === $ret$$73$$ || $e$$134$$.isDefaultPrevented()) {
  ...
  $oj$$79$$.$TreeDndContext$.prototype.$_dragDrop$ = function $$oj$$79$$$$TreeDndContext$$$$_dragDrop$$($e$$135$$) {
    var $dnd$$9$$ = this.$_dnd$, $vars$$4$$ = $dnd$$9$$.$vars$, $veto$$ = !1, $ret$$74$$;
    if ($vars$$4$$.$r$) {
      if ($dnd$$9$$.$dropDropCallback$) {
        $ret$$74$$ = $dnd$$9$$.$dropDropCallback$($e$$135$$, {reference:$dnd$$9$$.$bInternalNode$ ? null : $vars$$4$$.$r$, position:$dnd$$9$$.$bInternalNode$ ? "first" : $vars$$4$$.$last_pos$, reorder:!$dnd$$9$$.$foreign$ && $dnd$$9$$.reorder});
      } else {
        if ($dnd$$9$$.$foreign$ || !$dnd$$9$$.reorder) {
          $veto$$ = !0;
        }
      }
      $veto$$ || $ret$$74$$ && !$e$$135$$.isDefaultPrevented() || this.$_dndFinishReorder$($e$$135$$);
    }
  ...
  $oj$$79$$.$TreeDndContext$.prototype.$_dragEnd$ = function $$oj$$79$$$$TreeDndContext$$$$_dragEnd$$($e$$136$$) {
  ...
  $oj$$79$$.$TreeDndContext$.prototype.$_dragLeave$ = function $$oj$$79$$$$TreeDndContext$$$$_dragLeave$$($e$$137$$) {
  ...
  $oj$$79$$.$TreeDndContext$.prototype.$_dndFinishReorder$ = function $$oj$$79$$$$TreeDndContext$$$$_dndFinishReorder$$($e$$138$$) {
    var $dnd$$14$$ = this.$_dnd$, $vars$$9$$ = $dnd$$14$$.$vars$;
    $dnd$$14$$.$dragStarted$ && $dnd$$14$$.reorder && "object" == typeof $vars$$9$$.$o$ && 0 < $vars$$9$$.$o$.length && (this.$component$.$_moveNode$($vars$$9$$.$o$, $vars$$9$$.$r$, $vars$$9$$.$last_pos$, $oj$$79$$.$DomUtils$.$isMetaKeyPressed$($e$$138$$)), $vars$$9$$.$o$ = !1);
  };
  $oj$$79$$.$TreeDndContext$.prototype.$_dndFinishSelection$ = function $$oj$$79$$$$TreeDndContext$$$$_dndFinishSelection$$($children$$33_node$$181$$) {
    ...
    var $len$$24$$ = ($children$$33_node$$181$$ = this.$component$.getChildren($children$$33_node$$181$$)) && $children$$33_node$$181$$.length ? $children$$33_node$$181$$.length : 0, $i$$489$$;
    for ($i$$489$$ = 0;$i$$489$$ < $len$$24$$;$i$$489$$++) {
      this.$_dndFinishSelection$($$$$72$$($children$$33_node$$181$$[$i$$489$$]));
    }
  };
  $oj$$79$$.$TreeDndContext$.prototype.$_dndPlacement$ = function $$oj$$79$$$$TreeDndContext$$$$_dndPlacement$$($e$$139$$, $$node$$4$$) {
  ...
  $oj$$79$$.$TreeDndContext$.prototype.$_dndLeave$ = function $$oj$$79$$$$TreeDndContext$$$$_dndLeave$$($e$$140$$) {
  ...
  $oj$$79$$.$TreeDndContext$.prototype.$_dndStartDrag$ = function $$oj$$79$$$$TreeDndContext$$$$_dndStartDrag$$($$cnt_$nodes$$1$$, $$node$$5$$, $e$$141$$) {
  ...
  $oj$$79$$.$TreeDndContext$.prototype.$_setDataTypes$ = function $$oj$$79$$$$TreeDndContext$$$$_setDataTypes$$($dt$$6$$, $$nodes$$2$$) {
    var $dnd$$23$$ = this.$_dnd$, $cons$$12$$ = $oj$$79$$.$TreeDndContext$, $adata$$1_i$$490$$, $data$$184$$;
    ($adata$$1_i$$490$$ = this.$component$.$__getJson$($$nodes$$2$$)) && ($data$$184$$ = JSON.stringify($adata$$1_i$$490$$));
    if ($dnd$$23$$.$dragDataTypes$) {
      for ($adata$$1_i$$490$$ = 0;$adata$$1_i$$490$$ < $dnd$$23$$.$dragDataTypes$.length;$adata$$1_i$$490$$++) {
        $dt$$6$$.setData($dnd$$23$$.$dragDataTypes$[$adata$$1_i$$490$$], $data$$184$$);
      }
    }
    $dt$$6$$.setData($cons$$12$$.$_DND_INTERNAL_DT$, "0");
    $dnd$$23$$.$pureReorder$ && $dt$$6$$.setData($cons$$12$$.$_DND_INTERNAL_DT_REORDER$, "0");
  };
  $oj$$79$$.$TreeDndContext$.prototype.$_isDtType$ = function $$oj$$79$$$$TreeDndContext$$$$_isDtType$$($dt$$7$$, $type$$109$$) {
    var $aTypes$$ = $dt$$7$$.types, $len$$25$$ = $aTypes$$.length, $i$$491$$;
    for ($i$$491$$ = 0;$i$$491$$ < $len$$25$$;$i$$491$$++) {
      if ($type$$109$$ == $aTypes$$[$i$$491$$]) {
        return!0;
      }
    }
    return!1;
  ...
  $oj$$79$$.$TreeDndContext$.prototype.$_isDtAcceptDataTypes$ = function $$oj$$79$$$$TreeDndContext$$$$_isDtAcceptDataTypes$$($dt$$8$$) {
    var $comps$$1$$ = this.$_dnd$.$dropDataTypes$, $ret$$77$$ = !1, $i$$492$$;
    if ($comps$$1$$) {
      for ($ret$$77$$ = !(0 < $comps$$1$$.length), $i$$492$$ = 0;$i$$492$$ < $comps$$1$$.length;$i$$492$$++) {
        if (this.$_isDtType$($dt$$8$$, $comps$$1$$[$i$$492$$])) {
          $ret$$77$$ = !0;
          break;
        }
      }
  ...
  $oj$$79$$.$TreeDndContext$.prototype.$_checkAddedDataTypes$ = function $$oj$$79$$$$TreeDndContext$$$$_checkAddedDataTypes$$($aTypes$$1_dt$$9$$) {
    var $len$$26$$ = ($aTypes$$1_dt$$9$$ = $aTypes$$1_dt$$9$$.types) && $aTypes$$1_dt$$9$$.length ? $aTypes$$1_dt$$9$$.length : 0, $cons$$13$$ = $oj$$79$$.$TreeDndContext$, $ret$$78$$ = !1, $type$$110$$, $i$$493$$;
    for ($i$$493$$ = 0;$i$$493$$ < $len$$26$$;$i$$493$$++) {
      if ($type$$110$$ = $aTypes$$1_dt$$9$$[$i$$493$$], $type$$110$$ != $cons$$13$$.$_DND_INTERNAL_DT$ && $type$$110$$ != $cons$$13$$.$_DND_INTERNAL_DT_REORDER$) {
        $ret$$78$$ = !0;
        break;
      }
    }
