 ...
 */
"use strict";
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtTreeView"], function($oj$$68$$, $$$$62$$, $comp$$15$$, $base$$11$$, $dvt$$8$$) {
  $oj$$68$$.$__registerWidget$("oj.ojSunburst", $$$$62$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{optionChange:null, rotateInput:null}, $_CreateDvtComponent$:function($context$$158$$, $callback$$126$$, $callbackObj$$11$$) {
    return $dvt$$8$$.Sunburst.newInstance($context$$158$$, $callback$$126$$, $callbackObj$$11$$);
  ...
  }, getContextByNode:function($context$$159_node$$124$$) {
    return($context$$159_node$$124$$ = this.getSubIdByNode($context$$159_node$$124$$)) && "oj-sunburst-tooltip" !== $context$$159_node$$124$$.subId ? $context$$159_node$$124$$ : null;
