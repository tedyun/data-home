...
define(["ojs/ojcore", "jquery", "ojs/ojdatasource-common"], function($oj$$25$$, $$$$24$$) {
  ...
  $oj$$25$$.$ArrayTableDataSource$.prototype.change = function $$oj$$25$$$$ArrayTableDataSource$$$change$($m$$20$$, $options$$284$$) {
    ...
    this.$_checkDataLoaded$();
    var $silent$$23$$ = $options$$284$$.silent, $i$$311$$, $row$$33$$, $key$$134$$, $changedRow$$, $rowArray$$4$$ = {data:[], keys:[], indexes:[]};
    $m$$20$$ instanceof Array || ($m$$20$$ = [$m$$20$$]);
    for ($i$$311$$ = 0;$i$$311$$ < $m$$20$$.length;$i$$311$$++) {
      $row$$33$$ = $m$$20$$[$i$$311$$], null != $row$$33$$ && ($key$$134$$ = this.$_getId$($row$$33$$), $changedRow$$ = this.$_getInternal$($key$$134$$, null), $rowArray$$4$$.data.push($row$$33$$), $rowArray$$4$$.keys.push($key$$134$$), $rowArray$$4$$.indexes.push($changedRow$$.index), this.$_rows$.data[$changedRow$$.index] = $row$$33$$);
    }
  ...
  $oj$$25$$.$ArrayTableDataSource$.prototype.sort = function $$oj$$25$$$$ArrayTableDataSource$$$sort$($criteria$$2$$) {
    ...
    this.$_checkDataLoaded$();
    var $key$$135$$ = $criteria$$2$$.key, $direction$$7$$ = $criteria$$2$$.direction, $comparator$$9$$ = null;
    "ascending" == $direction$$7$$ ? $comparator$$9$$ = function $$comparator$$9$$$($row$$34$$) {
      return $$$$24$$.isFunction($row$$34$$[$key$$135$$]) ? $row$$34$$[$key$$135$$]() : $row$$34$$[$key$$135$$];
    } : "descending" == $direction$$7$$ && ($comparator$$9$$ = function $$comparator$$9$$$($rowA$$, $rowB$$) {
      var $a$$109$$, $b$$66$$;
      $$$$24$$.isFunction($rowA$$[$key$$135$$]) ? ($a$$109$$ = $rowA$$[$key$$135$$](), $b$$66$$ = $rowB$$[$key$$135$$]()) : ($a$$109$$ = $rowA$$[$key$$135$$], $b$$66$$ = $rowB$$[$key$$135$$]);
  ...
  $oj$$25$$.$ArrayTableDataSource$.prototype.$_addToRowSet$ = function $$oj$$25$$$$ArrayTableDataSource$$$$_addToRowSet$$($m$$22$$, $index$$189$$, $i$$313_options$$289$$) {
    ...
    for ($i$$313_options$$289$$ = 0;$i$$313_options$$289$$ < $m$$22$$.length;$i$$313_options$$289$$++) {
      if ($row$$35$$ = $m$$22$$[$i$$313_options$$289$$], null != $row$$35$$) {
        $j$$40_key$$136$$ = this.$_getId$($row$$35$$);
        ...
        if (!0 == this.$_sorted$ && 0 < this.$_rows$.data.length) {
          for ($j$$40_key$$136$$ = 0;$j$$40_key$$136$$ < this.$_rows$.data.length;$j$$40_key$$136$$++) {
            if (0 > $oj$$25$$.$ArrayTableDataSource$.$_sortFunc$($row$$35$$, this.$_rows$.data[$j$$40_key$$136$$], this.comparator, this)) {
              this.$_rows$.data.splice($j$$40_key$$136$$, 0, $row$$35$$);
  ...
  $oj$$25$$.$ArrayTableDataSource$.prototype.$_fetchInternal$ = function $$oj$$25$$$$ArrayTableDataSource$$$$_fetchInternal$$($options$$290$$) {
    ...
    this.$_checkDataLoaded$();
    var $pageSize$$4_result$$59$$;
    try {
      $pageSize$$4_result$$59$$ = 0 < $options$$290$$.pageSize ? $options$$290$$.pageSize : -1;
      this.$_startIndex$ || (this.$_startIndex$ = 0);
      this.$_startIndex$ = null == $options$$290$$.startIndex ? this.$_startIndex$ : $options$$290$$.startIndex;
      var $endIndex$$4$$ = $oj$$25$$.$ArrayTableDataSource$.$_getEndIndex$(this.$_rows$, this.$_startIndex$, $pageSize$$4_result$$59$$), $rowArray$$6$$ = [], $keyArray$$ = [], $i$$314$$;
    ...
    $options$$290$$.pageSize = $pageSize$$4_result$$59$$;
    $options$$290$$.startIndex = this.$_startIndex$;
    $options$$290$$.refresh = !0;
    $pageSize$$4_result$$59$$ = {data:$rowArray$$6$$, keys:$keyArray$$, startIndex:this.$_startIndex$};
    this.$_endFetch$($options$$290$$, $pageSize$$4_result$$59$$, null);
    return Promise.resolve($pageSize$$4_result$$59$$);
  };
  $oj$$25$$.$ArrayTableDataSource$.prototype.$_getInternal$ = function $$oj$$25$$$$ArrayTableDataSource$$$$_getInternal$$($id$$32$$) {
    var $i$$315$$, $j$$41$$, $row$$36$$, $key$$137$$, $result$$60$$ = null;
    for ($i$$315$$ = 0;$i$$315$$ < this.$_rows$.data.length;$i$$315$$++) {
      if ($row$$36$$ = this.$_rows$.data[$i$$315$$], void 0 !== $row$$36$$) {
        if ($key$$137$$ = this.$_getId$($row$$36$$), $$$$24$$.isArray($key$$137$$) && $$$$24$$.isArray($id$$32$$)) {
          if ($key$$137$$.length == $id$$32$$.length) {
            var $equal$$ = !0;
            for ($j$$41$$ = 0;$j$$41$$ < $id$$32$$.length;$j$$41$$++) {
              if ($key$$137$$[$j$$41$$] != $id$$32$$[$j$$41$$]) {
                $equal$$ = !1;
                break;
              }
            }
            $equal$$ && ($result$$60$$ = {data:$row$$36$$, key:$key$$137$$, index:this.$_rows$.indexes[$i$$315$$]});
          }
        } else {
          $key$$137$$ == $id$$32$$ && ($result$$60$$ = {data:$row$$36$$, key:$key$$137$$, index:this.$_rows$.indexes[$i$$315$$]});
        }
      }
    }
    return $result$$60$$;
  ...
  $oj$$25$$.$ArrayTableDataSource$.prototype.$_removeInternal$ = function $$oj$$25$$$$ArrayTableDataSource$$$$_removeInternal$$($m$$23$$, $options$$292$$) {
    var $i$$317$$, $deletedRow_key$$138_row$$37$$;
    ...
    for ($i$$317$$ = 0;$i$$317$$ < $m$$23$$.length;$i$$317$$++) {
      $deletedRow_key$$138_row$$37$$ = $m$$23$$[$i$$317$$], null != $deletedRow_key$$138_row$$37$$ && ($deletedRow_key$$138_row$$37$$ = this.$_getId$($deletedRow_key$$138_row$$37$$), $deletedRow_key$$138_row$$37$$ = this.$_getInternal$($deletedRow_key$$138_row$$37$$, null), null != $deletedRow_key$$138_row$$37$$ && $sortedRowArray$$.push({data:$deletedRow_key$$138_row$$37$$.data, key:$deletedRow_key$$138_row$$37$$.key, index:$deletedRow_key$$138_row$$37$$.index}));
    }
