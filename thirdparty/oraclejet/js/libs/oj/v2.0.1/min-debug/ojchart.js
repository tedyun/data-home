...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtChart"], function($oj$$27$$, $$$$26$$, $comp$$7$$, $base$$6$$, $dvt$$3$$) {
  $oj$$27$$.$__registerWidget$("oj.ojChart", $$$$26$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{categoryFilter:null, categoryHighlight:null, optionChange:null, selectInput:null, viewportChange:null, viewportChangeInput:null, drill:null}, $_CreateDvtComponent$:function($context$$110$$, $callback$$103$$, $callbackObj$$5$$) {
    return $dvt$$3$$.Chart.newInstance($context$$110$$, $callback$$103$$, $callbackObj$$5$$);
    ...
    var $selectedItems$$6_type$$87_viewportChangePayload$$ = $event$$381$$.type;
    if ("selection" === $selectedItems$$6_type$$87_viewportChangePayload$$) {
      var $selectPayload_selection$$14$$ = $event$$381$$.selection;
      if ($selectPayload_selection$$14$$) {
        for (var $selectedItems$$6_type$$87_viewportChangePayload$$ = [], $i$$322$$ = 0;$i$$322$$ < $selectPayload_selection$$14$$.length;$i$$322$$++) {
          $selectedItems$$6_type$$87_viewportChangePayload$$.push({id:$selectPayload_selection$$14$$[$i$$322$$].id, series:$selectPayload_selection$$14$$[$i$$322$$].series, group:$selectPayload_selection$$14$$[$i$$322$$].group});
        }
        $selectPayload_selection$$14$$ = {endGroup:$event$$381$$.endGroup, startGroup:$event$$381$$.startGroup, xMax:$event$$381$$.xMax, xMin:$event$$381$$.xMin, yMax:$event$$381$$.yMax, yMin:$event$$381$$.yMin, y2Max:$event$$381$$.y2Max, y2Min:$event$$381$$.y2Min};
        $event$$381$$.complete ? this.$_UserOptionChange$("selection", $selectedItems$$6_type$$87_viewportChangePayload$$, $selectPayload_selection$$14$$) : ($selectPayload_selection$$14$$.items = $selectedItems$$6_type$$87_viewportChangePayload$$, this._trigger("selectInput", null, $selectPayload_selection$$14$$));
      }
    } else {
      "categoryHide" === $selectedItems$$6_type$$87_viewportChangePayload$$ || "categoryShow" === $selectedItems$$6_type$$87_viewportChangePayload$$ ? (this._trigger("categoryFilter", null, {category:$event$$381$$.category, type:"categoryHide" === $selectedItems$$6_type$$87_viewportChangePayload$$ ? "out" : "in"}), this.$_UserOptionChange$("hiddenCategories", $event$$381$$.hiddenCategories)) : "categoryHighlight" === $selectedItems$$6_type$$87_viewportChangePayload$$ ? (this._trigger("categoryHighlight", 
      null, {categories:$event$$381$$.categories, type:$event$$381$$.categories && 0 < $event$$381$$.categories.length ? "on" : "off"}), this.$_UserOptionChange$("highlightedCategories", $event$$381$$.categories)) : "viewportChange" === $selectedItems$$6_type$$87_viewportChangePayload$$ ? ($selectedItems$$6_type$$87_viewportChangePayload$$ = {endGroup:$event$$381$$.endGroup, startGroup:$event$$381$$.startGroup, xMax:$event$$381$$.xMax, xMin:$event$$381$$.xMin, yMax:$event$$381$$.yMax, yMin:$event$$381$$.yMin}, 
      ...
      this.options.yAxis.viewportMax = $event$$381$$.yMax)), this._trigger($event$$381$$.complete ? "viewportChange" : "viewportChangeInput", null, $selectedItems$$6_type$$87_viewportChangePayload$$)) : "drill" === $selectedItems$$6_type$$87_viewportChangePayload$$ ? this._trigger("drill", null, {id:$event$$381$$.id, series:$event$$381$$.series, group:$event$$381$$.group}) : this._super($event$$381$$);
    }
  ...
  }, getContextByNode:function($context$$111_node$$81$$) {
    return($context$$111_node$$81$$ = this.getSubIdByNode($context$$111_node$$81$$)) && "oj-chart-tooltip" !== $context$$111_node$$81$$.subId ? $context$$111_node$$81$$ : null;
  }, $_GetComponentDeferredDataPaths$:function() {
    return{root:["groups", "series"]};
  }, whenReady:function() {
    return this._super();
  }});
  $oj$$27$$.$__registerWidget$("oj.ojSparkChart", $$$$26$$.oj.dvtBaseComponent, {widgetEventPrefix:"oj", options:{}, $_CreateDvtComponent$:function($context$$112$$, $callback$$104$$, $callbackObj$$6$$) {
    return $dvt$$3$$.SparkChart.newInstance($context$$112$$, $callback$$104$$, $callbackObj$$6$$);
  }, $_GetComponentStyleClasses$:function() {
