...
define(["ojs/ojcore", "jquery", "ojs/ojeditablevalue", "ojs/ojinputtext", "ojs/ojvalidation", "ojs/ojpopup", "ojs/ojbutton"], function($oj$$13$$, $$$$13$$) {
  function $coerceIsoString$$($value$$206$$) {
    return this.options.converter.parse($value$$206$$);
  }
  ...
  stepMonths:"numberOfMonths", stepBigMonths:12, weekDisplay:"none", yearRange:"c-10:c+10"}, converter:$oj$$13$$.$Validation$.$converterFactory$($oj$$13$$.$ConverterFactory$.CONVERTER_TYPE_DATETIME).createConverter({day:"2-digit", month:"2-digit", year:"2-digit"}), max:void 0, min:void 0, dayFormatter:null}, $_InitBase$:function __InitBase() {
    ...
    this.options.dayMetaData && (this.options.dayFormatter = function($value$$207$$) {
      return function($dateInfo$$) {
        return $_getMetaData$$($value$$207$$, 0, [$dateInfo$$.fullYear, $dateInfo$$.month, $dateInfo$$.date]);
      };
    ...
    return $ret$$22$$;
  }, _setOption:function __setOption$$1($key$$64$$, $value$$208$$, $flags$$20_updateDatePicker$$) {
    var $retVal$$9$$ = null;
    if ("value" === $key$$64$$) {
      return $value$$208$$ || ($value$$208$$ = null), $retVal$$9$$ = this._super($key$$64$$, $value$$208$$, $flags$$20_updateDatePicker$$), this.$_setCurrentDate$($value$$208$$), this.$_datepickerShowing$() && this.$_updateDatepicker$(!0), $retVal$$9$$;
    }
    if ("dayMetaData" === $key$$64$$) {
      this._setOption("dayFormatter", function($dateInfo$$1$$) {
        return $_getMetaData$$($value$$208$$, 0, [$dateInfo$$1$$.fullYear, $dateInfo$$1$$.month, $dateInfo$$1$$.date]);
      }, $flags$$20_updateDatePicker$$);
    } else {
      return $retVal$$9$$ = this._super($key$$64$$, $value$$208$$, $flags$$20_updateDatePicker$$), "disabled" === $key$$64$$ ? this.$_disableEnable$($value$$208$$) : "max" === $key$$64$$ || "min" === $key$$64$$ ? (this.$_datePickerDefaultValidators$[$oj$$13$$.$ValidatorFactory$.VALIDATOR_TYPE_DATETIMERANGE] = this.$_getValidator$("min"), this.$_AfterSetOptionValidators$()) : "readOnly" === $key$$64$$ && $value$$208$$ ? this.hide() : "dayFormatter" === $key$$64$$ && (this.$_datePickerDefaultValidators$[$oj$$13$$.$ValidatorFactory$.VALIDATOR_TYPE_DATERESTRICTION] = 
  ...
  }, $_selectDay$:function __selectDay($converterUtils$$1_isoString$$6_month$$5$$, $formatted$$4_value$$209_year$$5$$, $td_temp$$, $event$$135$$) {
    $$$$13$$($td_temp$$).hasClass(this.$_UNSELECTABLE_CLASS$) || this.options.disabled || (this.$_currentDay$ = $$$$13$$("a", $td_temp$$).html(), this.$_currentMonth$ = $converterUtils$$1_isoString$$6_month$$5$$, this.$_currentYear$ = $formatted$$4_value$$209_year$$5$$, $converterUtils$$1_isoString$$6_month$$5$$ = $oj$$13$$.$IntlConverterUtils$, ($formatted$$4_value$$209_year$$5$$ = this.options.value ? $converterUtils$$1_isoString$$6_month$$5$$.isoToLocalDate(this.options.value) : null) ? ($td_temp$$ = 
    new Date(this.$_currentYear$, this.$_currentMonth$, this.$_currentDay$), $copyTimeOver$$($formatted$$4_value$$209_year$$5$$, $td_temp$$), $formatted$$4_value$$209_year$$5$$ = $td_temp$$) : $formatted$$4_value$$209_year$$5$$ = new Date(this.$_currentYear$, this.$_currentMonth$, this.$_currentDay$), $converterUtils$$1_isoString$$6_month$$5$$ = $converterUtils$$1_isoString$$6_month$$5$$.dateToLocalIso($formatted$$4_value$$209_year$$5$$), $formatted$$4_value$$209_year$$5$$ = this.$_GetConverter$().format($converterUtils$$1_isoString$$6_month$$5$$), 
    this.$_SetDisplayValue$($formatted$$4_value$$209_year$$5$$), this.$_SetValue$($converterUtils$$1_isoString$$6_month$$5$$, $event$$135$$), this.hide());
    ...
    if (!this.$yearshtml$) {
      if (this.$yearshtml$ = "", $secondary$$ || "none" === $changeYear$$) {
        ...
        $determineYear_inMaxYear$$ = function $$determineYear_inMaxYear$$$($value$$210_year$$7$$) {
          $value$$210_year$$7$$ = $value$$210_year$$7$$.match(/c[+\-].*/) ? $drawYear$$1$$ + parseInt($value$$210_year$$7$$.substring(1), 10) : $value$$210_year$$7$$.match(/[+\-].*/) ? $thisYear$$ + parseInt($value$$210_year$$7$$, 10) : parseInt($value$$210_year$$7$$, 10);
          return isNaN($value$$210_year$$7$$) ? $thisYear$$ : $value$$210_year$$7$$;
        };
  ...
  options:{converter:$oj$$13$$.$Validation$.$converterFactory$($oj$$13$$.$ConverterFactory$.CONVERTER_TYPE_DATETIME).createConverter({hour:"2-digit", hour12:!0, minute:"2-digit"}), max:void 0, min:void 0, datePickerComp:null, timePicker:{timeIncrement:"00:30:00:00"}}, $_InitOptions$:function($originalDefaults$$9$$, $constructorOptions$$11$$) {
    ...
    return $ret$$25$$;
  }, _setOption:function __setOption$$2($key$$66$$, $value$$211$$, $flags$$21$$) {
    var $retVal$$11$$ = null;
    if ("value" === $key$$66$$) {
      return $value$$211$$ || ($value$$211$$ = null), $retVal$$11$$ = this._super($key$$66$$, $value$$211$$, $flags$$21$$), this.$_generateTime$(), $retVal$$11$$;
    }
    $retVal$$11$$ = this._superApply(arguments);
    "disabled" === $key$$66$$ ? ($value$$211$$ && this.hide(), this.$_triggerNode$.find("." + this.$_TRIGGER_TIME_CLASS$).attr("title", this.$_getTimeTitle$()), $disableEnableSpan$$(this.$_triggerNode$.children(), $value$$211$$)) : "max" !== $key$$66$$ && "min" !== $key$$66$$ || this.$_isContainedInDateTimePicker$() ? "readOnly" === $key$$66$$ && $value$$211$$ && this.hide() : (this.$_timePickerDefaultValidators$[$oj$$13$$.$ValidatorFactory$.VALIDATOR_TYPE_DATETIMERANGE] = $getImplicitDateTimeRangeValidator$$(this.options, 
  ...
  $_InitBase$:function __InitBase$$2() {
    ...
    return $ret$$27$$;
  }, _setOption:function __setOption$$3($key$$67$$, $value$$213$$, $flags$$22$$) {
    var $retVal$$13$$ = this._superApply(arguments);
    "value" === $key$$67$$ && (this.$_previousValue$ = $value$$213$$);
    this.$_timePicker$ && ($key$$67$$ in {disabled:!0, readOnly:!0} ? this.$_timePicker$.ojInputTime("option", $key$$67$$, $value$$213$$) : "timePicker" === $key$$67$$ ? this.$_timePicker$.ojInputTime("option", "timePicker.timeIncrement", $value$$213$$.timeIncrement) : "converter" === $key$$67$$ && (this.$_timeConverter$ = null, this.$_timePicker$.ojInputTime("option", $key$$67$$, this.$_getTimePickerConverter$(this.$_GetConverter$()))));
    return $retVal$$13$$;
    ...
    var $options$$235$$ = {}, $params$$17$$ = "hour hour12 minute second millisecond timeFormat".split(" "), $i$$175$$, $j$$26$$;
    $i$$175$$ = 0;
    for ($j$$26$$ = $params$$17$$.length;$i$$175$$ < $j$$26$$;$i$$175$$++) {
      $params$$17$$[$i$$175$$] in $converter$$6_resolvedOptions$$5_timeConverter$$1$$ && ("timeFormat" === $params$$17$$[$i$$175$$] && ($options$$235$$.formatType = "time"), $options$$235$$[$params$$17$$[$i$$175$$]] = $converter$$6_resolvedOptions$$5_timeConverter$$1$$[$params$$17$$[$i$$175$$]]);
    }
