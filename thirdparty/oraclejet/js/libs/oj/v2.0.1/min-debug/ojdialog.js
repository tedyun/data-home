...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojpopupcore", "jqueryui-amd/draggable", "jqueryui-amd/mouse"], function($oj$$40$$, $$$$37$$) {
  (function() {
    ...
    }, $_isNumber$:function($value$$278$$) {
      return!isNaN(parseInt($value$$278$$, 10));
    ...
    }, _setOption:function($isDraggable$$1_key$$159$$, $value$$279$$, $flags$$39$$) {
      var $isResizable_psOptions$$4_uiDialog$$;
      $isResizable_psOptions$$4_uiDialog$$ = this.$uiDialog$;
      if ("disabled" !== $isDraggable$$1_key$$159$$) {
        switch(this._super($isDraggable$$1_key$$159$$, $value$$279$$, $flags$$39$$), $isDraggable$$1_key$$159$$) {
          case "dragAffordance":
            ($isDraggable$$1_key$$159$$ = $isResizable_psOptions$$4_uiDialog$$.hasClass("oj-draggable")) && "none" === $value$$279$$ && ($isResizable_psOptions$$4_uiDialog$$.draggable("destroy"), this.$uiDialog$.removeClass("oj-draggable"));
            $isDraggable$$1_key$$159$$ || "title-bar" !== $value$$279$$ || this.$_makeDraggable$();
            break;
          case "position":
            this.$_position$();
            break;
          case "resizeBehavior":
            ...
            $isResizable_psOptions$$4_uiDialog$$ && "resizable" != $value$$279$$ && (this.$_resizableComponent$("instance") && this.$_resizableComponent$("destroy"), this.$_resizableComponent$ = null);
            $isResizable_psOptions$$4_uiDialog$$ || "resizable" !== $value$$279$$ || this.$_makeResizable$();
            break;
          case "title":
            this.$_title$(this.$uiDialogTitlebar$.find(".oj-dialog-title"));
            break;
          case "role":
            $isResizable_psOptions$$4_uiDialog$$.attr("role", $value$$279$$);
            break;
          case "modality":
            this.isOpen() && ($isResizable_psOptions$$4_uiDialog$$ = {}, $isResizable_psOptions$$4_uiDialog$$[$oj$$40$$.$PopupService$.$OPTION$.$POPUP$] = this.$uiDialog$, $isResizable_psOptions$$4_uiDialog$$[$oj$$40$$.$PopupService$.$OPTION$.$MODALITY$] = $value$$279$$, $oj$$40$$.$PopupService$.$getInstance$().$changeOptions$($isResizable_psOptions$$4_uiDialog$$));
            break;
          case "cancelBehavior":
            "none" === $value$$279$$ || "escape" === $value$$279$$ ? this.$_destroyCloseButton$() : "icon" === $value$$279$$ && (this.$userDefinedDialogHeader$ ? (this.$_destroyCloseButton$(), this.$_createCloseButton$(this.$_userDefinedHeader$), this.$_userDefinedTitle$ = this.$_userDefinedHeader$.find(".oj-dialog-title"), this.$_userDefinedTitle$.length && this.$_userDefinedTitle$.insertAfter(this.$uiDialogTitlebarCloseWrapper$)) : (this.$_destroyCloseButton$(), this.$_createCloseButton$(this.$uiDialogTitlebar$), 
  ...
  (function() {
    $oj$$40$$.$__registerWidget$("oj.ojResizable", $$$$37$$.oj.baseComponent, {version:"1.0.0", widgetEventPrefix:"oj", options:{cancel:"input,textarea,button,select,option", distance:1, delay:0, maxHeight:null, maxWidth:null, minHeight:10, minWidth:10, alsoResize:!1, animate:!1, animateDuration:"slow", animateEasing:"swing", containment:!1, ghost:!1, grid:!1, handles:"e,s,se", helper:!1, resize:null, start:null, stop:null}, $_num$:function($value$$280$$) {
      ...
      this._super();
      var $n$$24_o$$, $i$$349_mouseConstructor$$, $handle$$19$$, $axis$$44$$, $hname$$, $that$$4$$ = this;
      $n$$24_o$$ = this.options;
      $i$$349_mouseConstructor$$ = this.element.mouse.bind(this.element);
      $i$$349_mouseConstructor$$();
      this.$mouse$ = $i$$349_mouseConstructor$$("instance");
      ...
      if (this.handles.constructor === String) {
        for ("all" === this.handles && (this.handles = "n,e,s,w,se,sw,ne,nw"), $n$$24_o$$ = this.handles.split(","), this.handles = {}, $i$$349_mouseConstructor$$ = 0;$i$$349_mouseConstructor$$ < $n$$24_o$$.length;$i$$349_mouseConstructor$$++) {
          $handle$$19$$ = $$$$37$$.trim($n$$24_o$$[$i$$349_mouseConstructor$$]), $hname$$ = "oj-resizable-" + $handle$$19$$, $axis$$44$$ = $$$$37$$("\x3cdiv class\x3d'oj-resizable-handle " + $hname$$ + "'\x3e\x3c/div\x3e"), this.handles[$handle$$19$$] = ".oj-resizable-" + $handle$$19$$, this.element.append($axis$$44$$);
        }
      }
      this.$_renderAxis$ = function $this$$_renderAxis$$() {
        for (var $i$$350$$ in this.handles) {
          this.handles[$i$$350$$].constructor === String && (this.handles[$i$$350$$] = this.element.children(this.handles[$i$$350$$]).first().show());
        }
      };
      this.$_renderAxis$();
      ...
      var $i$$351$$, $handle$$20$$, $capture$$ = !1;
      for ($i$$351$$ in this.handles) {
        if ($handle$$20$$ = $$$$37$$(this.handles[$i$$351$$])[0], $handle$$20$$ === $event$$452$$.target || $$$$37$$.contains($handle$$20$$, $event$$452$$.target)) {
          $capture$$ = !0;
        }
      }
      ...
      if (this.$_proportionallyResizeElements$.length) {
        var $i$$352$$, $j$$43$$, $borders$$, $paddings$$, $prel$$, $element$$137$$ = this.helper || this.element;
        for ($i$$352$$ = 0;$i$$352$$ < this.$_proportionallyResizeElements$.length;$i$$352$$++) {
          $prel$$ = this.$_proportionallyResizeElements$[$i$$352$$];
          if (!this.$borderDif$) {
          ...
          $prel$$.css({height:$element$$137$$.height() - this.$borderDif$[0] - this.$borderDif$[2] || 0, width:$element$$137$$.width() - this.$borderDif$[1] - this.$borderDif$[3] || 0});
        }
      }
      ...
      function $_alsoResize$$($exp$$6$$, $c$$45$$) {
        $$$$37$$($exp$$6$$).each(function() {
          ...
          $$$$37$$.each($c$$45$$ && $c$$45$$.length ? $c$$45$$ : $el$$15$$.parents($ui$$29$$.$originalElement$[0]).length ? ["width", "height"] : ["width", "height", "top", "left"], function($i$$353$$, $prop$$72$$) {
      ...
      var $element$$138$$, $p$$6$$, $co_oc$$, $ch$$3_height$$26$$, $cw$$1_width$$28$$, $that$$8$$ = this, $ce_el$$16$$ = $that$$8$$.element;
      ...
      if ($ce_el$$16$$ = $co_oc$$ instanceof $$$$37$$ ? $co_oc$$.get(0) : /parent/.test($co_oc$$) ? $ce_el$$16$$.parent().get(0) : $co_oc$$) {
        $that$$8$$.$containerElement$ = $$$$37$$($ce_el$$16$$), /document/.test($co_oc$$) || $co_oc$$ === document ? ($that$$8$$.$containerOffset$ = {left:0, top:0}, $that$$8$$.$containerPosition$ = {left:0, top:0}, $that$$8$$.$parentData$ = {element:$$$$37$$(document), left:0, top:0, width:$$$$37$$(document).width(), height:$$$$37$$(document).height() || document.body.parentNode.scrollHeight}) : ($element$$138$$ = $$$$37$$($ce_el$$16$$), $p$$6$$ = [], $$$$37$$(["Top", "Right", "Left", "Bottom"]).each(function($i$$354$$, 
        $name$$139$$) {
          $p$$6$$[$i$$354$$] = $that$$8$$.$_num$($element$$138$$.css("padding" + $name$$139$$));
        }), $that$$8$$.$containerOffset$ = $element$$138$$.offset(), $that$$8$$.$containerPosition$ = $element$$138$$.position(), $that$$8$$.$containerSize$ = {height:$element$$138$$.innerHeight() - $p$$6$$[3], width:$element$$138$$.innerWidth() - $p$$6$$[1]}, $co_oc$$ = $that$$8$$.$containerOffset$, $ch$$3_height$$26$$ = $that$$8$$.$containerSize$.height, $cw$$1_width$$28$$ = $that$$8$$.$containerSize$.width, $cw$$1_width$$28$$ = $that$$8$$.$_hasScroll$($ce_el$$16$$, "left") ? $ce_el$$16$$.scrollWidth : 
