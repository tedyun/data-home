...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "hammerjs", "ojs/ojpagingtabledatasource", "ojs/ojinputtext", "ojs/ojjquery-hammer"], function($oj$$10$$, $$$$10$$, $compCore$$, $Hammer$$2$$) {
  (function() {
    ...
    $_DATA_ATTR_PAGE_NUM$:"data-oj-pagenum", $_OPTION_ENABLED$:"enabled", $_OPTION_DISABLED$:"disabled", $_TAB_INDEX$:"tabindex", $_MODE$:{$_LOAD_MORE$:"loadMore", $_PAGE$:"page"}, $_PAGE_OPTION_LAYOUT$:{$_AUTO$:"auto", $_ALL$:"all", $_INPUT$:"input", $_RANGE_TEXT$:"rangeText", $_PAGES$:"pages", $_NAV$:"nav"}, $_PAGE_OPTION_DEFAULT_MAX_PAGE_LINKS$:6, $_TYPE$:{$_NUMBERS$:"numbers", $_DOTS$:"dots"}, firstPage:function() {
    ...
    }, _setOption:function($key$$47$$, $value$$184$$) {
      ...
      for ($i$$134$$ = 0;$i$$134$$ < $event$$100$$.indexes.length;$i$$134$$++) {
        var $rowIdx$$ = $event$$100$$.indexes[$i$$134$$], $startIndex$$4$$ = $data$$72$$.getStartItemIndex(), $endIndex$$ = $startIndex$$4$$ + $pageSize$$1$$;
      ...
      if (!this.$_isResizeListenerAdded$) {
        var $self$$65$$ = this;
        $oj$$10$$.$DomUtils$.$addResizeListener$($element$$68$$[0], function() {
      ...
      var $pageNum$$3_totalPages$$ = this.$_getTotalPages$(), $currentPage$$1_i$$137_pageAfterCurrent$$ = this.$_getCurrentPage$();
      $pageSize$$3_parentDiv$$ = this.options.pageSize;
      var $numPagesToAdd$$ = $numLinks_pageList$$;
      $numLinks_pageList$$ = [];
      if (0 <= $currentPage$$1_i$$137_pageAfterCurrent$$) {
        if (this.$_isTotalSizeConfidenceActual$() && $pageNum$$3_totalPages$$ <= $numPagesToAdd$$) {
          for ($numLinks_pageList$$[0] = 0, $currentPage$$1_i$$137_pageAfterCurrent$$ = 1;$currentPage$$1_i$$137_pageAfterCurrent$$ < $pageNum$$3_totalPages$$;$currentPage$$1_i$$137_pageAfterCurrent$$++) {
            $numLinks_pageList$$[$currentPage$$1_i$$137_pageAfterCurrent$$] = $currentPage$$1_i$$137_pageAfterCurrent$$;
          }
        } else {
          $numLinks_pageList$$.push(0);
          0 != $currentPage$$1_i$$137_pageAfterCurrent$$ && $numLinks_pageList$$.push($currentPage$$1_i$$137_pageAfterCurrent$$);
          $currentPage$$1_i$$137_pageAfterCurrent$$ != $pageNum$$3_totalPages$$ - 1 && this.$_isTotalSizeConfidenceActual$() && $numLinks_pageList$$.push($pageNum$$3_totalPages$$ - 1);
          var $numPagesToAdd$$ = $numPagesToAdd$$ - $numLinks_pageList$$.length, $pageBeforeCurrent$$ = $currentPage$$1_i$$137_pageAfterCurrent$$ - 1, $numPagesAfterCurrent$$ = 1;
          for (!this.$_isTotalSizeConfidenceActual$() || $currentPage$$1_i$$137_pageAfterCurrent$$ != $pageNum$$3_totalPages$$ - 1 && $currentPage$$1_i$$137_pageAfterCurrent$$ != $pageNum$$3_totalPages$$ - 2 || ($numPagesAfterCurrent$$ = 0);$numPagesToAdd$$ > $numPagesAfterCurrent$$ && 1 <= $pageBeforeCurrent$$;) {
            $numLinks_pageList$$.push($pageBeforeCurrent$$), $pageBeforeCurrent$$--, $numPagesToAdd$$--;
          }
          $currentPage$$1_i$$137_pageAfterCurrent$$ += 1;
          for (-1 == $pageNum$$3_totalPages$$ && ($numPagesToAdd$$ = 0 < $errSummary$$8_size$$22$$ && $errSummary$$8_size$$22$$ >= $pageSize$$3_parentDiv$$ ? 1 : 0);0 < $numPagesToAdd$$ && ($currentPage$$1_i$$137_pageAfterCurrent$$ <= $pageNum$$3_totalPages$$ || -1 == $pageNum$$3_totalPages$$);) {
            $numLinks_pageList$$.push($currentPage$$1_i$$137_pageAfterCurrent$$), $currentPage$$1_i$$137_pageAfterCurrent$$++, $numPagesToAdd$$--;
          }
        }
        $numLinks_pageList$$.sort(function($a$$101$$, $b$$61$$) {
          return $a$$101$$ - $b$$61$$;
        });
        for ($currentPage$$1_i$$137_pageAfterCurrent$$ = 0;$currentPage$$1_i$$137_pageAfterCurrent$$ < $numLinks_pageList$$.length;$currentPage$$1_i$$137_pageAfterCurrent$$++) {
          $pageNum$$3_totalPages$$ = $numLinks_pageList$$[$currentPage$$1_i$$137_pageAfterCurrent$$], this.$_createPagingControlNavPage$($errDetail$$1_pagingControlNavPagesLinks$$, $pageNum$$3_totalPages$$), $currentPage$$1_i$$137_pageAfterCurrent$$ != $numLinks_pageList$$.length - 1 && $pageNum$$3_totalPages$$ != $numLinks_pageList$$[$currentPage$$1_i$$137_pageAfterCurrent$$ + 1] - 1 && this.$_createPagingControlNavPage$($errDetail$$1_pagingControlNavPagesLinks$$, -1);
        }
